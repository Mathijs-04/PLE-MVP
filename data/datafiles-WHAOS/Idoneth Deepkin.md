...
#### Concealing Tide (Activated)
- **Timing:** Once Per Battle Round, Any Hero Phase
- **Declare:** You can only use this ability if you did not use it in the previous battle round and you have not used any other Tidal abilities this round.
...
#### Swift Tide (Activated)
- **Timing:** Once Per Battle Round, Any Hero Phase
- **Declare:** You can only use this ability if you used the 'Concealing Tide' ability in the previous battle round and you have not used any other Tidal abilities this round.
...
#### Sea's Embrace (Activated)
- **Timing:** Once Per Battle Round, Your Hero Phase
- **Declare:** You can only use this ability if you used the 'Swift Tide' ability in the previous battle round and you have not used any other Tidal abilities this round.
- **Effect:** Friendly Idoneth Deepkin units have Strike-first for the rest of the turn.
- **Keywords:** Tidal

#### Unpredictable Tide (Activated)
- **Timing:** Once Per Battle Round, Your Hero Phase
- **Declare:** You can only use this ability if you did not use it in the previous battle round and you have not used any other Tidal abilities this round. Pick a friendly Idoneth Deepkin unit that is not in combat to be the target.
...
#### Inexorable Tide (Activated)
- **Timing:** Once Per Battle Round, Any Hero Phase
- **Declare:** You can only use this ability if you used the 'Unpredictable Tide' ability in the previous battle round and you have not used any other Tidal abilities this round.
...
#### Storm's Wrath (Activated)
- **Timing:** Once Per Battle Round, Your Hero Phase
- **Declare:** You can only use this ability if you used the 'Inexorable Tide' ability in the previous battle round and you have not used any other Tidal abilities this round.
- **Effect:** Friendly Idoneth Deepkin units' melee weapons have Crit (Mortal) for the rest of the turn.
- **Keywords:** Tidal

### Artefacts of Power

#### Lifekelp Pod (Activated)
...
#### Nightmare Legacy (Passive)
- **Effect:** Subtract 3 from the control scores of enemy units while they are within 6” of this unit.

#### Hunter of Souls (Passive)
- **Effect:** Pick 1 of the following weapon abilities for this unit’s melee weapons to have
this battle:
• Anti-Cavalry (+1 Rend)
• Anti-Infantry(+1 Rend)
• Anti-Monster(+1 Rend)

#### Endless Sea-Storm (Activated)
...
**Keywords:** HERO, IDONETH DEEPKIN, AELF, UNIQUE, ORDER, INFANTRY, ISHARANN, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Meloch’s Tentacles and Weapons | Melee | - | 8 | 4+ | 4+ | 1 | 1 | Companion |

**Abilities:**

#### Fount of Willpower (Activated)
- **Timing:** Once Per Turn, Reaction: You declared a Spell ability for a friendly Isharann unit wholly within 12" of this unit
- **Effect:** Remove 1 of this unit's soul-quota tokens. Then, you can re-roll the casting roll.

#### Catalogue of Souls (Passive)
- **Effect:** Each time an enemy unit is destroyed, give this unit a soul-quota token.

#### Empowered by Memory (Spell)
...
**Keywords:** HERO, FLY, MONSTER, WARD (5+), IDONETH DEEPKIN, AELF, EIDOLON, ORDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spear of Repressed Fury and Crulhook | Melee | - | 7 | 3+ | 2+ | 2 | 2 | Charge (+1 Damage) |

**Abilities:**

#### Drench With Hate (Passive)
...
#### Pulled Into the Depths (Activated)
...
**Points:** 340 | **Move:** 10" | **Health:** 12 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, FLY, MONSTER, WARD (5+), IDONETH DEEPKIN, AELF, EIDOLON, WIZARD (2), ORDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blasts of Abyssal Energy | Ranged | 12" | 3 | 3+ | 3+ | 2 | D3 | - |
| Psi-trident and Deep-sea Sceptre | Melee | - | 7 | 3+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Dormant Energies (Passive)
- **Effect:** Add 1 to casting rolls for this unit.

#### Tranquillity of the Abyss (Passive)
...
### Akhelian King
**Points:** 160 | **Move:** 12" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, FLY, IDONETH DEEPKIN, AELF, CAVALRY, AKHELIAN, ORDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Deepmare’s Fangs, Talons and Lashing Tails | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Companion |
| Akhelian Royal Weapons | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Charge (+1 Damage) |

**Abilities:**

#### Wave Rider (Activated)
...
**Points:** 230 | **Move:** 12" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, FLY, IDONETH DEEPKIN, AELF, WARMASTER, CAVALRY, UNIQUE, AKHELIAN, ORDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| The Astra Solus | Melee | - | 6 | 2+ | 3+ | 1 | 2 | Charge (+1 Damage) |
| Uasall’s Fangs, Talons and Lashing Tails | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Companion |

**Abilities:**

#### First Among Akhelians (Passive)
...
#### Supreme Lord of Tides (Activated)
...
**Keywords:** HERO, IDONETH DEEPKIN, AELF, ORDER, WIZARD (1), ISHARANN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Pelagic Staff | Melee | - | 4 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Master of the Ethersea (Activated)
...
### Isharann Soulscryer
**Points:** 100 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, IDONETH DEEPKIN, AELF, ORDER, ISHARANN, INFANTRY, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Abyssal Touch | Melee | - | 4 | 3+ | 4+ | - | D3 | - |

**Abilities:**

#### Finder of Ways (Activated)
- **Timing:** Reaction: You declared the 'Unpredictable Tide' ability or the 'Steed of Tides' ability
...
### Isharann Soulrender
**Points:** 90 | **Move:** 6" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, IDONETH DEEPKIN, AELF, ORDER, ISHARANN, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rakerdart’s Serrated Bill | Melee | - | 3 | 4+ | 4+ | 1 | 1 | Companion |
| Talúnhook | Melee | - | 4 | 3+ | 4+ | 1 | 2 | - |
...
**Keywords:** HERO, IDONETH DEEPKIN, AELF, ORDER, INFANTRY, AKHELIAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Esoteric Weapons | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Thrallmaster (Activated)
...
### Ikon of the Sea
**Points:** 120 | **Move:** 7" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, IDONETH DEEPKIN, AELF, ORDER, INFANTRY, AKHELIAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Tidal Glaive | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Charge (+1 Damage) |

**Abilities:**

#### The Surging Sea (Activated)
...
#### Rapid Approach (Passive)
- **Effect:** This unit can use a Run ability and still use Charge abilities later in the turn

---

### Mathaela, Oracle of the Abyss
**Points:** 160 | **Move:** 10" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, IDONETH DEEPKIN, AELF, UNIQUE, ORDER, INFANTRY, ISHARANN, WARD (6+), WIZARD (1), FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Riptide Blast | Ranged | 18" | 3 | 2+ | 4+ | 1 | D3 | Shoot in Combat |
| Staff of the Abyss | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |
| Dark Shoal’s Ferocious Bites | Melee | - | 5 | 4+ | 3+ | 1 | 1 | Companion |

**Abilities:**

#### Siren Song of The Abyss (Activated)
- **Timing:** Any Combat Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Maelstrom Blades | Melee | - | 7 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Storm of Blades (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
No mortal damage is inflicted on friendly Idoneth Deepkin units by Retreat abilities while they are wholly within 12" of this unit.

---

### Anvil of Apotheosis: Idoneth Deepkin Hero
**Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, INFANTRY, ORDER, IDONETH DEEPKIN, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Thassalic Weapon | Melee | - | 3 | 3+ | 4+ | 1 | 2 |  |
| Shoal of Zephyrfish | Ranged | 10" | 8 | 4+ | 5+ | 1 | 1 | Shoot in Combat, Companion |
| Allopex's Ferocious Bite | Melee | - | 4 | 4+ | 2+ | 2 | 2 | Anti-Monster (+1 Rend), Companion |
| Sea-steed's Fangs | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Companion |
| Mighty Sea-beast's Jaws | Melee | - | 6 | 4+ | 2+ | 2 | 3 | Companion |
| Deep-sea Companion's Bite | Melee | - | 2 | 4+ | 4+ | - | 1 | Companion |
| Razorshell Harpoon Launchers | Ranged | 18" | 4 | 3+ | 2+ | 1 | 3 | Anti-Monster (+1 Rend) |
| Crew's Spears and Harpoons | Melee | - | 4 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Battle Damaged (Passive)
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its Mighty Sea-beast's Jaws is 3.

#### Bloodthirsty Predators (Passive)
...
#### Swift as the Great Current (Activated)
- **Timing:** Any Combat Phase
- **Effect:** Roll a dice. Add 2 to the roll if this unit is Infantry. On a 4+, this unit has Strike-first for the rest of the turn.

#### Prodigy of the Asydrazor (Passive)
- **Effect:** If this unit is Akhelian, add a number equal to the number of ranks this unit has earned on its Path to the Attacks characteristic of its Thalassic Weapon.
*For example, if this unit has earned the Legendary rank on its Path, add 4 to the Attacks characteristic of its Thalassic Weapon.*

#### Royal Lineage (Passive)
- **Effect:** Add 1 to the control scores of friendly Idoneth Deepkin units while they are wholly within 12" of this unit.

#### Prodigy of the Túrscoll (Activated)
- **Timing:** Once Per Battle, Reaction: You declared a Spell ability for this unit
- **Effect:** If this unit is Isharann, re-roll 1 of the dice in the casting roll.

#### Isolationist (Passive)
...
#### Sea-beast Familiar (Passive)
- **Effect:** This unit's Sea-beast Familiar is a token. If it is removed from the battlefield, this unit cannot use the 'Deep-sea Aid' ability.

#### Abyssal Cephalopod (Passive)
- **Effect:** This unit's Abyssal Cephalopod is a token. If it is removed from the battlefield, this unit cannot use the 'Pelagic Defender' ability.

#### Pelagic Defender (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Effect:** Pick 1 of the following effects:
• Pick an enemy unit in combat with this unit to be the target, then roll 8 dice. For each 5+, inflict 1 mortal damage on the target.
...
### Akhelian Allopex
**Points:** 170 | **Move:** 12" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** IDONETH DEEPKIN, ORDER, CAVALRY, FLY, AELF, AKHELIAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Barbed Hooks and Blades | Melee | - | 4 | 3+ | 4+ | 1 | 1 | - |
| Allopex’s Ferocious Bite | Melee | - | 3 | 4+ | 2+ | 2 | 2 | Anti‑Monster (+1 Rend), Companion |
| Razorshell Harpoon | Ranged | 18" | 2 | 3+ | 2+ | 1 | 3 | Anti‑Monster (+1 Rend) |
| Retarius Net Launcher | Ranged | 18" | 2 | 3+ | 2+ | 1 | 3 | Anti‑Cavalry (+1 Rend) |
...
**Points:** 170 | **Move:** 14" | **Health:** 4 | **Save:** 4+ | **Control:** 1
**Keywords:** CAVALRY, CHAMPION, FLY, ORDER, IDONETH DEEPKIN, AELF, AKHELIAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Helsabre | Melee | - | 3 | 3+ | 4+ | 1 | 1 | - |
| Fangmora’s Fangs and Lashing Tail | Melee | - | 3 | 4+ | 3+ | 1 | D3 | Companion |

**Abilities:**

#### Biovoltaic Barrier (Activated)
- **Timing:** Any Combat Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Voltspear | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage), Anti‑Cavalry (+1 Rend) |
| Fangmora’s Fangs and Lashing Tail | Melee | - | 3 | 4+ | 3+ | 1 | D3 | Companion |

**Abilities:**

#### Biovoltaic Blast (Activated)
- **Timing:** Any Charge Phase
- **Declare:** If this unit charged this phase, pick an enemy unit within 1" of it to be the target.
...
### Akhelian Leviadon
**Points:** 470 | **Move:** 10" | **Health:** 16 | **Save:** 3+ | **Control:** 5
**Keywords:** IDONETH DEEPKIN, ORDER, FLY, AELF, AKHELIAN, MONSTER, WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Crew’s Spears and Harpoons | Melee | - | 4 | 3+ | 4+ | 1 | 1 | - |
| Leviadon’s Scythed Fins and Crushing Jaws | Melee | - | 7 | 4+ | 2+ | 2 | 3 | Crit (Mortal), Companion |
| Razorshell Harpoon Launchers | Ranged | 18" | 4 | 3+ | 2+ | 1 | 3 | Anti‑Monster (+1 Rend) |
...
**Keywords:** CHAMPION, ORDER, IDONETH DEEPKIN, AELF, INFANTRY, NAMARTI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lanmari | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Anti‑Infantry (+1 Rend), Anti-Monster (+1 Rend) |

**Abilities:**

#### Sweeping Blows (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit
...
> Variant: Namarti Thralls (Scourge of Ghyran) — 90 pts

---

### Namarti Reavers
**Points:** 130 | **Move:** 7" | **Health:** 1 | **Save:** 5+ | **Control:** 1
**Keywords:** CHAMPION, ORDER, IDONETH DEEPKIN, AELF, INFANTRY, NAMARTI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Keening Blade | Melee | - | 1 | 3+ | 4+ | - | 1 | - |
| Whisperbow | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |

**Abilities:**

#### Strike On the Move (Passive)
- **Effect:** This unit can use Shoot abilities even if it used a Run or Retreat ability in the same turn.

---

### Gloomtide Shipwreck
**Move:** - | **Health:** 7 | **Save:** 4+ | **Control:** -
**Keywords:** FACTION TERRAIN, ORDER, IDONETH DEEPKIN

**Abilities:**

#### Rise from the Depths (Activated)
...
**Keywords:** ORDER, INFANTRY, UNIQUE, CHAMPION, Legends, AELF, AKHELIAN, NAMARTI, IDONETH DEEPKIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lanmari Weapons | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |
| Cephanyr’s Tentacles | Melee | - | 6 | 4+ | 3+ | - | 1 | Companion |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Riptide Harpoon | Ranged | 8" | 1 | 3+ | 4+ | 1 | D3 | Shoot in Combat |
| Soulraid Weapons | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Elathain's Lurelight (Activated)
- **Timing:** End of Any Turn
...
- **Keywords:** Core, Fight, Attack

---

### Abyssal Tendril
**Move:** - | **Health:** 6 | **Save:** 6+ | **Banishment:** 6+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, ORDER, IDONETH DEEPKIN, INCARNATE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Freezing Grasp | Melee | - | 4 | 4+ | 2+ | 1 | D3 | - |

**Abilities:**

#### Crushing Coil (Passive)
- **Effect:** Add 1 to hit rolls for attacks made by friendly Idoneth Deepkin Manifestations that target an ensnared enemy unit.

#### Watery Clutch (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Move:** 10" | **Health:** 12 | **Save:** 4+ | **Banishment:** 9+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, ORDER, IDONETH DEEPKIN, INCARNATE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Crushing Maw and Scything Waves | Melee | - | 6 | 4+ | 2+ | 1 | 3 | Anti-Faction Terrain (+1 Rend) |

**Abilities:**

#### Surrender to the Sea (Passive)
...
#### Grasping Tendrils (Activated)
- **Timing:** Any Hero Phase
- **Effect:** Roll a dice. Add 1 to the roll if it is your turn.
On a 4+:
...
##### Teachings of the Asydrazor (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Effect:** You gain D3 asydrazor points.

##### The Shield of Ulchiss (Activated)
...
- **Effect:** Fore the rest of the turn:
...
##### The Last Living Cythai (Passive)
- **Effect:** The friendly Volturnos has Strike-first.

##### The Spear of Asphoren (Activated)
- **Timing:** Any Charge Phase
...
##### The Sword of Gwynnar (Activated)
...
##### Crest of the Ionrach (Passive)
- **Effect:** This unit has Ward (6+)

##### Prodigy of the Asydrazor (Activated)
- **Timing:** Once Per Battle, Reaction: You declared an Asydrazor ability for a friendly First Phalanx unit wholly within 12" of this unit.
- **Effect:** No asydrazor points are spent to use that ability.

##### Voidchill Darkness (Passive)
- **Effect:** Subtract 1 from hit rolls for attacks that target this unit if this unit charged this turn.

##### Swift-finned Skirmisher (Activated)
- **Timing:** Reaction: You declared the 'Redeploy' command for this unit
- **Effect:** If you roll a 1-3 when determining the distance that this unit can move, you can use a value of 4 instead.

##### Deep Connection (Passive)
...
##### Call Forth the Tsunami (Activated)
...
##### Spirits of the Chorrileum (Passive)
