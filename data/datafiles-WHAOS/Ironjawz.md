...
#### Trophy Skulls (Passive)
- **Effect:** Add 10 to this unit’s control score.

#### Armour of Gork (Passive)
- **Effect:** This unit has Ward (6+).

#### Amberbone Whetstone (Activated)
...
#### An Eye for da Fight (Activated)
- **Timing:** Reaction: You declared the ‘Redeploy’ command for a friendly Ironjawz unit wholly within 12" of this unit
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

## Units

### Weirdnob Shaman
**Points:** 120 | **Move:** 4" | **Health:** 6 | **Save:** 6+ | **Control:** 2
...
### Megaboss
**Points:** 150 | **Move:** 4" | **Health:** 8 | **Save:** 3+ | **Control:** 2
...
### Ardboy Big Boss
**Points:** 110 | **Move:** 4" | **Health:** 7 | **Save:** 3+ | **Control:** 2
...
### Anvil of Apotheosis: Ironjawz Hero
**Move:** 4" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, INFANTRY, DESTRUCTION, IRONJAWZ

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Choppa | Melee | - | 7 | 4+ | 3+ | 1 | 2 |  |
| Maw-grunta’s Tusks | Melee | - | 5 | 4+ | 2+ | 2 | 2 | Companion |
| Maw-krusha’s Fists and Tail | Melee | - | 8 | 4+ | 2+ | 1 | 3 | Companion |

**Abilities:**

#### Alright, Get 'Em (Passive)
- **Effect:** If a friendly IRONJAWZ unit uses the ‘Counter-charge’ command while it is wholly within 12" of this unit, spend 1 command point to use that command instead of 2.

#### Hunt and Crush (Passive)
- **Effect:** Friendly Ironjawz units can pile in 2D6" instead of 3" while they are wholly within 12" of this unit.

#### Rousing Ruckus (Passive)
- **Effect:** Each time you make a chanting roll for this unit, add 1 to the roll for each other friendly Ironjawz unit within this unit’s combat range.
...
> Variant: Gore-gruntas (Scourge of Ghyran) — 190 pts

---

### Brute Ragerz
**Points:** 100 | **Move:** 4" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, DESTRUCTION, IRONJAWZ, BRUTE
...
### Ardboyz
**Points:** 170 | **Move:** 4" | **Health:** 2 | **Save:** 3+ | **Control:** 1
**Keywords:** INFANTRY, CHAMPION, DESTRUCTION, IRONJAWZ
...
### Weirdbrute Wrekkaz
**Points:** 100 | **Move:** 4" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, DESTRUCTION, IRONJAWZ, BRUTE, WARD (5+)
...
> Variant: Weirdbrute Wrekkaz (Scourge of Ghyran) — 100 pts
...
**Keywords:** UNIQUE, Legends, CHAMPION, DESTRUCTION, INFANTRY, IRONJAWZ, BRUTE
...
### Ironskull's Boyz
**Points:** 110 | **Move:** 4" | **Health:** 3 | **Save:** 3+ | **Control:** 1
**Keywords:** UNIQUE, Legends, CHAMPION, DESTRUCTION, INFANTRY, IRONJAWZ
...
**Keywords:** FACTION TERRAIN, IRONJAWZ, DESTRUCTION
...
##### Da Boom Skull (Activated)
- **Timing:** Reaction: You declared a command for a friendly Grunta Stampede unit wholly within 18" of this unit
...
##### Shield of Scrap and Muscle (Passive)
- **Effect:** While a friendly Zoggrok Anvilsmasha is within the combat range of another friendly Ardboyz unit:
...
##### Ironclad Scrums (Passive)
- **Effect:** Friendly Zoggrok's Ironmongers Ardboyz units with 3 or more models have Ward (5+) while they are wholly within 12" of a different friendly Zoggrok's Ironmongerz Ardboyz unit with 3 or more models.

##### Legendary Vandals (Passive)
- **Effect:** Melee weapons used by friendly Zoggrok's Ironmongers units have Anti-Faction terrain (+1 Rend) and Anti-War Machine (+1 Rend).

##### Into Da Breach! (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick a friendly Zoggrok's Ironmongers unit that is more than 9" from any enemy units and had any damage points allocated to it this turn.
