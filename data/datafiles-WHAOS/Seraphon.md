...
#### Itzl the Tamer (Passive)
- **Keywords:** Asterism
- **Effect:** **Companion** weapons used by friendly Seraphon units have **Crit (2 Hits)**.

#### Further the Great Plan (Activated)
- **Timing:** Once Per Battle, Start of the Third Battle Round
...
#### Sotek the Deliverer (Passive)
- **Keywords:** Asterism
- **Effect:** Add 2 to the Move characteristic of friendly Seraphon units.

#### Tepok the Seer (Passive)
- **Keywords:** Asterism
- **Effect:** Add 1 to casting rolls for friendly Seraphon units.

### Artefacts of Power

#### Incandescent Rectrices (Activated)
- **Timing:** Any Hero Phase
- **Effect:** **Heal (D3)** this unit.

#### Coatl Familiar (Activated)
- **Timing:** Once Per Battle, Reaction: You declared a Spell ability for a friendly Seraphon Wizard within this unit’s combat range
- **Effect:** Add D6 to the casting roll for that spell.

#### Bloodrage Pendant (Passive)
...
#### Keeper of the Old Ways (Activated)
- **Timing:** Once Per Turn, Reaction: You declared the ‘Further the Great Plan’ ability
...
### Aggradon Lancers
**Points:** 200 | **Move:** 10" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** CHAMPION, CAVALRY, STANDARD BEARER (1/3), MUSICIAN (1/3), ORDER, SERAPHON, SAURUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Aggradon’s Rending Bites and Striking Talons | Melee | - | 3 | 4+ | 3+ | 2 | 2 | Companion |
| Celestite Spear and Club | Melee | - | 3 | 3+ | 3+ | 1 | 1 | Charge (+1 Damage), , Anti‑Monster (+1 Rend) |
...
**Points:** 230 | **Move:** 5" | **Health:** 12 | **Save:** 2+ | **Control:** 5
**Keywords:** ORDER, SERAPHON, SKINK, MONSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bludgeoning Tail | Melee | - | 3 | 3+ | 3+ | 1 | D3 | Companion |
| Handlers’ Meteoric Javelins | Ranged | 12" | 6 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Ark of Sotek | Melee | - | 20 | 4+ | 5+ | - | 1 | Crit (Mortal), Companion |

**Abilities:**

#### Ark of Sotek (Activated)
...
**Points:** 200 | **Move:** 5" | **Health:** 12 | **Save:** 2+ | **Control:** 5
**Keywords:** ORDER, SERAPHON, MONSTER, SKINK
...
| Bludgeoning Tail | Melee | - | 3 | 3+ | 3+ | 1 | D3 | Companion |
| Handlers’ Meteoric Javelins | Ranged | 12" | 6 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Solar Engine | Ranged | 18" | 3 | 3+ | 3+ | 2 | 3 | Crit (2 Hits) |

**Abilities:**

#### Tail Swipe (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
### Engine of the Gods
**Points:** 150 | **Move:** 8" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** ORDER, SERAPHON, MONSTER, SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stegadon’s Horns and Jaws | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Charge (+1 Damage), Companion |
| Handlers’ Meteoric Javelins | Ranged | 12" | 6 | 4+ | 4+ | - | 1 | Shoot in Combat |
...
**Points:** 80 | **Move:** 8" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Non-Monster Skink, SERAPHON, ORDER, MUSICIAN (1/5), SKINK, INFANTRY, WARD (5+), CHAMPION (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Feeble Claws | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Dartpipe | Ranged | 10" | 2 | 3+ | 3+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Hidden Hunters (Activated)
...
**Points:** 90 | **Move:** 8" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Non-Monster Skink, INFANTRY, ORDER, CHAMPION (1/5), MUSICIAN (1/5), WARD (5+), SERAPHON, SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Hunter Javelin | Melee | - | 3 | 3+ | 4+ | 1 | 2 | - |
| Hunter Javelin | Ranged | 10" | 1 | 3+ | 3+ | 1 | 2 | - |
| Starstone Bolas | Ranged | 10" | 1 | 3+ | 4+ | - | 1 | - |
| Moonstone Club | Melee | - | 2 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Starstone Bolas (Activated)
- **Timing:** Any Shooting Phase
...
### Kroxigor
**Points:** 200 | **Move:** 5" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** INFANTRY, ORDER, SERAPHON, KROXIGOR

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Moonstone Hammer | Melee | - | 4 | 3+ | 2+ | 1 | 3 | Anti‑Infantry (+1 Rend) |
| Drakebite Maul | Melee | - | 4 | 4+ | 2+ | 1 | 2 | Anti‑Infantry (+1 Rend) |

**Abilities:**

#### Brutal Blows (Passive)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Starfang Warpick | Melee | - | 4 | 3+ | 2+ | 1 | 3 | Anti‑Monster (+1 Rend) |
| Drakefang Warpick | Melee | - | 4 | 4+ | 2+ | 1 | 2 | Anti‑Monster (+1 Rend) |

**Abilities:**

#### Spawn of Sotek (Passive)
...
#### Heavy-scaled Skin (Passive)
- **Effect:** Subtract 1 from the Rend characteristic of ranged weapons used for shooting attacks that target this unit.

---

### Lord Kroak
**Points:** 440 | **Move:** 5" | **Health:** 18 | **Save:** 4+ | **Control:** 5
**Keywords:** UNIQUE, HERO, FLY, WARMASTER, ORDER, WIZARD (3), WARD (4+), SERAPHON, SLANN
...
#### Celestial Deliverance (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** This unit can cast this spell more than once per phase. Pick up to 3 different visible enemy units within 18" of this unit to be the targets, then make a casting roll of 2D6.
...
**Keywords:** Non-Monster Skink, Skink Cavalry, CHAMPION, SERAPHON, ORDER, STANDARD BEARER (1/5), MUSICIAN (1/5), SKINK, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Raptadon’s Serrated Fangs | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
| Tepok Lance | Melee | - | 3 | 4+ | 4+ | 1 | 1 | Charge (+1 Damage) |

**Abilities:**

#### Cold-blooded Unity (Passive)
...
### Raptadon Hunters
**Points:** 120 | **Move:** 12" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** Skink Cavalry, Non-Monster Skink, CHAMPION, SERAPHON, ORDER, STANDARD BEARER (1/5), MUSICIAN (1/5), SKINK, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Starstone Atlatl | Ranged | 12" | 2 | 4+ | 4+ | 2 | 1 | - |
| Raptadon’s Serrated Fangs | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
| Weighted Moonstone Club | Melee | - | 3 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Deadly Cohesion (Activated)
...
### Ripperdactyl Chief
**Points:** 110 | **Move:** 14" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, SERAPHON, SKINK, CAVALRY, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Skyblade | Melee | - | 5 | 4+ | 4+ | 1 | 2 | Crit (Auto-wound) |
| Ripperdactyl’s Tearing Jaws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Charge (+1 Damage), Companion |
...
#### Ripperdactyl Assault (Activated)
...
### Ripperdactyl Riders
**Points:** 100 | **Move:** 14" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** Skink Cavalry, Non-Monster Skink, CHAMPION, SERAPHON, ORDER, CAVALRY, FLY, SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Moonstone Warspear | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Cavalry (+1 Rend) |
| Ripperdactyl’s Tearing Jaws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Charge (+1 Damage), Companion |
...
**Points:** 120 | **Move:** 5" | **Health:** 6 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, SERAPHON, INFANTRY, SAURUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celestite Warclub | Melee | - | 4 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Celestial Conduit (Activated)
- **Timing:** Reaction: You declared a Spell ability for a friendly Seraphon Wizard wholly within 12" of this unit
...
**Keywords:** CHAMPION, SERAPHON, SAURUS, ORDER, INFANTRY, STANDARD BEARER (1/5), MUSICIAN (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celestite Polearm | Melee | - | 3 | 3+ | 3+ | 1 | 1 | - |

**Abilities:**

#### Selfless Protectors (Passive)
...
### Saurus Oldblood
**Points:** 90 | **Move:** 5" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, SERAPHON, SAURUS, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Relic Celestite Weapon | Melee | - | 5 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Predatory Exemplar (Activated)
...
#### Wrath of the Seraphon (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
**Points:** 240 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, SERAPHON, MONSTER, SAURUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sunbolt Gauntlet | Ranged | 12" | D6 | 3+ | 3+ | 1 | 1 | Shoot in Combat |
| Sunstone Spear | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Charge (+1 Damage) |
| Carnosaur’s Massive Jaws | Melee | - | 3 | 4+ | 2+ | 2 | 3 | Companion |
| Carnosaur’s Clawed Forelimbs | Melee | - | 4 | 4+ | 2+ | 1 | 3 | Companion |
...
#### Spearhead of the Charge (Passive)
...
### Saurus Oldblood on Carnosaur (Scourge of Ghyran)
**Points:** 320 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, SERAPHON, MONSTER, SAURUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sunstone Spear and Sunbolt Gauntlet | Melee | - | 6 | 3+ | 3+ | 1 | 2 | Charge (+1 Damage) |
| Carnosaur’s Massive Jaws | Melee | - | 3 | 4+ | 2+ | 2 | 4 | Companion |
| Carnosaur’s Clawed Forelimbs | Melee | - | 5 | 4+ | 2+ | 1 | 3 | Companion |

**Abilities:**

#### Alpha Predator (Passive)
- **Effect:** Friendly **Aggradon Lancers** do not lose **rage tokens** at the end of the turn while they are wholly within 12" of this unit.

#### Battle Damaged (Passive)
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its **Carnosaur’s Massive Jaws** is 2.

#### Frenzied by Blood (Passive)
- **Effect:** Add 1 to the Damage characteristic of this unit’s **Companion** weapons while it is within 6" of any damaged enemy units or while it is within 6" of any enemy units that had any models slain in the same turn.
...
**Points:** 140 | **Move:** 10" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, SERAPHON, SAURUS, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celestite Spear or Club | Melee | - | 4 | 3+ | 3+ | 2 | 2 | Charge (+1 Damage) |
| Aggradon’s Rending Bites and Striking Talons | Melee | - | 3 | 4+ | 3+ | 2 | 2 | Companion |
...
### Saurus Warriors
**Points:** 140 | **Move:** 5" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, SERAPHON, SAURUS, ORDER, STANDARD BEARER (1/10), MUSICIAN (1/10), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celestite Weapon | Melee | - | 2 | 3+ | 3+ | 1 | 1 | - |

**Abilities:**

#### Ordered Cohorts (Passive)
...
**Points:** 210 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, SERAPHON, MONSTER, WIZARD (1), SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Troglodon’s Noxious Spittle | Ranged | 15" | D6 | 3+ | 3+ | 1 | 2 | Shoot in Combat, Companion |
| Divining Rod | Melee | - | 2 | 4+ | 4+ | 1 | D3 | - |
| Troglodon’s Jaws | Melee | - | 3 | 4+ | 3+ | 1 | 3 | Crit (Mortal), Companion |
| Troglodon’s Talons | Melee | - | 2 | 4+ | 3+ | 1 | 2 | Companion |
...
#### Troglodon Regeneration (Activated)
- **Timing:** End of Any Turn
- **Effect:** **Heal (D3)** this unit.

#### Noxious Roar (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Skink Starpriest
**Points:** 90 | **Move:** 8" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, ORDER, SERAPHON, SKINK, WIZARD (1), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Serpent Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Serpent Staff (Activated)
- **Timing:** Your Hero Phase
...
### Skink Starseer
**Points:** 160 | **Move:** 5" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, SERAPHON, SKINK, INFANTRY, WIZARD (2), FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Astromancer’s Staff | Melee | - | 2 | 4+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Scry the Stars (Activated)
...
### Skinks
**Points:** 80 | **Move:** 8" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Non-Monster Skink, CHAMPION, SERAPHON, ORDER, INFANTRY, SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Javelins and Boltspitters | Ranged | 12" | 2 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Celestite Daggers and Moonstone Clubs | Melee | - | 1 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Swift and Nimble (Passive)
...
**Keywords:** HERO, FLY, ORDER, WIZARD (3), SERAPHON, SLANN, WARD (6+), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Azure Lightning | Melee | - | 6 | 3+ | 3+ | 1 | 1 | Crit (Mortal) |

**Abilities:**

#### Masters of Order (Passive)
- **Effect:** Add 1 to casting rolls for this unit. In addition, this unit can use an Unbind ability if an enemy Wizard anywhere on the battlefield uses a Spell ability instead of an enemy Wizard within 30" of this unit, and when using the ‘Banish Manifestation’ ability, this unit can pick a manifestation anywhere on the battlefield instead of within 30" of it.

#### Celestial Reinforcements (Command)
...
### Spawn of Chotec
**Points:** 100 | **Move:** 5" | **Health:** 8 | **Save:** 5+ | **Control:** 1
**Keywords:** Non-Monster Skink, ORDER, SERAPHON, BEAST, SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stream of Fire | Ranged | 10" | 5 | 2+ | 3+ | 1 | 1 | Anti‑Infantry (+1 Rend), Companion |
| Glob of Flame Acid | Ranged | 16" | 1 | 4+ | 2+ | 2 | D3+3 | Companion |
| Fiery Maw | Melee | - | 3 | 3+ | 3+ | 2 | 3 | Companion |

**Abilities:**

#### Acid-fuelled Flame (Passive)
...
| Stegadon’s Horns and Jaws | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Charge (+1 Damage), Companion |
| Handlers’ Meteoric Javelins | Ranged | 12" | 6 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Skystreak Bow | Ranged | 18" | 3 | 3+ | 3+ | 1 | 2 | Anti‑Monster (+1 Rend) |
| Sunfire Throwers | Ranged | 10" | 2D6 | 3+ | 3+ | - | 1 | Anti‑Infantry (+1 Rend), Crit (2 Hits) |
...
#### Unstoppable Stampede (Activated)
...
### Stegadon Chief
**Points:** 160 | **Move:** 8" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, SERAPHON, MONSTER, SKINK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Handlers’ Meteoric Javelins | Ranged | 12" | 6 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Meteoric Warspear | Melee | - | 3 | 3+ | 3+ | 1 | 1 | - |
| Stegadon’s Horns and Jaws | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Charge (+1 Damage), Companion |
| Skystreak Bow | Ranged | 18" | 3 | 3+ | 3+ | 1 | 2 | Anti‑Monster (+1 Rend) |
| Sunfire Throwers | Ranged | 10" | 2D6 | 3+ | 3+ | - | 1 | Anti‑Infantry (+1 Rend), Crit (2 Hits) |
...
### Sunblood Pack
**Points:** 150 | **Move:** 5" | **Health:** 3 | **Save:** 4+ | **Control:** 2
**Keywords:** ORDER, SERAPHON, SAURUS, HERO, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celestite Weapons | Melee | - | 3 | 3+ | 3+ | 1 | 2 | - |
| Celestite Weapons | Melee | - | 3 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Starspawned (Passive)
- **Effect:** Ignore the first damage point that would be allocated to friendly Saurus and Kroxigor units each phase while they are wholly within 12" of this unit.

#### Venomite Swarm (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** If this unit’s **Venomites** token is on the battlefield, roll a D3.
On a 1, remove this unit’s **Venomites** token from the battlefield. On a
2+, inflict an amount of mortal damage on the target equal to the roll.

#### Scaled Protectors (Passive)
- **Effect:** Ignore negative and positive modifiers to save rolls for this unit.

---

### Terradon Chief
**Points:** 100 | **Move:** 14" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, SERAPHON, SKINK, CAVALRY, FLY
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Skyblade | Melee | - | 5 | 4+ | 4+ | 1 | 2 | Crit (Auto-wound) |
| Terradon’s Razor-sharp Jaws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |

**Abilities:**

#### Chief's Deadly Cargo (Activated)
- **Timing:** Your Movement Phase
- **Declare:** Pick an enemy unit that this unit passed across this phase to be the target.
- **Effect:** Roll a dice and add 2 to the roll if this unit is within the combat ranges of any friendly **Terradon Riders** units.
On a 5+:
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Javelins and Bolas | Ranged | 10" | 3 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |
| Terradon’s Razor-sharp Jaws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
...
**Keywords:** SERAPHON, ORDER, BEAST, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Snapping Beaks | Melee | - | 3 | 4+ | 4+ | - | 1 | Companion |

**Abilities:**

#### Nerve-shredding Screeches (Activated)
...
### The Jaws of Itzl
**Points:** 120 | **Move:** 5" | **Health:** 3 | **Save:** 4+ | **Control:** 2
**Keywords:** ORDER, INFANTRY, UNIQUE, Legends, SERAPHON, SAURUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celestite Weapon | Melee | - | 2 | 3+ | 3+ | 1 | 1 | - |
| Relic Celestite Warmace | Melee | - | 4 | 3+ | 3+ | 1 | 3 | - |
| Celestite Weapon | Melee | - | 2 | 3+ | 3+ | 1 | 1 | - |

**Abilities:**

#### Scaled Protectors (Passive)
- **Effect:** While this unit’s **Kro-Jax** is on the battlefield, ignore the first damage point that would be allocated to this unit in each phase.
...
**Keywords:** Non-Monster Skink, ORDER, INFANTRY, UNIQUE, CHAMPION, Legends, SERAPHON, SKINK, SAURUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Relic Celestite Weapon | Melee | - | 5 | 3+ | 3+ | 1 | 2 | - |
| Starblood Weapons | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Starblood Weapons | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Starblood Weapons | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Starblood Weapons | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Starblood Weapons | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
...
| Skink Oracle on Troglodon | 210 |
| Bastiladon with Ark of Sotek | 230 |
| Saurus Oldblood on Carnosaur | 240 |
| Slann Starmaster | 260 |
| Saurus Oldblood on Carnosaur (Scourge of Ghyran) | 320 |
| Lord Kroak | 440 |
