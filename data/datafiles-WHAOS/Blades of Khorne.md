...
#### Red Raider (Passive)
- **Effect:** Add 1 to hit rolls for this unit if it charged in the same turn.

#### Hunter of Souls (Passive)
- **Effect:** You can re-roll run rolls for this unit.

#### Titan Slayer (Passive)
- **Effect:** This unit cannot be picked to be the target of Rampage abilities used by enemy units.

#### Devoted Followers (Passive)
- **Effect:** While this unit is within the combat range of a friendly non-Hero unit, this unit is not visible to enemy units more than 6" away.

#### Khorne's Retribution (Activated)
- **Timing:** End of Any Turn
- **Declare:** This unit must use this ability.
- **Effect:** If an enemy unit has not been destroyed by this unit this battle, inflict 1 mortal damage on this unit.

#### A True Berserker (Passive)
- **Effect:** This unit has a maximum control score of 1 that cannot be modified.

#### Willing Sacrifice (Passive)
- **Effect:** This unit cannot be healed.

#### Kin-killer (Activated)
- **Timing:** End of Any Turn
- **Declare:** This unit must use this ability.
- **Effect:** Inflict D3 mortal damage on every other friendly unit within 3" of this unit.

#### Brass Collar (Passive)
- **Effect:** Subtract 1 from casting rolls for Wizards while they are within 12" of this unit.

#### Blood-crazed Stare (Passive)
- **Effect:** This unit cannot be picked to be the target of Rampage abilities used by enemy units.
...
#### Ruthless Savagery (Passive)
- **Effect:** If an unmodified charge roll for this unit was 8+, it has Strike-first for the rest of the turn.

#### Bloody Prophet (Passive)
- **Effect:** Add 1 to chanting rolls and banishment rolls for this unit.

#### Blind to All but Hate (Activated)
- **Timing:** End of Enemy Turn
- **Declare:** Pick a visible enemy unit that destroyed a friendly unit this turn and is within 12" of this unit to be the target.
- **Effect:** Until the end of your next turn, add 1 to wound rolls for combat attacks that target that enemy unit.

#### Pulverising Charge (Activated)
...
#### Anathemic Runescars (Passive)
- **Effect:** The unit has Ward (4+) against damage inflicted by Spell abilities and abilities used by Manifestations.

#### Eager Killer (Activated)
- **Timing:** Reaction: You declared a Charge ability for this Hero
- **Effect:** Add D3 to the charge roll.

#### Anointed with Gore (Activated)
- **Timing:** Any Combat Phase
- **Declare:** If this unit charged this turn, pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice for each model in the target unit. For each 5+, inflict 1 mortal damage on the target.

### Paths

#### Blood-blind (Activated)
- **Timing:** Reaction: This unit was targeted by a Fight ability.
- **Effect:** Roll a D3. On a 2+, after that Fight ability has been resolved, inflict an amount of mortal damage on the enemy unit using that fight ability equal to the roll.

#### Invigorated by Wrath (Activated)
- **Timing:** Reaction: Opponent declared a Fight ability for a unit in combat with this unit.
- **Effect:** This unit can immediately make a pile-in move.

#### Brutal Onslaught (Passive)
- **Effect:** Add 1 to charge rolls for this unit.

#### Dominating Powerhouse (Activated)
- **Timing:** Your Movement Phase
- **Effect:** This unit can move D6". It must end that move in combat.

#### Breaker of the Arcane (Passive)
- **Effect:** This unit can use Unbind abilities as if it had Wizard (1). Each time this unit unbinds a spell, subtract 1 from the power level of the Wizard using that Spell ability, to a minimum of 0, for the rest of the battle. An enemy Wizard can be affected by this ability multiple times and the effects are cumulative.

#### Locus of Red Devotion (Activated)
- **Timing:** Once Per Turn, Reaction: Opponent declared a Prayer ability for a Priest within 12" of this unit
- **Effect:** The chanting roll must be re-rolled.

#### Whirlwind of Annihilation (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Effect:** This unit can use 2 Fight abilities this phase. After the first is used, this unit has Strike-last for the rest of the turn.

#### Vessel of Murder (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Declare:** Pick all enemy units in combat with this unit to be targets.
- **Effect:** Roll 8 dice. For each roll of 3-5, inflict 1 mortal damage on each target. For each 6, inflict D3 mortal damage on each target.

#### Pack of Murderers (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice. On a 4+, the target cannot use Retreat abilities until the start of your next turn.

#### Shield-breakers (Passive)
- **Effect:** Enemy units in combat with this unit cannot use the 'All-out Defence' command.

#### Savage Conquerors (Passive)
- **Effect:** Add 1 to wound rolls for this unit's attacks that target an enemy unit contesting an objective that you do not control.

#### Soul-eating Rage (Passive)
- **Effect:** Subtract 1 from ward rolls for enemy units while they are in combat with this unit.

#### Spell-killers (Passive)
- **Effect:** Enemy Manifestations in combat with this unit have Strike-last

#### Loping Pursuit (Activated)
- **Timing:** Reaction: You declared a Charge ability for this unit.
- **Effect:** If the charge roll was 5 or less, you can re-roll the dice.

#### Revenants in Red (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn)
- **Effect:** If any enemy units were destroyed this turn while they were in combat with this unit, **Heal (X)** this unit, where **X** is the number of damage points this unit has.

#### Infamous Warcry (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Declare:** If this unit charged this turn, pick each friendly unit within 3" of this unit to be the targets.
- **Effect:** Roll a dice for each target. If the result exceeds the target's control characteristic, for ther est of the turn, add 1 to the Rend characteristic of the target's melee weapons.

### Battle Traits

#### Blood-drenched (Activated)
- **Timing:** Reaction: You declared the 'Skulls for the Skull Throne' ability
...
#### Blood for the Blood God (Passive)
...
#### Skulls for the Skull Throne (Activated)
- **Timing:** Once Per Turn (Army), Start of Any Turn
- **Effect:** Pick a Blood Tithe ability that you have not unlocked and spend the number of blood tithe points required to unlock that ability. That Blood Tithe ability is now unlocked for the rest of the battle.

#### Murderlust (Blood Tithe)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Charge ability.
...
- **Blood Tithe Points:** 0
- **Unlock Condition:** You do not need to unlock this ability. It is already unlocked.

#### Divine Scorn (Blood Tithe)
- **Timing:** Once Per Turn, Start of Any Turn
...
- **Keywords:** Blood Tithe
- **Blood Tithe Points:** 1

#### Punish the Pacifist (Blood Tithe)
...
- **Keywords:** Blood Tithe
- **Blood Tithe Points:** 2
- **Unlock Condition:** You can only unlock this ability if you have unlocked 'Divine Scorn'.

#### Glorious Combat or Naught (Blood Tithe)
- **Timing:** Passive
- **Effect:** Subtract 1 from hit rolls for shooting attacks that target friendly Blades of Khorne units.
- **Keywords:** Blood Tithe
- **Blood Tithe Points:** 2
- **Unlock Condition:** You can only unlock this ability if you have unlocked 'Divine Scorn' or 'Punish the Pacifist'.

#### Revel in Battle (Blood Tithe)
- **Timing:** Passive
...
- **Keywords:** Blood Tithe
- **Blood Tithe Points:** 3
- **Unlock Condition:** You can only unlock this ability if you have unlocked 'Punish the Pacifist'.

#### Slaughter Triumphant (Blood Tithe)
- **Timing:** Passive
...
- **Keywords:** Blood Tithe
- **Blood Tithe Points:** 4
- **Unlock Condition:** You can only unlock this ability if you have unlocked 'Glorious Combat or Naught' or 'Murder the Mystic'.

#### Cleave Wide the Grin of Khorne (Blood Tithe)
- **Timing:** Passive
- **Effect:** Add 1 to hit rolls for combat attacks made by friendly Blades of Khorne units.
- **Keywords:** Blood Tithe
- **Blood Tithe Points:** 4
- **Unlock Condition:** You can only unlock this ability if you have already unlocked 'Revel in Battle' or Glorious Combat or Naught'.

### Artefacts of Power

#### Collar of Contempt (Passive)
...
#### Butchers of Nations (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Fight ability for a friendly Blades of Khorne Daemon unit
...
#### The Red God's Eye (Passive)
- **Effect:** Friendly Gorechosen Champions units have Ward (6+)

#### Hate-fuelled Killers (Passive)
- **Effect:** The first time each friendly Gorechosen Champions unit would be destroyed, before removing it from play, roll a dice. On a 5+, that unit is not destroyed and any remaining damage points inflicted on it have no effect. Then, **Heal (1)** that unit.

#### Murder-won Trophies (Activated)
...
#### The Scarring Blade (Activated)
- **Timing:** Any Combat Phase
- **Effect:** Allocate D3 damage points to this unit (ward rolls cannot be made for those damage points). For the rest of the turn, add **X** to the Attacks characteristic of melee weapons used by friendly Gorechosen Champions units, where **X** is equal to the amount of mortal damage allocated to this unit this turn by this ability.
For the rest of the battle, this unit cannot use the 'Hate-fuelled Killers' ability and cannot be healed.

#### Bloodmist Skull (Passive)
- **Effect:** This unit has Ward (3+) against damage inflicted by shooting attacks.

**Heroic Traits**

#### Crowned in Butchery (Passive)
...
#### Mage-eaters (Activated)
- **Timing:** Once Per Turn (Army), Reaction: Opponent declared a Spell ability
- **Effect:** Make a magic-eater roll of D6. On a 3+, the spell is unbound. If the spell was unbound and the magic-eater roll was 5+, inflict D3 mortal damage on the caster.

#### Born of Butchery (Activated)
- **Timing:** Once Per Turn, Your Movement Phase
- **Declare:** Pick a friendly non-Unique Baleful Lords unit that has been destroyed to be the target.
- **Effect:** Roll a number of dice equal to the current battle round number plus the number of units (friendly and enemy) that have been destroyed this battle. If the roll contains 8 or more results of 3+, set up a replacement unit identical to the target on the battlefield, wholly within 7" of the battlefield edge and more than 9" from all enemy units.

#### First in His Sight (Activated)
- **Timing:** Once Per Turn (Army), End of Enemy Turn
- **Effect:** **Heal (D3)** each friendly Baleful Lords Hero that is in combat.

#### Bellow of Hatred (Activated)
...
#### Sunder the Sorcerous (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
#### Crown of the Slaughterborn (Passive)
...
**Keywords:** CHAMPION, INFANTRY, CHAOS, BLADES OF KHORNE, BLOODBOUND, STANDARD BEARER (1/10)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Goreweapons | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Blood-hungry, Crit (Auto-wound) |
...
### Bloodcrushers
**Points:** 130 | **Move:** 10" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** Daemon Cavalry, WARD (6+), CHAOS, DAEMON, CHAMPION, MUSICIAN (1/3), STANDARD BEARER (1/3), CAVALRY, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodcrusher Hellblade | Melee | - | 3 | 3+ | 3+ | 1 | 1 | Blood-hungry, Crit (Mortal) |
| Juggernaut’s Brazen Hooves | Melee | - | 2 | 4+ | 3+ | 1 | D3 | Anti-Cavalry (+1 Rend), Companion |

**Abilities:**

#### Crushing Onslaught (Passive)
...
### Bloodcrushers (Scourge of Ghyran)
**Points:** 150 | **Move:** 10" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** Daemon Cavalry, WARD (6+), CHAOS, DAEMON, CHAMPION, MUSICIAN (1/3), STANDARD BEARER (1/3), CAVALRY, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodcrusher Hellblade | Melee | - | 2 | 3+ | 3+ | 1 | 1 | Blood-hungry, Charge (+1 Damage), Crit (Mortal) |
| Juggernaut’s Brazen Hooves | Melee | - | 2 | 4+ | 3+ | 1 | D3 | Anti-**Cavalry** (+1 Rend), Companion |

**Abilities:**

#### Brass Stampede (Activated)
...
### Bloodletters
**Points:** 150 | **Move:** 5" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** WARD (6+), CHAOS, DAEMON, INFANTRY, CHAMPION, STANDARD BEARER (1/10), MUSICIAN (1/10), BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Hellblade | Melee | - | 2 | 3+ | 3+ | 1 | 1 | Blood-hungry, Crit (Mortal) |

**Abilities:**

#### Ceaseless Violence (Activated)
- **Timing:** Any Combat Phase
...
**Points:** 120 | **Move:** 5" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, CHAOS, DAEMON, BLADES OF KHORNE, INFANTRY, WARD (6+), PRIEST (1)
...
### Bloodreavers
**Points:** 80 | **Move:** 5" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** CHAOS, INFANTRY, CHAMPION, STANDARD BEARER (1/10), MUSICIAN (1/10), BLOODBOUND, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Reaver Blades and Axes | Melee | - | 2 | 4+ | 3+ | - | 1 | Blood-hungry |
...
### Bloodsecrator
**Points:** 120 | **Move:** 5" | **Health:** 6 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ensorcelled Axe | Melee | - | 4 | 3+ | 3+ | 1 | 2 | Blood-hungry |

**Abilities:**

#### Icon of the Blood God (Passive)
...
#### Rage of Khorne (Activated)
- **Timing:** Once Per Battle (Army), Any Combat Phase
- **Effect:** Add 1 to the Attacks characteristics of friendly Bloodbound units' melee weapons for the rest of the turn.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Torture Blade and Blood Whip | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Blood-hungry |

**Abilities:**

#### Whipped to Fury (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
**Points:** 410 | **Move:** 12" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, CHAOS, DAEMON, MONSTER, WARD (5+), FLY, BLADES OF KHORNE, BLOODTHIRSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Great Axe of Khorne | Melee | - | 5 | 3+ | 2+ | 2 | 5 | Anti-Infantry (+1 Rend), Blood-hungry |
...
**Points:** 390 | **Move:** 12" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, CHAOS, DAEMON, MONSTER, WARD (5+), FLY, BLADES OF KHORNE, BLOODTHIRSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Mighty Axe of Khorne | Melee | - | 6 | 3+ | 2+ | 2 | 4 | Anti-Monster (+1 Rend), Blood-hungry |
| Lash of Khorne | Ranged | 8" | 4 | 3+ | 3+ | 1 | D3 | Shoot in Combat |
...
#### Beckon the Hunt (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
- **Declare:** Pick a friendly non-Unique Blades of Khorne Daemon unit to be the target.
- **Effect:** For the rest of the turn, when making charge rolls for the target, roll 1 additional dice, to a maximum of 3, and discard 1 dice of your choice.

---

### Claws of Karanak
**Points:** 100 | **Move:** 6" | **Health:** 1 | **Save:** 5+ | **Control:** 1
**Keywords:** CHAOS, INFANTRY, CHAMPION (1/8), BLOODBOUND, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Weapons of the Hunt | Melee | - | 3 | 4+ | 3+ | - | 1 | Blood-hungry, Crit (2 Hits) |

**Abilities:**

#### The Scent of Blood (Activated)
...
### Deathbringer
**Points:** 130 | **Move:** 5" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kingslayer Axe | Melee | - | 4 | 3+ | 3+ | 1 | 3 | Blood-hungry, Crit (2 Hits) |

**Abilities:**

#### Trophies of Glorious Deaths (Activated)
- **Timing:** Reaction: Opponent declared a command for a unit within 8" of this unit
- **Effect:** Roll a dice. On a 5+, that command has no effect, it still counts as having been used and the command points spent to use it are still lost. This reaction cannot be used more than once per command.

#### Killer of Kings (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick each enemy unit and Manifestation in combat with this unit to be the target.
...
**Keywords:** WARD (6+), BEAST, CHAMPION (1/5), CHAOS, DAEMON, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blood-dark Claws | Melee | - | 4 | 4+ | 3+ | - | 1 | Blood-hungry, Companion |

**Abilities:**

#### Hunters of Mystics (Passive)
...
If the chanting roll for an enemy Priest within 12" of this unit is an unmodified 2, the prayer fails and its effect is not resolved. In addition, your opponent cannot give that Priest any ritual points for the rest of the phase.

---

### Garrek's Reavers
**Points:** 70 | **Move:** 5" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, BLADES OF KHORNE, BLOODBOUND, CHAOS
...
### Gorechosen of Dromm
**Points:** 190 | **Move:** 5" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, BLADES OF KHORNE, BLOODBOUND, CHAOS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Weapons of Wrath | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Crit (Mortal) |
| Weapons of Wrath | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Crit (Mortal) |
| Weapons of Wrath | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Grisly Trophies (Passive)
...
**Points:** 160 | **Move:** 8" | **Health:** 10 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, CHAOS, DAEMON, BLADES OF KHORNE, PRIEST (1), WAR MACHINE, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blade of Blood and Hellblades | Melee | - | 7 | 3+ | 3+ | 1 | 2 | Blood-hungry, Crit (Mortal) |
...
### Kamandora's Blades
**Points:** 90 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, BLADES OF KHORNE, BLOODBOUND, CHAOS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodied Weapons | Melee | - | 2 | 4+ | 3+ | - | 1 | Blood-hungry |
| Bloodied Weapons | Melee | - | 2 | 4+ | 3+ | - | 1 | Blood-hungry |
| Bloodied Weapons | Melee | - | 2 | 4+ | 3+ | - | 1 | Blood-hungry |
| Bloodied Weapons | Melee | - | 2 | 4+ | 3+ | - | 1 | Blood-hungry |
...
#### Khornate Hound (Passive)
- **Effect:** This unit’s **Kannat** is a token. Each time you declare a Fight ability for this unit while its **Kannat** is on the battlefield, as a reaction, you can remove its **Kannat** from the battlefield and then add 1 to the Rend characteristic of this unit’s **Bloodied Weapons** for the rest of the phase.

#### Gather the Skulls (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a D3. If the roll exceeds the target’s Health characteristic, 1 model in the target unit is slain and you earn 1 blood tithe point.

---

### Karanak
**Points:** 110 | **Move:** 8" | **Health:** 7 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, DAEMON, BLADES OF KHORNE, BEAST, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Savage Maws and Goreslick Claws | Melee | - | 6 | 4+ | 3+ | 1 | 2 | Anti-Hero (+1 Rend), Blood-hungry |

**Abilities:**

#### Prey of the Blood God (Activated)
- **Timing:** Once Per Turn, Your Movement Phase
- **Effect:** Pick an enemy Hero to be this unit’s quarry. You can pick a Hero in reserve.

#### Stalk the Prey (Activated)
- **Timing:** Your Movement Phase
- **Declare:** If this unit's quarry is on the battlefield, pick this unit and up to 1 friendly **Flesh hounds** unit to be the targets.
...
### Khorgorath
**Points:** 120 | **Move:** 8" | **Health:** 8 | **Save:** 5+ | **Control:** 2
**Keywords:** CHAOS, BLADES OF KHORNE, MONSTER, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Claws and Fangs | Melee | - | 5 | 4+ | 2+ | 1 | 2 | Companion |

**Abilities:**

#### Horrific Predators (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice. On a 3+, the target cannot use commands for the rest of the turn.
- **Keywords:** Rampage

#### Feast Upon Their Bones (Activated)
- **Timing:** End of Any Turn
...
### Khorgos Khul
**Points:** 220 | **Move:** 5" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND, WARMASTER, UNIQUE, WARD (6+), Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Axe of Khorne | Melee | - | 6 | 3+ | 3+ | 2 | 2 | Crit (Mortal), Blood-hungry |
| Grizzlemaw’s Blood-dark Claws | Melee | - | 4 | 4+ | 3+ | - | 1 | Anti-Wizard (+1 Rend), Companion |

**Abilities:**

#### Retinue of Blood (Activated)
- **Timing:** Once Per Battle, Any Charge Phase
- **Declare:** Pick each friendly Bloodbound Hero within this unit's combat range to be the targets.
- **Effect:** The targets' melee weapons have **Charge (+1 Damage)** for the rest of the turn.

#### Master of the Goretide (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
- **Declare:** Spend 3 **blood tithe points** and pick a friendly Bloodbound unit that started the battle with 3 or more models and that has been destroyed to be the target.
...
#### Reality-Splitting Axe (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick an enemy unit that had any damage points allocated to it this turn by combat attacks made by this unit to be the target.
- **Effect:** Roll a dice. On a 5+, one model in that unit is slain.

---

### Khul Ascended
**Points:** 310 | **Move:** 10" | **Health:** 10 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, WARMASTER, UNIQUE, INFANTRY, DAEMON, WARD (5+), Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Axe of Khorne | Melee | - | 6 | 3+ | 3+ | 2 | 3 | Crit (Mortal), Blood-hungry |

**Abilities:**

#### Loathe the Arcane (Activated)
- **Timing:** Reaction: Opponent declared a Spell ability
- **Effect:** This unit can use this ability if it is not in combat. This unit can move 3" but must end that move closer to the unit that used the Spell ability. It cannot move into combat during any part of that move.

#### Ascended Warlord (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Effect:** Roll a dice. On a 3+, add 1 to the Attacks characteristic of this unit's **Axe of Khorne** for each other friendly Blades of Khorne unit that is within this unit's combat range and in combat.
- **Keywords:** Rampage
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wrathforged Axe | Melee | - | 6 | 3+ | 3+ | 1 | 2 | Blood-hungry |
| Juggernaut’s Brazen Hooves | Melee | - | 2 | 4+ | 3+ | 1 | D3 | Companion |

**Abilities:**

#### Lord of the Brass Stampede (Passive)
- **Effect:** If this unit charged this turn, for the rest of the turn, add 1 to charge rolls for Blades of Khorne Cavalry units while they are wholly within 12" of this unit.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Goreaxe | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Blood-hungry |
| Goreaxe | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Blood-hungry |
| Goreaxe | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Blood-hungry |
| Blood-dark Claws | Melee | - | 4 | 4+ | 3+ | - | 1 | Anti-Wizard (+1 Rend), Companion, Blood-hungry |
...
**Points:** 130 | **Move:** 5" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Axe of Khorne | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Blood-hungry |
| Flesh Hound’s Blood-dark Claws | Melee | - | 4 | 4+ | 3+ | - | 1 | Companion |
...
#### 'Bring Me Their Skull!' (Activated)
- **Timing:** Once Per Turn (Army), Your Combat Phase
...
### Mighty Lord of Khorne (Scourge of Ghyran)
**Points:** 140 | **Move:** 5" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Axe of Khorne | Melee | - | 4 | 3+ | 3+ | 2 | 3 | Blood-hungry |
| Flesh Hound’s Blood-dark Claws | Melee | - | 3 | 4+ | 3+ | - | 1 | Companion |
...
#### Howl of Blood-Curdling Savagery (Command)
- **Timing:** Once Per Battle (Army), Any Combat Phase
- **Cost:** 1
...
- **Effect:** The target can move a distance up to the value of the charge roll. That unit can move through the combat ranges of any enemy units and must end that move within ½" of a visible enemy unit. If it does so, the target has charged.
- **Keywords:** Move, Charge

---

### Mighty Skullcrushers
**Points:** 200 | **Move:** 10" | **Health:** 5 | **Save:** 2+ | **Control:** 2
**Keywords:** CHAOS, CHAMPION, MUSICIAN (1/3), STANDARD BEARER (1/3), CAVALRY, BLOODBOUND, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gorebathed Glaive or Axe | Melee | - | 3 | 3+ | 3+ | 1 | 1 | Blood-hungry, Charge (+1 Damage) |
| Juggernaut’s Brazen Hooves | Melee | - | 2 | 4+ | 3+ | 1 | D3 | Companion |
...
### Realmgore Ritualist
**Points:** 120 | **Move:** 5" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, PRIEST (1), INFANTRY, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ritual Athame | Melee | - | 2 | 3+ | 3+ | 2 | D3 | Blood-hungry |

**Abilities:**

#### Desecrating Blood Runes (Activated)
...
### Scyla Anfingrimm
**Points:** 130 | **Move:** 8" | **Health:** 8 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, BLADES OF KHORNE, BEAST, BLOODBOUND, Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Brutal Fists | Melee | - | 8 | 4+ | 2+ | - | 2 | Crit (2 Hits), Blood-hungry |

**Abilities:**

#### Bestial Leap (Activated)
- **Timing:** Any Charge Phase
...
### Skarbrand
**Points:** 410 | **Move:** 8" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, UNIQUE, CHAOS, DAEMON, MONSTER, WARD (5+), BLADES OF KHORNE, BLOODTHIRSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Slaughter | Melee | - | 4 | 3+ | 2+ | 2 | 4 | Blood-hungry |
| Carnage | Melee | - | 2 | 3+ | 2+ | 2 | 8 | Crit (Mortal) |

**Abilities:**

#### Skarbrand's Rage (Passive)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| The Bloodstorm Blades | Melee | - | 6 | 3+ | 3+ | 1 | 2 | Blood-hungry, Crit (2 Hits) |

**Abilities:**

#### The Slaughterborn (Activated)
...
### Skull Cannon
**Points:** 150 | **Move:** 8" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** CHAOS, DAEMON, BLADES OF KHORNE, WARD (6+), WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Burning Skulls | Ranged | 15" | 4 | 4+ | 3+ | 1 | 2 | Shoot in Combat |
| Gnashing Maw | Melee | - | 1 | 4+ | 3+ | 1 | D3 | Blood-hungry, Companion |
| Hellblades | Melee | - | 4 | 3+ | 3+ | 1 | 1 | Blood-hungry, Crit (Mortal) |

**Abilities:**

#### Gruesome Bombardment (Passive)
...
#### Grind Their Bones, Seize Their Skulls (Passive)
...
### Skullgrinder
**Points:** 110 | **Move:** 5" | **Health:** 6 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Brazen Anvil | Melee | - | 4 | 4+ | 2+ | 1 | 3 | Anti-Monster (+1 Rend), Blood-hungry |

**Abilities:**

#### Bone-crushing Strikes (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
#### Herald of Trampling Death (Activated)
- **Timing:** Once Per Battle, Any Charge Phase
...
### Skullreapers
**Points:** 170 | **Move:** 5" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAOS, CHAMPION, BLOODBOUND, INFANTRY, STANDARD BEARER (1/5), BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Daemonforged Weapons | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Blood-hungry, Crit (2 Hits) |

**Abilities:**

#### Trial of Skulls (Passive)
- **Effect:** Add 8 to this unit's control score while it is in combat.

---

### Skulltaker
**Points:** 120 | **Move:** 5" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, DAEMON, BLADES OF KHORNE, INFANTRY, WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| The Slayer Sword | Melee | - | 6 | 2+ | 3+ | 2 | 2 | Anti-Hero (+1 Rend), Blood-hungry |

**Abilities:**

#### Heroes' Bane (Activated)
- **Timing:** Any Combat Phase
...
#### Drawn by Blood (Activated)
- **Timing:** Once Per Battle (Army), End of Enemy Turn
...
### Slaughterpriest
**Points:** 130 | **Move:** 5" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, CHAOS, BLADES OF KHORNE, INFANTRY, BLOODBOUND, PRIEST (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodbathed Weapon | Melee | - | 4 | 3+ | 3+ | 1 | 2 | Blood-hungry |

**Abilities:**

#### Scorn of Sorcery (Passive)
- **Effect:** This unit can use Unbind abilities as if it had Wizard (1).
...
### Valkia the Bloody
**Points:** 180 | **Move:** 12" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, BLADES OF KHORNE, BLOODBOUND, Legends, INFANTRY, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Slaupnir | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Charge (+1 Damage), Blood-hungry |

**Abilities:**

#### Borne on Wings of Blood (Activated)
- **Timing:** Deployment Phase
...
#### The Red Angel of Slaughter (Activated)
- **Timing:** Your Movement Phase
...
**Points:** 400 | **Move:** 12" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, CHAOS, DAEMON, MONSTER, WARD (5+), FLY, BLADES OF KHORNE, BLOODTHIRSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Mighty Axe of Khorne and Bloodflail | Melee | - | 6 | 3+ | 2+ | 2 | 4 | Anti-Hero (+1 Rend), Blood-hungry |
| Hellfire Breath | Ranged | 8" | 2D6 | 2+ | 3+ | 1 | 1 | Shoot in Combat |
...
- **Effect:** Add 1 to hit rolls for this unit's attacks that target an enemy Hero.

---

### Wrathmongers
**Points:** 130 | **Move:** 5" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** CHAOS, CHAMPION, BLOODBOUND, INFANTRY, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wrath-flails | Melee | - | 4 | 4+ | 3+ | 1 | 1 | Blood-hungry, Crit (2 Hits) |
...
- **Effect:** Both player's roll off. If you win the roll-off, pick a melee weapon that the target is armed with. Your opponent must pick a visible unit in their army within 3" of the target (they can pick the target's own unit, and even if it is a single-model unit).
...
| Bloodcrushers (Scourge of Ghyran) | 150 |
| Bloodletters | 150 |
| Skull Cannon | 150 |
