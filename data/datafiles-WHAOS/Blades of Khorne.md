...
> Variant: Mighty Lord of Khorne (Scourge of Ghyran) — 170 pts
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Slaupnir | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Charge (+1 Damage) |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Brutal Fists | Melee | - | 8 | 4+ | 2+ | - | 2 | Crit (2 Hits) |
...
### Anvil of Apotheosis: Blades of Khorne Hero
**Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, INFANTRY, CHAOS, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodshed Blade | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Blood-hungry, Crit (2 Hits) |
| Blood-slick Weapon | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Blood-hungry |
| Juggernaut's Brass-shod Hooves | Melee | - | 2 | 4+ | 3+ | 1 | D3 | Companion |
| Great Blood-slick Weapon | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Blood-hungry, Crit (2 Hits) |
| Daemon Rider's Hellblades | Melee | - | 4 | 3+ | 3+ | 1 | 1 | Blood-hungry, Companion |
...
**Keywords:** CHAOS, INFANTRY, CHAMPION, BLOODBOUND, BLADES OF KHORNE
...
### Bloodletters
**Points:** 160 | **Move:** 5" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** WARD (6+), CHAOS, DAEMON, INFANTRY, CHAMPION, BLADES OF KHORNE
...
### Bloodcrushers
**Points:** 140 | **Move:** 10" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** WARD (6+), CHAOS, DAEMON, CHAMPION, CAVALRY, BLADES OF KHORNE
...
> Variant: Bloodcrushers (Scourge of Ghyran) — 160 pts

---

### Mighty Skullcrushers
**Points:** 200 | **Move:** 10" | **Health:** 5 | **Save:** 2+ | **Control:** 2
**Keywords:** CHAOS, CHAMPION, CAVALRY, BLOODBOUND, BLADES OF KHORNE
...
### Skullreapers
**Points:** 180 | **Move:** 5" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAOS, CHAMPION, BLOODBOUND, INFANTRY, BLADES OF KHORNE
...
**Keywords:** CHAMPION, INFANTRY, CHAOS, BLADES OF KHORNE, BLOODBOUND
...
### Wrath-axe
**Move:** 8" | **Health:** 7 | **Save:** 5+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, INVOCATION, FLY, CHAOS, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wrath-axe | Melee | - | 4 | 4+ | 2+ | 2 | D3 | - |

**Abilities:**

#### Hatred's Edge (Activated)
- **Timing:** Any Combat Phase
...
- **Effect:** Roll a dice. If the roll equals or exceeds the blood tithe points cost of the chosen ability, until the start of your next turn, the target can use the chosen ability as if it had been unlocked.

---

### Hexgorger Skulls
**Move:** 8" | **Health:** 6 | **Save:** 5+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, INVOCATION, FLY, CHAOS, BLADES OF KHORNE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stream of Molten Blood | Melee | - | 2 | 4+ | 3+ | - | D3 | - |
...
### Skull Altar
**Move:** - | **Health:** 10 | **Save:** 4+ | **Control:** -
**Keywords:** FACTION TERRAIN, CHAOS, BLADES OF KHORNE

**Abilities:**

#### Words of Hate (Passive)
...
#### Ascend the Altar (Activated)
- **Timing:** Your Hero Phase
- **Declare:** If this terrain feature does not have an Invoker, pick a friendly Blades of Khorne Infantry Priest within 3" of it to be the target.
- **Effect:** Place the target on this terrain feature. The target is now an Invoker (see ‘Words of Hate’).

#### Hatred of Sorcery (Activated)
- **Timing:** Once Per Turn, Your Hero Phase
- **Declare:** If this terrain feature has an Invoker, pick up to D3 enemy Endless Spells within 18" of this terrain feature to be the target(s) and make a banishment roll of 2D6 for each target.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Goreaxe | Melee | - | 3 | 4+ | 3+ | 1 | 1 | - |
| Blood-dark Claws | Melee | - | 4 | 4+ | 3+ | - | 1 | Anti-Wizard (+1 Rend), Companion |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Reaver Blades and Axes | Melee | - | 2 | 4+ | 3+ | - | 1 | - |
...
- **Effect:** Roll a number of dice equal to the current battle round number plus the number of units (friendly and enemy) that have been destroyed this battle. If the roll contains 8 or more results of 3+, set up a replacement unit identical to the target anywhere on the battlefield more than 9" from all enemy units.
