...
#### Rune of Fiery Determination (Activated)
...
#### Rune of Relentless Zeal (Activated)
...
#### Rune of Searing Heat (Activated)
...
#### Draught of the Finest Magmalt (Activated)
...
#### Incandescent Blaze (Activated)
- **Timing:** Once Per Battle, Your Shooting Phase
- **Effect:** For the rest of the turn:
• Double the Attacks characteristic of this unit's **Roaring Fyrestream**.
• This unit's **Roaring Fyrestream** has a Damage characteristic of 3.

#### Peerless Lineage (Activated)
- **Timing:** Reaction: You declared a Rampage ability for this unit.
- **Effect:** You can pick another eligible unit to be a second target of that Rampage ability. If that ability requires a roll, you must roll for each target.

#### Thickened Scales (Passive)
...
#### Skilled Drothwranglers (Activated)
- **Timing:** Reaction: You declared a non-Charge Move
ability for a friendly Magmadroth
...
**Keywords:** HERO, ORDER, WARD (6+), FYRESLAYERS, DUARDIN, INFANTRY
...
**Keywords:** INFANTRY, CHAMPION, ORDER, WARD (6+), FYRESLAYERS, DUARDIN, MUSICIAN (1/10)
...
**Keywords:** HERO, ORDER, WARMASTER, WARD (6+), FYRESLAYERS, DUARDIN, INFANTRY
...
**Keywords:** HERO, MONSTER, ORDER, WARMASTER, WARD (6+), FYRESLAYERS, DUARDIN, MAGMADROTH
...
**Keywords:** HERO, ORDER, WARD (6+), FYRESLAYERS, DUARDIN, INFANTRY, PRIEST (2)
...
**Keywords:** HERO, ORDER, WARD (6+), FYRESLAYERS, DUARDIN, INFANTRY, PRIEST (1)
...
**Keywords:** HERO, MONSTER, ORDER, WARD (6+), FYRESLAYERS, DUARDIN, MAGMADROTH, PRIEST (1)
...
**Keywords:** HERO, MONSTER, ORDER, WARD (6+), FYRESLAYERS, DUARDIN, MAGMADROTH
...
**Points:** 110 | **Move:** 4" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, CHAMPION, ORDER, WARD (6+), FYRESLAYERS, DUARDIN
...
**Keywords:** ORDER, INFANTRY, UNIQUE, CHAMPION, Legends, WARD (6+), DUARDIN, FYRESLAYERS
...
**Keywords:** INFANTRY, ORDER, CHAMPION (1/9), WARD (6+), FYRESLAYERS, DUARDIN
