...
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its **Corpse-beast's Talons** is 5.

#### Battle Damaged (Passive)
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its **Winged Abomination's Talons** is 4.

#### Blind to the World (Passive)
- **Effect:** Subtract 1 from wound rolls for shooting attacks that target this unit.

#### Far-Travelling Sellsword (Passive)
- **Effect:** When this unit uses the 'Run' ability, if you roll a 1-3 when determining the distance this unit can move, you can use a value of 4 instead.

#### Terrifyingly Regal (Passive)
- **Effect:** Add 10 to this unit's control score while it is contesting an objective that is not being contested by any other friendly units.

#### Blessed by Ushoran (Passive)
- **Effect:** Subtract 1 from ward rolls for enemy units while they are in combat with this unit.

#### Old Valour Wound (Passive)
- **Effect:** Ignore positive modifiers to hit rolls for this unit's attacks.

#### Court Pariah (Passive)
- **Effect:** This unit has a maximum control score of 1.

#### Frenzied Butcher (Passive)
- **Effect:** This unit cannot use commands while it is in combat.

#### Tilting at Windmills (Passive)
- **Effect:** In your charge phase, if this unit is not in combat and there is an enemy unit within 12" of it, this unit must use a Charge ability, and if the charge roll would allow it to end the move within 1/2" of an enemy unit, it must do so.

#### Regal Presence (Passive)
- **Effect:** Subtract 3 from the control scores of enemy units while they are in combat with this unit.

#### Powerful Maw (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick an enemy Monster in combat with this unit to be the target.
- **Effect:** You and your opponent must each roll 2D6. If you roll higher, inflict an amount of mortal damage on the target equal to the difference between your roll and your opponent's roll.
- **Keywords:** Rampage

#### Memories of Hate (Passive)
- **Effect:** While this unit has 10 or more damage points:
• Add 2 to the Attacks characteristic of this unit's **Companion** melee weapons.
• Subtract 1 from save rolls for this unit.

#### Infested Corpse (Passive)
- **Effect:** If this unit is destroyed, before removing it from play, roll a D3 for each enemy unit in combat with it. Of a 2+, inflict an amount of mortal damage on that unit equal to the roll.

#### Magnificent Monstrosity (Activated)
...
#### Infectious Mania (Activated)
- **Timing:** Reaction: Opponent declared a command for a unit in combat with this unit
- **Effect:** Roll a dice. On a 5+, the command has no effect, it still counts as having been used, and the command points spent to use it are still lost.

#### Agitator to the Masses (Activated)
- **Timing:** Once Per Battle (Army), Your Movement Phase
- **Declare:** Pick a visible friendly Serfs or Knights unit wholly within 12" of this unit to be the target.
- **Effect:** Roll a number of dice equal to the number of models in the target unit that have been slain. For each 4+, return 1 slain model to the target unit. No more than 3 slain models can be returned to a friendly Knights unit by this ability.

#### Sorcerer-Royarch (Passive)
- **Effect:** Add 1 to casting rolls and banishment rolls for this unit.

#### Cannibal Saint (Passive)
- **Effect:** Add 1 to chanting rolls and banishment rolls for this unit.

### Paths

#### Unnatural Parry (Passive)
- **Effect:** Combat attacks that target this unit cannot score critical hits (treat them as regular hits instead).

#### Skill-at-Arms (Passive)
- **Effect:** Ignore negative modifiers to hit rolls for this unit's combat attacks.

#### Unholy Thirst (Activated)
- **Timing:** Once Per Battle, Reaction: You declared a Fight ability for this unit
- **Effect:** Add 1 to the Attacks characteristic of this unit's melee weapons, including **Companion** weapons, for the rest of the turn.

#### Unnatural Wards (Passive)
- **Effect:** This unit has Ward (4+) against damage points inflicted by Spell abilities, Prayer abilities and abilities used by Manifestations.

#### Let Us Break Bread! (Passive)
- **Effect:** Enemy units cannot use Retreat abilities while they are in combat with this unit.

#### Glorious Charge (Passive)
- **Effect:** When making charge rolls for this unit, add 1 to the number of dice rolled, to a maximum of 3, then remove 1 dice of your choice and use the remaining dice as the charge roll.

#### Beloved of the Kingdom (Activated)
- **Timing:** Once Per Battle, Any Movement Phase
- **Declare:** Pick a friendly non-Unique Flesh-eater Courts unit that has been destroyed to be the target.
- **Effect:** Set up a replacement unit identical to the target wholly within 6" of a battlefield edge and more than 9" from all enemy units.

#### Regal Authority (Activated)
- **Timing:** Reaction: You declared the 'Counter-charge' command for this unit
- **Effect:** You and your opponent must roll off. If you roll higher, subtract 3 from the charge roll. If your roll is at least double your opponent's roll, pick 1 dice in the charge roll instead. Your opponent must remove that dice and use the remaining dice as the charge roll.

#### Sentries-at-Arms (Activated)
- **Timing:** Any Combat Phase
- **Declare:** If this unit charged this turn, pick an enemy unit in combat with it to be the target.
- **Effect:** Roll a dice. On a 4+, for the rest of the turn, add 1 to hit rolls for this unit's combat attacks that target that enemy unit.

#### Roving Pack (Activated)
- **Timing:** Start of Battle Round
- **Effect:** If this unit is not in combat, roll a dice. On a 4+, this unit can move 3". It cannot move into combat during any part of that move.

#### Culinary Artistes (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick up to 3 enemy units in combat with this unit and that have any damage points allocated to them to be the targets.
- **Effect:** Inflict 1 mortal damage on each target.

#### One With the Land (Passive)
- **Effect:** While this unit is wholly within 3" of a terrain feature, it is not visible to enemy units more than 6" away.

#### Guards of the Royal Menagerie (Passive)
- **Effect:** Subtract 2 from the Damage characteristic of **Companion** weapons used for attacks that target this unit.

#### Glory or Death (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Effect:** For the rest of the turn:
• Add 2 to the Attacks characteristic of this unit's melee weapons, including Companion weapons.
• This unit cannot contest objectives.

#### Royal Elite (Passive)
- **Effect:** This unit's melee weapons have **Crit (Mortal)**.

#### Famed Pilgrims (Activated)
- **Timing:** Once Per Battle, Any Movement Phase
- **Effect:** Return D6 slain models to this unit.

### Battle Traits

#### Royal Blood (Activated)
...
#### The Splintered Femur (Activated)
...
• That non-Hero can use a Rampage ability on its warscroll even if that ability has already been used by another friendly Monster in the same turn.
...
#### Like Snapping Hounds (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
#### Savage Beyond Reason (Passive)
- **Effect:** Add 1 to the Attacks characteristic of this unit's melee weapons, including **Companion** weapons, if it did not use a Fight ability in the previous turn. Add 2 to the Attacks characteristic of those weapons instead while this unit has not used a Fight ability this battle.

### Monstrous Traits

#### Horribly Resilient (Activated)
- **Timing:** End of Any Turn
- **Effect:** Heal (D3) this unit. If this unit is not a Hero, **Heal (2D3)** this unit instead.

#### Savage Abomination (Passive)
- **Effect:** Add 1 to the Attacks characteristic of this unit’s **Companion** melee weapons.

#### Revered Monstrosity (Passive)
- **Effect:** Add 1 to hit rolls for combat attacks made with **Companion** weapons by other friendly non‑Unique Flesh-eater Courts Monsters while they are wholly within 12" of this unit.
...
#### The Summerking's Colours (Activated)
...
#### A Duel, Good Sir (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** You must use this ability if the friendly **Ushoran** is in combat with the friendly general. Pick the enemy general to be the target.
...
#### In Their Sire's Shadow (Activated)
- **Timing:** Once Per Battle (Army), Any Charge Phase
- **Declare:** If the friendly **Ushoran** is not in combat and has not used any Run or Retreat abilities this turn, pick him to use this ability. Then, pick up to 2 friendly New Summercourt Knights units within his combat range that are not in combat and have not used a Run or Retreat ability this turn to be his royal retinue. Then, make a charge roll of 2D6.
- **Effect:** The friendly **Ushoran** can move a distance up to the value of the charge roll. He can move through the combat ranges of enemy units and must end that move within ½" of a visible enemy unit. If he does so, he has charged. If he charged, then after this ability has been resolved, each unit in his royal retinue can immediately use the 'Charge' ability even if it is not your charge phase and you can use the charge roll from this ability instead of making a charge roll when it does so, but it must end the charge move within 3" of the friendly **Ushoran**.
- **Keywords:** Core, Move, Charge

#### The Knight's Vow (Activated)
- **Timing:** Once Per Turn(Army), Any Combat Phase
...
#### Tip of the King's Lance (Activated)
- **Timing:** Any Combat Phase
...
#### A Display of Falconry (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
...
#### Make Merry 'Til the Morn (Passive)
...
#### Broken Sceptre of the Solstice (Activated)
...
**Keywords:** DEATH, HERO, FLESH-EATER COURTS, WARD (6+), INFANTRY, ABHORRANT, WIZARD (1)
...
**Keywords:** DEATH, HERO, FLESH-EATER COURTS, WARD (6+), INFANTRY, PRIEST (1), ABHORRANT
...
**Keywords:** DEATH, HERO, MONSTER, FLESH-EATER COURTS, ABHORRANT, FLY, WIZARD (1), WARD (6+)
...
### Charnel Throne
**Points:** 10 | **Move:** - | **Health:** 10 | **Save:** 4+ | **Control:** -
**Keywords:** DEATH, FACTION TERRAIN, FLESH-EATER COURTS

**Abilities:**

#### Steward of the Realm (Passive)
...
#### Ruler of All They Survey (Activated)
- **Timing:** Your Movement Phase
- **Declare:** If this terrain feature has a Steward, pick a visible friendly non-Hero Flesh-eater Courts unit that is not in combat to be the target.
...
**Keywords:** Undersize Unit, WARD (6+), DEATH, CHAMPION, FLY, FLESH-EATER COURTS, KNIGHTS, INFANTRY
...
**Keywords:** HERO, INFANTRY, Legends, WARD (6+), DEATH, FLESH-EATER COURTS, NOBLE
...
**Keywords:** WARD (6+), DEATH, CHAMPION, FLESH-EATER COURTS, INFANTRY, SERFS
...
**Keywords:** DEATH, HERO, FLESH-EATER COURTS, WARD (6+), INFANTRY, NOBLE
...
**Keywords:** WARD (6+), DEATH, CHAMPION, FLESH-EATER COURTS, KNIGHTS, INFANTRY
...
**Keywords:** DEATH, HERO, FLESH-EATER COURTS, WARD (6+), INFANTRY, NOBLE, FLY
...
**Keywords:** WARD (6+), DEATH, CHAMPION, FLESH-EATER COURTS, STANDARD BEARER (1/10), MUSICIAN (1/10), SERFS, INFANTRY
...
**Keywords:** DEATH, UNIQUE, HERO, FLESH-EATER COURTS, ABHORRANT, INFANTRY, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gore-streaked Gavel | Melee | - | 4 | 4+ | 3+ | - | D3 | - |

**Abilities:**

#### Arrest those Miscreants (Activated)
- **Timing:** Your Charge Phase
- **Declare:** Pick a visible enemy unit within 18" of this unit to be the target.
- **Effect:** Roll a dice. On a 3+, until the start of your next turn, the target has Strike-last while it is combat with any friendly Flesh-eater Courts Heroes and any friendly Serfs or Knights units.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Carrion Flock | Ranged | 12" | 1 | 4+ | 4+ | - | D6 | Shoot in Combat, Companion |
| Filthy Talons and Fangs | Melee | - | 5 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Be Mine Eyes (Activated)
- **Timing:** Your Hero Phase
- **Declare:** This unit's **Grype** is a token. If this unit's **Grype** is not next to an enemy unit, pick an enemy unit within 18" of this unit and not in combat to be the target.
...
**Keywords:** WARD (6+), DEATH, CHAMPION, FLY, CAVALRY, STANDARD BEARER (1/3), MUSICIAN (1/3), FLESH-EATER COURTS, KNIGHTS
...
**Points:** 830 | **Move:** 10" | **Health:** 18 | **Save:** 3+ | **Control:** 10
**Keywords:** DEATH, UNIQUE, HERO, MONSTER, WIZARD (9), WARD (5+), FLY, WARMASTER, FLESH-EATER COURTS
...
**Keywords:** WARD (6+), DEATH, FLESH-EATER COURTS, INFANTRY, SERFS, CHAMPION (1/10)
...
**Keywords:** DEATH, MONSTER, FLESH-EATER COURTS, FLY, WARD (6+)
...
**Keywords:** DEATH, MONSTER, FLESH-EATER COURTS, WARD (6+), FLY
...
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, WARD (6+), DEATH, FLESH-EATER COURTS, SERFS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Great Halberd | Melee | - | 4 | 2+ | 4+ | 1 | 2 | Crit (Auto-wound), Anti-Monster (+1 Rend) |
| Knightly Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Anti-Monster (+1 Rend) |
| Knightly Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Anti-Monster (+1 Rend) |
| Knightly Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Anti-Monster (+1 Rend) |
| Knightly Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Anti-Monster (+1 Rend) |
| Knightly Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Anti-Monster (+1 Rend) |
...
#### Quest to Slay the Monster (Activated)
- **Timing:** Any Combat Phase
...
### The Skinnerkin
**Points:** 80 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, WARD (6+), DEATH, FLESH-EATER COURTS, SERFS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Butchering Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |
| Butchering Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |
| Butchering Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |
| Butchering Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |
| Butchering Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |
...
**Points:** 450 | **Move:** 10" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** DEATH, UNIQUE, HERO, MONSTER, WARD (5+), WARMASTER, FLESH-EATER COURTS, WIZARD (2), ABHORRANT

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sceptre of the Carrion King | Melee | - | 4 | 3+ | 2+ | 2 | D3+3 | - |
| Monstrous Talons | Melee | - | 8 | 3+ | 3+ | 1 | 2 | - |
...
#### Epicentre of Delusion (Passive)
- **Effect:** Each time you make a delusion roll, you can add 1 or subtract 1 from the roll.

#### Glimpse of Delusion (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** Pick a visible enemy model within 18" of this unit to be the target, pick another enemy unit that is visible to the target and within the target’s combat range to be the victim, then make a casting roll of 2D6. You can only pick the target's unit to be the victim if that unit has 2 or more models.
...
**Keywords:** DEATH, FLESH-EATER COURTS, WARD (6+), BEAST
