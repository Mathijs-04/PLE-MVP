...
#### Splinters of the Vermindoom (Activated)
...
#### Always Three Clawsteps Ahead (Activated)
...
#### Devious Underling (Activated)
- **Timing:** Deployment Phase
- **Declare:** Pick another friendly Skaven Hero on the battlefield with a Health characteristic that equals or exceeds this unit’s Health characteristic to be the target.
...
**Points:** 340 | **Move:** 8" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, WARMASTER, SKAVEN, MASTERCLAN, WIZARD (2), WARD (5+), CHAOS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpfire Braziers | Melee | - | 6 | 4+ | 2+ | 2 | 3 | Companion |
| Staff of the Horned Rat | Melee | - | 4 | 4+ | 4+ | 1 | D3 | - |
| Custom Warpfire Projectors | Ranged | 10" | 6 | 2+ | 3+ | 2 | 1 | Companion |
...
#### Warp-amulet (Activated)
- **Timing:** End of Any Turn
- **Effect:** Heal (D3) this unit.

#### Boneripper Rampage (Activated)
...
**Points:** 380 | **Move:** 10" | **Health:** 13 | **Save:** 4+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, WARMASTER, SKAVEN, MASTERCLAN, WARD (5+), CHAOS, DAEMON, VERMINUS, PESTILENS, ESHIN, SKRYRE, MOULDER, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Glaive of the Rat King | Melee | - | 7 | 3+ | 2+ | 2 | 3 | Crit (2 Hits) |

**Abilities:**

#### The Thirteen-headed One (Activated)
- **Timing:** Your Hero Phase
...
#### Terrifying Monstrosity (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### The Dreaded Thirteenth Spell (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
### Verminlord Deceiver
**Points:** 390 | **Move:** 10" | **Health:** 13 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, SKAVEN, WARD (5+), CHAOS, WIZARD (1), DAEMON, ESHIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Doomstar | Ranged | 13" | 6 | 3+ | 3+ | 1 | 2 | Crit (Auto-wound) |
| Warpstiletto | Melee | - | 8 | 3+ | 2+ | 3 | 2 | Crit (Mortal) |

**Abilities:**

#### Lord of Assassins (Activated)
- **Timing:** Reaction: You declared the ‘Redeploy’ command for a friendly Eshin Infantry unit wholly within 13" of this unit
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

#### Burst From the Shadows (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 310 | **Move:** 6" | **Health:** 15 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, SKAVEN, CHAOS, WARD (5+), WAR MACHINE, MASTERCLAN, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rat Ogor’s Tearing Claws | Melee | - | 5 | 4+ | 3+ | 1 | 2 | Companion |
| Crushing Bulk | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Companion |
| Warpstone Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |
...
- **Effect:** Friendly Skaven Infantry units have Ward (6+) while they are wholly within 13" of this unit.

#### Peal of Doom (Activated)
- **Timing:** Your Hero Phase
...
> Variant: Grey Seer on Screaming Bell (Scourge of Ghyran) — 330 pts

---

### Verminlord Warbringer
**Points:** 300 | **Move:** 10" | **Health:** 13 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, SKAVEN, WARD (5+), CHAOS, WIZARD (1), DAEMON, VERMINUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Doom Glaive and Spike-fist | Melee | - | 7 | 3+ | 2+ | 2 | 3 | Crit (Mortal) |

**Abilities:**

#### Tyrant of Battle (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Verminlord Warpseer
**Points:** 320 | **Move:** 10" | **Health:** 13 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, SKAVEN, WARD (5+), CHAOS, DAEMON, MASTERCLAN, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Doom Glaive | Melee | - | 6 | 4+ | 2+ | 2 | 3 | - |
...
### Clawlord
**Points:** 70 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, VERMINUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpforged Blade | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |
...
#### Gnash-gnaw on Their Bones! (Activated)
...
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, PRIEST (1), PESTILENS, Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpstone-tipped Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | Crit (Auto-wound) |

**Abilities:**

#### Feed on Pestilence (Activated)
- **Timing:** Reaction: You declared a Fight ability for a friendly Pestilens unit wholly within 13" of this unit
...
### Warlock Engineer
**Points:** 110 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warplock Musket | Ranged | 24" | 2 | 3+ | 3+ | 2 | D3 | Crit (Auto-wound) |
| Warpforged Dagger | Melee | - | 3 | 4+ | 4+ | - | 2 | - |

**Abilities:**

#### More-more Warp Energy! (Activated)
- **Timing:** Reaction: You declared a Shoot ability for this unit, it was not set up this turn and it has not used a Move ability this turn
...
### Warlock Bombardier
**Points:** 90 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Doomrocket | Ranged | 18" | 2 | 4+ | 3+ | 1 | D6 | Anti-Infantry (+1 Rend) |
| Firing Pole | Melee | - | 3 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### More-more Doom! (Activated)
- **Timing:** Reaction: You declared a Shoot ability for this unit, it was not set up this turn and it has not used a Move ability this turn
...
### Arch-Warlock
**Points:** 150 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, WIZARD (1), INFANTRY, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpfire Gauntlet | Ranged | 10" | 3 | 4+ | 2+ | 2 | 1 | Shoot in Combat |
| Stormcage Halberd | Melee | - | 3 | 3+ | 4+ | 1 | 2 | - |
| Crushing Piston-claw | Melee | - | 2 | 4+ | 2+ | 2 | 2 | - |
...
**Points:** 300 | **Move:** 10" | **Health:** 13 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, SKAVEN, WARD (5+), CHAOS, DAEMON, PESTILENS, PRIEST (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plaguereapers | Melee | - | 8 | 3+ | 2+ | 2 | 2 | Crit (Auto-wound) |

**Abilities:**

#### Lord of Great Plagues (Activated)
...
### Grey Seer
**Points:** 120 | **Move:** 6" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, WIZARD (1), MASTERCLAN, INFANTRY
...
#### Warpstone Shards (Activated)
- **Timing:** Your Hero Phase
- **Effect:** The next time you make a casting roll for this unit this phase, roll 3D6 instead of 2D6. This roll cannot be rerolled or modified.
...
### Deathmaster
**Points:** 130 | **Move:** 7" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, ESHIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Eshin Throwing Stars | Ranged | 10" | 5 | 3+ | 4+ | - | D3 | Crit (Auto-wound), Shoot in Combat |
| Weeping Blade | Melee | - | 5 | 3+ | 4+ | 1 | D3 | Anti-Hero (+1 Rend), Crit (Mortal) |

**Abilities:**

#### Shadowy Killers (Passive)
...
### Master Moulder
**Points:** 80 | **Move:** 6" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, MOULDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpsyringe Pistol | Ranged | 10" | D6 | 4+ | 2+ | 2 | 1 | Shoot in Combat |
| Arsenal of Mutation | Melee | - | 4 | 3+ | 4+ | 1 | 1 | Crit (2 Hits) |

**Abilities:**

#### Lord of Flesh-grafting (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick another friendly Moulder unit wholly within 13" of this unit to be the target.
- **Effect:** Heal (3) the target.

#### Tyrannical Packmaster (Activated)
...
**Points:** 110 | **Move:** 9" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, VERMINUS, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpforged Halberd | Melee | - | 5 | 3+ | 4+ | 1 | 2 | - |
| Ratling Pistol | Ranged | 10" | D6 | 3+ | 3+ | 1 | 1 | Crit (Auto-wound), Shoot in Combat |
| Gnaw-beast’s Chisel Fangs | Melee | - | 4 | 4+ | 3+ | 1 | D3 | Companion |
...
**Points:** 340 | **Move:** 6" | **Health:** 15 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, SKAVEN, CHAOS, PESTILENS, PRIEST (1), WARD (5+), WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Great Plague Censer | Melee | - | 4 | 4+ | 2+ | 1 | 3 | Crit (Auto-wound) |
| Foetid Blades | Melee | - | 6 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |
| Crushing Bulk | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Companion |
| Warpstone-tipped Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | Crit (Auto-wound) |
...
- **Effect:** Subtract 1 from ward rolls for enemy units while they are within 13" of this unit.

#### Altar of the Great Corruptor (Passive)
- **Effect:** Friendly Pestilens units have Ward (6+) while they are wholly within 13" of this unit.

---

### Krittok Foulblade
**Points:** 150 | **Move:** 6" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** UNIQUE, HERO, WARMASTER, SKAVEN, CHAOS, VERMINUS, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warplock Pistol | Ranged | 10" | 2 | 3+ | 3+ | 2 | D3 | Crit (Auto-wound) |
| Doomfang | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Crit (Mortal) |
...
#### A Reputation For Cunning (Command)
...
**Points:** 360 | **Move:** 10" | **Health:** 15 | **Save:** 5+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, WARMASTER, SKAVEN, MASTERCLAN, WARD (5+), CHAOS, DAEMON, PRIEST (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Host of Vermin | Melee | - | 10 | 5+ | 5+ | - | 1 | Crit (Auto-wound), Companion |
| Unholy Gnawstaff | Melee | - | 6 | 4+ | 2+ | 1 | D6 | Crit (Mortal) |

**Abilities:**

#### Fissures In Reality (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick each enemy unit in combat with this unit to be the targets.
- **Effect:** Roll a D3 for each target. On a 2+, inflict an amount of mortal damage on the target equal to the roll.

#### Prophet of the Horned Rat (Activated)
...
### Warlock Galvaneer
**Points:** 140 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, SKAVEN, CHAOS, INFANTRY, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpvolt Obliterator | Ranged | 18" | 2 | 3+ | 3+ | 2 | D3 | Crit (2 Hits), Anti-Cavalry (+1 Rend) |
| Rusted Blade | Melee | - | 3 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### More-more Warpvolt Doom! (Activated)
...
### Anvil of Apotheosis: Skaven Hero
**Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, INFANTRY, CHAOS, SKAVEN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpforged Blade | Melee | - | 4 | 4+ | 4+ | 1 | 2 |  |
| Gnaw-beast's Chisel Fangs | Melee | - | 4 | 4+ | 3+ | 1 | D3 | Companion |
| Moulder-beast's Monstrous Limbs | Melee | - | 5 | 4+ | 2+ | 2 | 3 | Companion |
| Crushing Bulk | Melee | - | 6 | 4+ | 2+ | - | 2 | Companion |
| Warpfire Launcher | Ranged | 10" | 5 | 3+ | 3+ | 2 | 1 | Shoot in Combat, Companion |
| Warp Lightning Strike | Ranged | 20" | 2D6 | 4+ | ⟝See 'Warp Lightning Strike' ability⟞ | ⟝See 'Warp Lightning Strike' ability⟞ | ⟝See 'Warp Lightning Strike' ability⟞ | Companion |
| Clawed Catapult | Ranged | 24" | 2 | 3+ | 2+ | 1 | D6 | Anti-Infantry (+1 Rend), Companion |
| Warplock Musket | Ranged | 24" | 2 | 3+ | 3+ | 2 | D3 | Crit (Auto-wound) |
| Experimental Warpvolt Incinerator | Ranged | 18" | 2 | 3+ | 3+ | 2 | D3 | Anti-Cavalry (+1 Rend), Crit (2 Hits) |
| Doomrocket | Ranged | 18" | 2 | 4+ | 3+ | 1 | D6 | Anti-Infantry (+1 Rend) |

**Abilities:**

#### Malicious Authority (Passive)
...
#### Back-back to the Fray, Minions! (Passive)
...
#### One with the Shadows (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
- **Declare:** Pick up to 3 friendly Eshin units wholly within 13" of this unit and not in combat to be the targets.
- **Effect:** Remove the targets from the battlefield and set them up again on the battlefield more than 9" from all enemy units,

#### Incessant Tinkerer (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick up to 3 friendly non-Hero Skryre units wholly within 13" of this unit to be the targets.
...
#### Accelerated Regeneration (Activated)
- **Timing:** End of Any Turn
- **Effect:** Heal (D6) this unit.

#### Best-best Warpstone Spikes (Activated)
...
#### Deafening Bell (Passive)
- **Effect:** Subtract 1 from hit rolls for combat attack made by enemy units while they are within 13# of this unit.

#### Revolting Barrage (Passive)
...
#### Dealings with the Masterclan (Passive)
- **Effect:** Add 1 to casting rolls for this unit.

#### Cleric of the Horned Rat (Passive)
- **Effect:** Add 1 to chanting rolls for this unit.

---

### Grey Seer on Screaming Bell (Scourge of Ghyran)
**Points:** 120 | **Move:** 6" | **Health:** 15 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, SKAVEN, CHAOS, WARD (5+), WAR MACHINE, MASTERCLAN, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rat Ogor’s Tearing Claws | Melee | - | 5 | 4+ | 3+ | 1 | 2 | - |
| Crushing Bulk | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Charge (+1 Damage), Companion |
| Warpstone Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |
...
### Stormfiends
**Points:** 240 | **Move:** 6" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** SKAVEN, CHAOS, INFANTRY, MOULDER, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ratling Cannons | Ranged | 15" | 3D6 | 4+ | 3+ | 1 | 1 | - |
| Clubbing Blows | Melee | - | 3 | 4+ | 2+ | - | 2 | - |
| Grinderfists | Melee | - | 4 | 4+ | 2+ | 2 | 2 | - |
| Warpfire Projectors | Ranged | 10" | 2D6 | 2+ | 4+ | 2 | 1 | Shoot in Combat |
| Windlaunchers | Ranged | 15" | 3 | 4+ | 3+ | 2 | D3 | - |
| Doomflayer Gauntlets | Melee | - | 5 | 4+ | 2+ | 2 | D3 | Charge (+1 Damage) |
| Shock Gauntlets | Melee | - | 4 | 4+ | 2+ | 1 | 2 | - |

**Abilities:**

#### Grinderfist Tunnellers (Activated)
...
### Plagueclaw
**Points:** 100 | **Move:** 3" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** SKAVEN, CHAOS, WAR MACHINE, PESTILENS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plagueclaw Catapult | Ranged | 24" | 2 | 3+ | 2+ | 1 | D6 | Anti-Infantry (+1 Rend) |
| Crew’s Teeth and Knives | Melee | - | D6 | 4+ | 5+ | - | 1 |  |

**Abilities:**

#### Bubonic Barrage (Passive)
- **Effect:** Each time this unit uses a Shoot ability, if all of its attacks targeted the same enemy unit, after that ability has been resolved, roll a dice. If the result is equal to or less than the number of models in that enemy unit that were slain by attacks made by this unit’s Plagueclaw Catapult this phase, that enemy unit has Strike‑last for the rest of the turn.

---

### Warplock Jezzails
**Points:** 130 | **Move:** 6" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, SKRYRE, CHAMPION

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Knives | Melee | - | 2 | 4+ | 5+ | - | 1 | - |
| Warplock Jezzail | Ranged | 18" | 2 | 4+ | 3+ | 2 | 2 | Crit (Auto-wound) |

**Abilities:**

#### Warpstone Snipers (Activated)
...
### Ratling Warpblaster
**Points:** 120 | **Move:** 6" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** SKAVEN, CHAOS, WAR MACHINE, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Hail of Warpstone Bullets | Ranged | 20" | 3D6+3 | 4+ | 3+ | 1 | 1 | Crit (Auto-wound) |
| Thrall-rats’ Claws | Melee | - | 4 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### More-more Warpstone Bullets! (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
- **Effect:** If this unit is within the combat range of a friendly Skryre Hero, this unit’s Hail of Warpstone Bullets has an Attacks characteristic of 6D6+3 instead of 3D6+3 for the rest of the turn. However, for each unmodified hit roll of 1 for an attack made with this unit’s Hail of Warpstone Bullets, inflict 1 mortal damage on this unit after the Shoot ability has been resolved.

#### Overwhelming Fire (Passive)
- **Effect:** Add 1 to hit rolls for this unit’s shooting attacks that target an enemy unit that has 10 or more models.

---

### Warpfire Throwers
**Points:** 130 | **Move:** 6" | **Health:** 3 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, SKRYRE, WEAPON TEAM

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Knives | Melee | - | 2 | 4+ | 5+ | - | 1 | - |
| Warpfire Thrower | Ranged | 10" | 2D6 | 2+ | 4+ | 2 | 1 | Shoot in Combat |

---

### Rat Ogors
**Points:** 140 | **Move:** 6" | **Health:** 4 | **Save:** 5+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, MOULDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Claws, Blades and Fangs | Melee | - | 5 | 4+ | 3+ | 1 | 2 | - |
| Warpfire Gun | Ranged | 10" | 2D6 | 2+ | 4+ | 2 | 1 | Shoot in Combat |

**Abilities:**

#### Unleashed Warp-fury (Activated)
- **Timing:** Any Combat Phase
...
### Doom-flayers
**Points:** 110 | **Move:** 2D6+3" | **Health:** 4 | **Save:** 4+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, SKRYRE, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Whirling Blades | Melee | - | 2D6 | 3+ | 3+ | 1 | 1 | Anti-Infantry (+1 Rend), Charge (+1 Damage) |

**Abilities:**

#### Whirling Doom (Activated)
...
### Ratling Guns
**Points:** 170 | **Move:** 6" | **Health:** 3 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, SKRYRE, WEAPON TEAM
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Knives | Melee | - | 2 | 4+ | 5+ | - | 1 | - |
| Ratling Gun | Ranged | 15" | 3D6 | 4+ | 4+ | 1 | 1 | Crit (2 Hits) |

---

### Doomwheel
**Points:** 100 | **Move:** 2D6+7" | **Health:** 8 | **Save:** 4+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, WAR MACHINE, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warp Bolts | Ranged | 13" | D6 | 3+ | 3+ | 1 | D3 | Shoot in Combat |
| Grinding Wheels | Melee | - | 6 | 4+ | 3+ | - | 1 | Charge (+1 Damage) |

**Abilities:**

#### Rolling Doom (Activated)
- **Timing:** Your Movement Phase
...
**Keywords:** SKAVEN, CHAOS, INFANTRY, SKRYRE, WEAPON TEAM, CHAMPION

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Knife | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Poisoned Wind Globe | Ranged | 10" | 1 | 3+ | 3+ | 1 | D3 | Anti‑Infantry (+1 Rend), Shoot in Combat |
...
**Points:** 200 | **Move:** D6+5" | **Health:** 14 | **Save:** 5+ | **Control:** 5
**Keywords:** SKAVEN, CHAOS, MOULDER, MONSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gnashing Teeth and Flailing Fists | Melee | - | 13 | 4+ | 2+ | 2 | 2 | Anti-Infantry (+1 Rend), Companion |
...
5-6 *It’s Alive!:* This unit is not destroyed and any remaining damage points inflicted on it have no effect. Then, Heal (D6) this unit.

---

### Plague Monks
**Points:** 140 | **Move:** 6" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, CHAMPION, PESTILENS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Foetid Weapons | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Spreaders of Filth and Disease (Passive)
...
**Keywords:** SKAVEN, CHAOS, INFANTRY, CHAMPION, VERMINUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Weapon | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Seething Swarm (Activated)
- **Timing:** End of Any Turn
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stormvermin Weapons | Melee | - | 3 | 3+ | 4+ | 1 | 1 | Anti-charge (+1 Rend) |

**Abilities:**

#### Elite Bodyguard (Passive)
- **Effect:** Friendly Skaven Infantry Heroes have Ward (5+) while they are within this unit’s combat range.

---

### Warp Lightning Cannon
**Points:** 120 | **Move:** 3" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** SKAVEN, CHAOS, WAR MACHINE, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warp Lightning Blast | Ranged | 20" | 2D6 | 4+ | ⟝See Warp Lightning Blast ability⟞ | ⟝See Warp Lightning Blast ability⟞ | ⟝See Warp Lightning Blast ability⟞ | - |
| Crew’s Teeth and Knives | Melee | - | D6 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### More-more Warp Lightning! (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
#### Warp Lightning Blast (Passive)
- **Effect:** Each attack made with this weapon in a single phase must target the same enemy unit. Each hit inflicts 1 mortal damage on the target and the attack sequence ends.

---

### Night Runners
**Points:** 120 | **Move:** 7" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, CHAMPION, ESHIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Slings and Poisoned Stars | Ranged | 10" | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Shoot in Combat |
| Poisoned Blades | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Mortal) |

**Abilities:**

#### Slinking Advance (Activated)
- **Timing:** Deployment Phase
- **Effect:** This unit can use the ‘Normal Move’ ability as if it were your movement phase.

#### Sneaky Infiltrators (Passive)
...
### Bell of Doom
**Move:** 3D6" | **Health:** 7 | **Save:** 6+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, SKAVEN, CHAOS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Volatile Warp Energy | Melee | - | 2D6 | 4+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Toll of Doom (Passive)
...
### Gnawhole
**Move:** - | **Health:** 6 | **Save:** 4+ | **Control:** -
**Keywords:** FACTION TERRAIN, CHAOS, SKAVEN

**Abilities:**

#### Volatile Ground (Passive)
...
#### Tunnels Through Reality (Activated)
- **Timing:** Your Movement Phase
...
#### The Endless Vermintide (Command)
...
### Vermintide
**Move:** 7" | **Health:** 13 | **Save:** 6+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, SKAVEN, CHAOS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Chittering Bites | Melee | - | 13 | 5+ | 5+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### More-more Rats (Activated)
- **Timing:** End of Any Turn
...
**Move:** - | **Health:** 7 | **Save:** 6+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, SKAVEN, CHAOS
...
#### Warp Lightning Bolts (Activated)
- **Timing:** Any Hero Phase
...
#### Warp Vortex (Passive)
- **Effect:** Subtract 2 from run rolls and charge rolls for enemy units while they are within 6" of this Manifestation. In addition, if an enemy unit passes across this Manifestation and/or the round-cornered triangle formed by drawing a line around all the bases of the Manifestation’s parts, inflict D3 mortal damage on that enemy unit after the Move ability has been resolved.

---

### Plague Censer Bearers
**Points:** 160 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, Legends, PESTILENS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plague Censer | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Crit (Auto-wound) |
...
#### Enshrouding Fumes (Passive)
- **Effect:** Subtract 1 from hit rolls for shooting attacks that target this unit.

---

### Gutter Runners
**Points:** 110 | **Move:** 7" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, ESHIN, Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Poisoned Stars | Ranged | 10" | 3 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |
| Punch Dagger and Blade | Melee | - | 3 | 3+ | 5+ | 1 | 1 | Crit (Mortal) |

**Abilities:**

#### Deliver the Killing Strike (Activated)
...
**Points:** 100 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAOS, SKAVEN, PRIEST (1), PESTILENS, CHAMPION

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plague Censer | Melee | - | 4 | 4+ | 5+ | 1 | 2 | Crit (Auto-wound) |
| Plaguepack Weapons | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |
...
**Points:** 100 | **Move:** 7" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAOS, SKAVEN, ESHIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Poisoned Stars | Ranged | 10" | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound), Shoot in Combat |
| Weeping Blade | Melee | - | 5 | 3+ | 4+ | 1 | D3 | Anti-Hero (+1 Rend) |
| Poisoned Blades | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Mortal) |
...
### Spiteclaw's Swarm
**Points:** 100 | **Move:** 6" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAOS, SKAVEN, VERMINUS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Weapon | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |
| Wicked Halberd | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |
...
### Brood Terror
**Points:** 230 | **Move:** 6" | **Health:** 12 | **Save:** 5+ | **Control:** 5
**Keywords:** SKAVEN, CHAOS, MOULDER, MONSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warpflame Scourger | Ranged | 15" | 2D6 | 4+ | 2+ | 1 | D3 | Anti-Infantry (+1 Rend), Crit (Auto-wound) |
| Chain-flail | Melee | - | 5 | 4+ | 2+ | 2 | 3 | Crit (Mortal) |
| Bladed Limbs | Melee | - | 3 | 4+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Warpstone Fumes (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Regenerating Terror (Activated)
- **Timing:** End of Any Turn
- **Effect:** Heal (D6) this unit.

> Variant: Brood Terror (Scourge of Ghyran) — 240 pts

---

### Plaguepack
**Points:** 130 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, CHAOS, SKAVEN, PRIEST (1), PESTILENS, CHAMPION (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plague Censer | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Crit (Auto-wound) |
| Weapons of Corruption | Melee | - | 2 | 4+ | 5+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Plague Rat (Passive)
- **Effect:** This unit’s Plague rat is a token. If you make an unmodified chanting roll of 1 for this unit while its Plague rat is on the battlefield, you can remove its Plague rat from the battlefield and then re-roll that chanting roll.
...
### Warp-Grinder
**Points:** 120 | **Move:** 5" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** SKAVEN, CHAOS, SKRYRE, WAR MACHINE
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Crew's Teeth and Knives | Melee | - | D6 | 4+ | 5+ | - | 1 | - |
| Warpstone Drill-fang | Melee | - | D3 | 4+ | 2+ | 3 | 5 | - |

**Abilities:**

#### Tunnel Skulkers (Activated)
- **Timing:** Once Per Battle (Army), Deployment Phase
...
### Warpvolt Scourgers
**Points:** 180 | **Move:** 6" | **Health:** 3 | **Save:** 6+ | **Control:** 1
**Keywords:** SKAVEN, CHAOS, INFANTRY, SKRYRE, WEAPON TEAM
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rusty Knives | Melee | - | 2 | 4+ | 5+ | - | 1 | - |
| Warpvolt Scourger | Ranged | 15" | 2D6 | 2+ | 4+ | 1 | 1 | Crit (2 Hits), Anti-Cavalry (+1 Rend) |

---

### Zikkit's Tunnelpack
**Points:** 110 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAOS, SKAVEN, SKRYRE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warp Drill | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |
| Tunneling Gear | Melee | - | 2 | 4+ | 4+ | 1 | D3 | Charge (+1 Damage) |
| Skryre Bombs | Ranged | 10" | 2 | 4+ | 4+ | 2 | 1 | Shoot in Combat |
| Mangy Claws | Melee | - | 2 | 4+ | 5+ | - | 1 | - |
...
### Brood Terror (Scourge of Ghyran)
**Points:** 230 | **Move:** 6" | **Health:** 12 | **Save:** 5+ | **Control:** 5
**Keywords:** SKAVEN, CHAOS, MOULDER, MONSTER, WARD (5+)
...
| Warpflame Scourger | Ranged | 15" | 2D6 | 4+ | 2+ | 1 | D3 | Anti-Infantry (+1 Rend), Crit (Auto-wound) |
| Chain-flail | Melee | - | 5 | 4+ | 2+ | 2 | 3 | Crit (Mortal) |
| Loosely Attached Bladed Limbs | Melee | - | 5 | 4+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Lend A Claw (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick up to 4 other friendly non-Skryre Moulder units wholly within 12" of this unit to be the targets.
- **Effect:** Subtract 1 from the Attacks characteristic of this unit’s Loosely Attached Bladed Limbs for the rest of the phase for each target picked. Add 1 to hit rolls for the targets’ attacks for the rest of the phase, including those made with Companion weapons.
- **Keywords:** Rampage
...
##### Monstrous Entourage (Passive)
- **Effect:** The Companion weapon ability has no effect on Mutated Menagerie units.
While a friendly Thanquol is within the combat range of another friendly Mutated Menagerie unit:
...
##### Spiteful Swarms (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick a friendly non-Hero Mutated Menagerie Monster that has not used any Rampage abilities this turn to use this ability.
...
##### Unstoppable Warp-volley (Activated)
...
##### Harbinger of the Great Ascendancy (Activated)
