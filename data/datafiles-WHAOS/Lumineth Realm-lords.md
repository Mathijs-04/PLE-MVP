...
#### Immovable Defenders (Passive)
- **Effect:** If you depicted **Alaithi, Rune of the Mountain** this battle round, add 3 to the control scores of friendly Alarith units while they are wholly within 12" of this unit.

#### Gale-force Arrows (Passive)
- **Effect:** If you depicted **Oreali, Rune of the Wind** this battle round, ranged weapons used by friendly Hurakan units have **Crit (Auto-wound)** while they are wholly within 12" Of this unit.

#### Flow with the Current (Activated)
- **Timing:** End of Any Turn
- **Declare:** If you depicted **Ydriliqi, Rune of the River** this battle round, pick a friendly Ydrilan unit wholly within 12" of this unit to be the target.
- **Effect:** The target can immediately use the 'Normal Move' or 'Retreat' ability as if it were your movement phase.

#### Shining Blades (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** Pick a visible friendly Lumineth Realm-lords unit wholly within 12" of this unit to be the target, then make a casting roll of 2D6.
- **Effect:** Add 1 to the Rend characteristic of the target's melee weapons for the rest of the turn.
- **Keywords:** Spell

#### Battle Damaged (Passive)
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its **Aelementor Colossal Weapon** is 3.

#### Magical Aptitude (Passive)
- **Effect:** Add 1 to casting rolls for this unit.

#### Defensive Exemplar (Activated)
- **Timing:** Any Combat Phase
- **Effect:** For the rest of the turn:
• This unit has Strike-last.
• If the unmodified hit roll for an attack that targets this unit is 1-4, the attack fails and the attack sequence ends.

#### Elemental Focus (Activated)
- **Timing:** Once Per Battle, Reaction: You declared the 'Depict Rune' ability
- **Effect:** If this unit is Alarith, replace each rune on your **battle scripture** with **Alaithi, Rune of the Mountain**.
If this unit is Hurakan, replace each rune on your **battle scripture** with **Oreali, Rune of the Wind**.
If this unit is Ydrilan, replace each rune on your **battle scripture** with **Ydriliqi, Rune of the River**.
If this unit is Scinari or Vanari, pick 1 of the runes above and replace each rune on your **battle scripture** with that rune.

#### Wealth of the Land (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
- **Effect:** Add 1 to this unit's power level for the rest of the phase.
...
- **Effect:** Unmodified casting rolls for friendly Lumineth Realm-lords units wholly within 12" Of this unit that contain 2 or more rolls of 1 or 2 are miscast. This unit cannot end a move within 5" of a Manfestation.

#### Blasted by the Elements (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit n combat with this unit to be the target.
- **Effect:** Roll a dice. On a 3+, the target has Strike-last for the rest of the turn.
- **Keywords:** Rampage

#### Realms Manifest (Activated)
- **Timing:** Deployment Phase
- **Effect:** Pick 1 of the following runes:
• **Ydriliqi, Rune of the River**
• **Alaithi, Rune of the Mountain**
• **Oreali, Rune of the Wind**
For the rest of the battle, while a visible friendly unit is wholly within 12" of this unit:
• You are treated as having 1 additional instance of that rune depicted on your **battle scripture** for the purposes of the abilities on that unit's warscroll.
• If that unit is picked to be the target of the 'Depict Rune' ability, you can apply the enhanced effects of that ability to that unit as if you had an instance of that rune on your **battle scripture**.

#### Momentous Charge (Activated)
...
#### Magical Form (Passive)
- **Effect:** Ignore modifiers to save rolls for this unit (positive and negative).

#### One with the Realms (Activated)
- **Timing:** Once Per Battle, Your Movement Phase
- **Effect:** Remove this unit from the battlefield and set it up again anywhere on the battlefield more than 9" from all enemy units.
...
#### Unravel Magic (Passive)
- **Effect:** Add 1 to unbinding rolls for this unit.

#### Fleet and Deft (Activated)
- **Timing:** Any End of Any Turn
- **Effect:** If this unit is in combat, it can move 2D6". It can pass through enemy models during that move.

#### Steady Mind (Activated)
- **Timing:** Reaction: You declared a Spell ability for this unit
- **Effect:** Re-roll one of the dice in the casting roll.

#### Display of Prowess (Activated)
...
#### Enlightening Presence (Passive)
- **Effect:** While friendly Lumineth Realm-lords units are wholly within 12" of this unit, add 1 to casting rolls for those units and add 1 to wound rolls for those units' attacks.

#### Icon of Valour (Activated)
- **Timing:** Your Charge Phase
- **Declare:** Pick this unit and up to 2 other friendly Lumineth Realm-lords units wholly within 12" of this unit to be the targets.
- **Effect:** For the rest of the turn, when making charge rolls for the target(s), add 1 to the number of dice rolled, to a maximum or 3, then remove 1 dice of your choice and use the remaining dice as the charge roll.

#### Ascended Form (Passive)
- **Effect:** The first time this unit would be destroyed, before removing it from play, it is not destroyed and any remaining damage points inflicted on it have no effect. Then, **Heal (1)** this unit and for the rest of the battle:
• Ignore modifiers (positive and negative) to save rolls and ward rolls for this unit.
• This unit has Ward (4+) and Fly.
• This unit cannot be healed.

#### Fleet-footed (Activated)
- **Timing:** Reaction: You declared a Run ability for this unit
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

#### Courageous Resolve (Passive)
- **Effect:** Add 5 to this unit's control score while each model in this unit is contesting an objective you control.

#### Realmshift (Activated)
- **Timing:** Once Per Battle, End of Your Turn
- **Effect:** Remove this unit from the battlefield and set it up again anywhere on the battlefield more than 9" from all enemy units.

#### Unshakeable Focus (Passive)
- **Effect:** Ignore the effects of Strike-last on this unit.

#### Balanced Manoeuvres (Passive)
...
#### Artisan Armour (Passive)
- **Effect:** Subtract 1 from the Rend characteristic of weapons used for attacks that target this unit.

#### Blinding Brilliance (Passive)
- **Effect:** This unit cannot be picked to be the target of enemy units that are more than 9" away from it.

#### Sworn Defenders (Passive)
- **Effect:** While this unit is wholly within the combat range of another friendly unit, both this unit and that friendly unit have Ward (5+).

### Battle Traits

#### Depict Rune (Activated)
...
• If **Oreali, Rune of the Wind** is depicted on your **battle scripture**, each target can immediately move 3". They can pass through the combat ranges of enemy units and can end that move in combat.
...
#### Silver Wand (Passive)
- **Effect:** If this unit is not a Wizard, it can use the 'Unbind' ability as if it had Wizard (1). Otherwise, add 1 to casting rolls for this unit.
...
#### Masterful Tactician (Activated)
- **Timing:** Reaction: You declared the ‘Redeploy’ command for a friendly Lumineth Realm‑lords unit wholly within 12" of this unit
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

#### Acolyte of the Runes (Activated)
...
#### Aetherquartz Requisitioner (Activated)
- **Timing:** Once Per Battle, Reaction: You declared a Spell ability for a Lumineth Realm-lords Wizard within this unit’s combat range
- **Effect:** Add 3 to the casting roll for that spell.

#### Martial Perfectionist (Activated)
- **Timing:** Any Combat Phase
...
#### The Realms Fight Back (Activated)
...
**Points:** 340 | **Move:** 6" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** MONSTER, ORDER, LUMINETH REALM-LORDS, ALARITH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stoneheart Worldhammer | Melee | - | 4 | 4+ | 2+ | 2 | 5 | - |
| Geomantic Blast | Ranged | 12" | 1 | 3+ | 2+ | 2 | D6 | Shoot in Combat |
...
#### With the Force of a Landslide (Passive)
...
### Alarith Stoneguard
**Points:** 130 | **Move:** 5" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, LUMINETH REALM-LORDS, AELF, ALARITH, STANDARD BEARER (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stoneguard Hammers | Melee | - | 2 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Fortitude of the Earth (Passive)
...
### Alarith Stonemage
**Points:** 130 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, WIZARD (1), ALARITH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Staff of the High Peaks | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Strength of Stone (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick a friendly **Alarith Stoneguard** unit wholly within 12" of this unit to be the target.
- **Effect:** For the rest of the turn:
• Add 1 to the Rend characteristic of the target's melee weapons.
• The target cannot make pile-in moves.

#### Raise the Earth (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
**Points:** 640 | **Move:** 10" | **Health:** 16 | **Save:** 4+ | **Control:** 10
**Keywords:** UNIQUE, HERO, MONSTER, FLY, WARMASTER, ORDER, WARD (5+), WIZARD (4), AELF, LUMINETH REALM-LORDS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celennar’s Moonbright Talons | Melee | - | 5 | 3+ | 3+ | 2 | 3 | Companion |
| Sword of Teclis | Melee | - | 2 | 3+ | 3+ | 2 | D3 | Crit (Mortal) |
| Lunar Staff | Ranged | 12" | 1 | 2+ | 2+ | 2 | D3+3 | - |
...
In addition, this unit can use Spell abilities from the Lore of Hysh, the Lore of Awakened Realms, and the warscrolls of all friendly Lumineth Realm-lords Wizards on the battlefield.
...
#### Discs of the Aelementiri (Activated)
- **Timing:** Once Per Battle (Army), Start of Battle Round
...
There is a smaller diamond in the battle scripture diamond in the Rules Reference where you can record this extra rune.*

#### The Light of Truth (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
**Points:** 420 | **Move:** 6" | **Health:** 16 | **Save:** 3+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, ORDER, LUMINETH REALM-LORDS, ALARITH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Firestealer Hammers | Melee | - | 6 | 4+ | 2+ | 2 | 4 | - |
| Geomantic Blast | Ranged | 12" | 1 | 3+ | 2+ | 2 | D6 | Shoot in Combat |
...
• If that unit is picked to be the target of the 'Depict Rune' ability, you can apply the enhanced effects of that ability to that unit as if you had an instance of **Alaithi, Rune of the Mountain** on your **battle scripture**.

#### Unbreakable Bulwark (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** If this unit did not charge this turn, pick an enemy unit in combat with it to be the target.
- **Effect:** Roll a dice. On a 3+, for the rest of the turn, while that enemy unit is in combat with this unit, all attacks made by models in that unit within this unit's combat range must target this unit.
- **Keywords:** Rampage
...
**Points:** 290 | **Move:** 6" | **Health:** 10 | **Save:** 4+ | **Control:** 4
**Keywords:** UNIQUE, HERO, ORDER, WARD (5+), AELF, LUMINETH REALM-LORDS, INFANTRY, WIZARD (1), SCINARI, VANARI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Altairi | Melee | - | 5 | 2+ | 3+ | 1 | 2 | - |
| Dianaer | Melee | - | 2 | 3+ | 4+ | 1 | D3 | - |
| Blazing Sunbolt | Ranged | 12" | 3 | 3+ | 3+ | 1 | D3 | Crit (Auto-wound) |
...
#### Equal Prodigies (Activated)
- **Timing:** Your Hero Phase
- **Declare:** Pick whether Ellania leads or Ellathor leads.
- **Effect:** If Ellania leads, until the start of your next turn, add 1 to this unit’s power level and it has Ward (4+). 
If Ellathor leads, until the start of your next turn, add the current battle round number to the Damage characteristic of **Altairi**.

#### Sudden Translocation (Activated)
- **Timing:** End of Any Turn
...
**Points:** 270 | **Move:** 18" | **Health:** 8 | **Save:** 4+ | **Control:** 5
**Keywords:** ORDER, LUMINETH REALM-LORDS, MONSTER, FLY, WARD (5+), HURAKAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Swirling Shards | Melee | - | 6 | 2+ | 4+ | - | 1 | Crit (Mortal) |
| Bow of the Wind’s Vengeance | Ranged | 15" | 4 | 2+ | 3+ | 2 | 2 | Anti‑Monster (+1 Rend), Shoot in Combat |

**Abilities:**

#### Hunters of Majestic Beasts (Passive)
- **Effect:** The Damage characteristic of this unit’s **Bow of the Wind’s Vengeance** is 3 for attacks that target Monsters.

#### Spirit of the Wind (Activated)
...
**Points:** 160 | **Move:** 14" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, ORDER, LUMINETH REALM-LORDS, AELF, STANDARD BEARER (1/5), CAVALRY, HURAKAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Treerunner’s Claws | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |
| Windcharger Bow | Ranged | 12" | 3 | 3+ | 4+ | 1 | 1 | Anti-Cavalry (+1 Rend), Crit (Auto-wound) |
| Windcharger Blade | Melee | - | 1 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Guided by the Winds (Passive)
...
### Hurakan Windmage
**Points:** 140 | **Move:** 12" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, WIZARD (1), HURAKAN, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Windblast Vortex | Ranged | 12" | 1 | 2+ | 3+ | 2 | D3 | Shoot in Combat |
| Aspiragillum | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Windleap (Activated)
- **Timing:** Once Per Battle (Army), Your Movement Phase
- **Declare:** Pick up to 3 visible friendly Hurakan units wholly within 12" of this unit to be the targets.
...
**Points:** 250 | **Move:** 14" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, AELF, LUMINETH REALM-LORDS, WIZARD (1), CAVALRY, VANARI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lyrior’s Sword | Melee | - | 5 | 2+ | 3+ | 1 | 2 | Charge (+1 Damage), Crit (Mortal) |
| Farael’s Horns and Claws | Melee | - | 4 | 4+ | 3+ | 1 | 1 | Companion |
| Daemonbane | Melee | - | 2 | 2+ | 3+ | 1 | 2 | Anti-Daemon (+1 Rend), Charge (+1 Damage) |
...
• If that unit is picked to be the target of the 'Depict Rune' ability, you can apply the enhanced effects of that ability to that unit as if you had an instance of **Varinor, Rune of Strength** on your **battle scripture**.

---

### Myari's Purifiers
**Points:** 130 | **Move:** 6" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** ORDER, INFANTRY, UNIQUE, CHAMPION, Legends, AELF, LUMINETH REALM-LORDS, VANARI, SCINARI, ALARITH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Auralan Bow | Ranged | 18" | 2 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |
| Purifier Weapons | Melee | - | 2 | 2+ | 4+ | 1 | 2 | - |
| Purifier Weapons | Melee | - | 2 | 2+ | 4+ | 1 | 2 | - |
| Purifier Weapons | Melee | - | 2 | 2+ | 4+ | 1 | 2 | - |
| Purifier Weapons | Melee | - | 2 | 2+ | 4+ | 1 | 2 | - |
...
### Scinari Calligrave
**Points:** 130 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, SCINARI, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Calligrave Blade | Melee | - | 3 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Realmscribe (Activated)
- **Timing:** Once Per Battle (Army), Reaction: You declared the 'Depict Rune' ability
...
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, WIZARD (1), SCINARI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Despairing Touch | Melee | - | 3 | 3+ | 4+ | - | D3 | - |

**Abilities:**

#### Darkness of the Soul (Activated)
...
### Scinari Enlightener
**Points:** 180 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, SCINARI, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Crescent Staff | Ranged | 12" | 3 | 3+ | 3+ | 1 | D3 | Shoot in Combat |
| Enlightener Blade | Melee | - | 3 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Rune of Enthlai (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared an Unlimited Spell ability for this unit
...
### Scinari Loreseeker
**Points:** 140 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, SCINARI, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Eclipsian Staff | Ranged | 12" | 3 | 3+ | 3+ | 1 | D3 | Shoot in Combat |
| Loreseeker Blade | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Arcane Discovery (Activated)
- **Timing:** Once Per Battle (Army), Your Movement Phase
...
#### Independent Operative (Activated)
- **Timing:** Once Per Battle (Army), Deployment Phase
...
**Points:** 340 | **Move:** 18" | **Health:** 10 | **Save:** 4+ | **Control:** 5
**Keywords:** UNIQUE, HERO, ORDER, LUMINETH REALM-LORDS, MONSTER, FLY, WARD (5+), HURAKAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Swirling Shards | Melee | - | 6 | 2+ | 4+ | - | 1 | Crit (Mortal) |
| Enathrai, the Howling Death | Ranged | 15" | 4 | 2+ | 3+ | 3 | 3 | Shoot in Combat |
...
• If that unit is picked to be the target of the 'Depict Rune' ability, you can apply the enhanced effects of that ability to that unit as if you had an instance of **Oreali, Rune of the Wind** on your **battle scripture**.

#### Searing Desert Winds (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick up to 3 visible enemy units within 6" of this unit this unit to be the targets.
...
**Points:** 300 | **Move:** 6" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, WARD (4+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Celennari Blade | Melee | - | 2 | 2+ | 3+ | 1 | 3 | Anti-Hero (+1 Rend), Anti-Monster (+1 Rend) |
| Fangsword of Eltharion | Melee | - | 5 | 2+ | 3+ | 3 | 3 | Crit (2 Hits) |
| Searing Darts of Light | Ranged | 12" | 3 | 2+ | 3+ | 2 | D3 | Shoot in Combat |
...
- **Timing:** Any Combat Phase
- **Declare:** This unit cannot use this ability if it is in combat. Pick a friendly Lumineth Realm-lords unit that is in combat to be the target.
...
**Points:** 280 | **Move:** 6" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, AELF, LUMINETH REALM-LORDS, INFANTRY, WARD (4+)
...
| Celennari Blade | Melee | - | 2 | 2+ | 3+ | 1 | 3 | Anti-Hero (+1 Rend), Anti-Monster (+1 Rend) |
| Fangsword of Eltharion | Melee | - | 5 | 2+ | 3+ | 3 | 3 | Crit (2 Hits) |
| Searing Darts of Light | Ranged | 12" | 3 | 2+ | 3+ | 2 | D3 | - |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warden Pikes and Blades | Melee | - | 2 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend), Crit (Mortal) |

**Abilities:**

#### Anticipated Strike (Passive)
...
### Vanari Bannerblade
**Points:** 140 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, VANARI, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bannerblade’s Sword | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
...
**Points:** 140 | **Move:** 6" | **Health:** 5 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, VANARI, INFANTRY
...
### Vanari Bladelords
**Points:** 150 | **Move:** 6" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, LUMINETH REALM-LORDS, AELF, VANARI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sunmetal Blade | Melee | - | 3 | 3+ | 4+ | 1 | 1 | Crit (Mortal) |

**Abilities:**

#### Masters of Combat (Passive)
- **Effect:** Add 1 to the Rend characteristic of this unit's **Sunmental Blades** for each instance of **Varinor, Rune of Strength** depicted on your **battle scripture**.

#### Guardians of the Scinari (Passive)
...
### Vanari Dawnriders
**Points:** 180 | **Move:** 14" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, ORDER, LUMINETH REALM-LORDS, AELF, VANARI, STANDARD BEARER (1/5), CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Dawnrider Lances and Blades | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage), Crit (Mortal) |
| Stallions’ Hooves | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Dawnrider Charge (Passive)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Regent’s Sword | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Shining Example (Passive)
...
**Points:** 150 | **Move:** 14" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, AELF, LUMINETH REALM-LORDS, CAVALRY, VANARI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Regent’s Sword | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
| Lightcourser’s Horns and Claws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
...
**Keywords:** ORDER, LUMINETH REALM-LORDS, WAR MACHINE, VANARI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Starshard Bolts | Ranged | 24" | 4 | 3+ | 3+ | 1 | 2 | Anti-Monster (+1 Rend), Crit (2 Hits) |
| Crew’s Arming Swords | Melee | - | 2 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Blinding Bolts (Activated)
- **Timing:** Once Per Turn (Army), Any Shooting Phase
- **Declare:** Pick an enemy unit that was targeted by all this unit's shooting attacks this phase to be the target.
...
### Ydrilan Riverblades
**Points:** 140 | **Move:** 7" | **Health:** 1 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, ORDER, LUMINETH REALM-LORDS, AELF, CHAMPION (1/10), YDRILAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ythara Darts | Ranged | 10" | 2 | 3+ | 4+ | - | 1 | Shoot in Combat |
| Ydrilan Blades | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Relentless as the Driving Current (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Travel the Waterways (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
If you picked to depict **Ydriliqui, Rune of the River** on your **battle scripture** this battle round, you can instead set up this unit anywhere on the battlefield more than 9" from all enemy units.
...
| The Light of Eltharion (Scourge of Ghyran) | 280 |
