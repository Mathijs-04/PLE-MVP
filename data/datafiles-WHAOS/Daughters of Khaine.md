...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blade of Khaine | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
...
### Morathi-Khaine
**Points:** 760 | **Move:** 6" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, WARMASTER, WARD (6+), ORDER, WIZARD (3), INFANTRY, AELF, DAUGHTERS OF KHAINE
...
### The Shadow Queen
**Move:** 12" | **Health:** 12 | **Save:** 4+ | **Control:** 10
**Keywords:** UNIQUE, HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, MONSTER, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gaze of the Shadow Queen | Ranged | 12" | 1 | 2+ | 2+ | 3 | D6 | Shoot in Combat |
| Heartrender | Melee | - | 8 | 3+ | 3+ | 2 | 3 | Crit (Mortal) |
| Crown of Serpents | Melee | - | 2D6 | 4+ | 4+ | - | 1 | - |
| Envenomed Tail | Melee | - | 1 | 3+ | 3+ | 2 | 6 | - |

**Abilities:**

#### Iron Heart of Khaine (Passive)
...
#### Fury of the Shadow Queen (Activated)
...
**Points:** 180 | **Move:** 12" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, FLY, INFANTRY, PRIEST (1), AELF
...
#### Burnt Offerings (Activated)
- **Timing:** Once Per Turn, Any Hero Phase
- **Declare:** If this unit is within the combat range of a friendly Cauldron of Blood, pick a visible friendly Daughters of Khaine Aelf non-Hero Infantry unit wholly within 18" of this unit to be the target.
...
*Prophecy of Reclamation:* For the rest
of the turn, while the target is contesting an objective, subtract 10 from the control scores of enemy units contesting that objective that do not have the Hero or Monster keyword.

#### Murder of Crows (Prayer)
- **Timing:** Your Hero Phase
- **Chanting Value:** 4
...
> Variant: Krethusa the Croneseer (Scourge of Ghyran) — 260 pts

---

### Bloodwrack Shrine
**Points:** 200 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WAR MACHINE, MELUSAI, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodwrack Stare | Ranged | 12" | 1 | 2+ | ⟝See 'Bloodwrack Stare' ability⟞ | ⟝See 'Bloodwrack Stare' ability⟞ | ⟝See 'Bloodwrack Stare' ability⟞ | Shoot in Combat |
| Bloodwrack Spear and Whisperclaw | Melee | - | 5 | 3+ | 4+ | 1 | 2 | - |
| Shrinekeepers’ Goadstaves | Melee | - | 6 | 3+ | 4+ | - | 1 | - |
...
> Variant: Bloodwrack Shrine (Scourge of Ghyran) — 250 pts

---

### Melusai Ironscale
**Points:** 150 | **Move:** 8" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, MELUSAI, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Keldrisaíth | Melee | - | 6 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
| Keldrisaíth | Ranged | 12" | 2 | 3+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Gory Offering (Activated)
...
#### Wrath of the Scáthborn (Passive)
...
### Bloodwrack Medusa
**Points:** 150 | **Move:** 8" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WIZARD (1), MELUSAI, INFANTRY
...
#### Melusai Kin (Activated)
- **Timing:** Reaction: You declared a Fight ability
for this unit
...
- **Declare:** If this unit is in combat, pick a visible friendly Daughters of Khaine Aelf non-Hero Infantry unit wholly within 12" of this unit to be the target.
- **Effect:** Roll a dice. On a 2+, add 1 to the Rend characteristic of melee weapons used by the target for the rest of the turn.

#### Killing Stroke (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
**Points:** 330 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WAR MACHINE, PRIEST (1), AELF, CAULDRON OF BLOOD

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blade of Khaine | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
| Avatar’s Sword | Melee | - | 5 | 3+ | 3+ | 2 | 3 | - |
| Witch Aelves’ Sciansá | Melee | - | 6 | 3+ | 4+ | - | 1 | - |
| Torrent of Burning Blood | Ranged | 10" | 6 | 3+ | 3+ | 1 | 1 | Shoot in Combat |

**Abilities:**

#### Altar of Khaine (Passive)
...
**Points:** 200 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WAR MACHINE, MELUSAI, WIZARD (2)
...
### Avatar of Khaine
**Points:** 110 | **Move:** 6" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** WARD (6+), ORDER, DAUGHTERS OF KHAINE, MONSTER
...
**Keywords:** WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, AELF, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Paired Sciansá | Melee | - | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kruiplash and Sacrificial Knife | Melee | - | 3 | 3+ | 4+ | - | 1 | Anti-Infantry (+1 Rend) |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kruiplash | Melee | - | 2 | 3+ | 4+ | - | 1 | Anti-Infantry (+1 Rend) |

**Abilities:**

#### Dance of Diversion (Passive)
- **Effect:** Subtract 1 from hit rolls for combat attacks that target this unit.

#### Bladed Bucklers (Passive)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sciansá | Melee | - | 2 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
...
### Blood Stalkers
**Points:** 130 | **Move:** 8" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, INFANTRY, MELUSAI
...
**Keywords:** WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, INFANTRY, FLY, KHINERAI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Barbed Javelin | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |
| Barbed Javelin | Melee | - | 1 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Circling in the Skies Above (Activated)
- **Timing:** Deployment Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Barbed Sickle | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |
...
### Bloodwrack Viper
**Move:** 9" | **Health:** 10 | **Save:** 4+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, ORDER, DAUGHTERS OF KHAINE, MONSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fanged Strikes | Melee | - | 3 | 4+ | 2+ | 1 | 3 | Anti-Hero (+1 Rend), Crit (Mortal) |

**Abilities:**

#### Crushing Coils (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Bladewind
**Move:** 12" | **Health:** 7 | **Save:** 6+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, ORDER, DAUGHTERS OF KHAINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bladed Vortex | Melee | - | 9 | 3+ | 3+ | 1 | 1 | Crit (2 Hits) |
...
### Heart of Fury
**Move:** - | **Health:** 7 | **Save:** 4+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ORDER, DAUGHTERS OF KHAINE, INVOCATION
