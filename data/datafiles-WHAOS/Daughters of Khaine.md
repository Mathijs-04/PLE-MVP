...
#### Fist of the Scáthborn (Activated)
...
#### Masterful Executioner (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick a damaged enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice. If the roll is less than the number of damage points the target has, inflict an amount of mortal damage equal to the roll.

#### Shadowmeld (Activated)
...
#### Bloodmad (Passive)
- **Effect:** While this unit is within 3" of any visible damaged units (friendly or enemy), add 1 to wound rolls for attacks made with this unit's melee weapons.

#### Screeching Evangelist (Activated)
...
#### Lethal Blademaster (Passive)
- **Effect:** Attacks made with this unit's melee weapons score critical hits on unmodified hit rolls of 5+.

#### Ear-bursting Shriek (Activated)
- **Timing:** Any Shooting Phase
- **Declare:** Pick a visible enemy Hero within 10" of this unit to be the target.
- **Effect:** Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll and the target has Strike-last for the rest of the turn.

#### Blade of Shadow (Passive)
...
#### Flickering Blur (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Effect:** This unit has Ward (3+) for the rest of the turn.

#### Bellowed Exhortations (Activated)
- **Timing:** Once Per Battle, Any Hero Phase
- **Declare:** Pick a visible friendly non-Hero Daughters of Khaine unit wholly within 12" of this unit to be the target.
- **Effect:** If you have used the 'Blessings of Khaine' ability 3 or more times this battle, the target's combat attacks score critical hits on unmodified hit rolls of 4+ for the rest of the turn. Otherwise, roll a dice. If the roll is equal to or less than the current battle round number, the target's combat attacks score critical hits on unmodified hit rolls of 4+ for the rest of the turn.

#### Blessed of the Goddess (Activated)
- **Timing:** Your Hero Phase
...
#### Shadow-blessed (Activated)
- **Timing:** Once Per Battle, Any Movement Phase
- **Effect:** Remove this unit from the battlefield and set it up again more than **X**" from all enemy units, where **X** is equal to 10 minus the current battle round number.

#### First Blood (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Effect:** This unit has Strike-first for the rest of the turn.

#### Fangs of the Viper (Passive)
- **Effect:** Ward rolls cannot be made for damage points inflicted by this unit's attacks.

#### Fleet-footed Killers (Passive)
...
• An enemy unit is destroyed by a friendly Daughters of Khaine unit's attacks and any models in the enemy unit were contesting an objective you do not control in the same phase.
• A unit (friendly or enemy) is destroyed and it was within 3" of a **Place of Power** at the start of the phase.

#### Anointed Ritualist (Activated)
...
- **Effect:** The target is **anointed** for the rest of the battle, even if it has been destroyed. Friendly **anointed** units on the battlefield treat Exalted abilities on the warscrolls of friendly **anointed** units that have been destroyed as if they were on their warscroll.
...
#### Heretic's Bane (Activated)
- **Timing:** Once Per Turn (Army), Start of Enemy Turn
- **Declare:** Pick an enemy Wizard or Priest on the battlefield to be the target.
- **Effect:** Roll a dice for each objective you control. For each 3+, subtract 1 from castitng rolls and chanting rolls for the target for the rest of the turn.

#### Bloody-Handed Worshippers (Activated)
- **Timing:** Reaction: You declared a Fight ability for an anointed unit
- **Effect:** Pick a friendly non-Hero Daughters of Khaine unit that has not used a Fight ability this turn and is within that **anointed** unit's combat range to the the target. The target can be picked to use a Fight ability immediately after the Fight ability used by that **anointed** unit has been resolved. If it is picked to do so, the target's melee weapons have **Crit (Auto-wound)** for the rest of the turn. If the melee weapons already have **Crit (Auto-wound)**, they have **Crit (Mortal)** for the rest of the turn instead.

#### Final Frenzy (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick each friendly Daughters of Khaine unit contesting an objective to be the targets.
- **Effect:** Return up to D3 slain models to each target that has a Health characteristic of up to 2.
Return up to 1 slain model to each target that that has a Health characteristic of 3 or more.

### Heroic Traits

#### Shadow-Blooded (Activated)
- **Timing:** Reaction: You declared the 'Redeploy' command for a Daughters of Khaine unit wholly within 12" of this unit
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

#### Hand of Khaine (Activated)
- **Timing:** Any Combat Phase
...
**1** Add 1 to run rolls for those units.
**2** Add 1 to charge rolls for those units.
**3** Add 1 to hit rolls for those units' combat attacks.
**4** Add 1 to wound rolls for those units' combat attacks.
**5** Add 1 to the Attacks characteristic of those units' melee weapons.

#### Let the Blood Flow (Passive)
...
#### Hero of the Killing Games (Passive)
...
#### Blade of Prophetic Doom (Activated)
...
#### Matriarch of the Zainthar Kai (Command)
- **Timing:** Your Hero Phase
- **Cost:** 1
...
### Anvil of Apotheosis: Daughters of Khaine Hero
**Points:** 280 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** CRONESEER'S PARIAHS, Restrict General, HERO, INFANTRY, WARD (6+), ORDER, DAUGHTERS OF KHAINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Dark Steed's Hooves and Teeth | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |
| Avatar's Sword | Melee | - | 5 | 3+ | 3+ | 2 | 3 | Companion |
| Guardians' Blades | Melee | - | 4 | 3+ | 4+ | 1 | 2 | - |
| Bloodwrack Stare | Ranged | 15" | 4 | 3+ | 3+ | 2 | 3 | Crit (2 Hits), Shoot in Combat |
| Cult Blade | Melee | - | 5 | 3+ | 4+ | 1 | 2 | - |
| Word of Khaine | Ranged | 10" | 1 | 2+ | 2+ | 3 | 6 | Shoot in Combat |
| Torrent of Burning Blood | Ranged | 10" | 12 | 2+ | 2+ | 2 | 1 | Shoot in Combat |
...
**Keywords:** WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, AELF, STANDARD BEARER (1/5), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ki'raich | Ranged | 10" | 1 | 3+ | 4+ | 1 | 1 | - |
| Valthrai | Melee | - | 3 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Wicked Wardens (Passive)
...
#### Crimson Offerings (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared the 'Blessings of Khaine' ability
...
### Blood Sisters
**Points:** 140 | **Move:** 8" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** non-AELF, WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heartshard Glaive | Melee | - | 2 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Crystal Touch (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Blood Stalkers
**Points:** 150 | **Move:** 8" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** non-AELF, WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heartseeker Bow | Ranged | 18" | 3 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |
| Scianlar | Melee | - | 2 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Heartseekers (Activated)
...
### Bloodwrack Medusa
**Points:** 140 | **Move:** 8" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WIZARD (1), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodwrack Spear and Whisperclaw | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Exsanguinating Glare (Activated)
...
### Bloodwrack Shrine
**Points:** 280 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WAR MACHINE, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodwrack Stare | Ranged | 15" | 4 | 3+ | 3+ | 2 | 3 | Crit (2 Hits), Shoot in Combat |
| Shrine Guardians' Blades | Melee | - | 9 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Aura of Agony (Activated)
...
### Bloodwrack Shrine (Scourge of Ghyran)
**Points:** 250 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WAR MACHINE, WIZARD (2), MELUSAI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bloodwrack Gaze | Ranged | 15" | 4 | 3+ | 3+ | 2 | 3 | Crit (2 Hits), Shoot in Combat |
| Medusa's Spear and Shrinekeepers’ Goadstaves | Melee | - | 8 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Wracking Gaze (Activated)
...
### Doomfire Warlocks
**Points:** 150 | **Move:** 14" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** WARD (6+), CHAMPION, CAVALRY, WIZARD (1), ORDER, DAUGHTERS OF KHAINE, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Doomfire Crossbow | Ranged | 10" | 2 | 3+ | 4+ | - | 1 | - |
| Dark Steed’s Vicious Bite | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |
| Cursed Scimitar | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |
...
### Gryselle's Arenai
**Points:** 70 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** ORDER, INFANTRY, UNIQUE, CHAMPION, Legends, WARD (6+), AELF, DAUGHTERS OF KHAINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gladiatorial Weapons | Melee | - | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
| Gladiatorial Weapons | Melee | - | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
| Gladiatorial Weapons | Melee | - | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
| Gladiatorial Weapons | Melee | - | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
| Gladiatorial Weapons | Melee | - | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
...
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, PRIEST (1), AELF, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blade of Khaine | Melee | - | 5 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Catechisms of Violence (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Effect:** For the rest of the turn, each time a visible friendy Daughters of Khaine unit wholly within 12" of this unit uses a **Fight** ability, after that ability has been resolved, you can pick a visible friendly Daughters of Khaine Priest wholly within 12" of this unit. That Priest gains 1 ritual point.
- **Keywords:** Exalted
...
**Points:** 280 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, WAR MACHINE, PRIEST (1), AELF
...
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, AELF, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Barbed Whip and Gladiatrix’s Blade | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Paragon of Slaughter (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** Pick a visible friendly Daughters of Khaine Infantry unit wholly within 12" of this unit to be the target.
- **Effect:** If this unit is in combat, add 1 to the Rend characteristic of the target's melee weapons for the rest of the turn. If this unit is not in combat, roll a dice. On a 3+, add 1 to the Rend characteristic of the target's melee weapons for the rest of the turn.
- **Keywords:** Exalted

---

### Khainite Shadowstalkers
**Points:** 130 | **Move:** 6" | **Health:** 1 | **Save:** 5+ | **Control:** 1
**Keywords:** WARD (6+), ORDER, DAUGHTERS OF KHAINE, INFANTRY, AELF, CHAMPION (1/9)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Cursed Bolts and Missiles | Ranged | 10" | 2 | 3+ | 4+ | 1 | 1 | - |
| Blades of Murder | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |
...
**Points:** 100 | **Move:** 12" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** non-AELF, WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, INFANTRY, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Barbed Javelin | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | - |
| Barbed Javelin | Melee | - | 1 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Fire and Flight (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Shoot ability for this unit
...
### Knives of the Crone
**Points:** 220 | **Move:** 6" | **Health:** 3 | **Save:** 5+ | **Control:** 2
**Keywords:** ORDER, INFANTRY, UNIQUE, Legends, WARD (6+), AELF, DAUGHTERS OF KHAINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Haruspicy Blades | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |
| Haruspicy Blades | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |
| Aelven Crossbow | Ranged | 10" | 3 | 3+ | 4+ | - | 1 | Crit (Auto-wound) |
| Haruspicy Blades | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |
| Haruspicy Blades | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Rituals of Prophecy (Activated)
- **Timing:** Your Hero Phase
- **Effect:** Roll 6 dice:
...
**Points:** 220 | **Move:** 12" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, DAUGHTERS OF KHAINE, FLY, INFANTRY, AELF, PRIEST (2), WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Staff of Morai-Heg | Melee | - | 4 | 3+ | 4+ | 1 | D3 | - |
...
### Krethusa the Croneseer (Scourge of Ghyran)
**Points:** 260 | **Move:** 12" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, FLY, INFANTRY, AELF, PRIEST (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Staff of Morai-Heg | Melee | - | 5 | 3+ | 4+ | 1 | D3 | Crit (Auto-wound) |

**Abilities:**

#### Gift of Foresight (Command)
- **Timing:** Once Per Battle, Your Movement Phase
- **Cost:** 1
- **Declare:** Pick a friendly non-Unique Daughters of Khaine Aelf Infantry or Cavalry unit that has been destroyed to be the target.
...
- **Timing:** Your Hero Phase
- **Chanting Value:** 3
- **Declare:** Pick a visible friendly Daughters of Khaine Aelf Infantry or Cavalry unit wholly within 12" of this unit to be the target. Then, make a chanting roll of D6.
...
**Keywords:** WARD (6+), ORDER, DAUGHTERS OF KHAINE, HERO, INFANTRY, AELF, UNIQUE, Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Deadly Blades | Melee | - | 6 | 2+ | 5+ | 1 | 2 | Anti-Hero (+1 Rend) |
| Poisoned Throwing Knives | Ranged | 10" | 3 | 2+ | 4+ | 1 | D3 | Crit (Auto-wound), Shoot in Combat |

**Abilities:**

#### Hidden Agent (Activated)
- **Timing:** Deployment Phase
...
**Keywords:** HERO, WARD (6+), ORDER, DAUGHTERS OF KHAINE, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Keldrisaíth | Melee | - | 6 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
...
### Morathi-Khaine
**Points:** 730 | **Move:** 6" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, WARMASTER, ORDER, WIZARD (3), INFANTRY, AELF, DAUGHTERS OF KHAINE, WARD (4+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heartrender and Bladed Wings | Melee | - | 5 | 3+ | 4+ | 2 | 2 | - |

**Abilities:**

#### Surge of Hatred (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
**Points:** 120 | **Move:** 6" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** ORDER, INFANTRY, UNIQUE, CHAMPION, Legends, WARD (6+), AELF, DAUGHTERS OF KHAINE
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heartseeker Bow | Ranged | 18" | 3 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |
| Sacrificial Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Sacrificial Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Sacrificial Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Sacrificial Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Sacrificial Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
...
**Keywords:** FACTION TERRAIN, ORDER, WARD (6+), DAUGHTERS OF KHAINE

**Abilities:**

#### In Dark Communion (Activated)
- **Timing:** Your Hero Phase
...
**Keywords:** WARD (6+), CHAMPION, ORDER, DAUGHTERS OF KHAINE, AELF, MUSICIAN (1/5), STANDARD BEARER (1/5), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kruiplash | Melee | - | 3 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Dance of Death (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Deathsword and Blade of Khaine | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Fanatical Blademaster (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** Pick a friendly Daughters of Khaine unit wholly within 12" of this unit to be the target.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Shadowstalker Blades | Melee | - | 2 | 3+ | 4+ | - | 1 | - |
| Cursed Missiles | Ranged | 10" | 1 | 3+ | 3+ | 1 | 1 | - |
| Shadowstalker Blades | Melee | - | 2 | 3+ | 4+ | - | 1 | - |
| Cursed Missiles | Ranged | 10" | 1 | 3+ | 3+ | 1 | 1 | - |
| Shadowstalker Blades | Melee | - | 2 | 3+ | 4+ | - | 1 | - |
| Cursed Missiles | Ranged | 10" | 1 | 3+ | 3+ | 1 | 1 | - |
...
#### Mask of Shadowed Mirrors (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
| Krethusa the Croneseer | 220 |
| Bloodwrack Shrine (Scourge of Ghyran) | 250 |
| Krethusa the Croneseer (Scourge of Ghyran) | 260 |
| Anvil of Apotheosis: Daughters of Khaine Hero | 280 |
| Bloodwrack Shrine | 280 |
