...
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its **Pox Maggoth's Claws** is 3.

#### Projectile Vomiter (Activated)
- **Timing:** Once Per Battle, Reaction: Opponent declared a Fight ability for a unit in combat with this unit.
- **Effect:** Subtract 1 from hit rolls and wound rolls for that unit's combat attacks for the rest of the turn.

#### Scabrous Second Hide (Passive)
- **Effect:** Subtract 1 from the Rend characteristic of ranged weapons used for shooting attacks that target this unit.

#### Distended Gut (Passive)
- **Effect:** Add 7 to this unit's control score while it is contesting an objective you do not control.

#### Rooted in Blighted Soil (Passive)
- **Effect:** If this unit has not been set up this battle round and has not moved this battle round, it has Ward (4+).

#### Slow to React (Passive)
- **Effect:** This unit has Strike-last.

#### Healthy Constitution (Passive)
- **Effect:** Ward rolls cannot be made for this unit.

#### Boils and Cysts (Passive)
- **Effect:** Subtract 1 from run rolls and charge rolls for this unit.

#### Non-Contagious (Passive)
- **Effect:** Enemy units in combat with this unit cannot be picked to be the targets of the 'Blessed by the Plaguefather' ability.

#### Monstrous Belch (Activated)
...
#### Bileslime Drool (Activated)
- **Timing:** End of Your Turn
- **Declare:** Pick D3 enemy units in combat with this unit to be the targets. You cannot pick a Manifestation or terrain feature.
- **Effect:** Roll a dice for each target. On a 4+, the target has the Diseased keyword.

#### Corrosive to the Touch (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Infected Discharge (Passive)
- **Effect:** Ward rolls cannot be made for enemy units while they are in combat with this unit.

#### Thrice-Blessed (Activated)
- **Timing:** End of Any Turn
- **Effect:** **Heal (3)** this unit.

#### Master of Vile Magics (Passive)
- **Effect:** Add 1 to casting rolls and banishment rolls for this unit.

#### Plague Prophet (Passive)
- **Effect:** Add 1 to chanting rolls and banishment rolls for this unit.

### Paths

#### Bloated and Brutal (Passive)
- **Effect:** Add 1 to wound rolls for this unit's combat attacks

#### Foul Stench (Passive)
- **Effect:** Subtract 1 from hit rolls for attacks made by enemy non-Hero units while they are in combat with this unit.

#### Irrepressible Momentum (Activated)
- **Timing:** End of Any Turn
- **Effect:** If this unit is in combat, it can make a pile-in move.

#### Oozy (Activated)
- **Timing:** Reaction: Opponent declared a Retreat ability for a unit in combat with this unit.
- **Effect:** Roll a dice. On a 2+, inflict an amount of mortal damage on the target equal to the roll after the Retreat ability has been resolved.

#### Afflicted in Arms (Activated)
- **Timing:** Deployment Phase
- **Declare:** Pick an enemy unit to be the target
- **Effect:** For the rest of the battle, each time the target uses a command, after resolving that command or the ability it was a reaction to, **Heal (D3)** this unit.

#### Viscous Phlegm (Activated)
- **Timing:** Any Movement Phase
- **Declare:** Pick a visible enemy unit within 12" of this unit to be the target.
- **Effect:** Roll a dice. On a 3+, subtract 3 from charge rolls for the target for the rest of the turn.

#### Risen from Disease (Activated)
- **Timing:** Once Per Battle, End of Your Turn
- **Declare:** This unit can only use this ability if it has been destroyed. Pick this unit to be the target, then pick a Diseased enemy Hero to be the incubator.
- **Effect:** You and your opponent must roll off. Add the target's Control characteristic to your roll and add the intubator's Control characteristic to your opponent's roll. If your roll equals or exceeds your opponent's, set up a replacement unit for the target with 4 damage points allocated to it within 3" of the incubator. Then, if your roll is at least double your opponent's, the incubator is automatically destroyed.

#### The Foulness that Lurks Within (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Declare:** Pick each Diseased enemy unit on the battlefield to be the targets.
- **Effect:** The targets have Strike-last for the rest of the turn.

#### Repulsive Grins (Passive)
- **Effect:** Subtract 1 from casting and chanting rolls for enemy units while they are within 7" of this unit.

#### Mildew-Encrusted (Activated)
- **Timing:** Reaction: This unit was picked as the target of a Shoot ability
- **Effect:** Ignore the Rend characteristic of weapons used for attacks made as part of that Shoot ability.

#### Loathsome Fortitude (Passive)
- **Effect:** Add 1 to wound rolls for this unit's attacks while each model in this unit is contesting an objective.

#### Horrific Mutations (Activated)
- **Timing:** Any Charge Phase
- **Declare:** If this unit charged this turn, pick an enemy unit in combat with the target.
- **Effect:** Roll a dice. On a 2-3, inflict 1 mortal damage on the target. On a 6, inflict 2 mortal damage on the target.

#### Contagious to Living Magic (Passive)
- **Effect:** Enemy Manifestations cannot be set up within 12" of this unit and cannot pass through or end a move within this unit's combat range unless they started that move within this unit's combat range.

#### Reek of Mediocrity (Passive)
- **Effect:** Other than the **Companion** weapon ability, weapon abilities for attacks that target this unit have no effect.

#### Grasping Tentacles (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll 2D6. If the roll equals or exceeds the target's Move characteristic, add 1 to the Attacks characteristic of this unit's melee weapons for the rest of the turn.

#### Mimetic Parasites (Passive)
- **Effect:** Each time an enemy unit in combat with this unit uses the 'All-out Defence' or 'All-out Attack' command, the effect of that command also applies to this unit for the rest of the phase.

### Battle Traits

#### Desperate Remedies (Passive)
- **Effect:** If an ability would heal or return slain models to a Diseased enemy unit, that ability does not heal any damage points or return any slain models to it. Instead, it no longer has the Diseased keyword.

#### Wracked with Disease (Activated)
...
#### Blessed By the Plaguefather (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Effect:** Pick 1 of the following effects: 
***Infect:*** Pick an enemy unit within 7" of any friendly Maggotkin of Nurgles unit to be the target. You cannot pick a Manifestation or terrain feature.
• If the target is in combat with any Maggotkin of Nurgle units, it has the Diseased keyword.
• If the target is not in combat with any Maggotkin of Nurgle units, roll a dice. On a 4+, the target has the Diseased keyword.
...
#### Filth-laden Daemonic Blooms (Passive)
...
In the first battle round, if an ability would heal or return any slain models to a Diseased **plague progenitor**, that ability does not
heal any damage points or return any slain models to it.
...
#### Gift of Febrile Frenzy (Activated)
- **Timing:** Any Combat Phase
...
#### Grandfather's Blessing (Activated)
- **Timing:** End of Any Turn
- **Effect:** If this unit is in combat with a Diseased enemy unit, **Heal (D3)** this unit.

#### Overpowering Stench (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** You and your opponent must roll off. If you roll is higher, pick 1 of the following effects to apply for the rest of the turn:
• Ignore positive modifiers to save rolls for the target.
• Subtract 1 from ward rolls for the target.

#### Living Plague (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
If any damage points were allocated to the target by this ability, this unit can move 2D3". It can move through the combat ranges of enemy units but must end that move in combat with the unit it was already in combat with at the start of
the move.

#### Unctuous Preacher (Passive)
...
#### Revolution and Revulsion (Activated)
...
- **Keywords:** Cycle
- **Effect:** Subtract 3 from the control scores of enemy units wihle they are in combat with any friendly Cycle of Corruption units.

#### Plague of Misery (Passive)
- **Keywords:** Cycle
...
#### Head Gardener (Activated)
- **Timing:** Once Per Battle (Army), Your Movement Phase
- **Effect:** The friendly **Horticulous Slimux** can use his 'Cultivating the Garden of Nurgle' this phase even if there are 1 or more friendly **Feculent Gnarlmaws** on the battlefield.

#### Putrescent Sap (Activated)
...
#### Foul Fauna (Passive)
- **Effect:** Add 2" to the Move characteristic of friendly Gardeners of Nurgle **Beasts of Nurgle** and **Plague Drones** units while they are wholly within 6" of any friendly **Feculent Gnarlmaws**.

#### Sickly Spores (Passive)
...
#### Stinking Sporeseed (Activated)
- **Timing:** Once Per Battle, Your Movement Phase
- **Effect:** Set up a **Feculent Gnarlmaw** within 3" of this unit and more than 3" from all enemy units, objectives, and other terrain featues.
...
### Beast of Nurgle
**Points:** 110 | **Move:** 7" | **Health:** 8 | **Save:** 5+ | **Control:** 1
**Keywords:** WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, BEAST
...
- **Effect:** This unit can move a distance up to the value of the charge roll. During that move, this unit can move into combat and can pass through models in the target unit, but it must end that move within 1/2" of the target. Then, inflict D3 mortal damage on the target. If it does so, this unit has charged.
- **Keywords:** Core, Move, Charge

---

### Belga the Cystwitch
**Points:** 130 | **Move:** 4" | **Health:** 7 | **Save:** 5+ | **Control:** 3
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, INFANTRY, PRIEST (1), ROTBRINGERS, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Thrice-tainted Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Ruptured Cysts (Prayer)
- **Timing:** Your Hero Phase
- **Chanting Value:** 4
- **Declare:** Pick a visible Diseased enemy unit within 18" of this unit to be the target, then make a chanting roll of D6.
- **Effect:** Inflict D3 mortal damage on the target. Then, inflict 1 mortal damage on each other Diseased enemy unit within 3" of the target. If the chanting roll is 9+, you can also pick a friendly **Plaguebearers** unit within 12" of the target. For each enemy Infantry model slain by this ability this turn, you can return 1 slain model to that friendly unit.
- **Keywords:** Prayer

#### Scry the Filth (Activated)
- **Timing:** Your Hero Phase
...
### Bloab Rotspawned
**Points:** 260 | **Move:** 8" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, MONSTER, ROTBRINGERS, WIZARD (1), WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bilespurter's Vile Bile | Ranged | 7" | 7 | 2+ | 4+ | 1 | D3 | Shoot in Combat, Companion |
| Harvestman’s Scythe | Melee | - | 3 | 3+ | 3+ | 1 | 2 | Anti-Monster (+1 Rend) |
| Bilespurter’s Claws | Melee | - | 5 | 4+ | 2+ | 2 | 3 | Companion |
...
#### Miasma of Pestilence (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Pick a visible friendly unit wholly within 12" of this unit to be the target, then make a casting roll of 2D6.
- **Effect:** Until the start of your next turn, other than the **Companion** ability, weapon abilities for attacks that target that friendly unit have no effect.

---

### Cankerborn
**Points:** 200 | **Move:** 4" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** CHAOS, INFANTRY, MAGGOTKIN OF NURGLE, DAEMON, WARD (5+), UNIQUE, HERO

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blightblades | Melee | - | 4 | 3+ | 3+ | 1 | 3 | Crit (Mortal) |

**Abilities:**

#### Utter Defilement (Activated)
- **Timing:** End of Any Turn
...
- **Effect:** Place 2 of this unit's **Pestilent Pollutants** next to the target. If both of this unit's **Pestilent Pollutants** are already on the battlefield, pick 1 of them, remove it from the battlefield and place it next to the target instead.

#### From the Tainted Earth (Activated)
...
• A Polluted terrain feature (see Gelgus Pust's 'Master Contaminator' ability), or
...
### Doktor Festus
**Points:** 100 | **Move:** 4" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, Legends, MAGGOTKIN OF NURGLE, ROTBRINGERS, WARD (5+), INFANTRY, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plague Staff | Melee | - | 3 | 4+ | 3+ | - | D3 | - |
...
#### Delightful Brews, Splendid Restoratives (Activated)
- **Timing:** Your Hero Phase
...
**Points:** 130 | **Move:** 4" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, Legends, MAGGOTKIN OF NURGLE, WARD (5+), INFANTRY, DAEMON

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Epidemius’s Balesword | Melee | - | 3 | 4+ | 3+ | 1 | D3 | - |
| Mound of Nurglings | Melee | - | 10 | 5+ | 5+ | - | 1 | Companion |

**Abilities:**

#### Tallyman of Nurgle (Activated)
- **Timing:** Your Hero Phase
...
**Points:** 290 | **Move:** 5" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, DAEMON, MONSTER, WIZARD (2), WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gnarled Plague Staff | Melee | - | 3 | 3+ | 3+ | 1 | D3 | Crit (Auto-wound) |
| Gathoblyt's Fanged Maw | Melee | - | 4 | 4+ | 2+ | 2 | 3 | Crit (Mortal), Companion |
...
#### Vile Poisons and Debilitating Toxins (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 220 | **Move:** 8" | **Health:** 8 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, DAEMON, WARD (5+), INFANTRY, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Malady and Contagion | Melee | - | 7 | 3+ | 3+ | 1 | 3 | Crit (Auto-wound) |

**Abilities:**

#### Grin of the Grandfather (Activated)
- **Timing:** Any Combat Phase
...
**Points:** 110 | **Move:** 4" | **Health:** 3 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, MAGGOTKIN OF NURGLE, CHAOS, WARD (5+), DAEMON, STANDARD BEARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gardening Tools | Melee | - | 1 | 4+ | 3+ | - | 1 | Crit (Mortal) |
| Gardening Tools | Melee | - | 1 | 4+ | 3+ | - | 1 | Crit (Mortal) |
| Gardening Tools | Melee | - | 1 | 4+ | 3+ | - | 1 | Crit (Mortal) |
| Gardening Tools | Melee | - | 1 | 4+ | 3+ | - | 1 | Crit (Mortal) |
| Gardening Tools | Melee | - | 1 | 4+ | 3+ | - | 1 | Crit (Mortal) |
...
### Great Unclean One
**Points:** 400 | **Move:** 6" | **Health:** 20 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, WIZARD (2), WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Noxious Bile | Ranged | 7" | D3+3 | 3+ | 2+ | 2 | 2 | Shoot in Combat |
| Colossal Blight Weapons | Melee | - | 4 | 3+ | 2+ | 2 | 4 | - |

**Abilities:**

#### Bloated With Corruption (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
### Gutrot Spume
**Points:** 120 | **Move:** 4" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, ROTBRINGERS, INFANTRY, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rot-pocked Axe | Melee | - | 5 | 3+ | 2+ | 1 | 2 | Anti-Hero (+1 Rend), Crit (Mortal) |

**Abilities:**

#### Pestilential Beachhead (Activated)
- **Timing:** Your Movement Phase
...
#### Master of the Slime Fleet (Activated)
- **Timing:** Deployment Phase
...
### Harbinger of Decay
**Points:** 140 | **Move:** 8" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, MAGGOTKIN OF NURGLE, CAVALRY, ROTBRINGERS, PRIEST (1), WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grim Rotsword or Plague Scythe | Melee | - | 3 | 3+ | 3+ | 1 | 3 | Crit (Mortal) |
| Daemonic Mount’s Flyblown Bite | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Knell of Doom (Activated)
...
### Horticulous Slimux
**Points:** 140 | **Move:** 4" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, DAEMON, WARD (5+), CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lopping Shears | Melee | - | 3 | 3+ | 3+ | 1 | 2 | - |
| Slime-encrusted Jaws | Melee | - | 4 | 4+ | 3+ | 1 | D3 | Companion |

**Abilities:**

#### Cultivating the Garden of Nurgle (Activated)
- **Timing:** Your Movement Phase
...
### Lord of Afflictions
**Points:** 170 | **Move:** 8" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, MAGGOTKIN OF NURGLE, CAVALRY, ROTBRINGERS, FLY, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Festerspike | Melee | - | 4 | 3+ | 3+ | 1 | 2 | Charge (+1 Damage) |
| Rot Fly’s Mouthparts and Sting | Melee | - | 6 | 4+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Master of Rot Flies (Activated)
- **Timing:** Any Combat Phase
...
- **Effect:** Add 1 to the Rend characteristic of the targets’ **Rot Fly's Mouthparts and Sting** melee weapons for the rest of the turn.

#### Vectors of Foulest Contagion (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Lord of Blights
**Points:** 140 | **Move:** 4" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, CHAOS, MAGGOTKIN OF NURGLE, ROTBRINGERS, INFANTRY, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bubotic Hammer | Melee | - | 4 | 3+ | 3+ | 1 | 3 | Anti-charge (+1 Rend) |

**Abilities:**

#### Thrice-ripened Death's Heads (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit that charged this turn and is in combat with this unit or with a friendly **Plague Drones** wholly within 12" of this unit to be the target.
- **Effect:** Roll D3. On 2+, inflict an amount of mortal damage on the target equal to the roll.

#### Festering Bulwark (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Lord of Plagues
**Points:** 100 | **Move:** 4" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, CHAOS, MAGGOTKIN OF NURGLE, ROTBRINGERS, INFANTRY, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Plague-ridden Great Blade | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Sevenfold Slaughter (Activated)
- **Timing:** Any Combat Phase
...
#### Lord of the Infected Legions (Passive)
...
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, MONSTER, ROTBRINGERS, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Tripletongue’s Slabrous Tongues | Ranged | 7" | 3 | 3+ | 3+ | 1 | 1 | Shoot in Combat, Companion |
| Fleshreaper Scythe | Melee | - | 5 | 3+ | 3+ | 1 | 2 | - |
| Tripletongue’s Claws | Melee | - | 5 | 4+ | 2+ | 2 | 3 | Companion |
...
#### Gigantic Nurgling-kin (Activated)
- **Timing:** End of Any Turn
- **Effect:** **Heal (X) this unit**, where X is half the number of damage points this unit has (rounding up).

#### Tide of Nurglings (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick up tp 2 friendly **Nurglings** unit wholly within 12" of this unit’s to be the targets.
...
### Nurglings
**Points:** 100 | **Move:** 4" | **Health:** 4 | **Save:** 6+ | **Control:** 1
**Keywords:** WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, BEAST

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Tiny Razor-sharp Teeth | Melee | - | 5 | 5+ | 5+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Endless Swarm (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
### Orghotts Daemonspew
**Points:** 260 | **Move:** 8" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, MONSTER, ROTBRINGERS, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Whippermaw's Grasping Tongue | Ranged | 7" | 1 | 3+ | 3+ | - | D6 | Shoot in Combat, Companion |
| The Rotaxes | Melee | - | 7 | 3+ | 3+ | 1 | 2 | - |
| Whippermaw's Claws | Melee | - | 5 | 4+ | 2+ | 2 | 3 | Companion |
...
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, CHAMPION, INFANTRY, STANDARD BEARER (1/10), MUSICIAN (1/10), WARD (6+), ROTBRINGERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Corroded Weapons | Melee | - | 2 | 4+ | 3+ | - | 1 | - |

**Abilities:**

#### Bestial Desecration (Passive)
- **Effect:** Add 1 to the Rend characteristic of this unit's melee weapons while it is not within enemy territory.

---

### Plague Drones
**Points:** 150 | **Move:** 8" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, CAVALRY, CHAMPION, STANDARD BEARER (1/3), MUSICIAN (1/3), FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Noxious Plaguesword | Melee | - | 2 | 4+ | 3+ | - | 1 | Crit (Mortal) |
| Rot Fly's Mouthparts and Sting | Melee | - | 6 | 4+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Ripe Pastures (Passive)
...
**Keywords:** WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, CHAMPION, INFANTRY, STANDARD BEARER (1/10), MUSICIAN (1/10)
...
### Pox-Wretches
**Points:** 100 | **Move:** 5" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, CHAMPION, INFANTRY, WARD (6+), ROTBRINGERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Decaying Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Mire Kelpies (Passive)
- **Effect:** This unit's **Mire Kelpies** are tokens. There are 6 **Mire Kelpies** for every 14 models in this unit.

#### Contagious Catarrh (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
**Points:** 90 | **Move:** 4" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, WIZARD (1), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Corrupted Balesword | Melee | - | 3 | 4+ | 3+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Captain of the Plague Legions (Activated)
...
**Points:** 200 | **Move:** 8" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, CAVALRY, FLY, ROTBRINGERS, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Flyrider’s Arsenal | Melee | - | 4 | 3+ | 3+ | 1 | 1 | Charge (+1 Damage) |
| Rot Fly’s Mouthparts and Sting | Melee | - | 6 | 4+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Relentless Attackers (Passive)
- **Effect:** Add 1 to the Rend characteristic of this unit’s **Flyrider’s Arsenal** for attacks that target enemy units contesting an objective.
...
### Putrid Blightkings
**Points:** 130 | **Move:** 4" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, CHAMPION, INFANTRY, ROTBRINGERS, STANDARD BEARER (1/5), WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Pox-blighted Weapons | Melee | - | 4 | 3+ | 3+ | 1 | 1 | Anti-Priest (+1 Rend), Anti-Wizard (+1 Rend) |

**Abilities:**

#### Discomfiting Stench (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
### Rotbringer Sorcerer
**Points:** 100 | **Move:** 4" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, CHAOS, MAGGOTKIN OF NURGLE, ROTBRINGERS, INFANTRY, WIZARD (1), WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rotwood Staff | Melee | - | 3 | 4+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Tainted Sorceries (Activated)
- **Timing:** Your Hero Phase
...
### Rotigus
**Points:** 420 | **Move:** 6" | **Health:** 22 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, UNIQUE, WARMASTER, CHAOS, MAGGOTKIN OF NURGLE, DAEMON, MONSTER, WIZARD (2), WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gnarlrod | Melee | - | 5 | 3+ | 2+ | 1 | 3 | - |
| Fanged Maws | Melee | - | 4 | 3+ | 2+ | 2 | 2 | - |
...
#### Mountain of Loathsome Flesh (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
- **Declare:** If this unit charged this turn, roll a dice. On a 3+, pick an enemy unit within 1" of it to be the target.
...
- **Effect:** Inflict 1 mortal damage on each enemy target and **Heal (1)** each friendly target. Then, until the start of your next turn, if an ability would heal or return any slain models to an enemy unit while they are within 18" of this unit, that ability does not heal any damage points or return any slain models to it.
- **Keywords:** Spell

---

### Rotigus (Scourge of Ghyran)
**Points:** 430 | **Move:** 6" | **Health:** 22 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, UNIQUE, WARMASTER, CHAOS, MAGGOTKIN OF NURGLE, DAEMON, MONSTER, WIZARD (2), WARD (5+)
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gnarlrod | Melee | - | 5 | 3+ | 2+ | 1 | 3 | - |
| Fanged Maws | Melee | - | 2 | 3+ | 2+ | 2 | 2 | - |
| Host of Nurglings | Melee | - | 10 | 5+ | 5+ | - | 1 | Crit (Auto-wound), Companion |
...
#### Befouled Rainfall (Passive)
- **Effect:** Subtract 1 from save rolls for enemy units while they are within 6" of this unit.

---

### Rotmire Creed
**Points:** 110 | **Move:** 5" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, INFANTRY, CHAMPION (1/10), ROTBRINGERS, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bilewood Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Contagion Blowpipes | Ranged | 12" | 2 | 4+ | 3+ | - | 1 | Crit (Auto-wound) |

**Abilities:**

#### Virulent Concoctions (Passive)
...
### Rotswords
**Points:** 200 | **Move:** 4" | **Health:** 2 | **Save:** 3+ | **Control:** 1
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, CHAMPION, INFANTRY, STANDARD BEARER (1/10), MUSICIAN (1/10), WARD (6+), ROTBRINGERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ruined Master-crafted Weapons | Melee | - | 2 | 3+ | 3+ | 1 | 1 | Crit (2 Hits) |

**Abilities:**

#### Sweat-Soaked and Reeking (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit that charged this turn and is in combat with this unit to be the target.
- **Effect:** Roll a dice. On a 3+, the target cannot use commands for the rest of the turn.
...
**Keywords:** HERO, UNIQUE, CHAOS, MAGGOTKIN OF NURGLE, INFANTRY, ROTBRINGERS, WARD (6+), WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rotstave | Melee | - | 3 | 4+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Purulent Profusion (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** Pick a visible enemy unit within 18" of this unit to be the target, then make a casting roll of 2D6.
...
**Points:** 100 | **Move:** 4" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Marotter | Melee | - | 3 | 4+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Jolly Gutpipes (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
• Each time the target is removed from the battlefield and set up again on the battlefield further from the unit than it was before it was removed, after the ability used by the target has been resolved.

---

### Sloven Knights
**Points:** 180 | **Move:** 8" | **Health:** 4 | **Save:** 3+ | **Control:** 1
**Keywords:** CHAOS, MAGGOTKIN OF NURGLE, CHAMPION, ROTBRINGERS, WARD (6+), CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Entropic Bludgeons | Melee | - | 2 | 4+ | 3+ | 2 | 2 | Charge (+1 Damage) |
| Foetid Nag's Hooves | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Pall of Exhaustion (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
**Points:** 80 | **Move:** 4" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, WARD (5+), CHAOS, MAGGOTKIN OF NURGLE, DAEMON, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Disgusting Sneezes | Ranged | 7" | D6 | 2+ | 4+ | - | 1 | Shoot in Combat |
| Distended Maw | Melee | - | 3 | 4+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Keep Counting, I'm Watching You (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
### The Glottkin
**Points:** 470 | **Move:** 6" | **Health:** 24 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, UNIQUE, WARMASTER, CHAOS, MAGGOTKIN OF NURGLE, MONSTER, ROTBRINGERS, WIZARD (1), WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ghurk's Lamprey Maw | Melee | - | 3 | 3+ | 2+ | 2 | 3 | - |
| Ghurk's Tentacle | Melee | - | 4 | 3+ | 2+ | 2 | 5 | - |
| Otto's Scythe | Melee | - | 4 | 3+ | 3+ | 1 | 3 | - |
...
#### Blighted Stampede (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared the ‘Counter-charge’ command for this unit
...
### The Wurmspat
**Points:** 160 | **Move:** 4" | **Health:** 4 | **Save:** 4+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, CHAMPION, MAGGOTKIN OF NURGLE, ROTBRINGERS, CHAOS, WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blighted Weapons | Melee | - | 4 | 3+ | 3+ | 1 | 1 | - |
| Blighted Weapons | Melee | - | 4 | 3+ | 3+ | 1 | 1 | - |
| Blighted Weapons | Melee | - | 4 | 3+ | 3+ | 1 | 1 | - |
