...
#### Elixir of the Frostwyrm (Activated)
- **Timing:** Once Per Battle, Any Shooting Phase
...
#### Fixated on Feeding (Activated)
- **Timing:** Once Per Turn (Army), Enemy Charge Phase
- **Declare:** Pick a friendly Ogor Infantry unit that is not in combat to be the target.
...
#### Postprandial Warfare (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick up to D3 friendly Ogor Infantry units that were in combat this turn with an enemy unit that was destroyed this turn to be the targets.
- **Effect:** Return 1 slain model to each target unit.

### Heroic Traits

#### Great Gutlord (Passive)
- **Effect:** Ignore negative modifiers to this unit’s control score and to hit rolls and wound rolls for this unit’s attacks.

#### Touched by the Everwinter (Passive)
...
• War Machine
• Beast
For the rest of the battle, each time any damage points are allocated to an enemy unit with that keyword by this unit’s combat attacks and that enemy unit is destroyed in the same turn, add 1 to the Attacks characteristic of this unit’s melee weapons. This effect is cumulative.

#### Mage-Swallower (Passive)
- **Effect:** Subtract 1 from ward rolls for enemy units while they are within 6" of this unit.

#### Gutslugger (Passive)
- **Effect:** Add 1 to hit rolls for this unit’s combat attacks if it did not charge in the same turn.
...
### Bloodpelt Hunter
**Points:** 110 | **Move:** 6" | **Health:** 8 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, INFANTRY, OGOR, GUTBUSTERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Skullshatter Crossbow | Ranged | 18" | 2 | 4+ | 3+ | 1 | D3 | - |
| Hacker-axe and Meatblade | Melee | - | 5 | 4+ | 2+ | 1 | 2 | Anti-Monster (+1 Rend) |
| Impaling Spear | Ranged | 12" | 1 | 4+ | 2+ | 1 | D6 | Anti-Monster (+1 Rend) |
...
### Butcher
**Points:** 150 | **Move:** 6" | **Health:** 7 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, INFANTRY, OGOR, GUTBUSTERS, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Butcher’s Tools | Melee | - | 3 | 4+ | 2+ | 1 | 3 | - |
...
### Firebelly
**Points:** 140 | **Move:** 6" | **Health:** 7 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, INFANTRY, OGOR, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Basalt Hammer | Melee | - | 3 | 4+ | 2+ | 1 | D3 | - |
| Fire Breath | Ranged | 8" | 6 | 2+ | 3+ | - | 1 | Shoot in Combat |
...
### Frost Sabres
**Points:** 70 | **Move:** 9" | **Health:** 3 | **Save:** 6+ | **Control:** 1
**Keywords:** OGOR MAWTRIBES, DESTRUCTION, BEAST, BEASTCLAW RAIDERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Tusks and Claws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | - |
...
**Points:** 320 | **Move:** 10" | **Health:** 15 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, OGOR, MONSTER, BEASTCLAW RAIDERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Stonehorn’s Hooves | Melee | - | D6 | 4+ | 2+ | 1 | D3 | Companion |
| Frost Spear | Melee | - | 4 | 4+ | 2+ | 2 | 2 | Charge (+1 Damage) |
...
#### Earth-shattering Charge (Activated)
...
**Points:** 230 | **Move:** 10" | **Health:** 15 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, OGOR, MONSTER, BEASTCLAW RAIDERS
...
#### Bellowing Voice (Activated)
- **Timing:** Once Per Battle (Army), Your Charge Phase
...
**Points:** 120 | **Move:** 9" | **Health:** 9 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, OGOR MAWTRIBES, RHINOX, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rhinox’s Sharp Horns | Melee | - | 1 | 4+ | 2+ | 1 | D3 | Companion |
| Scrappers’ Stabbers | Melee | - | 7 | 5+ | 5+ | - | 1 | - |
| Piles of Old Scrap | Ranged | 24" | 3D6 | 4+ | 4+ | - | 1 | Anti-Infantry (+1 Rend), Crit (Auto-wound) |

**Abilities:**

#### Load It Up! (Activated)
...
### Gnoblar Scraplauncher (Scourge of Ghyran)
**Points:** 120 | **Move:** 9" | **Health:** 9 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, OGOR MAWTRIBES, RHINOX, WAR MACHINE
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rhinox’s Sharp Horns and Crew's Weapons | Melee | - | 4 | 4+ | 2+ | 1 | D3 | Anti-charge (+1 Rend), Companion |
| Scrap Lobber | Ranged | 18" | 12 | 4+ | 2+ | 1 | 1 | Crit (2 Hits) |

**Abilities:**

#### Scrap Away! (Activated)
...
- **Effect:** Roll a dice. If the roll equals or exceeds the target’s Save characteristic, halve the target’s Move characteristic until the start of your next turn. In addition, on a 5+, until the start of your next turn, subtract 1 from the number of dice rolled when making charge rolls for the target, to a minimum of 1.

---

### Gnoblars
**Points:** 130 | **Move:** 5" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, OGOR MAWTRIBES, DESTRUCTION, CHAMPION

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sharp Stuff | Ranged | 8" | 1 | 4+ | 5+ | - | 1 | - |
| Motley Assortment of Weapons | Melee | - | 1 | 5+ | 5+ | - | 1 | - |

**Abilities:**

#### Nasty Traps and Tricks (Activated)
- **Timing:** Any Charge Phase
...
### Gorger Mawpack
**Points:** 240 | **Move:** 6" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** INFANTRY, OGOR MAWTRIBES, DESTRUCTION, OGOR, CHAMPION (1/5), MUSICIAN (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Clubs, Claws and Jaws | Melee | - | 5 | 4+ | 2+ | 1 | 2 | Anti-Infantry (+1 Rend) |

**Abilities:**

#### Troglodytic Lurkers (Activated)
...
### Gorlok Blackpowder
**Points:** 120 | **Move:** 6" | **Health:** 7 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, Legends, INFANTRY, DESTRUCTION, OGOR, OGOR MAWTRIBES

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grunderbuss | Ranged | 12" | 2 | 3+ | 3+ | 1 | D3 | Crit (Auto-wound) |
| Great Cutlass | Melee | - | 5 | 4+ | 2+ | 1 | 2 | Anti-Infantry (+1 Rend) |

**Abilities:**

#### Blackpowder's Buccaneers (Passive)
...
**Points:** 120 | **Move:** 6" | **Health:** 7 | **Save:** 5+ | **Control:** 5
**Keywords:** Regimental Leader, HERO, Legends, INFANTRY, DESTRUCTION, OGOR, OGOR MAWTRIBES, BEASTCLAW RAIDERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Trap Launcher | Ranged | 12" | 2 | 4+ | 3+ | 1 | D3 | Anti-Infantry (+1 Rend) |
| Hunting Knife | Melee | - | 5 | 4+ | 2+ | - | 2 | - |

**Abilities:**

#### Hunting Beast (Activated)
- **Timing:** Your Movement Phase
...
**Points:** 290 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, OGOR, MONSTER, BEASTCLAW RAIDERS, PRIEST (1)
...
**Points:** 220 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 10
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, OGOR, MONSTER, BEASTCLAW RAIDERS, PRIEST (1)
...
### Icebrow Hunter
**Points:** 100 | **Move:** 6" | **Health:** 7 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, INFANTRY, OGOR, BEASTCLAW RAIDERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Culling Club | Melee | - | 4 | 4+ | 2+ | - | 1 | Anti-Monster (+1 Rend) |
| Hunter’s Crossbow | Ranged | 12" | 1 | 4+ | 2+ | - | D3 | Anti-Monster (+1 Rend) |
| Great Throwing Spear | Ranged | 10" | 1 | 4+ | 3+ | 1 | D3 | Anti-Monster (+1 Rend) |

**Abilities:**

#### Masters of Ambush (Activated)
- **Timing:** Deployment Phase
...
### Icefall Yhetees
**Points:** 100 | **Move:** 6" | **Health:** 4 | **Save:** 6+ | **Control:** 1
**Keywords:** OGOR MAWTRIBES, DESTRUCTION, BEASTCLAW RAIDERS, INFANTRY, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Claws and Ice‑encrusted Weapons | Melee | - | 3 | 4+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Bounding Leaps (Activated)
...
### Ironblaster
**Points:** 160 | **Move:** 9" | **Health:** 9 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, OGOR MAWTRIBES, OGOR, GUTBUSTERS, RHINOX, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rhinox’s Sharp Horns | Melee | - | 1 | 4+ | 2+ | 1 | D3 | Companion |
| Clubber | Melee | - | 2 | 4+ | 2+ | - | 2 | - |
| Ironblaster Cannon: Big Shot | Ranged | 18" | 2 | 4+ | 2+ | 2 | D3+3 | - |
| Ironblaster Cannon: Hail Shot | Ranged | 12" | 8 | 4+ | 3+ | 1 | 2 | - |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rhinox’s Sharp Horns | Melee | - | 3 | 4+ | 2+ | 1 | D3 | Anti-charge (+1 Rend), Companion |
| Clubber | Melee | - | 2 | 4+ | 2+ | 1 | 2 | - |
| Ironblaster Cannon | Ranged | 18" | 2 | 4+ | 2+ | 2 | 5 | - |

**Abilities:**

#### Shrapnel Blast (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
- **Effect:** For the rest of the phase:
• Add 1 to the Attacks characteristic of this unit’s ranged weapons.
• This unit’s ranged weapons have **Crit (2 Hits)**.

---

### Ironguts
**Points:** 210 | **Move:** 6" | **Health:** 4 | **Save:** 5+ | **Control:** 2
**Keywords:** INFANTRY, CHAMPION, OGOR MAWTRIBES, DESTRUCTION, OGOR, GUTBUSTERS, MUSICIAN (1/4), STANDARD BEARER (1/4)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Irongut Weapon | Melee | - | 3 | 4+ | 2+ | 2 | 3 | - |

**Abilities:**

#### Down to the Ironguts (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
**Keywords:** HERO, UNIQUE, MONSTER, WARMASTER, WARD (5+), DESTRUCTION, OGOR MAWTRIBES
...
### Leadbelchers
**Points:** 120 | **Move:** 6" | **Health:** 4 | **Save:** 5+ | **Control:** 2
**Keywords:** INFANTRY, CHAMPION, OGOR MAWTRIBES, DESTRUCTION, OGOR, GUTBUSTERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Leadbelcher Gun | Ranged | 15" | D3 | 4+ | 3+ | 1 | 1 | - |
| Bludgeoning Blows | Melee | - | 2 | 4+ | 2+ | - | 2 | - |

**Abilities:**

#### Firing from the Belly (Activated)
- **Timing:** Your Shooting Phase
...
### Maneaters
**Points:** 160 | **Move:** 6" | **Health:** 4 | **Save:** 5+ | **Control:** 2
**Keywords:** INFANTRY, OGOR MAWTRIBES, DESTRUCTION, OGOR

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Pistols or Throwing Weapons | Ranged | 10" | 1 | 3+ | 3+ | 1 | D3 | Shoot in Combat |
| Maneater Weapons | Melee | - | 4 | 4+ | 2+ | 1 | 2 | - |

**Abilities:**

#### Been There, Done That (Activated)
- **Timing:** Once Per Turn (Army), Reaction: This unit was picked as the target of a non-Core ability
- **Effect:** Roll a dice. On a 4+, that ability has no effect on this unit.

---

### Mantrapper
**Points:** 130 | **Move:** 6" | **Health:** 8 | **Save:** 5+ | **Control:** 3
**Keywords:** HERO, INFANTRY, DESTRUCTION, OGOR, OGOR MAWTRIBES, BEASTCLAW RAIDERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Mantrap Launcher | Ranged | 15" | 4 | 3+ | 3+ | 1 | D3 | Crit (Auto-wound) |
| Mantrapper’s Hunting Knife | Melee | - | 4 | 4+ | 2+ | 1 | 2 | - |
...
#### Just a Little Closer... (Activated)
...
- **Effect:** This unit’s **Sabrefang**, **Gnoblars** and **Trap** are **Mantrapper accomplice** tokens. After setting up this unit on the battlefield for the first time, place all its tokens next to it.
If an enemy unit is destroyed or removed from the battlefield while any of this unit’s **Mantrapper accomplices** are next to it, remove those **Mantrapper accomplices** from the battlefield.

---

### Mournfang Pack
**Points:** 150 | **Move:** 9" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** CHAMPION, OGOR MAWTRIBES, DESTRUCTION, OGOR, MUSICIAN (1/4), STANDARD BEARER (1/4), CAVALRY, BEASTCLAW RAIDERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Mournfang Rider Weapon | Melee | - | 3 | 4+ | 2+ | 1 | 2 | Anti-Cavalry (+1 Rend) |
| Mournfang’s Tusks | Melee | - | 4 | 4+ | 2+ | 1 | 2 | Companion |
| Ironlock Pistol | Ranged | 10" | 1 | 4+ | 3+ | 1 | D3 | Shoot in Combat |
...
### Ogor Gluttons
**Points:** 220 | **Move:** 6" | **Health:** 4 | **Save:** 5+ | **Control:** 2
**Keywords:** INFANTRY, CHAMPION, MUSICIAN (1/6), STANDARD BEARER (1/6), OGOR MAWTRIBES, DESTRUCTION, OGOR, GUTBUSTERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Glutton Weapons | Melee | - | 4 | 4+ | 2+ | 1 | 2 | - |
...
### Slaughtermaster
**Points:** 150 | **Move:** 6" | **Health:** 8 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, INFANTRY, OGOR, GUTBUSTERS, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gnoblars’ Implements | Melee | - | 3 | 5+ | 5+ | - | 1 | Companion |
| Stump Blades | Melee | - | 2D6 | 4+ | 2+ | 1 | 1 | - |
...
**Points:** 260 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 10
**Keywords:** DESTRUCTION, OGOR MAWTRIBES, OGOR, MONSTER, BEASTCLAW RAIDERS
...
**Points:** 180 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 10
**Keywords:** DESTRUCTION, OGOR MAWTRIBES, OGOR, MONSTER, BEASTCLAW RAIDERS
...
#### Everwinter's Assault (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
### Tyrant
**Points:** 130 | **Move:** 6" | **Health:** 8 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, OGOR MAWTRIBES, INFANTRY, OGOR, GUTBUSTERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Thundermace | Melee | - | 3 | 4+ | 2+ | 2 | 3 | Crit (Mortal) |
| Beastskewer Glaive | Melee | - | 2 | 4+ | 2+ | 1 | 2 | Anti-Monster (+1 Rend) |
| Ogor Pistols | Ranged | 10" | 2 | 4+ | 3+ | 1 | D3 | Shoot in Combat |
...
#### Bully of the First Degree (Activated)
...
| Gnoblar Scraplauncher | 120 |
| Gnoblar Scraplauncher (Scourge of Ghyran) | 120 |
...
| Slaughtermaster | 150 |
| Ironblaster | 160 |
| Ironblaster (Scourge of Ghyran) | 160 |
| Maneaters | 160 |
| Thundertusk Beastriders | 180 |
| Ironguts | 210 |
| Huskard on Thundertusk | 220 |
| Ogor Gluttons | 220 |
| Frostlord on Thundertusk | 230 |
| Gorger Mawpack | 240 |
