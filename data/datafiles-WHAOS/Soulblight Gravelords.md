...
- **Effect:** Until the start of your next turn, each time the target uses a command, you receive 1 command point.
- **Keywords:** Spell

#### Immortal Retainers (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit
- **Effect:** Pick a friendly Deathrattle Cavalry or Infantry unit that has not used a Fight ability this turn and is within this unit’s combat range to be the target. The target can be picked to use a Fight ability immediately after the Fight** ability used by this unit has been resolved.

#### Battle Damaged (Passive)
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of its **Mighty Grave Beast's Talons** is 4.

#### Beast Form (Activated)
- **Timing:** Your Hero Phase
- **Effect:** Pick 1 of the following units to be this unit's **beast form**:
• A **Dire Wolves** unit with 1 model.
• A **Fell Bats** unit with 1 model.
Set up the **beast form** unit within 1" of this unit, then remove this unit from the battlefield. The **Beast Form** unit can use Move and Core abilities in your next movement phase.
If the **beast form is destroyed**, before it is removed from play, set up this unit on the battlefield once more within 1" of it.
In addition, in any combat phase before Fight abilities are used, or at the end of any turn, you can have the **beast form** unit transform back into this unit. If you do so, set up this unit within 1" of the **beast form** unit and remove the **beast form** unit from the battlefield.
This ability can only be used by an Infantry hero.

#### Acolyte of Necros (Passive)
- **Effect:** Each time this unit successfully casts a spell in your hero phase and the casting roll was an unmodified 10+, add 1 to this unit's power level until the start of your next turn

#### Fabled Heirlooms (Passive)
- **Effect:** When this unit is added to your Order of Battle, you can immediately give it 1 artefact of power

#### Picky Eater (Passive)
- **Effect:** This unit cannot be picked as a target for the 'The Hunger' ability unless your opponent's gneral has the Order keyword. This flaw can only be picked for a Vampire hero.

#### Fractured Mind (Activated)
- **Timing:** Start of Battle Round
- **Effect:** Roll a dice. On a 1-3, for the rest of the battle round, this unit cannot use commands and any heroic trait they have has no effect.

#### Repulsed by the Sacred (Passive)
- **Effect:** You cannot make ward rolls for this unit while it is within 12" of an enemy Priest or for damage inflicted on it by a Prayer ability.

#### Tenuous Grip on Undeath (Activated)
- **Timing:** End of Your Turn
- **Declare:** This unit must use this ability if no enemy models were slain by it this turn.
- **Effect:** Allocate 1 damage point to this unit (a ward roll cannot be made for that damage point).

#### Crushing Stomp (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick a non-Monster enemy unit n combat with this unit to be the target.
- **Effect:** Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll.
- **Keywords:** Rampage

#### Feed on Sorcery (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice. On a 3+, for the rest of the turn, ward rolls cannot be made for the target and add 1 to the Damage characteristic of this unit's **Companion** melee weapons.
- **Keywords:** Rampage
...
#### Undying Companion (Passive)
- **Effect:** This unit's **Undying Companion** is a token. This unit has Ward (5+) while its **Undying Companion** is on the battlefield. If you make an unmodified ward roll of 1 for this unit, remove its **Undying Companion** from the battlefield.

#### Master of Dark Magics (Passive)
- **Effect:** While this unit is not in combat, add 1 to casting rolls for this unit.
...
#### Siphon Spirit (Activated)
- **Timing:** Any Hero Phase
- **Declare:** Pick a friendly non-Hero unit wholly within 12" of this unit to be the target.
- **Effect:** Allocate D3 damage points to the target (ward rolls cannot be made), then **Heal (D3)** this unit.

#### Shadowy Translocation (Activated)
...
#### Protection of Shyish (Activated)
- **Timing:** Once Per Battle, Any Hero Phase
- **Effect:** This unit has Ward (5+) for the rest of the turn.

#### Cold Commander (Activated)
- **Timing:** Once Per Turn, Reaction: you declared the 'All-out Attack' command for a friendly unit
- **Effect:** If this unit is wholly within 12" of the unit using the 'All-out Attack' command, no command points are spent to use that command.

#### Hexed Weapons (Passive)
- **Effect:** Add 1 to the Rend characteristic of this unit's melee weapons.

#### Eternal Champion (Activated)
- **Timing:** Once Per Battle, Any Movement Phase
- **Declare:** This unit can use this ability if it has been destroyed.
- **Effect:** Roll 2D6. On a 7+, set up a replacement unit on the battlefield more than 9" from all enemy units.

#### Curse-bound Sentinel (Passive)
- **Effect:** While this unit is wholly within friendly territory, unmodified save rolls of 4+ for it are always successful.

#### Relentless Shamblers (Passive)
- **Effect:** Add 1" to this unit's Move characteristic.

#### The Vigilant Dead (Passive)
- **Effect:** Add 5 to this unit's control score.

#### Unholy Presence (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Inflict D3 mortal damage on the target. If the target is a Priest, inflict 3 mortal damage on it instead.

#### The Restless Dead (Activated)
- **Timing:** End of Any Turn
- **Effect:** Return 1 slain model to this unit.

#### Empowered by Shyish (Passive)
- **Effect:** This unit has Ward (5+).

#### Withering Touch (Passive)
- **Effect:** Subtract 1 from save rolls for enemy units while they are in combat with this unit.

#### Cursed Weapons (Passive)
- **Effect:** This unit's melee weapons have **Crit (Mortal)**.

#### Doomed Warriors (Passive)
- **Effect:** When a replacement unit is set up for this unit, it has the same abilities from the 'Path of the Revenant' as this unit. In addition, this unit can return as a replacement unit any number of times during the battle.

### Battle Traits

#### The Hunger (Activated)
...
If it is your movement phase, you can set up the replacement unit more than3" from all enemy units instead of more than 9", but if you set it up within 9" of any enemy units, it cannot use Charge abilities this turn.

#### Deathly Invocation (Activated)
...
#### The Rising Dead (Activated)
- **Timing:** Your Movement Phase
- **Declare:** Pick a friendly unit that is **in the grave**.
- **Effect:** Set up that unit wholly within 6" of a friendly **Cursed Sepulchre** and more than 9" from all enemy unit, or wholly within 6" of the edge of the battlefield, wholly within friendly territory, and more than 9" from all enemy units.

#### Ancient Burial Sites (Activated)
- **Timing:** Once Per Battle (Army), Deployment Phase
- **Effect:** If there is a friendly **Cursed Sepulchre** on the battlefield, you can set up to 2 additional friendly **Cursed Sepulchres** on the battlefield. The first must be set up more than 3" from all units, objectives, and other terrain features. The second must be set up wholly outside enemy territory and more than 3" from all units, objectives and other terrain features.
...
#### Amulet of Graves (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
- **Effect:** If there are fewer than 3 friendly **Cursed Sepulchres** on the battlefield, set up a **Cursed Sepulchre** on the battlefield more than 9" away from all enemy units, more than 1" from all friendly units and more than 3" from all objectives and other terrain features.

#### Shard of Night (Passive)
- **Effect:** Ignore modifiers to save rolls for shooting attacks that target this unit (positive and negative).

### Battle Formations

#### Dragged Down and Torn Apart (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
#### Aristocracy of the Night (Passive)
...
#### Tide of Bones and Blades (Passive)
...
#### Horror Unending (Passive)
- **Effect:** You can pick 1 additional target when using the ‘Deathly Invocation’ ability.

#### Wardens of the Wolf (Passive)
- **Effect:** Each time 1 or more slain models are returned to a friendly Soulblight Gravelords Infantry or Beast unit wholly within 12" of a friendly **Belladamma Volga**, **Radukar the Wolf**, **Radukar the Beast**, **Ivya Volga**, **Lady Annika**, **Kritza**, **Torgillius the Chamberlain**, **Gorslav the Gravekeeper** or **Watch Captain Halgrim**, add 1 to the number of slain models returned to that unit.

#### Unhallowed Site (Activated)
...
• If the target is not in combat, it can move D6" but cannot move into combat during any part of the move. 
• If the target is in combat, it can make a pile-in move.

#### Unbending Will (Activated)
- **Timing:** Your Hero Phase
...
- **Effect:** Each time an ability would heal exactly 1 or 2 of this unit’s damage points, heal 3 damage points instead.

#### Immortal Ego (Passive)
...
- **Effect:** Set up 3 **Cursed Sepulchres** wholly within friendly territory, each within 1/2" of any of the others and more than 3" from all objectives and other terrain features. After you have done so, they have been deployed and they are considered to be a single **Cursed Sepulchre** terrain feature that has a Health characteristic of 24 instead of 8.
- **Keywords:** Deploy Terrain

#### Gifts to the Petty Kingdoms (Activated)
- **Timing:** Once Per Battle, Deployment Phase
...
**Designer's Note:** *These artefacts of power are give to the* Heroes *during the deployment phase, not during list construction.*

#### Endless Legions of Bone (Activated)
- **Timing:** Once Per Battle Round (Army), Any Movement Phase
- **Declare:** Pick a friendly non Unique Barrow Legion that has been destroyed to be the target.
...
#### Ring of Stricken Souls (Passive)
- **Effect:** This unit has Ward (5+)

#### Crown of Cold Command (Activated)
...
#### Amulet of Nightmares (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
#### Lord of the Arcane Aegis (Activated)
- **Timing:** Deployment Phase
...
#### From a Quarter Unseen (Activated)
...
#### Chalice of the Blood Dragon (Activated)
- **Timing:** Once Per Battle, End of Any Turn
- **Effect:** **Heal (3D3)** this unit.

**Heroic Traits**

#### Immortal Dedication (Activated)
...
- **Keywords:** Exquisite Plot

#### Thaumic Realignment (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
#### Keeper of the Royal Menagerie (Activated)
- **Timing:** Your Hero Phase
...
**Keywords:** INFANTRY, WARD (6+), DEATH, CHAMPION (1/8), SOULBLIGHT GRAVELORDS, VAMPIRE
...
**Keywords:** DEATH, INFANTRY, WARD (6+), CHAMPION, SOULBLIGHT GRAVELORDS, DEATHRATTLE, STANDARD BEARER (1/5), MUSICIAN (1/5)
...
**Keywords:** DEATH, WARD (6+), CAVALRY, CHAMPION, STANDARD BEARER (1/5), SOULBLIGHT GRAVELORDS, DEATHRATTLE, MUSICIAN (1/5)
...
**Points:** 220 | **Move:** 8" | **Health:** 9 | **Save:** 4+ | **Control:** 5
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (2), CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lupine Fangs and Claws | Melee | - | 6 | 4+ | 4+ | - | 1 | Companion |
| Timeworn Scimitar | Melee | - | 4 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Under a Killing Moon (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
#### First of the Vyrkos (Passive)
- **Effect:** Add 3 to the control scores of friendly **Radukar the Wolf**, **Radukar the Beast**, **Ivya Volga**, **Lady Annika** and **Kritza** units while they are wholly within 18" of this unit.
...
**Points:** 290 | **Move:** 6" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** INFANTRY, UNIQUE, WARD (6+), DEATH, WIZARD (1), VAMPIRE, SOULBLIGHT GRAVELORDS, HERO

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kennistrix's Fangs | Melee | - | 2 | 4+ | 2+ | 3 | D3 | Companion |
| Ezechiarian Greatsword | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Crit (Auto-wound) |
| Sissendra's Twin Blades | Melee | - | 8 | 3+ | 3+ | 1 | 1 | Crit (Mortal) |

**Abilities:**

#### Solia, the Tutor (Activated)
- **Timing:** Any Combat Phase
- **Declare:** This unit can use this ability while its **Cado Ezechiar** is on the battlefield.
...
#### Aurelias (Activated)
- **Timing:** Your Hero Phase
- **Declare:** This unit can use this ability while its **Aurelias** is on the battlefield.
- **Effect:** Pick 1 of the following to apply for the rest of the turn:
• Add 1 to this unit's power level.
• Each time a casting roll is made for this unit, you can re-roll 1 of the dice.

#### Retribution or Salvation (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** This unit can cast this spell while its **Cado Ezechiar** is on the battlefield. Pick a visible unit within 12" of this unit to be the target, then make a casting roll of 2D6.
- **Effect:** If the target is an enemy unit, inflict D3 mortal damage on it. If the target is a friendly **Deathrattle** or **Deadwalkers** unit, subtract 1 from wound rolls for combat attacks that target that unit for the rest of the turn.
- **Keywords:** Spell
...
**Keywords:** DEATH, WARD (6+), CAVALRY, CHAMPION, STANDARD BEARER (1/5), SOULBLIGHT GRAVELORDS, VAMPIRE
...
#### The Court of the Lost (Activated)
- **Timing:** Your Hero Phase
...
**Keywords:** WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, WAR MACHINE, DEADWALKERS
...
**Keywords:** DEATH, INFANTRY, WARD (6+), SOULBLIGHT GRAVELORDS, DEADWALKERS
...
**Keywords:** DEATH, INFANTRY, WARD (6+), CHAMPION, STANDARD BEARER (1/10), SOULBLIGHT GRAVELORDS, DEATHRATTLE
...
**Keywords:** DEATH, WARD (6+), SOULBLIGHT GRAVELORDS, DEADWALKERS, BEAST, CHAMPION (1/10)
...
**Keywords:** DEATH, WARD (6+), SOULBLIGHT GRAVELORDS, BEAST, DEADWALKERS, FLY
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gravekeeper's Spade | Melee | - | 5 | 4+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Arise! Arise! (Activated)
- **Timing:** Once Per Battle, Reaction: You declared the ‘Endless Legions’ ability and picked a friendly Deadwalkers unit to be the target
- **Effect:** When resolving the effect of the ‘Endless Legions’ ability, set up the replacement unit wholly within 3" of this unit instead of wholly within 12" and more than 3" from all enemy units instead of more than 9", even if it is not your movement phase. The replacement unit can still use Charge abilities this turn.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heirloom Axe | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Anti-Monster(+1 Rend) |
| Bat Swarm's Needling Fangs | Ranged | 12" | 2D6 | 4+ | 4+ | - | 1 | Shoot in Combat, Companion |

**Abilities:**

#### Total Dominance (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
...
**Points:** 70 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gnawblade | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Crit (2 Hits) |

**Abilities:**

#### Scurrying Retreat (Activated)
- **Timing:** Any Combat Phase
...
**Points:** 100 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** DEATH, HERO, UNIQUE, SOULBLIGHT GRAVELORDS, VAMPIRE, INFANTRY, WARD (4+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blade Proboscian | Melee | - | 7 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Starving Nightmare (Activated)
- **Timing:** Your Movement Phase
...
#### Kiss of the Blade Proboscian (Activated)
- **Timing:** End of Any Turn
...
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), MONSTER, FLY, SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Askurga Rapier | Melee | - | 5 | 3+ | 3+ | 2 | 2 | - |
| Gore-drenched Talons | Melee | - | 3 | 3+ | 2+ | 3 | 3 | - |

**Abilities:**

#### The Queen's Dictat (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Pick a visible friendly non-Unique Soulblight Gravelords Monster wholly within 12" of this unit to be the target, then make a casting roll of 2D6.
- **Effect:** Pick 1 of the target’s melee weapons. If the target has any **Companion** melee weapons, you must pick 1 of those. Add D3 to the Attacks characteristic of that weapon for the rest of the turn.
- **Keywords:** Spell
...
**Points:** 430 | **Move:** 12" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** DEATH, HERO, WIZARD (2), UNIQUE, WARD (6+), MONSTER, FLY, SOULBLIGHT GRAVELORDS, VAMPIRE, WARMASTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ashigaroth's Claws | Melee | - | 5 | 4+ | 2+ | 3 | 3 | Companion |
| Gheistvor | Melee | - | 6 | 3+ | 3+ | 1 | 2 | - |
...
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** Pick a point on the battlefield within 18" of the caster, pick up to 3 enemy units within 6" of that point and visible to the caster to be the targets, then make a casting roll of 2D6.
- **Effect:** Roll a D3 for each target. On a 2+, inflict an amount of mortal damage on the target equal to the roll.
- **Keywords:** Spell

#### The Mortarch of Night (Activated)
- **Timing:** Reaction: You declared the ‘Redeploy’ command for a Soulblight Gravelords unit wholly within 12" of this unit
...
### Mortis Engine
**Points:** 230 | **Move:** 10" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, WIZARD (1), WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, WAR MACHINE, FLY
...
**Points:** 780 | **Move:** 10" | **Health:** 18 | **Save:** 3+ | **Control:** 10
**Keywords:** DEATH, UNIQUE, HERO, MONSTER, WIZARD (9), WARD (5+), FLY, SOULBLIGHT GRAVELORDS
...
#### Supreme Lord of the Undead (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
...
**Keywords:** HERO, WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, INFANTRY, WIZARD (1)
...
**Points:** 450 | **Move:** 12" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** DEATH, HERO, WIZARD (2), UNIQUE, WARD (6+), MONSTER, FLY, SOULBLIGHT GRAVELORDS, VAMPIRE, WARMASTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Aken-seth | Melee | - | 3 | 2+ | 3+ | 2 | 2 | - |
| Akmet-har | Melee | - | 5 | 3+ | 3+ | 2 | 1 | Anti-Hero (+1 Rend) |
| Nagadron's Claws | Melee | - | 5 | 4+ | 2+ | 3 | 3 | Companion |
...
#### The Mortarch of Blood (Activated)
- **Timing:** Deployment Phase
...
### Prince Vhordrai
**Points:** 470 | **Move:** 12" | **Health:** 18 | **Save:** 3+ | **Control:** 5
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), MONSTER, FLY, SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Shordmaire's Claws | Melee | - | 7 | 4+ | 2+ | 1 | 2 | Companion |
| Shordmaire's Maw | Melee | - | 3 | 4+ | 2+ | 2 | 3 | Companion |
| The Bloodlance | Melee | - | 6 | 3+ | 3+ | 2 | 2 | Charge (+1 Damage) |
| Shordemaire's Miasma | Ranged | 10" | D6 | 3+ | 3+ | 2 | 2 | Shoot in Combat, Companion |

**Abilities:**

#### Battle Damaged (Passive)
- **Effect:** While this unit has 10 or more damage points, the Attacks characteristic of **Shordmaire's Claws** is 5.

#### Trail of Crimson (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Radukar the Beast
**Points:** 250 | **Move:** 8" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** MONSTER, DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blood-slick Claws | Melee | - | 6 | 3+ | 3+ | 2 | 3 | Crit (Mortal) |
| Vyrkos Blood-born's Piercing Blades | Melee | - | 6 | 3+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Armour of the Night (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Make a casting roll of 2D6.
...
#### The Beast Will Out (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Effect:** If this unit is not in combat, it can move D6". It can move into combat.
- **Keywords:** Rampage

#### Call to the Hunt (Passive)
- **Effect:** If this unit charged this turn, for the rest of the turn, add 1 to wound rolls for combat attacks made by friendly Deathrattle and Deadwalkers units while they are wholly within 12" of this unit.

---

### Radukar the Wolf
**Points:** 130 | **Move:** 6" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (1), INFANTRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Vyrkos Barrow-blade | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Master of the Pack (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Make a casting roll of 2D6.
...
**Points:** 160 | **Move:** 6" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, INFANTRY, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Nulahmian Warglaive | Melee | - | 5 | 3+ | 3+ | 1 | 2 | Crit (2 Hits) |
| Ouboroth’s Godhusk Fangs | Melee | - | 3 | 4+ | 3+ | 2 | D3 | Companion |

**Abilities:**

#### Death's Construction (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
- **Declare:** Pick a visible enemy unit within 12" of this unit to be the target, then make a casting roll of 2D6.
- **Effect:** Until the start of your next turn, while they are wholly within 6" of this unit, friendly Soulblight Gravelords units cannot be picked to be the target of abilities used by the target other than Fight abilities.
- **Keywords:** Spell
...
#### The Time-swallower's Maw (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
### Sekhar, Fang of Nulahmia (Scourge of Ghyran)
**Points:** 190 | **Move:** 6" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, INFANTRY, WIZARD (2)
...
#### Allow Me To Remind You... (Activated)
- **Timing:** Once Per Turn, Reaction: Opponent declared a command for a visible enemy unit within 18" of this unit
...
#### Lest You Forget... (Activated)
- **Timing:** Once Per Battle Round, Reaction: Opponent declared a Spell or Charge ability for a visible enemy unit within 18" of this unit
...
### The Crimson Court
**Points:** 210 | **Move:** 6" | **Health:** 3 | **Save:** 3+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, WARD (6+), DEATH, CHAMPION, WIZARD (1), VAMPIRE, SOULBLIGHT GRAVELORDS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Courtly Weapon | Melee | - | 3 | 3+ | 3+ | 1 | 2 | Anti-Hero (+1 Rend) |
| Courtly Weapon | Melee | - | 3 | 3+ | 3+ | 1 | 2 | Anti-Hero (+1 Rend) |
| Courtly Weapon | Melee | - | 3 | 3+ | 3+ | 1 | 2 | Anti-Hero (+1 Rend) |
| Courtly Weapon | Melee | - | 3 | 3+ | 3+ | 1 | 2 | Anti-Hero (+1 Rend) |
...
**Keywords:** INFANTRY, UNIQUE, Legends, WARD (6+), DEATH, CHAMPION, SOULBLIGHT GRAVELORDS, DEADWALKERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Arco-electric Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Crit (2 Hits) |
| Arco-electric Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Crit (2 Hits) |
| Arco-electric Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Crit (2 Hits) |
| Arco-electric Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Crit (2 Hits) |
| Arco-electric Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Crit (2 Hits) |
...
**Points:** 110 | **Move:** 4" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, WARD (6+), DEATH, CHAMPION, SOULBLIGHT GRAVELORDS, DEATHRATTLE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ancient Weapon | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Ancient Weapon | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Ancient Weapon | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Ancient Weapon | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Ancient Weapon | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
...
### The Sons of Velmorn
**Points:** 130 | **Move:** 4" | **Health:** 2 | **Save:** 3+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, WARD (6+), DEATH, CHAMPION, SOULBLIGHT GRAVELORDS, DEATHRATTLE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Royal Weapons | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Crit (Mortal) |
| Royal Weapons | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Crit (Mortal) |
| Royal Weapons | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Crit (Mortal) |
| Royal Weapons | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Crit (Mortal) |
| Royal Weapons | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Crit (Mortal) |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Familiars’ Fangs and Claws | Melee | - | 4 | 4+ | 4+ | - | 1 | Companion |
| Necrotising Bolts | Ranged | 18" | 6 | 4+ | 4+ | 1 | D3 | Shoot in Combat |

**Abilities:**

#### Failing Fortitude (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Pick a visible enemy unit within 18" of this unit to be the target, then make a casting roll of 2D6.
...
**Keywords:** HERO, WIZARD (1), WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, INFANTRY, VAMPIRE
...
**Keywords:** HERO, WIZARD (1), WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, VAMPIRE, CAVALRY
...
**Keywords:** DEATH, WARD (6+), CHAMPION, SOULBLIGHT GRAVELORDS, VAMPIRE, INFANTRY, FLY
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Cursed Halberd and Sabre | Melee | - | 5 | 4+ | 3+ | 2 | 2 | Crit (Mortal) |

**Abilities:**

#### Echoes of the Watch (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit
...
**Keywords:** HERO, WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, INFANTRY, DEATHRATTLE
...
**Keywords:** HERO, WARD (6+), DEATH, SOULBLIGHT GRAVELORDS, DEATHRATTLE, CAVALRY
...
**Points:** 120 | **Move:** 4" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, WARD (6+), DEATH, CHAMPION, SOULBLIGHT GRAVELORDS, DEADWALKERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Graverobber’s Tools | Melee | - | 3 | 4+ | 4+ | - | 1 | - |
| Rending Claws | Melee | - | 4 | 4+ | 3+ | 1 | 2 | - |
| Graverobber’s Tools | Melee | - | 3 | 4+ | 4+ | - | 1 | - |
| Graverobber’s Tools | Melee | - | 3 | 4+ | 4+ | - | 1 | - |
| Graverobber’s Tools | Melee | - | 3 | 4+ | 4+ | - | 1 | - |
...
| Sekhar, Fang of Nulahmia (Scourge of Ghyran) | 190 |
...
| Lauka Vai, Mother of Nightmares | 220 |
| Terrorgheist | 220 |
| Vengorian Lord | 220 |
| Coven Throne | 230 |
| Mortis Engine | 230 |
...
| Prince Vhordrai | 470 |
| Nagash, Supreme Lord of the Undead | 780 |
