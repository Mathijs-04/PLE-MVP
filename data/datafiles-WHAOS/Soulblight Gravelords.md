...
**Points:** 800 | **Move:** 10" | **Health:** 18 | **Save:** 3+ | **Control:** 10
**Keywords:** DEATH, UNIQUE, HERO, MONSTER, WIZARD (9), WARD (5+), FLY, SOULBLIGHT GRAVELORDS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Alakanash | Melee | - | 4 | 3+ | 3+ | 2 | D6 | - |
| Zefet-nebtar | Melee | - | 4 | 3+ | 3+ | 2 | 3 | - |
...
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (1), MONSTER
...
**Points:** 230 | **Move:** 10" | **Health:** 11 | **Save:** 4+ | **Control:** 5
**Keywords:** DEATH, HERO, UNIQUE, WARD (6+), MONSTER, FLY, SOULBLIGHT GRAVELORDS, VAMPIRE, WIZARD (1)
...
**Points:** 200 | **Move:** 10" | **Health:** 8 | **Save:** 3+ | **Control:** 2
...
### Wight King
**Points:** 90 | **Move:** 4" | **Health:** 5 | **Save:** 3+ | **Control:** 2
...
### Necromancer
**Points:** 140 | **Move:** 5" | **Health:** 5 | **Save:** 6+ | **Control:** 2
...
**Points:** 180 | **Move:** 6" | **Health:** 6 | **Save:** 3+ | **Control:** 2
...
> Variant: Sekhar, Fang of Nulahmia (Scourge of Ghyran) — 210 pts
...
### Anvil of Apotheosis: Soulblight Gravelords Hero
**Move:** 5" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, INFANTRY, DEATH, SOULBLIGHT GRAVELORDS, WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grave Blade | Melee | - | 3 | 4+ | 4+ | 1 | 2 |  |
| Mighty Grave Beast's Talons | Melee | - | 7 | 4+ | 2+ | 2 | 2 | Companion |
| Spectral Host's Blades | Melee | - | 10 | 4+ | 4+ | - | 1 | Companion |
| Necrotic Breath | Ranged | 10" | D6 | 2+ | 4+ | 1 | 2 | Shoot in Combat, Companion |
| Undead Steed's Hooves | Melee | - | 3 | 5+ | 3+ | - | 1 | Companion |
...
**Keywords:** DEATH, INFANTRY, WARD (6+), CHAMPION, SOULBLIGHT GRAVELORDS, DEATHRATTLE
...
### Barrow Knights
**Points:** 210 | **Move:** 10" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** DEATH, WARD (6+), CAVALRY, CHAMPION, SOULBLIGHT GRAVELORDS, DEATHRATTLE
...
### Vargskyr
**Points:** 160 | **Move:** 8" | **Health:** 8 | **Save:** 5+ | **Control:** 1
...
### Askurgan Trueblades
**Points:** 130 | **Move:** 6" | **Health:** 2 | **Save:** 5+ | **Control:** 1
...
**Keywords:** DEATH, WARD (6+), CAVALRY, CHAMPION, SOULBLIGHT GRAVELORDS, VAMPIRE
...
> Variant: Corpse Cart (Scourge of Ghyran) — 80 pts

---

### Barrow Guard
**Points:** 150 | **Move:** 4" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** DEATH, INFANTRY, WARD (6+), CHAMPION, SOULBLIGHT GRAVELORDS, DEATHRATTLE
...
### Deadwalker Zombies
**Points:** 140 | **Move:** 4" | **Health:** 1 | **Save:** 6+ | **Control:** 1
...
### Fell Bats
**Points:** 90 | **Move:** 12" | **Health:** 3 | **Save:** 6+ | **Control:** 1
...
### Cursed Sepulchre
**Move:** - | **Health:** 8 | **Save:** 4+ | **Control:** -
**Keywords:** DEATH, FACTION TERRAIN, SOULBLIGHT GRAVELORDS, WARD (6+)

**Abilities:**

#### Locus of Shyish (Passive)
- **Effect:** Each time a friendly Soulblight Gravelords Wizard casts a Summon Spell from the 'Manifestations of the Grave' lore, you can measure the range and visibility from this terrain feature instead.

#### Leeching Soil (Passive)
- **Effect:** Each time a model (friendly or enemy) is slain while it is within 9" of this terrain feature, Heal (1) this terrain feature.

---

### Unholy Reliquary
**Move:** - | **Health:** 8 | **Save:** 5+ | **Banishment:** 7+
**Keywords:** DEATH, WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, SOULBLIGHT GRAVELORDS

**Abilities:**

#### Draw on Power (Activated)
- **Timing:** Any Combat Phase
...
### Sanguine Swarm
**Move:** 12" | **Health:** 6 | **Save:** 6+ | **Banishment:** 7+
**Keywords:** DEATH, WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, SOULBLIGHT GRAVELORDS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Leeching Bites | Melee | - | 10 | 5+ | 5+ | - | 1 | Crit (Mortal) |

**Abilities:**

#### Leeching Bites (Passive)
- **Effect:** Each time an attack made by this Manifestation scores a critical hit, Heal (1) this Manifestation.

#### Multiple Parts (Passive)
...
### Hand of Nagash
**Move:** 8" | **Health:** 10 | **Save:** 5+ | **Banishment:** 8+
**Keywords:** DEATH, WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, SOULBLIGHT GRAVELORDS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grasping Talon | Melee | - | 5 | 4+ | 2+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### Chill Grasp (Activated)
- **Timing:** Any Combat Phase
