...
#### Seen That Before! (Passive)
- **Effect:** Other than the **Companion** weapon ability, weapon abilities for attacks that target this unit have no effect.

#### The Bad Moonbeam (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
- **Effect:** For the rest of the battle round, this unit is affected by all of the faces of the bad moon.

#### Sneaky Git (Passive)
- **Effect:** If this unit is not a Monster, while it is wholly on a terrain feature, it is not visible to enemy units that are not within this unit's combat range. If this unit is a Monster, subtract 1 from hit rolls for attacks that target this unit while it is wholly on a terrain feature.

#### Gittishly Overconfident (Passive)
- **Effect:** In your charge phase, if this unit is not in combat and there is an enemy Hero within 12" of this unit, this unit must use the 'Charge' ability, and if the charge roll would allow it to finish within 1/2" of that enemy Hero, it must do so.

#### Last to the Fight (Passive)
- **Effect:** This unit has Strike-last.

#### Shroomist (Activated)
- **Timing:** Reaction: You declared a Move ability for this unit
- **Effect:** Roll 2D6. If the total is equal to or lower than this unit's Control characteristic, that Move ability has no effect.

#### Vicious Until the End (Passive)
- **Effect:** If this unit is destroyed, before removing it from play, pick an enemy unit in combat with it and roll a number of dice equal to this unit's health characteristic. For each 5+, inflict 1 mortal damage on that enemy unit.

#### Boinging Ker-splat! (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
- **Declare:** If this unit charged this phase, pick any number of enemy units within 1" of it to be the targets.
- **Effect:** Roll a dice and add the number of targets to the roll. If the result is less than 6, inflict 1 mortal damage on each target and repeat the sequence, but add another dice to the roll each time you do so.
- **Keywords:** Rampage

#### Webbed! (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy Hero within 1" of this unit to be the target.
- **Effect:** Roll 2D6. If the roll exceeds the target's Move characteristic, until the start of your next turn, the target cannot pile in and cannot use Retreat abilities.

#### Incredibly Annoying (Passive)
- **Effect:** While your hero is contesting an objective, subtract 1 from the control scores of enemy units while they are in combat with your hero.

#### Slippery Git (Activated)
- **Timing:** Any Combat Phase
- **Effect:** If this unit is in combat, roll a dice. On a 4+, this unit can immediately use the 'Retreat' ability without any mortal damage being inflicted on it.

#### Cunning Git (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice. On a 3+, ward rolls cannot be made for damage points inflicted on the target by this unit's attacks this phase.

#### Squig-fang Stikka (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick each enemy unit that charged this turn and that is in combat with this unit to be the targets.
- **Effect:** Roll a dice for each target. On a 4+, inflict D3 mortal damage on that target.

#### Sneaky Git (Passive)
- **Effect:** If this unit is not a Monster, while it is wholly on a terrain feature, it is not visible to enemy units that are not in combat with it. If this unit is a Monster, subtract 1 from hit rolls for attacks that target this unit while it is wholly on a terrain feature.
...
#### Extra Stabby (Passive)
- **Effect:** This unit's melee weapons have **Crit (2 Hits)**.

#### Tough Git (Passive)
- **Effect:** Add 1 to this unit's Health characteristic.

#### Scary Scowler (Passive)
- **Effect:** This unit cannot be picked to be the target of Rampage abilities used by enemy units.

#### Frothing Enthusiasm (Passive)
- **Effect:** If this unit charged this turn, add 2 to charge rolls for friendly units while they are wholly within 12" of this unit.

#### Sadistik Scoundrel (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick each enemy unit in combat with this unit that had any damage points allocated to it this turn to be the targets.
- **Effect:** Roll a D3 for each target. On a 2+, inflict an amount of mortal damage on the target equal to the roll.

#### Almost Blessed by the Bad Moon (Passive)
- **Effect:** This unit has Ward (5+). After the first failed ward roll made for it, however, it has Ward (6+) instead.

#### Sneaky Sidestepper (Activated)
- **Timing:** Any Combat Phase
- **Effect:** Roll a dice. On a 3+, pick 1 of the target's weapons and subtract 3 from its Attacks characteristic for the rest of the turn.

#### The Angriest Git Around (Passive)
- **Effect:** Add 3 to the control scores of all friendly units while this unit is contesting an objective.

#### Fungus Brew (Activated)
- **Timing:** Reaction: Opponent declared a non-Fight ability for a Manifestation
- **Effect:** Roll a dice. On a 4+, that ability has no effect on this unit.

#### Notorious and Vicious (Passive)
- **Effect:** Subtract 2 from the control scores of enemy units while they are contesting the same objective as this unit.

#### Fungal Freaks (Passive)
- **Effect:** Subtract 1 from hit rolls for shooting attacks that target this unit.

#### Devious Survivors (Passive)
- **Effect:** No mortal damage is inflicted on this unit by Retreat abilities.

#### Hit 'Em Back (Passive)
- **Effect:** Each time the unmodified save roll for a combat attack that targets this unit is 6, inflict 1 mortal damage on the attacking unit after the Fight ability has been resolved.

#### Looncrew (Passive)
- **Effect:** This unit has Ward (6+). If this unit already has Ward (6+), it has Ward (5+) instead.

#### Nasty Press Gang (Passive)
- **Effect:** Roll a D3. On a 2+, return a number of slain models to this unit equal to the roll.

#### Stab 'Em Again and Again (Passive)
- **Effect:** Add 1 to the Attacks characteristic of this unit's non-**Companion** weapons.

### Battle Traits

#### The Faces of the Bad Moon (Activated)
...
- **Effect:** If it is the first battle round, pick the starting face of the Bad Moon (**Grinnin'**, **Scowlin'**, **Sulkin'** **Cacklin'**). If it is not the first battle round, the face of the Bad Moon moves to the next face in the sequence.

#### Under the Light of the Bad Moon (Passive)
...
- **Effect:** If you picked a target, roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll. Then, the unit using this ability can move a distance up to its Move characteristic. It can move through the combat range of enemy units but cannot end that move in combat.
- **Keywords:** Core, Move, Retreat

#### Spreading Loonacy (Activated)
...
#### Extra Snappy (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick up to 3 friendly Gitmob units that charged this turn to be the targets.
- **Effect:** Add 1 to the Rend characteristic of **Companion** weapons used by the targets for the rest of turn.

#### Grots Upon Grots (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick a friendly non-Squig Moonclan unit that is contesting an objective to be the target.
- **Effect:** For the rest of the turn, add 1 to the control score of the target unit for each model in that unit that is not contesting any objectives.
...
#### Wotnot of Prestige (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick a point on the battlefield within 9" of this unit. Each visible enemy unit within 3" of that point is a target.
- **Effect:** Roll a D3 for each target, On a 2+, inflict an amount of mortal damage on the target equal to the roll.

#### Loonstone Medallion (Passive)
- **Effect:** This unit has Ward (6+). While this unit is contesting an objective that is not being coned by any other friendly units, it has Ward (5+).

**Heroic Traits**

#### Da King's Adjutant (Activated)
- **Timing:** Once Per Battle (Army), End of Your Turn
- **Declare:** You cannot use this ability and the **Bad Moon Loonshrine's** 'Moonclan Lairs' ability in the same turn. While this unit is within 12" of a friendly **Bad Moon Loonshrine**, pick a friendly non-reinforced, non-Hero, non-Monster King's Gitz unit that has been destroyed to be the target.
- **Effect:** Set up a replacement unit wholly within 12" of a friendly **Bad Moon Loonshrine** and more than 3" from all enemy units.

#### Glarejester (Activated)
- **Timing:** Your Movement Phase
...
#### Dis Fight's Not Fer Me (Activated)
...
- **Effect:** Each time this unit uses a Retreat ability or the 'Frazzlegit's Flame Stream' ability, before moving this unit, pick an enemy unit in combat with it and roll a D3. On a 2+, inflict an amount of mortal damage in the target equal to the roll.
...
### Aleguzzler Gargant
**Points:** 150 | **Move:** 8" | **Health:** 12 | **Save:** 5+ | **Control:** 10
**Keywords:** Legends, GLOOMSPITE GITZ, DESTRUCTION, MONSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| ’Eadbutt | Melee | - | 1 | 4+ | 2+ | 2 | 4 | - |
| Massive Club | Melee | - | 4 | 4+ | 2+ | 1 | 2 | - |
| Mighty Kick | Melee | - | 1 | 4+ | 2+ | 2 | D3 | - |
| Throwin’ Rocks | Ranged | 12" | 1 | 5+ | 2+ | 2 | D3 | - |
...
#### Stuff 'Em in Me Bag (Activated)
- **Timing:** Once Per Turn, Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
**Points:** 230 | **Move:** 10" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, SPIDERFANG, MONSTER, ARACHNAROK

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Monstrous Spider Fangs | Melee | - | 4 | 3+ | 2+ | 1 | 3 | Crit (Mortal), Companion |
| Chitinous Legs | Melee | - | 8 | 4+ | 2+ | 1 | 1 | Companion |
| Crooked Spears | Melee | - | 10 | 4+ | 5+ | - | 1 | - |
| Spider-bows | Ranged | 18" | 10 | 4+ | 5+ | - | 1 | - |
| Flinger | Ranged | 24" | D3 | 4+ | 3+ | - | 1 | Crit (2 Hits) |
...
#### Beast-binding Webbing (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 220 | **Move:** 10" | **Health:** 16 | **Save:** 4+ | **Control:** 10
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, SPIDERFANG, MONSTER, ARACHNAROK
...
### Boingrot Bounderz
**Points:** 120 | **Move:** D6+6" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** CAVALRY, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, SQUIG, MOONCLAN, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fang-filled Gob | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
| Pokin’ Lance | Melee | - | 3 | 4+ | 4+ | 1 | 1 | Charge (+1 Damage) |

**Abilities:**

#### Boing! Smash! (Activated)
...
**Points:** 90 | **Move:** 5" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, UNIQUE, Legends, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Borgit's Stabba | Melee | - | 5 | 4+ | 4+ | 1 | D3 | Anti-Beast (+1 Rend), Anti-Monster (+1 Rend) |
| Beastgrabba Weapons | Melee | - | 2 | 4+ | 5+ | - | 1 | Anti-Beast (+1 Rend), Anti-Monster (+1 Rend) |
| Troggoth Fists | Melee | - | 4 | 4+ | 3+ | - | 2 | Anti-Beast (+1 Rend), Anti-Monster (+1 Rend) |
| Beastgrabba Weapons | Melee | - | 2 | 4+ | 5+ | - | 1 | Anti-Beast (+1 Rend), Anti-Monster (+1 Rend) |
| Beastgrabba Weapons | Melee | - | 2 | 4+ | 5+ | - | 1 | Anti-Beast (+1 Rend), Anti-Monster (+1 Rend) |

**Abilities:**

#### Borgit's Masterplan (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
#### Uglug the Troggoth (Passive)
- **Effect:** While this unit includes **Uglug**, ignore the first damage point allocated to it each phase.

---

### Dankhold Troggboss
**Points:** 220 | **Move:** 6" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, DESTRUCTION, GLOOMSPITE GITZ, TROGGOTH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Boulder Club | Melee | - | 5 | 4+ | 2+ | 2 | D6 | - |

**Abilities:**

#### Shepherd of Destruction (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Greater Regeneration (Activated)
...
### Dankhold Troggoth
**Points:** 140 | **Move:** 6" | **Health:** 10 | **Save:** 4+ | **Control:** 5
**Keywords:** MONSTER, DESTRUCTION, GLOOMSPITE GITZ, TROGGOTH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Colossal Boulder Club | Melee | - | 4 | 4+ | 2+ | 2 | D3+3 | - |

**Abilities:**

#### Wade and Smash (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Doom Diver Catapult
**Points:** 160 | **Move:** 5" | **Health:** 12 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, WAR MACHINE, GITMOB

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Slicers and Krag-smasha's Paws | Melee | - | 6 | 4+ | 3+ | - | 1 | Companion |
| Doom Diver | Ranged | 24" | 4 | 4+ | 3+ | 3 | 3 | - |
| Catapult Crew Tools | Melee | - | 2 | 5+ | 6+ | - | 1 | - |

**Abilities:**

#### Shoddy Wing-like Gizmos (Activated)
...
### Droggz da Sunchompa
**Points:** 150 | **Move:** 12" | **Health:** 7 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, UNIQUE, HERO, CAVALRY, GITMOB

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Jaggedsnarl's Jaws | Melee | - | 4 | 3+ | 3+ | 1 | 2 | Companion |
| Da Metal Toof | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |
...
#### Time ta Scarper (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Fight ability for a unit wholly within 9" of this unit
...
### Fellwater Troggoths
**Points:** 160 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, TROGGOTH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Noxious Vomit | Ranged | 6" | D3 | 2+ | 3+ | 2 | 1 | Shoot in Combat |
| Spiked Club | Melee | - | 4 | 4+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Noxious Vomit (Passive)
...
**Points:** 140 | **Move:** 12" | **Health:** 9 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, HERO, WIZARD (1), WAR MACHINE, GITMOB

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Snarlfangs' Frothing Jaws | Melee | - | 6 | 4+ | 3+ | - | 2 | Companion |
| Wheela Slicers | Melee | - | 3 | 4+ | 4+ | - | 1 | - |
...
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spore Squig’s Vicious Teeth | Melee | - | 2 | 4+ | 3+ | 1 | 1 | Companion |
| Moon-sickle | Melee | - | 3 | 4+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Deffcap Mushroom (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
...
### Gobbapalooza
**Points:** 150 | **Move:** 5" | **Health:** 3 | **Save:** 6+ | **Control:** 2
**Keywords:** Moonclan Infantry, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Staff, Stikka or Jaggedy Blade | Melee | - | 1 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Hallucinogenic Fungus Brews (Passive)
...
#### Gobbapalooza Know-wotz (Activated)
...
**Keywords:** Moonclan Infantry, INFANTRY, UNIQUE, Legends, CHAMPION, DESTRUCTION, MOONCLAN, GLOOMSPITE GITZ

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Moon-slicer | Melee | - | 5 | 4+ | 4+ | 1 | D3 | - |
| Looncourt Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Looncourt Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Squigapult | Ranged | 15" | 1 | 4+ | 3+ | 1 | D3+2 | Crit (Auto-wound) |
| Looncourt Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Looncourt Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Looncourt Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Looncourt Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
...
#### The Looncourt's Quest (Activated)
- **Timing:** Deployment Phase
...
**Points:** 580 | **Move:** 10" | **Health:** 18 | **Save:** 4+ | **Control:** 15
**Keywords:** HERO, UNIQUE, MONSTER, WARMASTER, WARD (5+), DESTRUCTION, GLOOMSPITE GITZ

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| The Dread Mace | Melee | - | 6 | 3+ | 2+ | 3 | 4 | - |
| Tuskbreaker | Melee | - | 3 | 4+ | 2+ | 2 | D3 | Crit (2 Hits) |
| Hooves of Wrack and Ruin | Melee | - | 6 | 3+ | 2+ | 1 | 2 | - |
...
#### Rampaging Destruction (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
...
#### The Shield Inviolate (Activated)
- **Timing:** Reaction: Opponent declared a Spell ability
...
### Loonboss
**Points:** 80 | **Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN, WARD (6+)
...
**Points:** 80 | **Move:** D6+6" | **Health:** 6 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, MOONCLAN, SQUIG, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Massive Fang-filled Gob | Melee | - | 4 | 4+ | 3+ | 2 | D3 | Companion |
| Moon-cutta or Loonboss Stabba | Melee | - | 5 | 4+ | 4+ | 1 | 2 | Charge (+1 Damage) |

**Abilities:**

#### Let's Get Bouncin'! (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit
- **Effect:** Pick a friendly non-Hero Moonclan Cavalry unit that has not used a Fight ability this turn and is within this unit’s combat range to be the target. The target
can be picked to use a Fight ability immediately after the Fight ability used by this unit has been resolved.

---

### Loonboss on Mangler Squigs
**Points:** 150 | **Move:** D6+8" | **Health:** 14 | **Save:** 5+ | **Control:** 5
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, MOONCLAN, MONSTER, FLY, SQUIG

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Balls and Chains | Melee | - | 4 | 4+ | 4+ | - | D3 | Companion |
| Huge Fang-filled Gobs | Melee | - | 4 | 4+ | 2+ | 1 | D6 | Companion |
| Moon-slicer | Melee | - | 5 | 4+ | 4+ | 1 | D3 | - |
...
- **Effect:** Add 1 to hit rolls for the targets’ **Fang-filled Gobs**, **Massive Fang-filled Gobs** and **Huge Fang-filled Gobs** for the rest of the turn.
...
**Points:** 120 | **Move:** 5" | **Health:** 6 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, Legends, INFANTRY, GLOOMSPITE GITZ, SQUIG, MOONCLAN, DESTRUCTION

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Moon-prodder | Melee | - | 5 | 4+ | 4+ | 1 | 2 | - |
| Massive Fang-filled Gob | Melee | - | 4 | 4+ | 3+ | 2 | D3 | Companion |

**Abilities:**

#### Gobbled Up (Activated)
- **Timing:** End of Any Turn
...
### Loonsmasha Fanatics
**Points:** 110 | **Move:** 2D6" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ball and Chain | Melee | - | D6 | 4+ | 3+ | 2 | D3 | - |

**Abilities:**

#### Whirling Death (Passive)
- **Effect:** This unit has Strike-first.

#### Hidden Loons (Activated)
- **Timing:** Deployment Phase
...
#### Release the Fanatics! (Activated)
...
### Loonsmasha Fanatics (Scourge of Ghyran)
**Points:** 110 | **Move:** 2D6" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ball and Chain | Melee | - | 3 | 4+ | 3+ | 2 | D3 | - |

**Abilities:**

#### Lost in the Horde (Activated)
- **Timing:** Deployment Phase
- **Declare:** Pick this unit if it has not been deployed.
- **Effect:** Set up this unit in reserve **lost in the horde**. This unit has now been deployed.
- **Keywords:** Deploy

#### Whirling Destruction (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
- **Declare:** Pick this unit if it is **lost in the horde**.
...
### Madcap Shaman
**Points:** 80 | **Move:** 5" | **Health:** 4 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, Legends, INFANTRY, GLOOMSPITE GITZ, MOONCLAN, DESTRUCTION, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Moon Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Madcap Mushroom (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
- **Effect:** For the rest of the turn:
...
### Mangler Squigs
**Points:** 130 | **Move:** D6+8" | **Health:** 14 | **Save:** 5+ | **Control:** 5
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, MOONCLAN, MONSTER, FLY, SQUIG
...
### Mollog
**Points:** 210 | **Move:** 6" | **Health:** 8 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, Legends, INFANTRY, GLOOMSPITE GITZ, DESTRUCTION, TROGGOTH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Jabbertoad | Ranged | 8" | 1 | 4+ | 4+ | - | D3 | Shoot in Combat |
| Puff-fungus Club | Melee | - | 4 | 4+ | 2+ | 2 | 3 | - |
...
#### Unleash the Critters! (Activated)
- **Timing:** Any Combat Phase
- **Effect:** Pick 1 of the following effects:
**Spore Cloud:** Remove this unit’s **Spiteshroom**. For the rest of the turn, subtract 1 from hit rolls for attacks made by enemy units while they
...
### Moonclan Shootas
**Points:** 120 | **Move:** 5" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN, MUSICIAN (1/20), STANDARD BEARER (1/20)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Moonclan Bow | Ranged | 18" | 2 | 4+ | 5+ | - | 1 | - |
| Moonclan Bow | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
...
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bat Squigs | Ranged | 12" | 3 | 4+ | 4+ | - | D3 | Crit (Auto-wound) |
| Moon-sickle and Basha | Melee | - | 5 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Secret Tunnels (Activated)
- **Timing:** Deployment Phase
- **Declare:** Pick this unit if it has not been deployed.
- **Effect:** Set up this unit in reserve **in a secret tunnel**. It has now been deployed.
- **Keywords:** Deploy

#### 'Neh Neh Na-neh Neh! Can't Catch Me!" (Activated)
...
#### Emerge from the Depths (Activated)
- **Timing:** Your Movement Phase
...
### Rippa's Snarlfangs
**Points:** 100 | **Move:** 12" | **Health:** 3 | **Save:** 5+ | **Control:** 1
**Keywords:** UNIQUE, Legends, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, GITMOB, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Snarlfang’s Slavering Jaws | Melee | - | 2 | 4+ | 3+ | - | 2 | Companion |
| Wolfgit Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Charge (+1 Damage) |
| Snarlfang’s Slavering Jaws | Melee | - | 2 | 4+ | 3+ | - | 2 | Companion |
| Wolfgit Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Charge (+1 Damage) |
| Snarlfang’s Slavering Jaws | Melee | - | 2 | 4+ | 3+ | - | 2 | Companion |
| Wolfgit Weapons | Melee | - | 3 | 4+ | 5+ | - | 1 | Charge (+1 Damage) |
...
#### Marking Your Territory (Passive)

---

### Rockgut Troggoths
**Points:** 180 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, TROGGOTH, WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Throwin’ Boulders | Ranged | 10" | 1 | 5+ | 2+ | 2 | D3 | - |
| Stone Maul or Craggy Hands | Melee | - | 2 | 4+ | 2+ | 2 | 3 | - |
...
**Points:** 160 | **Move:** 10" | **Health:** 7 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, Legends, GLOOMSPITE GITZ, DESTRUCTION, CAVALRY, SPIDERFANG

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Envenomed Spear | Melee | - | 5 | 4+ | 4+ | 1 | 2 | - |
| Gigantic Fangs | Melee | - | 4 | 4+ | 3+ | 1 | 2 | Crit (Mortal), Companion |

**Abilities:**

#### Scuttle Away! (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
**Points:** 190 | **Move:** 10" | **Health:** 13 | **Save:** 4+ | **Control:** 5
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, SPIDERFANG, MONSTER, ARACHNAROK
...
**Points:** 200 | **Move:** 5" | **Health:** 6 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, UNIQUE, WARMASTER, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, WIZARD (2), WARD (4+), MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Da Moon Onna Stikk | Melee | - | 4 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Fangz of da Bad Moon (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
#### The Loonking's Entreaty (Activated)
- **Timing:** Once Per Battle (Army), Reaction: You declared the ‘The Faces of the Bad Moon’ ability
...
### Snarlboss
**Points:** 100 | **Move:** 12" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, HERO, GITMOB, CAVALRY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Snarlfang's Slavering Jaws | Melee | - | 2 | 4+ | 3+ | - | 2 | Companion |
| Boss Loppa | Melee | - | 5 | 4+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Vicious Snarls and Great Howls (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 140 | **Move:** 12" | **Health:** 9 | **Save:** 4+ | **Control:** 2
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, HERO, WAR MACHINE, GITMOB

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Snarlfangs' Frothing Jaws | Melee | - | 6 | 4+ | 3+ | - | 2 | Companion |
| Chain Basha | Melee | - | 5 | 4+ | 3+ | 1 | 2 | Crit (Auto-wound) |
| Wheela Slicers | Melee | - | 3 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Frazzlegit's Flame Stream (Activated)
- **Timing:** Your Movement Phase
...
#### Keepin' Up Wiv da Boss (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit
...
#### Da Glare of Frazzlegit (Activated)
...
### Snarlfang Riders
**Points:** 110 | **Move:** 12" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** CAVALRY, CHAMPION, MUSICIAN (1/5), STANDARD BEARER (1/5), DESTRUCTION, GLOOMSPITE GITZ, GITMOB

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grot Bow | Ranged | 15" | 2 | 4+ | 5+ | - | 1 | - |
| Snarlfang’s Slavering Jaws | Melee | - | 2 | 4+ | 3+ | - | 2 | Companion |
| Stabbin’ Stikka | Melee | - | 2 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Can't Catch Us! (Activated)
- **Timing:** Once Per Turn (Army), Enemy Movement Phase
- **Effect:** If this unit is not in combat, this unit can move D6". It cannot end that move in combat.

---

### Snarlpack Cavalry
**Points:** 110 | **Move:** 12" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** CAVALRY, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, GITMOB

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Giant Snarlfang’s Jaws | Melee | - | 3 | 4+ | 3+ | - | 2 | Companion |
| Pointy Skewas | Melee | - | 4 | 4+ | 5+ | - | 1 | Charge (+1 Damage) |

**Abilities:**

#### Markin' Territory (Passive)
- **Effect:** If this unit charged this turn, add 5 to its control score for the rest of the turn.

#### Frazzleburned Scrap (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Effect:** If this unit charged this turn, it has Strike-first for the rest of the turn.

---

### Sneaky Snufflers
**Points:** 90 | **Move:** 5" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN, WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Loonfungus Sickle | Melee | - | 3 | 4+ | 4+ | - | 1 | - |
| Snufflesquig’s Gnashers | Melee | - | 2 | 4+ | 4+ | - | 1 | Companion |

**Abilities:**

#### Looncap Mushrooms (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** If this unit is not in combat, pick a friendly Moonclan unit wholly within 12" of it to be the target.
...
### Spider Riders
**Points:** 110 | **Move:** 10" | **Health:** 2 | **Save:** 5+ | **Control:** 2
**Keywords:** CAVALRY, CHAMPION, MUSICIAN (1/5), STANDARD BEARER (1/5), DESTRUCTION, GLOOMSPITE GITZ, SPIDERFANG

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spider-bow | Ranged | 18" | 2 | 4+ | 5+ | - | 1 | - |
| Spider Fangs | Melee | - | 2 | 4+ | 4+ | - | 1 | Crit (Mortal), Companion |
| Crooked Spear | Melee | - | 2 | 4+ | 5+ | - | 1 | - |

---

### Sporesplatta Fanatics
**Points:** 90 | **Move:** 2D6" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spore-ball and Chain | Melee | - | D3 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Puffshroom Frenzy (Passive)
- **Effect:** Add 1 to the Attacks characteristic of melee weapons used by other friendly Moonclan units while they are wholly within 12" of this unit. Subtract 1 from the Attacks characteristic of melee weapons used by enemy units while they are in combat with this unit.

#### A Prod in the Right Direction (Activated)
- **Timing:** Deployment Phase
...
**Points:** 80 | **Move:** 2D6" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spore-ball and Chain | Melee | - | 2 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Choking Spore-clouds (Passive)
- **Effect:** Subtract 1 from the Attacks characteristic of weapons used by enemy units while they are in combat with this unit.

#### Spinning Loons (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Effect:** If this unit was not set up this phase, this unit can move 2D6". It can move through the combat ranges of enemy units and can finish that move in combat.

---

### Squig Herd
**Points:** 100 | **Move:** D6+3" | **Health:** 1 | **Save:** 6+ | **Control:** 1
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, MOONCLAN, BEAST, SQUIG

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fang-filled Gob | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
| Squig Prodder | Melee | - | 2 | 5+ | 5+ | - | 1 | - |

**Abilities:**

#### Squigs Gone Wild (Passive)
...
### Squig Hoppers
**Points:** 160 | **Move:** D6+8" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** CAVALRY, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, SQUIG, MOONCLAN, FLY
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fang-filled Gob | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
| Slitta | Melee | - | 2 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Boing! Boing! Boing! (Activated)
- **Timing:** Any Movement Phase
...
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN, SQUIG

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fang-filled Gob | Melee | - | 2 | 4+ | 3+ | 1 | 1 | Companion |
| Squig-krook | Melee | - | 5 | 4+ | 4+ | - | 2 | - |

**Abilities:**

#### Feedin' Time (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** Pick a friendly Squig unit
...
**Points:** 360 | **Move:** 6" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, UNIQUE, MONSTER, WARMASTER, DESTRUCTION, GLOOMSPITE GITZ, TROGGOTH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ironshell Club | Melee | - | 4 | 3+ | 2+ | 3 | 4 | - |
| Mighty Antlers | Melee | - | 2 | 4+ | 2+ | 2 | D3+3 | - |
...
#### Crushing Grip (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit within 1" of this unit to be the target.
- **Effect:** Roll a dice. If the roll equals or exceeds the target’s Health characteristic, 1 model in the target unit is slain.
- **Keywords:** Rampage

#### Malfunctioning Leystone (Activated)
- **Timing:** Your Hero Phase
...
### Webspinner Shaman
**Points:** 100 | **Move:** 6" | **Health:** 4 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, WARD (6+), SPIDERFANG, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spider God Staff | Melee | - | 3 | 4+ | 5+ | - | D3 | Crit (Mortal) |

**Abilities:**

#### Web Slingshot (Activated)
- **Timing:** Your Hero Phase
...
**Points:** 250 | **Move:** 10" | **Health:** 16 | **Save:** 4+ | **Control:** 5
**Keywords:** DESTRUCTION, GLOOMSPITE GITZ, SPIDERFANG, MONSTER, HERO, WIZARD (1), ARACHNAROK
...
### Wolfgit Retinue
**Points:** 70 | **Move:** 12" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** CAVALRY, DESTRUCTION, GLOOMSPITE GITZ, GITMOB
...
#### I Got Dis, Boss! (Passive)
- **Effect:** While a friendly **Snarlboss** is within this unit's combat range, both this unit and that **Snarlboss** have Ward (5+).

---

### Zarbag's Gitz
**Points:** 130 | **Move:** 5" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** Moonclan Infantry, UNIQUE, Legends, CHAMPION, DESTRUCTION, GLOOMSPITE GITZ, INFANTRY, MOONCLAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Git Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Git Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Git Weapons | Melee | - | 2 | 4+ | 5+ | - | 1 | - |
| Git Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Git Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Git Weapons | Melee | - | 2 | 4+ | 5+ | 1 | 1 | - |
| Moonclan Bow | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
...
| Wolfgit Retinue | 70 |
| Loonboss | 80 |
| Loonboss on Giant Cave Squig | 80 |
| Madcap Shaman | 80 |
| Sporesplatta Fanatics (Scourge of Ghyran) | 80 |
...
| Frazzlegit Shaman on War-Wheela | 140 |
| Snarlboss on War-Wheela | 140 |
| Aleguzzler Gargant | 150 |
| Droggz da Sunchompa | 150 |
| Gobbapalooza | 150 |
| Loonboss on Mangler Squigs | 150 |
