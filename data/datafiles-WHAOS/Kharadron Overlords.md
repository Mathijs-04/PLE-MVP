...
#### Spell Breaker (Passive)
- **Effect:** This unit can use Unbind abilities as if it has Wizard (1).

#### Backup Thruster-endrins (Passive)
- **Effect:** This unit cannot be picked to be the target of enemy Rampage abilities.

#### Figurehead Battering Ram (Activated)
- **Timing:** Any Charge Phase
- **Declare:** If this unit charged this phase, pick an enemy unit within 1" of it to be the target, then roll a dice.
- **Effect:** On a 3+, inflict an amount of mortal damage on the target equal to the roll.

#### Custom Aetherburner (Activated)
- **Timing:** End of Your Turn
- **Effect:** This unit can move a distance up to its Move characteristic. It can pass through the combat ranges of enemy units that were in combat with it at the start of the move, but not those of other enemy units. It cannot end the move in combat.

#### Solitary Pioneer (Passive)
- **Effect:** While this unit is contesting an objective that is not being contested by any other friendly units, add 8 to this unit's control score.

#### Old Skybeard (Passive)
- **Effect:** Add 2" to the Move characteristic of friendly Skyvessels while they are within 3" of this unit.

#### Loyalty Bought (Passive)
- **Effect:** While this unit is within the combat range of a friendly **Arkanaut Company** unit:
• This unit has Ward (4+).
• Each time you make a successful ward roll for this unit, allocate 1 damage point to a friendly **Arkanaut Company** unit within its combat range after the damage sequence has been resolved (ward rolls cannot be made for those damage points).

#### Master of Ballistics (Activated)
- **Timing:** Once Per Battle, Reaction: You declared a Shoot ability for a unit within 3" of this unit
- **Effect:** You can re-roll hit rolls of 1 for the attacks made as part of that Shoot ability.

#### Slow and Steady (Passive)
- **Effect:** While this unit is in combat with an enemy unit that is also in combat with another friendly unit, this unit has Strike-last.

#### Bad Luck Charm (Passive)
- **Effect:** This unit cannot be picked to be a target of the 'Transport Skyfarers' ability.

#### Piratical Tendencies (Passive)
- **Effect:** While this unit is in combat with an enemy unit that has an enhancement, all attacks made by this unit must target that enemy unit.

#### Glass Eye (Passive)
- **Effect:** Subtract 1 from hit rolls for this unit's shooting attacks.

#### Hasty Repairist (Activated)
...
#### Spell-bottler (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Declare:** Pick an enemy Manifestation in combat with this unit to be the target.
- **Effect:** Roll 3D6. If the roll is equal to or highter than the target's banishment value, it is automatically destroyed and, for the rest of the battle, your opponent and their units cannot use abilities that would summon that Manifestation

#### Nullstone-studded Armour (Passive)
- **Effect:** Enemy Manifestations have Strike-last while they are in combat with this unit.

#### A Company Duardin (Activated)
...
- **Effect:** Add 1 to wound rolls for shooting attacks made by friendly Skyfarer units that target that enemy unit for the rest of the turn.

### Paths

#### Drillbill-feather Trigger (Passive)
- **Effect:** This unit's ranged weapons have **Crit (2 Hits)**.

#### Custom Ammunition (Passive)
- **Effect:** Add 1 to wound rolls for this unit's shooting attacks

#### Learned in the Ways of the Wind (Passive)
- **Effect:** Each time an enemy unit within 9" of this unit uses a Move ability, the effects of the 'Fly' ability do not apply to that unit.

#### Nullstone Amulet (Passive)
- **Effect:** This unit can use Unbind and Banish abilities as if it had Wizard (1).

#### Phosphoric Flares (Activated)
- **Timing:** Any Hero Phase
- **Declare:** Pick a visible enemy unit within 12" of this unit to be the target.
- **Effect:** Roll a dice. If the result is equal to or less than the number of models in the target, pick 1 of the following effects:
• For the rest of the turn, subtract 1 from hit rolls for shooting attacks made by the target.
• For the rest of the turn, re-roll hit rolls of 1 for this unit's shooting attacks that target that enemy unit.

#### Codebreaker (Passive)
- **Effect:** If an enemy unit within 12" of this unit uses the 'Rally' command, your opponent must make 3 fewer rally rolls of D6.
If a friendly unit wholly within 12" of this unit uses the 'Rally' command, you can make 3 additional rally rolls of D6.

#### Reserve Crew, Disembark (Activated)
- **Timing:** Once Per Battle, Any Movement Phase
- **Declare:** Pick a friendly non-Hero non-Skyvessel unit that has been destroyed to be the target.
- **Effect:** Set up a replacement unit identical to the target wholly within 12" of this unit and more than 3" from all enemy units.

#### Emergency Blast-vent (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Effect:** For the rest of the turn, enemy units have Strike-last while they are in combat with this unit.

#### Hail of Aethershot (Activated)
- **Timing:** Any Shooting Phase
- **Effect:** Roll a dice. On a 4+, this unit can use Shoot abilities this turn even if it used a Retreat ability in the same turn.

#### Skyfarer's Grit (Passive)
- **Effect:** This unit has Ward (6+) against shooting attacks while it is contesting an objective.

#### Stern and Resolute (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Subtract D6 from the control score of the target for the rest of the turn.

#### Cloudwalkers (Passive)
- **Effect:** Add 1 to charge rolls for this unit.

#### Sappers (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
- **Declare:** Pick an enemy faction terrain feature or Manifestation within this unit's combat range to be the target.
- **Effect:** Roll a dice. On a 3+, inflict an amount of mortal damage on the target equal to the roll.

#### Deal-sealer Rounds (Passive)
- **Effect:** This unit's ranged weapons have **Crit (Auto-wound)**.

#### Aethermatic Augments (Passive)
- **Effect:** Ignore positive modifiers to save rolls for enemy units while they are in combat with this unit.

#### Chamonite-edged Blades (Passive)
- **Effect:** Add 1 to the Damage characteristic of this unit's melee weapons that have an unmodified Attacks characteristic of 1 or 2.
Add 1 to wound rolls for attacks made with this unit's melee weapons that have an unmodified Attacks characteristic of 3 or more.

#### Powerful Reversing Propellers (Passive)
- **Effect:** This unit can use Shoot abilities even if it used a Retreat ability in the same turn.

#### Reliable Endrins (Passive)
- **Effect:** You can re-roll run rolls and charge rolls for this unit.

#### Spikehead Rivets (Activated)
- **Timing:** End of Any Turn
- **Effect:** Inflict 1 mortal damage on each unit in combat with this unit.

#### Skyhorn Siren (Activated)
- **Timing:** Once Per Battle, End of Any Turn
- **Declare:** Make a **skyhorn blast** roll of 4D6. Each enemy unit within **X**" of this unit is a target, where **X** is the **skyhorn blast roll**.
- **Effect:** Roll a dice for each target. Subtract the roll from the target's control score for the rest of the turn.

#### Battle-hardened Endrineers (Activated)
- **Timing:** End of Enemy Turn
- **Effect:** Roll a dice. If the roll is equal to or less than the current battle round number, **Heal (X)** this unit, where **X** is the current battle round number.

#### Exhaust Venting (Activated)
- **Timing:** Once Per Battle, Reaction: Opponent declared a Shoot ability.
- **Effect:** If the unmodified hit roll for an attack made as part of that Shoot ability is 1-4, the attack fails and the attack sequence ends.

#### Nullstone Cloud-seeding (Passive)
- **Effect:** Spells cast by Wizards within 12" of this unit are miscast if any two dice in the unmodified casting roll show the same result.

#### Gattlesson's Collossal Detonation Ammo (Activated)
- **Timing:** Once Per Battle, Start of Any Battle Round
- **Declare:** Pick 1 of this unit's ranged weapons.
- **Effect:** For the rest of the battle round:
• Double the Attacks characteristic of that weapon.
• For each unmodified hit roll of 1 for a shooting attack made by this unit, allocate 1 damage point to this unit after the Shoot ability has been resolved (ward rolls cannot be made for those damage points).

### Battle Traits

#### Skyvessel Cover (Passive)
- **Effect:** Subtract 1 from hit rolls for attacks that target friendly Kharadron Overlords Infantry units that have not charged in the same turn while they are wholly within 6" of a friendly **Arkanaut Ironclad** or **Arkanaut Frigate** that has not charged in the same turn.

#### Flying High (Activated)
...
#### Descend from the Clouds (Activated)
...
#### Transport Skyfarers (Activated)
- **Timing:** Your Movement Phase, Reaction: You declared a non-Charge Move ability for a friendly Skyvessel
- **Declare:** The Skyvessel using that Move ability
...
**Designer's Note:** *This Great Endrinwork is given to the unit during the deployment phase not during army composition.*

### Artefacts of Power

#### Celestium Burst Grenade (Activated)
- **Timing:** Once Per Battle, Your Shooting Phase
- **Declare:** Pick a visible enemy unit within 12" of this unit to be the target.
- **Effect:** Ward rolls cannot be made for the target for the rest of the turn.

#### Voidstone Orb (Activated)
...
#### Blazebeard and Sons Bamboozling Flakgun (Activated)
- **Timing:** Once Per Turn, Reaction: Opponent declared a Charge ability for a unit within 12" of this unit.
...
#### Nullstone Galvanisation (Activated)
- **Timing:** End of Any Turn
...
#### Tracer-Fire Rounds (Activated)
- **Timing:** Your Shooting Phase, Reaction: You declared a Shoot ability for this unit.
- **Effect:** If all of the attacks target the same enemy unit, ignore negative modifiers to hit rolls for those attacks.

#### Voidstone Repulser Vents (Activated)
- **Timing:** Reaction: A friendly unit within 12" of this unit was picked to be the target of an enemy Spell ability.
...
#### Zonbarcorp 'Dealbreaker' Battle Ram (Activated)
- **Timing:** Any Charge Phase
...
#### Blazebeard and Sons Ejector Pod (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
...
#### Transport Skyfarers (Activated)
- **Timing:** Reaction: You declared a non-Charge Move ability for a friendly Skyvessel
...
#### Aetheric Nullifier (Activated)
- **Timing:** Opponent declared a Shoot or Fight ability for a Manifestation within 9" of the bearer
...
#### Entrenchment Expert (Activated)
- **Timing:** Reaction: You declared the ‘All-Out Defence’ command for a friendly unit wholly within 12" of this Hero
...
#### Settling Accounts (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** You can only use this ability if you have not use any Code abilities this turn and if a friendly Auto-Endrin was destroyed this turn by an enemy unit.
...
#### Aggressive Acquisitions (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** You can only use this ability if you have not use any Code abilities this turn and if there is a friendly Pioneer unit in each large quarter of the battlefield. Each of those units must b e more than 6" from all other large quarters of the battlefield and not in combat.
...
#### Secure Investments (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** You can only use this ability if you have not use any Code abilities this turn and if any enemy units that were within 3" of your **Zontari Endrin Dock** this turn were destroyed this turn.
...
#### Market Dominance (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** You can only use this ability if you have not use any Code abilities this turn and if you control every objective that is not wholly within enemy territory.
...
#### Hostile Takeover (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** You can only use this ability if you have not use any Code abilities this turn and if an enemy Hero was destroyed by shooting attacks made by a friendly Pioneer unit this turn.
...
#### Copper Fingers (Activated)
- **Timing:** Once Per Battle, Reaction: You declared the 'Endrinworks Outpost' ability for a Zontari Endrin Dock
- **Effect:** If this unit is wholly within 9" of that **Zontari Endrin Dock**, instead of resolving the effect of that 'Endrinworks Outpost' ability, set up a replacement Auto-Endrin on the battlefield, wholly within 6" of that **Zontari Endrin Dock** and more than 3" from all enemy units.
...
#### Cutting-Edge Endrinpacks (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
- **Declare:** Pick up to 2 friendly Magnate's Crew Infantry units that are wholly within 9" of a friendly Magnate's Crew Skyvessel to be the targets.
- **Effect:** For the rest of the turn, each target can use Charge abilities even if it used a Run ability in the same turn.

#### Loyalty to the Magnate (Passive)
...
#### Invictunite-lined Hull (Activated)
- **Timing:** Once Per Battle (Army), Enemy Hero Phase
...
#### Aerodynamism (Passive)
- **Effect:** If the unit moved this turn, subtract 1 from hit rolls for attacks that target this unit for the rest of the turn.

#### Guns for All Occasions (Activated)
- **Timing:** End of Your Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
### Aether-Khemist
**Points:** 110 | **Move:** 4" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heavy Instruments | Melee | - | 3 | 4+ | 4+ | - | D3 | - |
| Atmospheric Anatomiser | Ranged | 8" | 3D6 | 4+ | 4+ | 2 | 1 | Shoot in Combat |

**Abilities:**

#### Aetheric Augmentation (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ranging Pistol | Ranged | 10" | 2 | 3+ | 3+ | 1 | 1 | Shoot in Combat |
| Zephyrscope | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Read the Winds (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
### Arkanaut Admiral
**Points:** 130 | **Move:** 4" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Masterwork Volley Pistol | Ranged | 10" | 3 | 3+ | 3+ | 1 | 2 | Shoot in Combat |
| Skalfhammer | Melee | - | 4 | 3+ | 3+ | 1 | 3 | - |

**Abilities:**

#### The Admiral's Flagship (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
#### 'Bring Every Gun to Bear!' (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
### Arkanaut Company
**Points:** 80 | **Move:** 4" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Skypike | Melee | - | 2 | 3+ | 3+ | 1 | 2 | Charge (+1 Damage) |
| Privateer Pistol | Ranged | 10" | 2 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Arkanaut Hand Weapon | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Privateer Heavy Weapon | Ranged | 15" | 2 | 4+ | 3+ | 1 | 2 | - |

**Abilities:**

#### Grizzled Buccaneers (Activated)
...
### Arkanaut Frigate
**Points:** 300 | **Move:** 10" | **Health:** 14 | **Save:** 2+ | **Control:** 5
**Keywords:** ORDER, FLY, KHARADRON OVERLORDS, DUARDIN, WAR MACHINE, SKYVESSEL

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Heavy Sky Ordnance | Ranged | 24" | 4 | 4+ | 2+ | 2 | 3 | - |
| Boarding Weapons | Melee | - | 8 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Assault Boat (Activated)
- **Timing:** Your Charge Phase
- **Declare:** This unit cannot use this ability if it is in combat or has used a Run or Retreat ability this turn. Pick a number of units up to its Transport Capacity that are wholly within 6" of it, are not in combat and that have not charged this turn to be the targets. Then, make a charge roll of 2D6.
...
• Remove the targets from the battlefield and set them up again wholly within this unit’s combat range. The targets can be set up in combat.
...
### Arkanaut Ironclad
**Points:** 450 | **Move:** 10" | **Health:** 18 | **Save:** 2+ | **Control:** 5
**Keywords:** ORDER, FLY, KHARADRON OVERLORDS, DUARDIN, WAR MACHINE, SKYVESSEL

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Great Sky Ordnance | Ranged | 24" | 6 | 4+ | 2+ | 2 | 3 | - |
| Aethershock Torpedoes | Ranged | 18" | 6 | 4+ | 3+ | 1 | 2 | - |
| Boarding Weapons | Melee | - | 8 | 4+ | 4+ | - | 1 | - |
...
**Points:** 260 | **Move:** 12" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, WARMASTER, UNIQUE, ORDER, INFANTRY, FLY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grungsson’s Boast | Ranged | 18" | 1 | 3+ | 2+ | 2 | D3+3 | - |
| The Magnate’s Charter | Ranged | 12" | 6 | 3+ | 3+ | 1 | 2 | Shoot in Combat |
| Brokk’s Aethermatic Saw | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Crit (2 Hits) |

**Abilities:**

#### Command the Fleet (Activated)
- **Timing:** Once Per Battle, Your Movement Phase
...
#### First Rule of Grungsson (Activated)
...
#### Moustache-mounted Aetherblasters (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Battletome | Melee | - | 3 | 4+ | 4+ | - | D3 | - |
| Aethershot Pistol | Ranged | 10" | 2 | 3+ | 3+ | 1 | 1 | Shoot in Combat |

**Abilities:**

#### Advisory Role (Activated)
...
### Codewright (Scourge of Ghyran)
**Points:** 100 | **Move:** 4" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER
...
#### I'm Watching You (Activated)
- **Timing:** Any Hero Phase
- **Effect:** Give this unit D3 **vexed points**.

#### Alright, Listen Up (Activated)
- **Timing:** Once Per Turn (Army), Any Hero Phase
- **Declare:** If this unit is wholly within 12" of a friendly non-Hero Kharadron Overlords unit, pick a visible enemy unit wholly within 18" of this unit to be the target. Then, choose to spend either 3 or 6 **vexed points**.
...
### Drekki Flynt
**Points:** 120 | **Move:** 4" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, UNIQUE, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| The Aethermatic Equaliser Mk. III | Ranged | 10" | 2D6 | 3+ | 3+ | 1 | 2 | Shoot in Combat |
| Grunnsson’s Axe | Melee | - | 4 | 3+ | 3+ | 1 | 3 | Anti-Monster (+1 Rend) |

**Abilities:**

#### Captain of the Aelsling (Activated)
- **Timing:** Deployment Phase
...
#### She Can Handle It! (Passive)
- **Effect:** You can re-roll run rolls and charge rolls for the Aelsling while it is wholly within 12" of this unit.

---

### Endrinmaster with Dirigible Suit
**Points:** 150 | **Move:** 12" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, FLY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Aethercannon | Ranged | 18" | 1 | 3+ | 3+ | 2 | 3 | - |
| Dirigible Suit Weapon Battery | Ranged | 12" | 6 | 3+ | 3+ | 1 | 1 | Shoot in Combat |
| Upgraded Aethermatic Saw | Melee | - | 4 | 3+ | 3+ | 2 | 2 | - |

**Abilities:**

#### Combat Engineers (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 150 | **Move:** 4" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Aethermight Hammer | Melee | - | 3 | 4+ | 2+ | 2 | 3 | - |

**Abilities:**

#### 'Aye Aye, Captain!' (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
### Endrinriggers
**Points:** 110 | **Move:** 12" | **Health:** 2 | **Save:** 3+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Skyrigger Heavy Weapon | Ranged | 15" | 1 | 4+ | 3+ | 1 | D3 | Anti-Monster (+1 Rend) |
| Gun Butt | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Rapid-fire Rivet Gun | Ranged | 10" | 3 | 3+ | 4+ | 1 | 1 | Shoot in Combat |
| Aethermatic Saw | Melee | - | 3 | 4+ | 3+ | 1 | 2 | Anti-charge (+1 Rend) |
| Aethermatic Volley Gun | Ranged | 15" | 2D6 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Gun Butt | Melee | - | 1 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Emergency Field Repairs (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick a friendly Skyvessel or **Zontari Endrin Dock** within this unit’s combat range to be the target.
...
### Grundstok Gunhauler
**Points:** 150 | **Move:** 14" | **Health:** 10 | **Save:** 2+ | **Control:** 2
**Keywords:** ORDER, FLY, KHARADRON OVERLORDS, DUARDIN, WAR MACHINE, SKYVESSEL

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sky Ordnance | Ranged | 15" | 3 | 4+ | 3+ | 2 | 3 | - |
| Boarding Weapons | Melee | - | 4 | 4+ | 4+ | - | 1 | - |
...
#### Light Bomb Racks (Activated)
- **Timing:** Your Movement Phase
- **Declare:** Pick an enemy unit that does not have Fly and that this unit passed across this phase to be the target.
- **Effect:** Roll 4 dice. For each 4+, inflict 1 mortal damage on the target.

#### Transport Capacity (Passive)
- **Effect:** This unit can transport 1 friendly Kharadron Overlords Infantry units with a model count of up to 5 (see Battle Traits).

#### Aethershot Overwatch (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit that charged this turn and is in combat with this unit to be the target.
- **Effect:** Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll.
...
### Grundstok Gunhauler (Scourge of Ghyran)
**Points:** 170 | **Move:** 14" | **Health:** 10 | **Save:** 2+ | **Control:** 2
**Keywords:** ORDER, FLY, KHARADRON OVERLORDS, DUARDIN, WAR MACHINE, SKYVESSEL

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sky Ordinance | Ranged | 15" | 3 | 4+ | 3+ | 2 | 3 | - |
| Bombs and Boarding Weapons | Melee | - | 4 | 4+ | 4+ | 1 | D3 | - |
...
**Keywords:** CHAMPION, INFANTRY, ORDER, KHARADRON OVERLORDS, DUARDIN, SKYFARER, STANDARD BEARER (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Grundstok Mortar or Aethercannon | Ranged | 18" | 2 | 4+ | 3+ | 1 | 2 | - |
| Aethershot Rifle | Ranged | 18" | 2 | 3+ | 4+ | 1 | 1 | - |
| Gun Butt | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Aetheric Fumigator or Decksweeper | Ranged | 10" | 5 | 3+ | 4+ | - | 1 | Shoot in Combat |

**Abilities:**

#### Specialist Grundstok Ammunition (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase, Reaction: You declared a Shoot ability for this unit
...
### Null-Khemist
**Points:** 120 | **Move:** 12" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Prospecting Clamp | Melee | - | 4 | 3+ | 4+ | 1 | 2 | - |
| Null-gas Extinguisher | Ranged | 8" | 3D6 | 2+ | 4+ | 1 | 1 | Shoot in Combat |
...
### Skywardens
**Points:** 130 | **Move:** 12" | **Health:** 2 | **Save:** 3+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, KHARADRON OVERLORDS, DUARDIN, SKYFARER, FLY
...
| Skyrigger Heavy Weapon | Ranged | 15" | 1 | 4+ | 3+ | 1 | D3 | Anti-Monster (+1 Rend) |
| Gun Butt | Melee | - | 1 | 4+ | 5+ | - | 1 | - |
| Vulcaniser Pistol | Ranged | 10" | 3 | 3+ | 3+ | 1 | 1 | Shoot in Combat |
| Skywarden's Skypike | Melee | - | 2 | 3+ | 3+ | 1 | 2 | Charge (+1 Damage) |
| Aethermatic Volley Gun | Ranged | 15" | 2D6 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Gun Butt | Melee | - | 1 | 4+ | 5+ | - | 1 | - |

**Abilities:**

#### Timed Charges (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a D3. On a 2+:
• Inflict an amount of mortal damage on the target equal to the roll.
...
**Points:** 150 | **Move:** 4" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** ORDER, INFANTRY, UNIQUE, Legends, DUARDIN, KHARADRON OVERLORDS, SKYFARER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Aethermatic Firearms | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | - |
| Skypike | Melee | - | 2 | 3+ | 3+ | 1 | 2 | Crit (Mortal) |
| Arkanaut Cutter | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Aethermatic Firearms | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | - |
| Arkanaut Cutter | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Aethermatic Firearms | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | - |
| Arkanaut Cutter | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Aethermatic Firearms | Ranged | 12" | 2 | 3+ | 4+ | 1 | 1 | - |
| Arkanaut Cutter | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Aethermatic Anatomiser | Ranged | 8" | 3D6 | 4+ | 4+ | 2 | 1 | - |

**Abilities:**

#### Aethermatic Anatomiser (Activated)
- **Timing:** Your Shooting Phase
...
**Points:** 120 | **Move:** 12" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, KHARADRON OVERLORDS, DUARDIN, SKYFARER, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Pioneer Weapons | Melee | - | 2 | 4+ | 3+ | 1 | 1 | - |
| Skydrake Harpoon or Firearm | Ranged | 12" | 2 | 3+ | 3+ | 1 | 1 | Anti-Monster (+1 Rend) |

**Abilities:**

#### Light Endrinpacks (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Vongrim Cutlass | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Crit (2 Hits) |
| Privateer Pistol | Ranged | 10" | 2 | 4+ | 4+ | - | 1 | Shoot in Combat |

**Abilities:**

#### Spotter's Flaregun (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Zontari Endrin Dock
**Points:** 20 | **Move:** - | **Health:** 10 | **Save:** 3+ | **Control:** -
**Keywords:** FACTION TERRAIN, ORDER, KHARADRON OVERLORDS, FLY

**Abilities:**

#### Repair Routines (Activated)
- **Timing:** Your Hero Phase
...
#### Release the Auto-Endrins (Activated)
- **Timing:** Deployment Phase
...
#### Endrinworks Outpost (Activated)
- **Timing:** Your Hero Phase
- **Declare:** Pick a friendly Auto-Endrin or replacement Auto-Endrin that has been removed from the battlefield to be the target.
...
| Arkanaut Company | 80 |
| Codewright | 90 |
| Codewright (Scourge of Ghyran) | 100 |
| Aether-Khemist | 110 |
| Endrinriggers | 110 |
