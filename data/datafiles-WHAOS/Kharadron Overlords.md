...
### Aether-Khemist
**Points:** 120 | **Move:** 4" | **Health:** 5 | **Save:** 4+ | **Control:** 2
...
### Arkanaut Admiral
**Points:** 140 | **Move:** 4" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER
...
> Variant: Codewright (Scourge of Ghyran) — 100 pts

---

### Endrinmaster with Dirigible Suit
**Points:** 160 | **Move:** 12" | **Health:** 8 | **Save:** 3+ | **Control:** 2
...
### Null-Khemist
**Points:** 130 | **Move:** 12" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, INFANTRY, KHARADRON OVERLORDS, DUARDIN, SKYFARER
...
### Anvil of Apotheosis: Kharadron Overlords Hero
**Move:** 4" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, INFANTRY, KHARADRON OVERLORDS, SKYFARER, DUARDIN, ORDER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Dirigible Suit Tools | Melee | - | D6+2 | 3+ | 4+ | 1 | 1 | Crit (Mortal) |
| Steamforged Weapon | Melee | - | 3 | 3+ | 3+ | 1 | 2 |  |
| Kharadron Anatomizer | Ranged | 8" | 5 | 3+ | 4+ | 1 | 2 | Shoot in Combat |
| Kharadron Pistol | Ranged | 10" | 2 | 3+ | 3+ | 1 | 2 | Shoot in Combat |
| Gift from the Grundcorps | Ranged | 24" | 5 | 3+ | 3+ | 1 | 2 | Anti-Monster (+1 Rend) |
| Grapeshot Batteries | Melee | - | 20 | 4+ | 4+ | - | 1 | - |
...
### Grundstok Gunhauler
**Points:** 160 | **Move:** 14" | **Health:** 10 | **Save:** 2+ | **Control:** 2
...
> Variant: Grundstok Gunhauler (Scourge of Ghyran) — 170 pts

---

### Grundstok Thunderers
**Points:** 140 | **Move:** 4" | **Health:** 2 | **Save:** 3+ | **Control:** 1
...
### Arkanaut Company
**Points:** 90 | **Move:** 4" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, INFANTRY, ORDER, KHARADRON OVERLORDS, DUARDIN, SKYFARER
...
### Arkanaut Ironclad
**Points:** 460 | **Move:** 10" | **Health:** 18 | **Save:** 2+ | **Control:** 5
**Keywords:** ORDER, FLY, KHARADRON OVERLORDS, DUARDIN, WAR MACHINE, SKYVESSEL
...
### Auto-Endrin
**Move:** 12" | **Health:** 5 | **Save:** 4+ | **Control:** -
**Keywords:** ORDER, KHARADRON OVERLORDS, FLY, WAR MACHINE, AUTO-ENDRIN

**Abilities:**

#### Nullifier Auto-Endrin (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** If this unit is a Nullifier Auto-Endrin and is in combat with any enemy Manifestations, pick each enemy Manifestation in combat with it to be the targets.
...
#### Stuncloud Auto-Endrin (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** If this unit is a Stuncloud Auto-Endrin and is in combat, pick each enemy unit in combat with it to be the targets.
...
#### Grudgeblast Auto-Endrin (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** If this unit is a Grudgeblast Auto-Endrin and is in combat, pick each enemy unit in combat with it to be the targets.
