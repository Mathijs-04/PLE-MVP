...
#### Inner Power (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Effect:** The next spell cast by this unit this phase cannot be unbound.

#### Strongest When in the Field (Passive)
- **Effect:** Add 1 to casting rolls for this unit while it is within 6" of an enemy unit.

#### Strong Constitution (Activated)
- **Timing:** End of Any Turn
- **Effect:** **Heal (1)** this unit.

#### Spell Disruptor (Activated)
- **Timing:** Once Per Battle Round (Army), Reaction: Opponent declared a Spell ability for a visible enemy unit within 18" of this unit.
- **Effect:** Pick 1 dice from that casting roll for that ability. Your opponent must re-roll that dice.

#### Insufferably Arrogant (Passive)
- **Effect:** This unit cannot use commands.

#### Old Bones (Passive)
- **Effect:** Subtract 2 from run rolls for this unit.

#### Strong Fashion Sense (Passive)
- **Effect:** Ignore positive modifiers to save rolls for this unit.

#### Reckless (Passive)
- **Effect:** If an unmodified casting roll for this unit contains any doubles, the spell is miscast.

#### Master Unbinder (Passive)
- **Effect:** Add 1 to unbinding rolls and banishment rolls for this unit.

#### Magical Maestro (Passive)
- **Effect:** Add 1 to casting rolls for this unit.

#### Arcane Conductor (Passive)
- **Effect:** Add 1 to the Damage characteristic of this unit's **Mage Staff** for each Manifestation on the battlefield.

#### Spell Mastery (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Spell ability for this unit
- **Effect:** If that spell is successfully cast, roll a dice. On a 3+, after resoving the effect of that spell, this unit can immediately cast that spell a second time using the same casting roll. Do not count the second spell towards the number of Spell abilities this unit can use this phase.

#### War-horse Charge (Activated)
...
#### Sound the Attack (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Charge ability for a unit that is **under orders**
- **Effect:** You can change the lowest D6 in the charge roll to match the highest D6.

#### Into Them, You Dogs! (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick a friendly Hero that is **under orders** to use this ability. That unit is the **field officer** for the rest of the turn. Then, pick 2 other visible friendly non-Hero units that are **under orders** and wholly within 12" of the **field officer** to be the targets.
- **Effect:** For the rest of the turn, the first time the **field officer** uses a Fight ability, you can pick a target that has not used a Fight ability this turn. That target is **inspirited** and the other target is **emboldened**.The **inspirited** target can be picked to use a Fight ability immediately after the Fight ability used by the **field officer** has been resolved. Then, if the **emboldened** target has not used a Fight ability this turn, it can be picked to use a Fight ability immediately after the **inspirited** target's Fight ability has been resolved.

#### Hurl Them Back! (Activated)
- **Timing:** One Per Turn (Army), Any Combat Phase
...
#### The Last Blade of Embergard (Activated)
...
#### Bones of Saint Ignifus (Activated)
- **Timing:** Reaction: You declared a Spell or Prayer ability for a visible unit that is wholly within 12" of this unit and **under orders**
- **Effect:** Add 1 to the casting roll or chanting roll for that ability.

#### The Sphere Celestial (Activated)
- **Timing:** Your Hero Phase
- **Declare:** If this unit is not in combat, pick a point on the battlefield more than 3" from all units (friendly and enemy) and terrain features to be the target point. Then, pick another visible friendly Cities of Sigmar Infantry or **Cavalry Hero** that is wholly within 18" of this unit and not in combat to be the target unit.
- **Effect:** Remove this unit from the battlefield and set it up again within 1" of the target unit and not in combat. Then, remove the target from the battlefield and set it up again within 1" of the target point and not in combat. This unit and the target unit can use Move abilities in the following movement phase (this is an exception to Core Rules, 24.0).

### Battle Formations

#### To the Last (Passive)
- **Effect:** Each time a friendly unit that is **under orders** uses the 'Rally' command, you can make 3 additional rally rolls of D6.

#### Masters of the Arcane (Passive)
...
#### Throngs of the Faithful (Activated)
- **Timing:** Once Per Turn (Army), Reaction: Your opponent declared a Fight ability.
...
#### Dawnbringer Crusade (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** Pick a friendly non-Hero Cities of Sigmar Infantry unit wholly within friendly territory to use this ability.
- **Effect:** If that unit is in combat, it can move 6". It can move through the combat ranges of enemy units but can only end that move in combat with units it was in combat with at the start of the move. It does not have to end the move in combat.
If that unit is not in combat, it can move 6". It cannot move into combat during any part of that move.
- **Keywords:** Move

#### Canny Crews (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
#### Have No Mercy (Activated)
- **Timing:** Once Per Turn (Army), Start of Battle Round
- **Declare:** Pick a visible enemy unit to be the target.
- **Effect:** Until the start of the next battle round, add 1 to wound rolls for combat attacks made by friendly Darkling Covens units that target that enemy unit while it is damaged or has had any models slain in the same turn.

#### I've Seen Worse and Killed Batter (Activated)
- **Timing:** Once Per Turn (Army), Enemy Combat Phase
- **Declare:** Pick an enemy unit that charged this turn and is in combat with any friendly **Dispossessed** units that did not charge this turn to be the target.
- **Effect:** Roll a dice. On a 4+, other than the **Companion** weapon ability, weapon abilities for the target’s combat attacks have no effect for the rest of the turn.

### Heroic Traits

#### Stentorian General (Passive)
- **Effect:** Subtract 1 from ward rolls for enemy units while they are in combat with any visible friendly units that are wholly within 12" of this unit and **under orders**.

#### Beloved Leader (Passive)
- **Effect:** Ignore negative modifiers to hit rolls and wound rolls applied by enemy abilities for attacks made by visible friendly units that are wholly within 12" of this unit and **under orders**.

#### Grizzled Drillmaster (Passive)
- **Effect:** Other visible friendly units have Ward (6+) while they are wholly within 12" of this unit and **under orders**.

#### Cosmopolitan Leader (Activated)
- **Timing:** Your Hero Phase
...
#### Prototype Arco-Combustor Uninhibitor (Activated)
- **Timing:** Once Per Battle, Your Movement Phase
- **Effect:** For the rest of the turn:
• Add 3" to this unit's Move characteristic
• This unit can use Shoot abilities even if it used a Retreat ability in the same turn.
• No mortal damage is inflicted on this unit by Retreat abilities.

#### Emergency Bellows (Activated)
- **Timing:** End of Any Turn
- **Effect:** Remove 1 of this unit's **heat tokens**.

#### Grapple-net Launcher (Activated)
- **Timing:** Once Per Battle, Enemy Combat Phase
- **Declare:** If this unit did not charge this turn, pick an enemy unit in combat with this unit and that charged this turn to be the target.
...
#### Form Up, Allies! (Activated)
- **Timing:** Start of Battle Round
- **Declare:** Pick a friendly Allies of the Free Cities unit to use this ability, then pick 2 other visible friendly Allies of the Free Cities units wholly within 12" of it to be the targets.
The unit using this ability and the targets:
• cannot be **under orders**
• must each be a different unit type.
- **Effect:** For the rest of the battle round, the unit using this ability and the targets are **under orders**.
**Designer's Note:** *'Unit type' refers to the name of the warscroll (Core Rules, 4.0), e.g. 'Freeguild Cavalier-Marshal' or 'Allies of the Free Cities Auric Hearthguard'.*

**Artefacts of Power**

#### Signet of the City (Activated)
- **Timing:** Once Per Battle (Army), Any Hero Phase
- **Declare:** Pick this unit and each visible friendly Allies of the Free Cities unit wholly within 18" of this unit to be the targets.
- **Effect:** For the rest of the turn:
• The targets are **under orders**.
• The targets have Ward (6+).
• The targets have a maximum control score of 1.
...
#### Form Up, Iron March (Activated)
- **Timing:** Start of Battle Round
- **Declare:** Pick a friendly Iron March unit to use this ability, then pick either 1 or 2 other visible friendly Iron March units wholly within 12" of it to be the targets.
The unit using this ability and the targets:
• cannot be **under orders**
• must each be a different unit type.
- **Effect:** For the rest of the battle round, the unit using this ability and the targets are **under orders**.
**Designer's Note:** *'Unit type' refers to the name of the warscroll (Core Rules, 4.0), e.g. 'Cannonade Cogfort' or 'Mallus Forgepriest'.*

**Engineers of the Iron March**

#### Engineer Kirsta Loudren (Passive)
- **Effect:** If this unit is destroyed, before removing it from play, roll a dice for each visible unit (friendly and enemy) within its combat range. On a 3+, inflict an amount of mortal damage on that unit equal to the roll.

#### Engineer Gurren Ashbrow (Passive)
- **Effect:** Each time this unit uses the 'Rally' command, you can make 3 additional rally rolls of D6.

#### Engineer Bartel Holst (Passive)
- **Effect:** This unit has Ward (6+) and Strike-last.

**Iron March Auxiliaries**

#### Battle-Priest Solantra Whyl (Passive)
- **Effect:** This unit has Priest (1)

#### Broadmoore and Louse (Passive)
...
#### Master Sapper Gavelock Fiske (Passive)
- **Effect:** This unit's ranged weapons have **Anti-Faction Terrain (+1 Rend)** and **Anti-War Machine (+1 Rend)**.

**Commanders of the Iron March**

#### Castellan-Captain Vyan Philsin (Passive)
- **Effect:** Add 1 to wound rolls for combat attacks made by friendly Iron March Infantry while they are wholly within 12" of this unit and **under orders**.

#### Commodore de Graçon (Activated)
- **Timing:** Deployment Phase
...
#### Castellan-Captain Regan Vandercloud (Activated)
...
• The target has a maximum control score of 1 for the rest of the turn.

## Units

### Alchemite Warforger
**Points:** 130 | **Move:** 5" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, WIZARD (1), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Tongstaff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Runic Crucible (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
### Allies of the Free Cities Auric Hearthguard
**Points:** 130 | **Move:** 4" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** INFANTRY, CHAMPION, ORDER, WARD (6+), DUARDIN, MUSICIAN (1/10), CITIES OF SIGMAR, ALLIES OF THE FREE CITIES

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Magmapike | Melee | - | 1 | 3+ | 3+ | 1 | 1 | - |
| Magmapike | Ranged | 12" | 2 | 4+ | 3+ | 1 | D3 | Shoot in Combat |

**Abilities:**

#### Lava-encrusted (Passive)
- **Effect:** While this unit is **under orders**, each time a shooting attack made by this unit scores a critical hit, subtract 1" from the target unit’s Move characteristic until the start of your next turn (this effect is cumulative). This ability cannot reduce the target unit’s unmodified Move characteristic below half its starting value.

---

### Allies of the Free Cities Vanari Auralan Sentinels
**Points:** 140 | **Move:** 6" | **Health:** 1 | **Save:** 5+ | **Control:** 1
**Keywords:** Aelf Infantry, CHAMPION, INFANTRY, ORDER, AELF, CITIES OF SIGMAR, ALLIES OF THE FREE CITIES

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Auralan Bow | Ranged | 18" | 2 | 3+ | 4+ | 1 | 1 | Crit (Auto-wound) |
| Sentinel Blades | Melee | - | 1 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Fire Lofted Shots (Activated)
...
### Allies of the Free Cities Vanari Auralan Wardens
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warden Pike and Blades | Melee | - | 2 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend), Crit (Mortal) |

**Abilities:**

#### Protective Pike-wall (Passive)
...
### Allies of the Free Cities Vulkyn Flameseekers
**Points:** 160 | **Move:** 4" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, ORDER, CHAMPION (1/9), WARD (6+), DUARDIN, CITIES OF SIGMAR, ALLIES OF THE FREE CITIES

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Vulkyn Weapons | Melee | - | 3 | 3+ | 3+ | 1 | 1 | Anti-Monster (+1 Rend) |
| Emberteeth | Melee | - | 1 | 3+ | 3+ | - | 2 | Crit (Mortal), Companion |
| Vulkyn Weapons | Melee | - | 3 | 3+ | 3+ | 1 | 1 | Anti-Monster (+1 Rend) |

**Abilities:**

#### Allies Drothmasters (Activated)
- **Timing:** Any Combat Phase
...
### Amethyst Knellmage
**Points:** 110 | **Move:** 5" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, WIZARD (1), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Amethyst Scythe | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Deathly Candlelight (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
### Aqshian Pyrocaster
**Points:** 100 | **Move:** 5" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, WIZARD (1), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Burning Fists | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Incandescent Incineration (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Pick a visible enemy unit within 12" of this unit to be the target, then make a casting roll of 2D6.
...
### Assassin
**Points:** 150 | **Move:** 6" | **Health:** 5 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Poison-coated Blades | Melee | - | 6 | 3+ | 4+ | 1 | 2 | Anti-Hero (+1 Rend), Crit (Mortal) |
...
### Battlemage
**Points:** 100 | **Move:** 5" | **Health:** 5 | **Save:** 6+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, HUMAN, INFANTRY, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wizard’s Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Protective Focus (Activated)
...
**Points:** 230 | **Move:** 8" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, HUMAN, WIZARD (1), WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wizard’s Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |
| Warhorses' Steel-shod Hooves | Melee | - | 4 | 5+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Storm of Shemtek (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
**Points:** 260 | **Move:** 12" | **Health:** 15 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, FLY, ORDER, CITIES OF SIGMAR, HUMAN, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Amber Spear | Ranged | 12" | 3 | 4+ | 3+ | 1 | D3 | Anti‑Monster (+1 Rend) |
| Beaststaff | Melee | - | 3 | 4+ | 3+ | 1 | D3 | - |
| Griffon’s Razor Claws and Twin Beaks | Melee | - | 6 | 4+ | 2+ | 2 | 3 | Companion |

**Abilities:**

#### Ghurish Ferocity (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 280 | **Move:** 8" | **Health:** 12 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, HUMAN, WIZARD (1), WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Searing Beam of Light | Ranged | 24" | 1 | 2+ | ⟝See 'Searing Beam of Light' ability⟞ | ⟝See 'Searing Beam of Light' ability⟞ | ⟝See 'Searing Beam of Light' ability⟞ | - |
| Warhorses' Steel-shod Hooves | Melee | - | 4 | 5+ | 3+ | - | 1 | Companion |
| Wizard’s Staff | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Searing Beam of Light (Passive)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Repeater Handbow | Ranged | 10" | 2 | 4+ | 4+ | - | 1 | Shoot in Combat |
| Vicious Blades | Melee | - | 2 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Swift Shots (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
...
**Points:** 90 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wicked Cutlass and Murder Hook | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Crit (Mortal) |

**Abilities:**

#### 'At Them, You Curs!' (Activated)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Darkling Sword | Melee | - | 2 | 3+ | 4+ | - | 1 | Crit (2 Hits) |

**Abilities:**

#### Merciless Conquerors (Activated)
- **Declare:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 100 | **Move:** 5" | **Health:** 2 | **Save:** 6+ | **Control:** 1
**Keywords:** Sigmarite Infantry, ORDER, CITIES OF SIGMAR, HUMAN, INFANTRY, UNIQUE, CHAMPION, Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Brethren Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Brethren Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Brethren Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Brethren Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
| Brethren Weapons | Melee | - | 3 | 4+ | 4+ | - | 1 | Crit (Mortal) |
...
### Callis and Toll
**Points:** 240 | **Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, UNIQUE, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Flintlock Pistols | Ranged | 10" | 4 | 3+ | 4+ | 1 | 1 | Anti‑Wizard (+1 Rend), Shoot in Combat |
| Azyrite Blades | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Anti‑Wizard (+1 Rend) |

**Abilities:**

#### Relentless Hunters (Activated)
- **Timing:** Start of Battle Round
...
#### Right Tools for the Job (Passive)
- **Effect:** Double the Damage characteristic of this unit’s melee weapons for attacks that target the enemy **mark**.

---

### Cannonade Cogfort
**Points:** 530 | **Move:** 6" | **Health:** 25 | **Save:** 3+ | **Control:** 10
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, SIGMARITE, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Godbreaker Cannon | Ranged | 24" | 4 | 4+ | 2+ | 2 | 4 | - |
| Breacher Cannon | Ranged | 12" | 6 | 3+ | 3+ | 1 | 2 | Anti-Infantry (+1 Rend) |
| Crew's Leadshotters | Ranged | 12" | 6 | 4+ | 3+ | 1 | D3 | Shoot In Combat |
| Crushing Iron Feet | Melee | - | 4 | 4+ | 2+ | 2 | 4 | Companion |
...
***Grapeshot*:** After that Shoot ability has been resolve, if all of the attacks made with this unit's **Godbreaker Cannon** targeted the same enemy unit, inflict D3 mortal damage on each other enemy unit within that enemy unit's combat range.

---

### Celestial Hurricanum
**Points:** 170 | **Move:** 8" | **Health:** 10 | **Save:** 4+ | **Control:** 5
**Keywords:** Sigmarite War Machine, ORDER, CITIES OF SIGMAR, HUMAN, WAR MACHINE
...
### Cogsmith
**Points:** 110 | **Move:** 4" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, DUARDIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Cogsmith’s Firearms | Ranged | 15" | 4 | 3+ | 3+ | 1 | 1 | - |
| Gun Butt and Cog Axe | Melee | - | 3 | 4+ | 4+ | 1 | 2 | - |
...
### Conqueror Cogfort
**Points:** 440 | **Move:** 6" | **Health:** 25 | **Save:** 3+ | **Control:** 10
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, SIGMARITE, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Realmscorcher Flame Cannon | Ranged | 18" | 6D6 | 2+ | 4+ | 1 | 1 | Anti-Infantry (+1 Rend) |
| Crew's Leadshotters | Ranged | 12" | 6 | 4+ | 3+ | 1 | D3 | Shoot In Combat |
| Crushing Iron Feet | Melee | - | 4 | 4+ | 2+ | 2 | 4 | Companion |
...
**2 *Full Throttle*:** For the rest of the turn, this unit's Move characteristic is 10".
**3 *Repel Boarders!*:** For the rest of the turn, add 2 to the Attacks characteristic of this unit's **Leadshotters** and **Crushing Iron Feet**.
...
- **Effect:** Set up each target wholly within 6" of this unit and either not in combat or within 1/2" of an enemy unit. If a target is set up in combat, it has charged. Then, if this unit is not **under orders**, this unit and the targets are **under orders** for the rest of the battle round.

---

### Dark Riders
**Points:** 170 | **Move:** 12" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** CHAMPION, ORDER, CITIES OF SIGMAR, CAVALRY, STANDARD BEARER (1/5), AELF, MUSICIAN (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Dark Steed’s Vicious Bite | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |
| Repeater Crossbow | Ranged | 12" | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Barbed Spear | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Anti-Infantry (+1 Rend) |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Master-crafted Repeater Crossbow | Ranged | 15" | 2 | 3+ | 4+ | - | 1 | Anti-Infantry (+1 Rend) |
| Cruel Dagger | Melee | - | 1 | 3+ | 4+ | - | 1 | - |

**Abilities:**

#### Storm of Iron-tipped Bolts (Activated)
- **Timing:** Your Shooting Phase
...
### Drakespawn Chariot
**Points:** 110 | **Move:** 10" | **Health:** 8 | **Save:** 4+ | **Control:** 5
**Keywords:** ORDER, CITIES OF SIGMAR, AELF, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Barbed Spear | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage) |
| Drakespawn’s Ferocious Jaws | Melee | - | 6 | 4+ | 3+ | 1 | 1 | Companion |

**Abilities:**

#### Scythed Runners (Activated)
- **Timing:** Any Charge Phase
...
### Drakespawn Knights
**Points:** 190 | **Move:** 10" | **Health:** 3 | **Save:** 3+ | **Control:** 1
**Keywords:** CHAMPION, ORDER, CITIES OF SIGMAR, CAVALRY, STANDARD BEARER (1/5), AELF, MUSICIAN (1/5)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Drakespawn’s Ferocious Jaws | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Companion |
| Barbed Lance | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage) |

**Abilities:**

#### Bestial Instincts (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Effect:** For the rest of the turn, add 1 to the Attacks characteristic of this unit’s **Drakespawn’s Ferocious Jaws** while it is in combat with any enemy units that had any damage points allocated to them this phase or that had any models slain this phase.

---

### Dreadlord on Black Dragon
**Points:** 260 | **Move:** 12" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, FLY, ORDER, CITIES OF SIGMAR, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Repeater Crossbow | Ranged | 12" | 2 | 4+ | 4+ | - | 1 | Crit (2 Hits) |
| Black Dragon’s Noxious Breath | Ranged | 10" | D3+3 | 2+ | 4+ | 1 | 1 | Shoot in Combat, Companion |
| Black Dragon’s Fearsome Jaws and Claws | Melee | - | 6 | 4+ | 2+ | 2 | 2 | Companion |
| Dreadlord’s Weapons | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Charge (+1 Damage) |
...
#### Indiscriminate Slaughter (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
### Dreadspears
**Points:** 110 | **Move:** 6" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** INFANTRY, CHAMPION, ORDER, CITIES OF SIGMAR, AELF, STANDARD BEARER (1/10), MUSICIAN (1/10)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Darkling Spear | Melee | - | 2 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend) |

**Abilities:**

#### Coven Guard (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 170 | **Move:** 12" | **Health:** 9 | **Save:** 4+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, CITIES OF SIGMAR, SIGMARITE, FLY, CAVALRY, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rod of Radiance | Ranged | 10" | 2 | 3+ | 3+ | 2 | D3 | Crit (2 Hits) |
| Glyphwing's Heads | Melee | - | 4 | 4+ | 3+ | 1 | D3+1 | Companion |

**Abilities:**

#### Lantern of All-Knowledge (Activated)
- **Timing:** Your Hero Phase
...
#### The Four Corners of the Realms (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Make a casting roll of 2D6.
- **Effect:** Remove this unit from the battlefield and set it up again within 9" of a corner of the battlefield and more than 3" from all enemy units.
- **Keywords:** Spell
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Executioner’s Draich | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Severing Strike (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Castigating Flails and Clubs | Melee | - | 2 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Glorious Martyrs (Passive)
...
**Points:** 120 | **Move:** 10" | **Health:** 7 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, CAVALRY, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Dragoon Pistol | Ranged | 10" | 4 | 3+ | 4+ | 1 | 1 | Shoot in Combat |
| Master-forged Cavalier Sword | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Charge (+1 Damage) |
| Warhorse’s Steel-shod Hooves | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |

**Abilities:**

#### 'For Sigmar, For Glory!' (Activated)
...
#### Run Down the Foe (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
- **Declare:** If this unit charged this turn, pick this unit and up to 2 non-Hero Sigmarite Cavalry units that charged this turn and are wholly within 12" of this unit to be the targets.
...
### Freeguild Cavaliers
**Points:** 150 | **Move:** 10" | **Health:** 3 | **Save:** 3+ | **Control:** 1
**Keywords:** Sigmarite Cavalry, CHAMPION, ORDER, CITIES OF SIGMAR, CAVALRY, STANDARD BEARER (1/5), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warhorse’s Steel‑shod Hooves | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |
| Cavalier Weapon | Melee | - | 3 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage) |

**Abilities:**

#### Storm of Steel (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Warhorse’s Steel‑shod Hooves | Melee | - | 2 | 5+ | 3+ | - | 1 | Companion |
| Cavalier Weapon | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage) |

**Abilities:**

#### The Red Work (Activated)
- **Timing:** Any Charge Phase
...
**Points:** 200 | **Move:** 5" | **Health:** 3 | **Save:** 4+ | **Control:** 1
**Keywords:** Sigmarite Infantry, INFANTRY, ORDER, CITIES OF SIGMAR, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Adjutant Weapons | Melee | - | 3 | 4+ | 4+ | 1 | 2 | - |
| Adjutant Weapons | Melee | - | 3 | 4+ | 4+ | 1 | 2 | - |
| Adjutant Weapons | Melee | - | 3 | 4+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Freeguild Adjutants (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
### Freeguild Fusiliers
**Points:** 120 | **Move:** 5" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** Sigmarite Infantry, INFANTRY, CHAMPION, ORDER, CITIES OF SIGMAR, STANDARD BEARER (1/10), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fusil-cannon | Ranged | 18" | 1 | 4+ | 2+ | 2 | 1 | - |
| Bayonet | Melee | - | 1 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Blackpowder Squire (Activated)
- **Timing:** Once Per Battle, Reaction: You declared a Shoot ability for this unit and this unit is in combat
...
### Freeguild Gallants
**Points:** 130 | **Move:** 5" | **Health:** 2 | **Save:** 3+ | **Control:** 1
**Keywords:** Sigmarite Infantry, CHAMPION, ORDER, CITIES OF SIGMAR, STANDARD BEARER (1/5), INFANTRY, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Weapons of Gallantry | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |
...
#### Break Them Upon the Walls (Passive)
...
**Points:** 140 | **Move:** 5" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** Sigmarite Infantry, INFANTRY, ORDER, CITIES OF SIGMAR, SIGMARITE, CHAMPION

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ruin-sweeper Arsenal | Ranged | 10" | 1 | 4+ | 2+ | 2 | 1 | - |
| Grenadier Bardiche | Melee | - | 2 | 4+ | 4+ | 1 | 2 | - |
| Grenadier Bardiche | Melee | - | 2 | 4+ | 4+ | 1 | 2 | - |
| Ruin-sweeper Arsenal | Ranged | 10" | 1 | 4+ | 2+ | 2 | 1 | - |
| Trailhound’s Ferocious Bite | Melee | - | 2 | 4+ | 3+ | - | 1 | Companion |

**Abilities:**

#### Cinders and Ashes (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
...
**Points:** 110 | **Move:** 5" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Master-forged Weapon | Melee | - | 5 | 3+ | 4+ | 1 | 2 | - |
| Duelling Pistols | Ranged | 10" | 4 | 3+ | 4+ | 1 | 1 | Shoot in Combat |

**Abilities:**

#### Front-line Commander (Command)
- **Timing:** Once Per Battle (Army), Reaction: You declared a Fight ability for this unit
- **Cost:** 1
...
#### Attendant Relic Envoy (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
**Points:** 230 | **Move:** 12" | **Health:** 15 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, FLY, ORDER, CITIES OF SIGMAR, HUMAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Marshal’s Armaments | Melee | - | 5 | 3+ | 4+ | 1 | 2 | Charge (+1 Damage) |
| Griffon’s Razor Claws and Deadly Beak | Melee | - | 6 | 4+ | 2+ | 2 | 3 | Companion |
...
#### Tactical Acumen (Activated)
- **Timing:** Reaction: You declared the ‘Redeploy’ command for a friendly Cities of Sigmar Human unit wholly within 12" of this unit
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

#### Piercing Bloodroar (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
**Points:** 90 | **Move:** 5" | **Health:** 1 | **Save:** 4+ | **Control:** 1
**Keywords:** Sigmarite Infantry, INFANTRY, CHAMPION, ORDER, CITIES OF SIGMAR, MUSICIAN (1/10), STANDARD BEARER (1/10), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Freeguild Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Steel of Helm and Heart (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
• This unit must be picked to be the target of pile-in move made by the target.
...
**Points:** 160 | **Move:** 6" | **Health:** 8 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Long Fusil | Ranged | 24" | 2 | 3+ | 2+ | 2 | 2 | Crit (Auto-wound), Anti-Hero (+1 Rend) |
| Warhulk’s Mace | Melee | - | 4 | 4+ | 2+ | 2 | 2 | - |

**Abilities:**

#### Coordinate Attacks (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
...
**Keywords:** UNIQUE, HERO, ORDER, CITIES OF SIGMAR, INFANTRY, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spell-banishing Pistol | Ranged | 10" | 4 | 3+ | 4+ | 1 | 1 | Shoot in Combat |
| Consecrated Blade | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Anti-Wizard (+1 Rend) |
| Consecrated Blade | Melee | - | 4 | 3+ | 4+ | 1 | 2 | Anti-Wizard (+1 Rend) |
| Anti‑thaumic Crossbow | Ranged | 18" | 3 | 3+ | 4+ | 1 | 2 | Anti‑Manifestation (+1 Rend), Anti‑Wizard (+1 Rend) |

**Abilities:**

#### Guardian and Mentor (Passive)
- **Effect:** While this unit contains 2 models, it has Ward (5+).

#### Weapons of Banishment (Activated)
- **Timing:** Your Hero Phase
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Scattershot Cannon | Ranged | 10" | 5 | 4+ | 3+ | 1 | D3 | - |
| Massive Warmaul | Melee | - | 5 | 4+ | 2+ | 2 | 3 | - |

**Abilities:**

#### Aggressive Defenders (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
- **Effect:** Each target can use Shoot and/or Charge abilitie even if it used a Retreat ability this turn. In addition, no mortal damage is inflicted on the targets by Retreat abilities for the rest of the turn.

#### Open the Gates! (Activated)
- **Timing:** Once Per Turn (Army), Any Charge Phase
...
### Gyrobomber
**Points:** 120 | **Move:** 12" | **Health:** 6 | **Save:** 3+ | **Control:** 2
**Keywords:** ORDER, CITIES OF SIGMAR, DUARDIN, WAR MACHINE, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Clattergun | Ranged | 12" | 3 | 4+ | 3+ | 1 | D3 | - |
| Rotor Blades | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Grudgebuster Bombs (Activated)
...
### Gyrocopter
**Points:** 120 | **Move:** 12" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** ORDER, CITIES OF SIGMAR, DUARDIN, WAR MACHINE, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gyrocopter Guns | Ranged | 12" | 5 | 4+ | 3+ | 1 | D3 | - |
| Rotor Blades | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Guild Bombs (Activated)
- **Timing:** Once Per Battle, Your Movement Phase
- **Declare:** If this unit used a Move ability this phase, pick an enemy unit that does not have Fly and that this unit passed across this turn to be the target.
- **Effect:** Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll.
...
**Keywords:** INFANTRY, ORDER, CITIES OF SIGMAR, DUARDIN
...
### Hexbane's Hunters
**Points:** 120 | **Move:** 5" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** Sigmarite Infantry, ORDER, CITIES OF SIGMAR, HUMAN, INFANTRY, UNIQUE, CHAMPION, Legends, WARD (5+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Blackpowder Pistols | Ranged | 8" | 3 | 3+ | 4+ | - | 1 | Shoot in Combat, Anti-Wizard (+1 Rend) |
| Witch Hunter Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Wizard (+1 Rend) |
| Witch Hunter Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Wizard (+1 Rend) |
| Blackpowder Pistols | Ranged | 8" | 3 | 3+ | 4+ | - | 1 | Shoot in Combat, Anti-Wizard (+1 Rend) |
| Witch Hunter Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Wizard (+1 Rend) |
| Witch Hunter Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Wizard (+1 Rend) |
| Witch Hunter Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Wizard (+1 Rend) |
| Witch Hunter Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | Anti-Wizard (+1 Rend) |
| Crossbow Launcher | Ranged | 15" | 2 | 4+ | 3+ | 1 | D3 | Anti-Wizard (+1 Rend) |

**Abilities:**

#### Flamewood Stakes (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
#### Hunt with Conviction (Activated)
...
**Keywords:** INFANTRY, ORDER, CITIES OF SIGMAR, DUARDIN, CHAMPION, MUSICIAN (1/10), STANDARD BEARER (1/10)
...
**Points:** 140 | **Move:** 3" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** Sigmarite War Machine, ORDER, CITIES OF SIGMAR, WAR MACHINE, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Great Cannon | Ranged | 24" | 3 | 4+ | 2+ | 2 | D3+2 | - |
| Crew’s Tools and Sidearms | Melee | - | 2 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Relentless Bombardment (Activated)
...
- **Effect:** Roll a dice. Add 1 to the roll if this unit is **under orders**. On a 3+, subtract 2 from charge rolls and run rolls for the target unit until the start of your next turn.

---

### Jorvan Kreel, Heir of the Kraken
**Points:** 120 | **Move:** 6" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, CITIES OF SIGMAR, SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ranger Blades | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |

**Abilities:**

#### Harrying Attacks (Passive)
...
#### Prowling Ash Panther (Activated)
- **Timing:** Any Combat Phase
...
#### Fluid Combat Style (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit or a non-Hero Sigmarite Infantry unit wholly within 12" of this unit.
...
### Kharibdyss
**Points:** 150 | **Move:** 8" | **Health:** 12 | **Save:** 5+ | **Control:** 5
**Keywords:** MONSTER, ORDER, CITIES OF SIGMAR, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fanged Tentacles and Spiked Tail | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Companion |

**Abilities:**

#### Goaded and Whipped (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Effect:** Double the Attacks characteristic of this unit’s **Companion** melee weapons for the rest of the turn.

#### Abyssal Howl (Activated)
- **Timing:** Once Per Turn (Army), End of Any Turn
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a dice. On a 3+, the target has a maximum control score of
...
### Luminark of Hysh
**Points:** 230 | **Move:** 8" | **Health:** 10 | **Save:** 4+ | **Control:** 5
**Keywords:** Sigmarite War Machine, ORDER, CITIES OF SIGMAR, HUMAN, WAR MACHINE
...
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, SIGMARITE, PRIEST (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Meteoric Warhammer | Melee | - | 4 | 4+ | 3+ | 1 | D3 | Crit (Auto-wound) |

**Abilities:**

#### Consecrate the Land (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
**Points:** 190 | **Move:** 5" | **Health:** 9 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, CITIES OF SIGMAR, PRIEST (2), INFANTRY, WARD (4+), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sceptre of the Wheel | Melee | - | 3 | 4+ | 4+ | 1 | D3 | - |
| Acolytes’ Club and Axe | Melee | - | 4 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### The Great Wheel Turns (Passive)
- **Effect:** Each time a model in a visible friendly Sigmarite unit wholly within 12" of this unit is slain by a combat attack and that model was in combat with the attacking unit, make a number of zealotry rolls of D6 equal to that model's Health characteristic. For each 6+, inflict 1 mortal damage on the attacking units after the Fight ability has been resolved.

#### Vessel of Sigmar (Prayer)
- **Timing:** Your Hero Phase
- **Chanting Value:** 5
...
### Pontifex Zenestra, Matriarch of the Great Wheel (Scourge of Ghyran)
**Points:** 260 | **Move:** 5" | **Health:** 9 | **Save:** 5+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, CITIES OF SIGMAR, PRIEST (2), INFANTRY, WARD (4+), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Sceptre of the Wheel and Acolytes' Weapons | Melee | - | 5 | 4+ | 4+ | - | D3 | - |

**Abilities:**

#### Word of the God-King (Activated)
- **Timing:** Any Hero Phase
...
• If the target is a Wizard or Priest, inflict an amount of mortal damage on the target equal to the roll.

#### Sigmar's Will (Prayer)
- **Timing:** Your Hero Phase
- **Chanting Value:** 4
- **Declare:** Make a chanting roll of D6. If the roll is an unmodified 1, you can re-roll the dice.
- **Effect:** Pick 1 of the following effects. Pick up to 2 different effects instead if the chanting roll was 10+.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Rune Staff and Forgehammer | Melee | - | 3 | 4+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Runes of Spellbreaking (Passive)
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Ravager Harpoon | Ranged | 16" | 2 | 3+ | 3+ | 1 | D3 | Anti‑Monster (+1 Rend) |
| Dark Steeds’ Vicious Bites | Melee | - | 4 | 5+ | 3+ | - | 1 | Companion |
| Hook Spear | Melee | - | 2 | 3+ | 4+ | 1 | 1 | Anti‑Monster (+1 Rend) |

**Abilities:**

#### Lay the Beast Low (Passive)
...
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, WIZARD (1), AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Witchstaff | Melee | - | 1 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Cruel Sacrifice (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** Pick a visible friendly Cities of Sigmar Aelf unit wholly within 6" of this unit to be the target.
...
**Points:** 280 | **Move:** 12" | **Health:** 14 | **Save:** 4+ | **Control:** 5
**Keywords:** HERO, MONSTER, FLY, ORDER, CITIES OF SIGMAR, AELF, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Cruel Weapons | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |
| Black Dragon’s Noxious Breath | Ranged | 10" | D3+3 | 2+ | 4+ | 1 | 1 | Shoot in Combat, Companion |
| Black Dragon’s Fearsome Jaws and Claws | Melee | - | 6 | 4+ | 2+ | 2 | 2 | Companion |
...
### Steam Tank
**Points:** 240 | **Move:** 8" | **Health:** 12 | **Save:** 2+ | **Control:** 5
**Keywords:** Sigmarite War Machine, ORDER, CITIES OF SIGMAR, HUMAN, WAR MACHINE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Steam Cannon | Ranged | 18" | 1 | 4+ | 2+ | 2 | D3+2 | - |
| Crushing Wheels | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Companion |
| Steam Gun | Ranged | 12" | 2D6 | 2+ | 4+ | - | 1 | - |

**Abilities:**

#### More Pressure! (Activated)
- **Timing:** Your Hero Phase
...
**Points:** 250 | **Move:** 8" | **Health:** 12 | **Save:** 2+ | **Control:** 5
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, HUMAN, WAR MACHINE
...
| Steam Cannon | Ranged | 18" | 1 | 4+ | 2+ | 2 | D3+2 | - |
| Crushing Wheels | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Companion |
| Commander’s Sword | Melee | - | 3 | 3+ | 4+ | 1 | 2 | - |
| Commander’s Rifle | Ranged | 18" | 3 | 3+ | 3+ | 1 | 2 | - |
| Steam Gun | Ranged | 12" | 2D6 | 2+ | 4+ | - | 1 | - |

**Abilities:**

#### Division Commander (Activated)
...
**Points:** 340 | **Move:** 12" | **Health:** 15 | **Save:** 3+ | **Control:** 5
**Keywords:** UNIQUE, HERO, ORDER, CITIES OF SIGMAR, SIGMARITE, MONSTER, WARMASTER, WARD (6+), FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Infernadine’s Scorpid Stinger | Melee | - | 2 | 4+ | 2+ | 2 | D3+3 | Crit (Mortal), Companion |
| Weapon of Office | Melee | - | 6 | 3+ | 4+ | 1 | 2 | - |
| Infernadine’s Leonine Jaws | Melee | - | 3 | 3+ | 2+ | 2 | 3 | Anti-Monster (+1 Rend), Companion |
...
#### Lead from the Front (Activated)
- **Timing:** Once Per Battle, Any Combat Phase
- **Declare:** If this unit is in combat, pick each visible friendly Sigmarite unit wholly within 12" of this unit to be the targets.
- **Effect:** Add 1 to hit rolls and wound rolls for the targets' combat attacks for the rest of the turn.

#### Paralysing Venom (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
### The Iron March Immolator Cogfort
**Points:** 510 | **Move:** 6" | **Health:** 25 | **Save:** 3+ | **Control:** 10
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, SIGMARITE, WAR MACHINE, IRON MARCH
...
**3 *Get Us In There!*:** This unit's **Crushing Iron Feet** have **Charge (+1 Damage)**
...
### The Iron March Linebreaker Cogfort
**Points:** 450 | **Move:** 6" | **Health:** 25 | **Save:** 3+ | **Control:** 10
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, SIGMARITE, WAR MACHINE, IRON MARCH
...
#### Venture Forth (Activated)
- **Timing:** Once Per Battle, Any Charge Phase
- **Declare:** If this unit has not used a Run ability this turn, pick this unit’s **passengers** to be the targets.
- **Effect:** Set up each target wholly within 6" of this unit and either not in combat or within 1/2" of an enemy unit. If a target is set up in combat, it has charged. Then, ,if this unit is not **under orders**, this unit and the targets are **under orders** for the rest of the battle round.

#### Ride to Glory (Activated)
- **Timing:** Deployment Phase
...
### War Hydra
**Points:** 170 | **Move:** 8" | **Health:** 12 | **Save:** 5+ | **Control:** 5
**Keywords:** MONSTER, ORDER, CITIES OF SIGMAR, AELF

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fiery Breath | Ranged | 10" | 6 | 4+ | 3+ | - | D3 | Shoot in Combat, Companion |
| Razor-sharp Fangs | Melee | - | 6 | 4+ | 2+ | 1 | 2 | Anti-Infantry (+1 Rend), Companion |

**Abilities:**

#### Impossible To Destroy (Passive)
- **Effect:** If this unit would be destroyed, before removing it from play, roll 6 dice. Subtract 1 from the number of dice rolled for each **destroyed head token** this unit has. If any of the rolls are a 5+, this unit is not destroyed and any remaining damage points inflicted on it have no effect. Then, **Heal (1)** this unit for each 5+. Finally, give this unit 1 **destroyed head token**.

#### Six-headed Strike (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
...
### Warden King
**Points:** 120 | **Move:** 4" | **Health:** 5 | **Save:** 3+ | **Control:** 2
**Keywords:** HERO, ORDER, CITIES OF SIGMAR, INFANTRY, DUARDIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Runic Hammer | Melee | - | 5 | 3+ | 3+ | 2 | 2 | - |

**Abilities:**

#### Fearless Leader (Activated)
- **Timing:** Reaction: You declared a Fight ability for this unit
...
#### Ancestral Grudgebearer (Activated)
- **Timing:** Once Per Battle (Army), Deployment Phase
...
**Keywords:** Sigmarite Infantry, INFANTRY, ORDER, CITIES OF SIGMAR, CHAMPION (1/11), SIGMARITE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Trailhound’s Ferocious Bite | Melee | - | 2 | 4+ | 4+ | - | 1 | Companion |
| Wildercorps Hunting Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Hunting Crossbow | Ranged | 15" | 2 | 4+ | 4+ | 1 | 1 | - |
| Hunting Weapons | Melee | - | 2 | 4+ | 4+ | - | 1 | - |
| Hunting Crossbow | Ranged | 15" | 2 | 4+ | 4+ | 1 | 1 | - |
| Trailhound’s Ferocious Bite | Melee | - | 2 | 4+ | 4+ | - | 1 | Companion |

**Abilities:**

#### Expert Pathfinders (Activated)
- **Timing:** Once Per Turn (Army), Deployment Phase
- **Declare:** Pick this unit and up to two friendly non-Monster non-War Machine Sigmarite units if none of them have been deployed.
- **Effect:** Set up those units in reserve **scouting ahead**. They have now been deployed.
- **Keywords:** Deploy

#### Prepared Arrival (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
| Allies of the Free Cities Vanari Auralan Wardens | 120 |
...
| Allies of the Free Cities Auric Hearthguard | 130 |
| Black Guard | 130 |
...
| Kharibdyss | 150 |
| Allies of the Free Cities Vulkyn Flameseekers | 160 |
| Fusil-Major on Ogor Warhulk | 160 |
| Celestial Hurricanum | 170 |
| Dark Riders | 170 |
...
| Battlemage on Celestial Hurricanum | 230 |
| Freeguild Marshal on Griffon | 230 |
| Luminark of Hysh | 230 |
| Callis and Toll | 240 |
| Steam Tank | 240 |
| Steam Tank Commander | 250 |
| Battlemage on Griffon | 260 |
| Dreadlord on Black Dragon | 260 |
| Pontifex Zenestra, Matriarch of the Great Wheel (Scourge of Ghyran) | 260 |
| Battlemage on Luminark of Hysh | 280 |
| Sorceress on Black Dragon | 280 |
| Gate Gargants | 320 |
| Tahlia Vedra, Lioness of the Parch | 340 |
| Conqueror Cogfort | 440 |
| The Iron March Linebreaker Cogfort | 450 |
| The Iron March Immolator Cogfort | 510 |
