...
- **Declare:** Pick any number of friendly Sylvaneth units wholly within 6" of any friendly Awakened Wyldwoods to be the targets.
...
#### Crown of Fell Bowers (Activated)
...
#### Greenwood Gladius (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll.

#### Acorn of the Ages (Activated)
...
- **Timing:** Reaction: Opponent declared a Spell or Prayer ability
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Swarm of Spites | Ranged | 12" | 6 | 4+ | 4+ | 1 | 1 | Crit (Auto-wound), Companion |
| Greenwood Scythe and Bittergrub | Melee | - | 3 | 3+ | 4+ | 1 | D3 | - |

**Abilities:**

#### Fury of the Forest (Activated)
...
**Points:** 680 | **Move:** 14" | **Health:** 16 | **Save:** 3+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, FLY, WARMASTER, WARD (6+), ORDER, SYLVANETH, WIZARD (3)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spear of Kurnoth | Melee | - | 5 | 3+ | 3+ | 2 | 2 | - |
| Spear of Kurnoth | Ranged | 12" | 1 | 2+ | 3+ | 2 | 4 | - |
| Wardroth’s Great Antlers | Melee | - | 6 | 4+ | 2+ | 2 | 4 | Companion |
...
### The Lady of Vines
**Points:** 210 | **Move:** 8" | **Health:** 8 | **Save:** 3+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, WARMASTER, ORDER, SYLVANETH, WIZARD (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kurnotheal’s Wrath | Ranged | 12" | 1 | 2+ | 2+ | 1 | D6 | - |
| Kurnotheal’s Wrath and Lashing Vines | Melee | - | 6 | 3+ | 3+ | 2 | 2 | Crit (Mortal) |

**Abilities:**

#### Verdian Crown (Passive)
...
### Drycha Hamadreth
**Points:** 220 | **Move:** 9" | **Health:** 10 | **Save:** 3+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, ORDER, SYLVANETH, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Flitterfuries | Ranged | 12" | 10 | 4+ | 4+ | 1 | 1 | Shoot in Combat, Companion |
| Slashing Talons | Melee | - | 5 | 3+ | 2+ | 1 | 2 | Anti-Infantry (+1 Rend) |
| Swarm of Squirmlings | Melee | - | 10 | 4+ | 4+ | 1 | 1 | Anti-Infantry (+1 Rend), Companion |

**Abilities:**

#### Mercurial Aspect (Activated)
...
> Variant: Drycha Hamadreth (Scourge of Ghyran) — 300 pts

---

### Belthanos, First Thorn of Kurnoth
**Points:** 350 | **Move:** 12" | **Health:** 14 | **Save:** 3+ | **Control:** 5
...
| Carnelian Greatspite’s Razor-like Mandibles | Melee | - | 4 | 4+ | 2+ | 2 | 3 | Companion |
...
### Warsong Revenant
**Points:** 200 | **Move:** 6" | **Health:** 7 | **Save:** 5+ | **Control:** 2
**Keywords:** HERO, ORDER, SYLVANETH, FLY, INFANTRY, WIZARD (2), WARD (6+)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spearing Vines and Spirit Falchion | Melee | - | 5 | 3+ | 3+ | 1 | D3 | - |

**Abilities:**

#### Wyldwood Revenants (Passive)
- **Effect:** Add 1 to unbinding rolls and banishment rolls for this unit while it is wholly within 6" of any Awakened Wyldwoods.

#### Unleash Swarm of Spites (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 7
...
### Arch-Revenant
**Points:** 110 | **Move:** 12" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, ORDER, SYLVANETH, FLY, INFANTRY
...
### Spirit of Durthu
**Points:** 320 | **Move:** 5" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, ORDER, SYLVANETH, MONSTER

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Verdant Blast | Ranged | 12" | 5 | 4+ | 3+ | 1 | 2 | - |
| Guardian Sword | Melee | - | 4 | 3+ | 2+ | 2 | 5 | Anti-Monster (+1 Rend) |
...
### Treelord Ancient
**Points:** 230 | **Move:** 5" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** ORDER, SYLVANETH, MONSTER, HERO, WIZARD (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Doom Tendril Staff | Ranged | 18" | 4 | 4+ | 3+ | 1 | D3 | - |
| Sweeping Blows | Melee | - | 5 | 4+ | 2+ | 1 | 2 | Anti-charge (+1 Rend) |
| Massive Impaling Talons | Melee | - | 2 | 4+ | 2+ | 2 | 3 | Crit (Mortal) |
...
**Points:** 220 | **Move:** 10" | **Health:** 12 | **Save:** 3+ | **Control:** 5
**Keywords:** UNIQUE, HERO, MONSTER, ORDER, SYLVANETH, WIZARD (1)
...
**Move:** 12" | **Health:** 6 | **Save:** 4+ | **Control:** 2
**Keywords:** UNIQUE, HERO, ORDER, SYLVANETH, KURNOTHI, CAVALRY, Legends

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kurnothi Princeling’s Bow | Ranged | 18" | 3 | 3+ | 3+ | 2 | 2 | Crit (Auto-wound) |
| Hooves and Knuckles | Melee | - | 4 | 3+ | 3+ | 1 | 1 | Charge (+1 Damage |

**Abilities:**

#### Debilitating Shot (Activated)
- **Timing:** Any Shooting Phase
...
#### Clarion of the Forest Prince (Activated)
- **Timing:** Your Hero Phase
...
**Points:** 200 | **Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** CHAMPION, ORDER, INFANTRY, SYLVANETH, KURNOTHI

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kurnoth Greatbow | Ranged | 18" | 2 | 3+ | 3+ | 1 | 2 | Anti-Hero (+1 Rend) |
...
- **Effect:** For the rest of the turn, this unit can ignore the effects of the ‘Guarded Hero’ ability (Core Rules, 25.0) when picking targets for its shooting attacks.

---

### The Twistweald
**Points:** 100 | **Move:** 5" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** INFANTRY, CHAMPION (1/8), ORDER, SYLVANETH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Twistroot Talons | Melee | - | 3 | 3+ | 4+ | - | 1 | - |
| Warden’s Bow | Ranged | 18" | 2 | 3+ | 4+ | 1 | 1 | - |
| Warden’s Blade | Melee | - | 2 | 3+ | 4+ | 1 | 2 | - |
| Voracious Swarm | Ranged | 10" | 6 | 3+ | 4+ | 1 | 1 | Shoot in Combat |

**Abilities:**

#### Eruption of Thorned Vines (Activated)
...
### Spite-Revenants
**Points:** 80 | **Move:** 5" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** CHAMPION, ORDER, SYLVANETH, INFANTRY
...
### Spiterider Lancers
**Points:** 190 | **Move:** 12" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** CAVALRY, CHAMPION, FLY, ORDER, SYLVANETH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spiterider Lance | Melee | - | 3 | 3+ | 4+ | 1 | 1 | Charge (+1 Damage), Anti‑Cavalry (+1 Rend) |
| Sharp Mandibles | Melee | - | 3 | 4+ | 3+ | 1 | 1 | Charge (+1 Damage), Companion |

**Abilities:**

#### Thrumming with Life (Activated)
- **Timing:** End of Any Turn
- **Effect:** Heal (3) this unit.

#### Descent of the Spiteriders (Activated)
- **Timing:** Any Combat Phase
...
**Keywords:** CHAMPION, ORDER, INFANTRY, FLY, SYLVANETH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Gossamid Bow | Ranged | 12" | 2 | 3+ | 3+ | 1 | 1 | Crit (Auto-wound), Shoot in Combat |
...
**Points:** 190 | **Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** CHAMPION, ORDER, INFANTRY, SYLVANETH, KURNOTHI
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Wracking Talons | Melee | - | 2 | 4+ | 4+ | - | 1 | - |

**Abilities:**

#### Blessings of the Forest (Passive)
...
#### Harvesters of the Lamentiri (Passive)
...
> Variant: Revenant Seekers (Scourge of Ghyran) — 230 pts
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Protector Glaive and Blade | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Waypiper's Dance (Activated)
- **Timing:** Once Per Turn (Army), Your Movement Phase
...
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, ORDER, SYLVANETH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Fearsome Mandibles and Bladed Carapace | Melee | - | 6 | 4+ | 2+ | 1 | D3 | Anti-Wizard (+1 Rend) |

**Abilities:**

#### Burrow Below (Activated)
- **Timing:** Your Movement Phase
...
#### Feed on Eldritch Energy (Activated)
- **Timing:** End of Any Turn
...
### Vengeful Skullroot
**Move:** 8" | **Health:** 8 | **Save:** 4+ | **Banishment:** 7+
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, FLY, ORDER, SYLVANETH

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lumbering Bulk | Melee | - | 3 | 4+ | 2+ | 1 | D3 | - |

**Abilities:**

#### Vengeful Terrors (Activated)
- **Timing:** End of Any Turn
- **Declare:** Pick an enemy unit within 3" of this Manifestation to be the target.
- **Effect:** For the rest of the turn, subtract an amount from the target’s control score equal to the number of friendly units that have been destroyed this battle (not including Manifestations or Faction Terrain).’

#### Creeping Willow (Passive)
...
**Keywords:** WARD (6+), MANIFESTATION, ENDLESS SPELL, ORDER, SYLVANETH

**Abilities:**

#### The Hive Nourishes (Activated)
- **Timing:** Your Hero Phase
...
**Keywords:** FACTION TERRAIN, ORDER, SYLVANETH, WARD (5+)

**Abilities:**

#### Deploy Wyldwood (Activated)
...
#### Overgrown Wilderness (Passive)
- **Effect:** Enemy units are visible to friendly Sylvaneth units even if every model in that enemy unit is within 1" of this terrain feature. In addition, the Range characteristic of friendly Sylvaneth units’ ranged weapons is not halved while every model in that friendly unit is within 1" of this terrain feature.

#### Vengeful Forest Spirits (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Growing Woods (Passive)
- **Effect:** Each time you set up an Awakened Wyldwood, you can place 1-3 scenery pieces (Terrain, 1.6). If you place more than 1 scenery piece, the tips at the end of each base must touch, forming a circle. The area inside this circle is considered to be part of this terrain
feature. For each additional scenery piece in this terrain feature that is placed after the first:
...
**Keywords:** ORDER, INFANTRY, UNIQUE, Legends, CHAMPION
...
### Skaeth's Wild Hunt
**Points:** 90 | **Move:** 6" | **Health:** 2 | **Save:** 5+ | **Control:** 1
**Keywords:** ORDER, INFANTRY, UNIQUE, Legends, CHAMPION, KURNOTHI
...
**Keywords:** ORDER, UNIQUE, Legends, CHAMPION, KURNOTHI, CAVALRY
