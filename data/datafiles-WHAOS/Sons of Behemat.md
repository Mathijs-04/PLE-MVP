...
#### Gargant Charge (Activated)
- **Timing:** Any Charge Phase
- **Declare:** Pick a friendly Mega-Gargant or Gargant unit that charged this turn to use this ability, then pick an enemy unit that has not been picked as the target of this ability this turn and that is in combat with that unit to be the target.
...
#### Rabble Rouser (Passive)
- **Effect:** Add 1 to charge rolls for friendly Sons of Behemat units while they are wholly within 12" of this unit.

#### Monstrously Tough (Passive)
- **Effect:** This unit has a Health characteristic of 40 instead of 35.

#### Terrifying Hulk (Activated)
- **Timing:** Once Per Turn, Reaction: Your opponent declared a Charge ability for a visible non-Monster enemy unit within 12" of this unit
- **Effect:** If this unit is not in combat, roll a dice. On a 3+, you can change one of the dice in that charge roll to a 1.

#### Grabby (Passive)
- **Effect:** Add 1 to hit rolls for this unit’s combat attacks that target an enemy unit contesting an objective you do not control.

#### Mega-Grump (Passive)
- **Effect:** This unit has Ward (5+) while it has 25 or more damage points.

### Artefacts of Power

#### Glowy Lantern (Passive)
...
#### Glowy Shield of Protectiness (Passive)
...
#### Mantle of Tusk and Horns (Activated)
...
#### More Stuff for Me Collection (Activated)
...
#### Strike! Hur Hur! (Activated)
- **Timing:** Once Per Turn (Army), Your Shooting Phase
- **Declare:** Pick up to 2 friendly Mega-Gargant units within 3" of any terrain features and pick any friendly Gargant units within 3" of any terrain features to be the targets.
- **Effect:** Double the Attacks characteristic of each target’s ranged weapons for the rest of the turn. If the target has no ranged weapons, pick an enemy unit within 12" of the target instead and roll a D3. On a 2+, inflict an amount of mortal damage on that enemy unit equal to the roll.

#### Lofty Louts (Activated)
- **Declare:** Pick a friendly **Mancrusher Gargant** unit to be the target.
...
#### Smash it All to Bits (Activated)
...
#### The World Titan's Prophet (Passive)
...
The Mega-Gargant using this Rampage has
Strike-last for the rest of the turn.
- **Keywords:** Rampage

#### Crafty Creepers (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### I Can Do That Better (Activated)
- **Timing:** Once Per Battle (Army), Reaction: You declared the ‘Wrath of Brodd’ ability for a friendly unit
...
**Points:** 470 | **Move:** 10" | **Health:** 35 | **Save:** 4+ | **Control:** 20
**Keywords:** HERO, MONSTER, DESTRUCTION, SONS OF BEHEMAT, MEGA-GARGANT

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Menhir Club | Melee | - | 5 | 4+ | 2+ | 2 | 5 | Anti-Monster (+1 Rend) |
| Death Grip | Melee | - | 1 | 4+ | 2+ | 2 | D6 | Anti-Hero (+1 Rend) |
| Almighty Stomp | Melee | - | 4 | 4+ | 2+ | 2 | D3 | Anti-Infantry (+1 Rend) |
...
**Points:** 490 | **Move:** 10" | **Health:** 35 | **Save:** 4+ | **Control:** 20
**Keywords:** HERO, MONSTER, DESTRUCTION, SONS OF BEHEMAT, MEGA-GARGANT

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Hurled Boulder | Ranged | 18" | 1 | 3+ | 2+ | 3 | 4 | - |
| Death Grip | Melee | - | 1 | 4+ | 2+ | 2 | D6 | Anti-Hero (+1 Rend) |
| Almighty Stomp | Melee | - | 4 | 4+ | 2+ | 2 | D3 | Anti-Infantry (+1 Rend) |
| Fortcrusha Flail | Melee | - | 6 | 4+ | 2+ | 2 | 4 | Anti-Faction Terrain (+1 Rend) |
...
### King Brodd
**Points:** 520 | **Move:** 10" | **Health:** 40 | **Save:** 4+ | **Control:** 20
**Keywords:** HERO, UNIQUE, MONSTER, WARMASTER, DESTRUCTION, SONS OF BEHEMAT, MEGA-GARGANT, PRIEST (1)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Obelisk of Tor Crania | Melee | - | 6 | 4+ | 2+ | 2 | 5 | - |
| Death Grip | Melee | - | 1 | 4+ | 2+ | 2 | D6 | Anti-Hero (+1 Rend) |
| Almighty Stomp | Melee | - | 4 | 4+ | 2+ | 2 | D3 | Anti-Infantry (+1 Rend) |
...
**Points:** 590 | **Move:** 10" | **Health:** 18 | **Save:** 4+ | **Control:** 15
**Keywords:** HERO, UNIQUE, MONSTER, WARMASTER, WARD (5+), DESTRUCTION, SONS OF BEHEMAT
...
**Points:** 430 | **Move:** 10" | **Health:** 35 | **Save:** 4+ | **Control:** 20
**Keywords:** HERO, MONSTER, DESTRUCTION, SONS OF BEHEMAT, MEGA-GARGANT

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Hurled Debris | Ranged | 24" | 3 | 4+ | 3+ | 1 | D3 | - |
| Death Grip | Melee | - | 1 | 4+ | 2+ | 2 | D6 | Anti-Hero (+1 Rend) |
| Almighty Stomp | Melee | - | 4 | 4+ | 2+ | 2 | D3 | Anti-Infantry (+1 Rend) |
| Shipwrecka Warclub | Melee | - | 4 | 4+ | 2+ | 2 | 4 | - |
...
### Kraken-eater Mega-Gargant (Scourge of Ghyran)
**Points:** 430 | **Move:** 10" | **Health:** 35 | **Save:** 4+ | **Control:** 20
**Keywords:** HERO, MONSTER, DESTRUCTION, SONS OF BEHEMAT, MEGA-GARGANT
...
| Hurled Debris | Ranged | 24" | 3 | 4+ | 3+ | 1 | D3 | - |
| Death Grip | Melee | - | 1 | 4+ | 2+ | 2 | D6 | Anti-Hero (+1 Rend) |
| Spine-shattering Stomp | Melee | - | 4 | 4+ | 2+ | 2 | D3 | Anti-Infantry (+1 Rend) |
| Shipwrecka Warclub | Melee | - | 4 | 4+ | 2+ | 2 | 5 | - |
...
#### Lurking Beneath the Waves (Activated)
...
#### Emerge from the Deep (Activated)
- **Timing:** Your Movement Phase
- **Declare:** Pick this unit if it is **beneath the waves**.
...
### Mancrusher Gargant
**Points:** 120 | **Move:** 8" | **Health:** 12 | **Save:** 5+ | **Control:** 10
**Keywords:** MONSTER, DESTRUCTION, SONS OF BEHEMAT, GARGANT
...
### Mancrusher Mob
**Points:** 350 | **Move:** 8" | **Health:** 12 | **Save:** 5+ | **Control:** 10
**Keywords:** MONSTER, DESTRUCTION, SONS OF BEHEMAT, GARGANT
...
#### ’Oo’s Under The Heel Now? (Passive)
...
**Points:** 450 | **Move:** 10" | **Health:** 35 | **Save:** 4+ | **Control:** 20
**Keywords:** HERO, MONSTER, DESTRUCTION, SONS OF BEHEMAT, MEGA-GARGANT
...
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Death Grip | Melee | - | 1 | 4+ | 2+ | 2 | D6 | Anti-Hero (+1 Rend) |
| Almightier Stomp | Melee | - | 6 | 4+ | 2+ | 2 | D3 | Anti-Infantry (+1 Rend) |
| Titanic Boulderclub | Melee | - | 4 | 4+ | 2+ | 2 | 2 | Anti-Infantry (+1 Rend) |
...
| Mancrusher Mob | 350 |
| Kraken-eater Mega-Gargant | 430 |
| Kraken-eater Mega-Gargant (Scourge of Ghyran) | 430 |
