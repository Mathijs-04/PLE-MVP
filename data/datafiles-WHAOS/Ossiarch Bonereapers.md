...
#### Hastily Repaired (Passive)
- **Effect:** In your charge phase, if this unit is not in combat and there are any enemy units within 12" of it, this unit must use the 'Charge' ability, and if the charge roll would allow it to finish within 1/2" of any enemy units, it would do so.

#### Ostracised (Passive)
- **Effect:** The number after this unit's Relentless Discipline keyword is 0.

#### Impossible Precision (Activated)
...
#### Unliving Regeneration (Activated)
- **Timing:** End of Any Turn
- **Effect:** **Heal (D3)** this unit.

#### Grasping Limbs (Activated)
...
#### Hasty Advance (Activated)
- **Timing:** Deployment Phase
- **Effect:** This unit can use the 'Normal Move' ability as if it were your movement phase.

#### Aggressive Commander (Passive)
- **Effect:** Add 1 to charge rolls for this unit.

#### Peerless Leader (Activated)
- **Timing:** Once Per Turn, Reaction: You declared a Relentless Discipline ability for this unit
...
#### Nadirite Blademaster (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target
- **Effect:** Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll.

#### Disturbing Stillness (Passive)
- **Effect:** Subtract 1 from wound rolls for combat attacks that target this unit if it did not charge in the same turn.

#### Remorseless Conquerer (Passive)
- **Effect:** Add 2 to run rolls for visible friendly Ossiarch Bonereapers units while they are wholly within 12" of this unit.

### Paths

#### Ambitious Duellist (Passive)
...
#### Scholar of the Deathly Arts (Activated)
...
#### Obsessively Studious (Activated)
- **Timing:** Once Per Battle, Your Hero Phase
- **Declare:** Pick a non-Summon ability that this unit can use.
- **Effect:** For the rest of the phase, this unit can use that ability as if it had the Unlimited keyword.

#### Aura of the Nadir (Activated)
- **Timing:** Any Combat Phase
- **Declare:** Pick an enemy unit in combat with this unit to be the target.
- **Effect:** Subtract 1 from the Attacks characteristic of the target's melee weapons for the rest of the turn.

#### Necromantic Prodgies (Passive)
- **Effect:** Add 1 to this unit's power level.

#### Single-minded Ruthlessness (Activated)
- **Timing:** Any Combat Phase
...
#### Ruthless Extermination (Activated)
- **Timing:** Once Per Turn (Army), Reaction: You declared a Shoot ability for a unit that has not used a Relentless Discipline ability this phase
...
#### Pitiless Assault (Activated)
- **Timing:** Reaction: You declared a Fight ability for a unit that has not used a Relentless Discipline ability this phase.
...
- **Effect:** No mortal damage is inflicted on friendly Ossiarch Bonereapers units by Retreat abilities while they are wholly within 12" of this unit.
...
#### Remorseless Conquerors (Activated)
- **Timing:** Reaction: You declared a Run ability for a friendly Ossiarch Bonereapers unit.
- **Effect:** If you roll a 1-3 when determining the distance that unit can move, you can use a value of 4 instead.

#### Plentiful Bone (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
...
#### Manufactured Mind (Activated)
- **Timing:** Once Per Battle, Start of Battle Round
...
#### Imperious Will (Activated)
- **Timing:** Reaction: You declared a Fight ability for a non-Hero Ossiarch Bonereapers unit wholly within 12" of this unit.
- **Effect:** Pick an enemy unit in combat with that non-Hero unit and that did not charge this turn to be the target. Roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll. This unit can use this ability more than once per phase but only once per Fight ability.

## Subfactions

### Legions of Nagash [LEGENDS]

### Petrifex Elite [LEGENDS]

**Battle Traits**

#### Constructs of Petrified Bone (Passive)
- **Effect:** Ignore the first damage point that would be allocated to each friendly Petrifex Elite unit in each phase.

#### Relentless Onslaught (Activated)
...
- **Effect:** You gain a number of **relentless discipline** points equal to a number of shown after the target's Relentless Discipline keyword. At the end of the battle round, any unspent **relentless discipline** points are lost.
...
#### Prevailing Tactician (Activated)
- **Timing:** Your Hero Phase
...
#### Arcane Immunity (Passive)
- **Effect:** Friendly Null Myraid units have Ward (4+) against damage points inflicted by Spell abilities, Prayer abilities and abilities used by Manifestations.

#### Supernatural Absorbtion (Activated)
- **Timing:** Once Per Turn (Army), Your Hero Phase
- **Declare:** Pick an enemy Manifestation within a friendly Null Myraid unit's combat range to be the target.
...
#### First of the Mortarchs (Passive)
- **Effect:** Each time you make a casting roll for a friendly **Arkhan the Black**, if all of the following are true, that spell cannot be unbound:
...
#### Gothizzar Cartouche (Activated)
- **Timing:** Your Combat Phase
- **Declare:** Pick a visible enemy unit within 12 inches of this unit to be the target.
...
**Keywords:** HERO, DEATH, OSSIARCH BONEREAPERS, WARD (6+), UNIQUE, CAVALRY, RELENTLESS DISCIPLINE (7)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Kavalos Steed's Hooves, Teeth, and Barbed Tails | Melee | - | 4 | 5+ | 3+ | - | 1 | Companion |
| The Dark Lance | Melee | - | 5 | 3+ | 3+ | 2 | 2 | Charge (+1 Damage) |
...
**Points:** 440 | **Move:** 12" | **Health:** 14 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, DEATH, UNIQUE, OSSIARCH BONEREAPERS, WARD (6+), FLY, MONSTER, WIZARD (3), WARMASTER, RELENTLESS DISCIPLINE (3)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Razarak's Ebon Claws | Melee | - | 5 | 4+ | 2+ | 3 | 3 | Companion |
| Zefet-kar and Khenash-an | Melee | - | 4 | 3+ | 4+ | 1 | D3 | - |
...
#### The Doom of Traitors (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Mortarch of Sacrament (Activated)
- **Timing:** Once Per Turn, Reaction: Opponent declared a Spell ability for a unit within 18" of this unit
...
**Keywords:** OSSIARCH BONEREAPERS, WARD (6+), DEATH, WAR MACHINE
...
**Keywords:** INFANTRY, OSSIARCH BONEREAPERS, WARD (6+), DEATH
...
### Kainan's Reapers
**Points:** 140 | **Move:** 8" | **Health:** 2 | **Save:** 4+ | **Control:** 1
**Keywords:** INFANTRY, UNIQUE, Legends, WARD (6+), DEATH, OSSIARCH BONEREAPERS, MORTISAN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Soulreaper Axe | Melee | - | 4 | 3+ | 3+ | 2 | 2 | Anti-charge (+1 Rend) |
| Nadirite Weapon | Melee | - | 3 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend) |
| Nadirite Weapon | Melee | - | 3 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend) |
| Nadirite Weapon | Melee | - | 3 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend) |
| Nadirite Weapon | Melee | - | 3 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend) |
| Nadirite Weapon | Melee | - | 3 | 3+ | 4+ | - | 1 | Anti-charge (+1 Rend) |
...
#### Mir Kainan (Passive)
- **Effect:** While this unit’s **Mir Kainan** is on the battlefield, this unit has Wizard (1), Relentless Discipline (2) and can be picked as the target of the ‘Immortal Elite’ ability as if it had the Hero
keyword.

---

### Katakros, Mortarch of the Necropolis
**Points:** 500 | **Move:** 4" | **Health:** 20 | **Save:** 3+ | **Control:** 10
**Keywords:** OSSIARCH BONEREAPERS, DEATH, WARD (6+), HERO, INFANTRY, UNIQUE, WARMASTER, RELENTLESS DISCIPLINE (10)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Inda-Khaat | Melee | - | 3 | 3+ | 3+ | 2 | 3 | Crit (2 Hits) |
| Retinue Blades | Melee | - | 10 | 3+ | 4+ | 1 | 1 | - |
| The Shield Immortis | Melee | - | 3 | 3+ | 3+ | 2 | 2 | - |
...
- **Declare:** This unit can only use this ability if at least half the units from your starting army have been destroyed.
...
#### Supreme Lord of the Bonereaper Legions (Activated)
- **Timing:** Any Combat Phase
...
**Keywords:** OSSIARCH BONEREAPERS, WARD (6+), DEATH, CHAMPION, CAVALRY, STANDARD BEARER (1/5)
...
**Keywords:** DEATH, OSSIARCH BONEREAPERS, WARD (6+), WAR MACHINE
...
**Keywords:** HERO, DEATH, OSSIARCH BONEREAPERS, WARD (6+), CAVALRY, RELENTLESS DISCIPLINE (6)
...
**Keywords:** HERO, DEATH, OSSIARCH BONEREAPERS, WARD (6+), RELENTLESS DISCIPLINE (6), WAR MACHINE
...
**Keywords:** HERO, DEATH, OSSIARCH BONEREAPERS, WARD (6+), INFANTRY, RELENTLESS DISCIPLINE (5)
...
**Keywords:** INFANTRY, OSSIARCH BONEREAPERS, WARD (6+), DEATH, FLY
...
**Keywords:** INFANTRY, OSSIARCH BONEREAPERS, WARD (6+), DEATH, CHAMPION, STANDARD BEARER (1/10)
...
**Keywords:** INFANTRY, OSSIARCH BONEREAPERS, WARD (6+), DEATH, CHAMPION
...
**Keywords:** HERO, WIZARD (1), INFANTRY, WARD (6+), OSSIARCH BONEREAPERS, DEATH, RELENTLESS DISCIPLINE (2)
...
**Keywords:** HERO, WIZARD (1), INFANTRY, WARD (6+), OSSIARCH BONEREAPERS, MORTISAN, DEATH
...
**Keywords:** HERO, WIZARD (1), INFANTRY, WARD (6+), OSSIARCH BONEREAPERS, DEATH, RELENTLESS DISCIPLINE (2), FLY
...
**Keywords:** HERO, INFANTRY, WARD (6+), OSSIARCH BONEREAPERS, DEATH, WIZARD (2), RELENTLESS DISCIPLINE (2)
...
**Keywords:** DEATH, OSSIARCH BONEREAPERS, UNIQUE, HERO, MONSTER, WIZARD (9), WARD (5+), FLY, WARMASTER, RELENTLESS DISCIPLINE (3)
...
**Keywords:** OSSIARCH BONEREAPERS, WARD (6+), DEATH, CHAMPION (1/8), BEAST
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Weapons of the Tithe-reapers | Melee | - | 2 | 3+ | 4+ | 1 | 1 | - |

**Abilities:**

#### Truebone Mastery (Activated)
- **Timing:** Your Hero Phase
...
**Points:** 320 | **Move:** 6" | **Health:** 12 | **Save:** 3+ | **Control:** 5
**Keywords:** HERO, Legends, DEATH, OSSIARCH BONEREAPERS, MONSTER, WIZARD (1), WARD (6+), PETRIFEX ELITE, UNIQUE

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Bludgeoning Strikes | Melee | - | 5 | 4+ | 2+ | 2 | 4 | Crit (2 Hits) |
| Petrified Spinesaw | Melee | - | 1 | 4+ | 3+ | 2 | 6 | Anti-Infantry(+1 Rend) |

**Abilities:**

#### Crushing Bonebulk (Activated)
- **Timing:** Once Per Turn (Army), Any Combat Phase
...
#### Battlefield Enhancements (Activated)
- **Timing:** Once Per Battle (Army), End of Any Turn
- **Declare:** If an enemy Hero or Monster was destroyed by this unit's combat attacks this turn, pick 1 of this unit's melee weapons to be the target weapon.
...
**Points:** 140 | **Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, UNIQUE, WIZARD (2), INFANTRY, WARD (6+), DEATH, OSSIARCH BONEREAPERS, RELENTLESS DISCIPLINE (2)

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Staff of Retribution | Melee | - | 3 | 4+ | 3+ | 1 | D3 | - |
| Gaze of Death | Ranged | 12" | 1 | 3+ | 2+ | 1 | D6 | - |

**Abilities:**

#### Voice of Nagash (Command)
...
#### Mortal Contract (Spell)
- **Timing:** Your Hero Phase
- **Casting Value:** 6
- **Declare:** Pick a visible enemy unit within 18" of this unit to be the target, then make a casting roll of 2D6.
- **Effect:** Until the start of your next turn, each time the target is picked to use a Core ability, roll a D3. On a 2+, inflict an amount of mortal damage on the target equal to the roll. If the target is destroyed by this ability, do not resolve the effect of that Core ability.
- **Keywords:** Spell
