...
> Variant: Mortisan Boneshaper (Scourge of Ghyran) — 100 pts
...
- **Timing:** Your Hero Phase
- **Cost:** 1
- **Declare:** If this unit is not in combat, pick a friendly Mortek Guardunit that has been destroyed to be the target.
...
### Anvil of Apotheosis: Ossiarch Bonereapers Hero
**Move:** 5" | **Health:** 5 | **Save:** 4+ | **Control:** 2
**Keywords:** HERO, INFANTRY, WARD (6+), RELENTLESS DISCIPLINE (2), DEATH, OSSIARCH BONEREAPERS

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Nadirite Blade | Melee | - | 3 | 3+ | 4+ | 1 | 2 |  |
| Monstrous Blades | Melee | - | 3 | 3+ | 2+ | 2 | 3 | Crit (Mortal) |
| Kavalos Steed's Hooves, Teeth, and Barbed Tails | Melee | - | 4 | 5+ | 3+ | - | 1 | Companion |
| Chariot Steeds' Fangs and Hooves | Melee | - | 6 | 5+ | 3+ | - | 1 | Companion |
| Crushing Appendages | Melee | - | 7 | 4+ | 3+ | - | 2 | Anti-Faction Terrain (+1 Rend), Companion |
| Ossified Talons | Melee | - | 3 | 4+ | 4+ | - | D3 |  |
| Guardian's Weapons | Melee | - | 5 | 3+ | 3+ | 2 | 2 |  |
| Titanic Weapons | Melee | - | 5 | 3+ | 2+ | 2 | 3 | Crit (Mortal) |
| Morbid Catapult | Ranged | 18" | 4 | 4+ | 3+ | 1 | 3 | Companion |
...
> Variant: Mortek Guard (Scourge of Ghyran) — 100 pts
...
**Keywords:** OSSIARCH BONEREAPERS, WARD (6+), DEATH, CHAMPION, CAVALRY
...
### Bone-tithe Nexus
**Points:** 0 | **Move:** - | **Health:** 13 | **Save:** 4+ | **Control:** -
**Keywords:** DEATH, OSSIARCH BONEREAPERS, FACTION TERRAIN

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Almighty Obsidian Blade | Melee | - | 2 | 4+ | 2+ | 2 | 3 | - |

**Abilities:**

#### Deathly Aura (Passive)
...
### Soulstealer Carrion
**Move:** 10" | **Health:** 7 | **Save:** 5+ | **Banishment:** 7+
**Keywords:** DEATH, WARD (6+), OSSIARCH BONEREAPERS, MANIFESTATION, ENDLESS SPELL, FLY

**Weapons:**
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Spectral Claws and Beak | Melee | - | 6 | 4+ | 2+ | 1 | D3 | - |
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Lacerating Claws | Melee | - | 6 | 4+ | 2+ | 2 | 2 | - |

**Abilities:**

#### Death Incarnate (Activated)
- **Timing:** End of Any Turn
- **Effect:** If this Manifestation was destroyed or banished this turn and the unit that summoned it is on the battlefield, roll a dice. On a 4+, set up this Manifestation again, wholly within 12" of the unit that summoned it and more than 9" from all enemy units. That unit has summoned that Manifestation.
...
| Weapon | Type | Rng | Atk | Hit | Wnd | Rnd | Dmg | Ability |
|--------|------|-----|-----|-----|-----|-----|-----|---------|
| Soul-rending Shriek | Melee | - | 4 | 3+ | 4+ | 1 | D3 | - |
| Soul-rending Shriek | Ranged | 12" | 4 | 3+ | 4+ | 1 | D3 | Shoot in Combat |
...
#### Shields of the Legion (Activated)
- **Timing:** Once Per Phase (Army), Reaction: A friendly Ossiarch Bonereapers War Machine, Monster, or Mortisan unit within this unit's combat range was targeted by an Attack ability
...
### Thanatek's Tithe
**Move:** 4" | **Health:** 2 | **Save:** 4+ | **Control:** 1
...
### Ossiarch Bonereapers - The Lance of Ossia
...
### Ossiarch Bonereapers - The Null Myriad
