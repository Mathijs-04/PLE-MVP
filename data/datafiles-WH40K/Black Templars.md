...
**Keywords:** Character, Infantry, Grenades, Imperium, Tacticus, Lieutenant, Castellan

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Astartes Chainsword | Melee | Melee | 7 | 2+ | 4 | -1 | 1 | Sustained Hits 1 |
| Master-crafted Power Weapon | Melee | Melee | 6 | 2+ | 5 | -2 | 2 | Lethal Hits |
...
- **Prioritised Eradication:** Each time a model in this model's unit makes a melee attack that destroys one or more enemy units, roll one D6: on a 4+, you gain 1 CP
...
### Chaplain Grimaldus
**Points:** 110 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 1 | **LD:** 8+ | **OC:** 1
**Keywords:** Infantry, Imperium, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Artificer Crozius | Melee | Melee | 6 | 2+ | 6 | -2 | 2 | - |
...
**Keywords:** Character, Infantry, Grenades, Ancient, Tacticus, Imperium, Crusade Ancient

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Power Weapon | Melee | Melee | 5 | 2+ | 5 | -2 | 2 | Lethal Hits |
...
### Emperor's Champion
**Points:** 100 | **M:** 8" | **T:** 4 | **SV:** 2+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Imperium, Tacticus, Emperor's Champion

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Black Sword - Strike | Melee | Melee | 6 | 2+ | 8 | -3 | 3 | Anti-Character 5+, Precision |
| ➤ Black Sword - Sweep | Melee | Melee | 10 | 2+ | 6 | -2 | 1 | - |
...
■ Sword Brethren
■ Sternguard Veteran Squad
- **Chosen of the Emperor:** You cannot include more than one Emperor's Champion model in your army.
...
### Execrator
**Points:** 60 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 5+ | **OC:** 1
**Keywords:** Infantry, Character, Chaplain, Grenades, Imperium, Tacticus, Execrator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Power Weapon | Melee | Melee | 3 | 2+ | 5 | -2 | 2 | Extra Attacks, Lethal Hits |
...
**Points:** 120 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 3
**Keywords:** Epic Hero, Character, Grenades, Imperium, Tacticus, High Marshal Helbrecht, Infantry, Chapter Master

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Sword of the High Marshals - Sweep | Melee | Melee | 12 | 2+ | 6 | -3 | 1 | - |
| ➤ Sword of the High Marshals - Strike | Melee | Melee | 6 | 2+ | 8 | -3 | 3 | - |
| Ferocity | Ranged | 24" | 2 | 2+ | 5 | -1 | 2 | Anti-infantry 4+, Devastating Wounds |

**Abilities:**

- **Crusade of Wrath:** While this model is leading a unit, add 1 to the Attacks and Strength characteristic of melee weapons equipped by models in that unit.
...
### Impulsor
**Points:** 85 | **M:** 12" | **T:** 9 | **SV:** 3+ | **W:** 11 | **LD:** 6+ | **OC:** 2
...
- **Assault Ramp:** Each time a unit disembarks from this model after it has made a Normal move, that unit is still eligible to declare a charge this turn.
- **Legacy of Jerulas:** In your Shooting phase, after this model has shot, select one enemy unit hit by one or more of those attacks. Until the end of the turn, each time a friendly model that disembarked from this TRANSPORT this turn makes an attack that targets that enemy unit, re-roll a Hit roll of 1 and a re-roll a Wound roll of 1
...
### Marshal
**Points:** 80 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Imperium, Tacticus, Marshal, Captain

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Power Weapon | Melee | Melee | 7 | 2+ | 5 | -2 | 2 | Lethal Hits |
| ➤ Plasma Pistol - Standard | Ranged | 12" | 1 | 2+ | 7 | -2 | 1 | Pistol |
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Las-talon | Ranged | 36" | 2 | 3+ | 10 | -3 | D6 | - |
...
- **Interception Strike:** Each time this model makes a ranged attack that targets a unit that is within 12" of one or more ADEPTUS ASTARTES units from your army, you can re-roll the Hit roll.
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Astartes Chainsword | Melee | Melee | 6 | 3+ | 4 | -1 | 1 | - |
| Power Weapon | Melee | Melee | 5 | 3+ | 5 | -2 | 1 | - |
| Power Fist | Melee | Melee | 4 | 3+ | 8 | -2 | 2 | - |

**Abilities:**

- **Vitruous Onslaught:** Each time a model in this unit makes an attack that targets the closest eligible target, you can re-roll a Wound roll of 1.
...
### Sword Brethren Squad
**Points:** 105 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
...
| Master-crafted Power Weapon | Melee | Melee | 3 | 2+ | 5 | -2 | 2 | Lethal Hits |
| Astartes Chainsword | Melee | Melee | 6 | 2+ | 4 | -1 | 1 | Sustained Hits 1 |
| Twin Lightning Claws | Melee | Melee | 5 | 2+ | 5 | -2 | 1 | Twin-linked |
...
### Terminator Squad
**Points:** 175 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 1
