...
### Darnath Lysander
**Points:** 100 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 7 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Captain, Imperium, Terminator, Darnath Lysander

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Fist of Dorn | Melee | Melee | 5 | 2+ | 10 | -3 | 3 | Devastating Wounds |
...
■ Terminator Assault Squad
■ Terminator Squad
- **Inspiring Commander:** ‘If you include this model in your army, until the end of the battle, non-Character models in Terminator Assault Squad and Terminator Squad units from your army have an Objective Control characteristic of 2 while they are not Battle-shocked.
...
**Keywords:** Epic Hero, Character, Infantry, Grenades, Imperium, Chapter Master, Pedro Kantor

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Dorn's Arrow | Ranged | 24" | 2 | 2+ | 5 | -1 | 2 | Rapid Fire 2, Sustained Hits 1 |
| Fist of Retribution | Melee | Melee | 5 | 2+ | 8 | -3 | 3 | - |
...
■ Sternguard Veteran Squad
■ Tactical Squad
- **Inspiring Commander:** If you include this model in your army, until the end of the battle, non-Character models in Sternguard
...
### Tor Garadon
**Points:** 90 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Captain, Gravis, Tor Garadon, Imperium

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Artificer Grav Gun | Ranged | 18" | 2 | 2+ | 5 | -1 | 2 | Anti-vehicle 2+ |
| Hand of Defiance | Melee | Melee | 5 | 2+ | 12 | -2 | 2 | - |
