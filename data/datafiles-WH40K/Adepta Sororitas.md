...
**Points:** 70 | **M:** 6" | **T:** 3 | **SV:** 2+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Aestred Thurga and Agathae Dolan, Character, Imperium, Grenades, Infantry

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blade of Vigil | Melee | Melee | 4 | 2+ | 5 | -2 | 2 | - |
| Scribe's staff | Melee | Melee | 3 | 4+ | 4 | 0 | 1 | - |
...
### Arco-Flagellants
**Points:** 45 | **M:** 7" | **T:** 3 | **SV:** 7+ | **W:** 2 | **LD:** 8+ | **OC:** 1
**Keywords:** Infantry, Imperium, Penitent

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Arco-flails | Melee | Melee | 4 | 4+ | 5 | 0 | 1 | Sustained Hits 1 |
...
### Battle Sisters Squad
**Points:** 105
**Keywords:** Infantry, Battleline, Grenades, Battle Sisters Squad, Imperium
...
### Canoness
**Points:** 60 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Canoness

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Brazier of Holy Fire | Ranged | 12" | D6 | N/A | 6 | -1 | 2 | Ignores Cover, One Shot, Torrent |
| Blessed blade | Melee | Melee | 4 | 2+ | 6 | -2 | 2 | Lethal Hits |
| Power weapon | Melee | Melee | 4 | 2+ | 4 | -2 | 2 | - |
| Hallowed Chainsword | Melee | Melee | 5 | 2+ | 3 | -1 | 1 | - |
| Bolt Pistol | Ranged | 12" | 1 | 2+ | 4 | 0 | 1 | Pistol |
| Condemnor boltgun | Ranged | 24" | 1 | 2+ | 4 | 0 | 1 | Anti-Psyker 2+, Devastating Wounds, Precision, Rapid Fire 1 |
| Inferno Pistol | Ranged | 6" | 1 | 2+ | 8 | -4 | D3 | Melta 2, Pistol |
...
**Points:** 75 | **M:** 12" | **T:** 3 | **SV:** 3+ | **W:** 3 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Canoness, Jump Pack, Fly, Imperium

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blessed Halberd | Melee | Melee | 5 | 2+ | 5 | -2 | 2 | - |
| Power weapon | Melee | Melee | 4 | 2+ | 4 | -2 | 2 | - |
| Holy Eviscerator | Melee | Melee | 3 | 2+ | 6 | -2 | 2 | Sustained Hits 1 |

**Abilities:**

- **Divine Deliverance:** Once per battle, at the start of the Fight phase, this model can use this ability. If it does, until the end of the phase, add 3 to the Attacks characteristic of melee weapons equipped by the model and those weapons have the [DEVASTATING WOUNDS] ability
- **Invulnerable Save:** This model has an invulnerable save of 4+
- **Leader:** This unit can be attached to the following units: 
- Seraphim Squad
- Zephyrim Squad
...
### Castigator
**Points:** 160 | **M:** 10" | **T:** 10 | **SV:** 3+ | **W:** 11 | **LD:** 7+ | **OC:** 3
**Keywords:** Vehicle, Smoke, Imperium, Castigator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Heavy bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Sustained Hits 1 |
| Castigator autocannons | Ranged | 48" | 4 | 3+ | 9 | -1 | 3 | Twin-Linked, Rapid Fire 4 |
| Castigator battle cannon | Ranged | 48" | D6+3 | 3+ | 10 | -1 | 3 | Blast, Ignores Cover |
...
**Points:** 120 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Celestian Insidiants

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blessed sword | Melee | Melee | 3 | 3+ | 4 | -2 | 2 | Lethal Hits |
| Virge of Admonition | Melee | Melee | 3 | 4+ | 6 | -2 | 3 | Anti-PSYKER 4+, Devastating Wounds |
...
- **Attached Unit:** If a Character unit from your army can be attached to a Dominion Squad unit, it can be attached to this unit instead.
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Anointed Halberd | Melee | Melee | 3 | 3+ | 5 | -2 | 1 | Sustained Hits 1 |
| Hallowed Mace | Melee | Melee | 3 | 3+ | 4 | -1 | 2 | Lethal Hits |
...
- **Invulnerable Save:** Models in this unit have an Invulnerable save of 4+.
...
### Daemonifuge
**Points:** 85 | **M:** 8" | **T:** 3 | **SV:** 3+ | **W:** 5 | **LD:** 7+ | **OC:** 1
**Keywords:** Epic Hero, Infantry, Grenades, Character, Imperium, Daemonifuge

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Sanctity | Melee | Melee | 4 | 2+ | 6 | -2 | 2 | Anti-Chaos 2+, Precision |
| The Outcast's Blades | Melee | Melee | 6 | 2+ | 4 | -2 | 1 | Precision |
...
- **Mysterious Savious:** You can target this unit with the Heroic Intervention Stratagem for 0CP, and can do so even if you have already targeted a different unit with that Stratagem this phase.
- **Invulnerable Save:** Models in this units have an Invulnerable save of 4+
...
### Dialogus
**Points:** 40 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Imperium, Dialogus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Dialogus staff | Melee | Melee | 3 | 4+ | 4 | 0 | 1 | - |
...
### Dogmata
**Points:** 45 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Grenades, Imperium, Dogmata

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Mace of the Righteous | Melee | Melee | 4 | 3+ | 5 | -2 | 2 | - |
...
- **Holy Vanguard:** If this unit has a Leader unit attached to it during the Declare Battle Formations step and this unit starts the battle embarked within a Transport, that Leader unit gains the Scouts 6" ability.
- **Righteous Awareness:** Once per turn, when an enemy unit ends a Normal, Advance, or Fall Back move within 9" of this unit, if this unit is not within Engagement Range of one or more enemy units, it can make a Normal move of up to D6".
...
### Exorcist
**Points:** 210 | **M:** 10" | **T:** 10 | **SV:** 3+ | **W:** 11 | **LD:** 7+ | **OC:** 3
...
|--------|------|-------|---|-------|---|----|---|----------|
| Heavy Bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Sustained Hits 1 |
| Exorcist Missile Launcher | Ranged | 36" | D6+2 | 3+ | 10 | -3 | D6 | Indirect Fire |
| Exorcist Conflagration Rockets | Ranged | 36" | 3D6 | 3+ | 6 | -1 | 1 | Blast, Ignores Cover, Indirect Fire |
...
### Geminae Superia
**M:** 12" | **T:** 3 | **SV:** 2 | **W:** 2 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Fly, Grenades, Imperium, Jump Pack

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Power Weapon | Melee | Melee | 4 | 3+ | 4 | -2 | 1 | - |
...
### Hospitaller
**Points:** 60 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 3 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Character, Imperium, Hospitaller

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Chirugeon's tools | Melee | Melee | 3 | 4+ | 3 | 0 | 1 | - |
...
- **Sacred Healing:** While this model is leading a unit, in your Command phase, you can return up to 1 destroyed model (excluding Character models) to that unit. If you wish, you first discard 1 Miracle dice; if you do, you can return up to D3+1 destroyed models (excluding Character models) to that unit instead.
- **Invulnerable Save:** This model has an invulnerable save of 6+

---

### Imagifier
**Points:** 65 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Grenades, Imperium, Imagifier

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 3 | 4+ | 3 | 0 | 1 | - |
...
■ Retributor Squad
This model can be attached to a Battle Sisters Squad, even if one Canoness, Palatine, Junith Eruita, or Aestred Thurga unit has already been attached to it. If you do, and that Bodyguard unit is destroyed, the Leader units attached to it become separate units, with their original Starting Strengths.
- **Litany of Deeds:** Each time you gain a Miracle dice as the result of a friendly ADEPTA SORORITAS unit or model being destroyed, if that unit or model was destroyed within 12" of this model, you can re-roll the result of that Miracle dice before adding it to your Miracle dice pool.
...
### Immolator
**Points:** 115 | **M:** 12" | **T:** 10 | **SV:** 3+ | **W:** 11 | **LD:** 7+ | **OC:** 2
**Keywords:** Dedicated Transport, Vehicle, Smoke, Transport, Imperium, Immolator
...
### Inspiring Devotee [Crucible]
**Points:** 50 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Imperium, Crucible, Inspiring Devotee

**Abilities:**

- **Sacred Devotions:** Each time this unit performs an Act of Faith, the value of one of the Miracle dice used in that Act of Faith is first changed to a 4.
- **Leader:** This model can be attached to the following units: Battle Sisters Squad, Celestian Sacresants, Dominion Squad, Retributor Squad, Sisters Novitiate Squad
- **Invulnerable Save (6+):** This model has a 6+ invulnerable save.

---

### Junith Eruita
**Points:** 80 | **M:** 8" | **T:** 5 | **SV:** 2+ | **W:** 8 | **LD:** 6+ | **OC:** 2
**Keywords:** Epic Hero, Character, Fly, Imperium, Junith Eruita, Mounted

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Twin Ministorum Heavy Flamer | Ranged | 12" | D6 | N/A | 6 | -1 | 1 | Ignores Cover, Torrent, Twin-Linked |
| Mace of Castigation | Melee | Melee | 4 | 2+ | 6 | -2 | 2 | - |
...
■ Retributor Squad
■ Sisters Novitiate Squad
- **The Pulpit of Saint Holline’s Basilica:** While this model is leading a unit, each time an attack targets that unit, subtract 1 from the Hit roll.
- **Fiery Conviction:** If this model is on the battlefield at the start
...
### Militant Commander [Crucible]
**Points:** 75 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Imperium, Canoness, Militant Commander, Crucible

**Abilities:**

- **Sacred Command:** Once per battle round, one unit from your army with the ability can be targeted with a Stratagem for 0CP, even if another unit from your army has already been targeted with that Stratagem this phase.
- **Leader:** This model can be attached to the following units: Battle Sisters Squad, Celestian Sacresants, Dominion Squad, Retributor Squad, Sisters Novitiate Squad
- **Invulnerable Save (4+):** This model has a 4+ invulnerable save.
...
**Keywords:** Infantry, Character, Imperium, Ministorum Priest, Penitent
...
- **Holy Mission:** If this model is attached to a Dominion Squad during the Declare Battle Formations step, it gains the Scouts 6" ability. If this model is attached to a Sisters Novitiate Squad during the Declare Battle Formations step, it gains the Infiltrators ability.
- **Invulnerable Save:** This model has an invulnerable save of 4+

---

### Mortifiers
**Points:** 70 | **M:** 8" | **T:** 6 | **SV:** 4+ | **W:** 5 | **LD:** 7+ | **OC:** 2
**Keywords:** Vehicle, Walker, Imperium, Mortifiers, Penitent

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Twin Penitent Buzz-Blades | Melee | Melee | 4 | 3+ | 10 | -3 | 2 | Sustained Hits 1,Twin-Linked |
| Twin Penitent Flails | Melee | Melee | 8 | 3+ | 5 | -1 | 1 | Sustained Hits 1, Twin-Linked |
| Penitent Buzz-Blade | Melee | Melee | 4 | 3+ | 10 | -3 | 2 | Sustained Hits 1 |
| Penitent Flail | Melee | Melee | 8 | 3+ | 5 | -1 | 1 | Sustained Hits 1 |
| Heavy Bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Sustained Hits 1 |
| Mortifier flamer | Ranged | 12" | D6 | n/a | 5 | 0 | 1 | Ignores Cover, Torrent, Twin-Linked |

**Abilities:**

- **Anchorite Sarcophagus:** The bearer has a Move characteristic of 7" and a Save Characteristic of 3+.
- **Anguish of the Unredeemed:** Each time a model in this unit is destroyed by a melee attack, if that model has not fought this phase, roll one D6. On a 2+, do not remove it from play; that destroyed model can fight after attacking unit has finished making its attacks, and is then removed from play.
- **Invulnerable Save:** This model has an invulnerable save of 6+

---

### Morvenn Vahl
**Points:** 185 | **M:** 8" | **T:** 7 | **SV:** 2+ | **W:** 8 | **LD:** 6+ | **OC:** 3
**Keywords:** Vehicle, Walker, Character, Epic Hero, Imperium, Morvenn Vahl

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Lance of Illumination - strike | Melee | Melee | 5 | 2+ | 8 | -2 | 3 | Devastating Wounds |
| ➤ Lance of Illumination - sweep | Melee | Melee | 10 | 2+ | 5 | -1 | 1 | Devastating Wounds |
| Fidelis | Ranged | 36" | 3 | 2+ | 6 | -1 | 2 | Sustained Hits 1 |
| ➤ Paragon missile launcher - prioris | Ranged | 36" | 2 | 2+ | 9 | -2 | D6 | - |
| ➤ Paragon missile launcher - sanctorum | Ranged | 36" | 2D6 | 2+ | 4 | 0 | 1 | Blast |
...
### Palatine
**Points:** 50 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Character, Grenades, Imperium, Palatine

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Palatine blade | Melee | Melee | 4 | 2+ | 4 | -2 | 2 | - |
| ➤ Plasma pistol - supercharge | Ranged | 12" | 1 | 2+ | 8 | -3 | 2 | Hazardous, Pistol |
| ➤ Plasma pistol - standard | Ranged | 12" | 1 | 2+ | 7 | -2 | 1 | Pistol |
...
### Paragon Warsuits
**Points:** 210 | **M:** 8" | **T:** 7 | **SV:** 2+ | **W:** 4 | **LD:** 7+ | **OC:** 2
**Keywords:** Vehicle, Walker, Grenades, Imperium, Paragon Warsuits

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Paragon Storm Bolters | Ranged | 24" | 2 | 3+ | 4 | 0 | 1 | Rapid Fire 2, Twin-Linked |
| Paragon Grenade Launchers | Ranged | 24" | 1 | 3+ | 9 | -2 | D3 | Twin-Linked |
| Paragon War Blade | Melee | Melee | 4 | 3+ | 8 | -2 | 2 | - |
| Paragon War Mace | Melee | Melee | 3 | 3+ | 12 | -1 | 3 | - |
| Heavy Bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Sustained Hits 1 |
| Multi-melta | Ranged | 18" | 2 | 3+ | 9 | -4 | D6 | Melta 2 |
...
### Penitent Engines
**Points:** 75 | **M:** 8" | **T:** 6 | **SV:** 4+ | **W:** 5 | **LD:** 7+ | **OC:** 2
**Keywords:** Vehicle, Walker, Imperium, Penitent Engines, Penitent

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Penitent Flamers | Ranged | 12" | 2D6 | N/A | 5 | 0 | 1 | Assault, Ignores Cover, Torrent, Twin-Linked |
| Twin Penitent Buzz-Blades | Melee | Melee | 4 | 4+ | 10 | -3 | 2 | Sustained Hits 1, Twin-Linked |
| Twin Penitent Flails | Melee | Melee | 8 | 4+ | 5 | -1 | 1 | Sustained Hits 1, Twin-Linked |
| Penitent Buzz-Blade | Melee | Melee | 4 | 4+ | 10 | -3 | 2 | Sustained Hits 1 |
| Penitent Flail | Melee | Melee | 8 | 4+ | 5 | -1 | 1 | Sustained Hits 1 |
...
### Reliquant Knight [Crucible]
**Points:** 100 | **M:** 8" | **T:** 7 | **SV:** 2+ | **W:** 4 | **LD:** 7+ | **OC:** 2
**Keywords:** Character, Grenades, Imperium, Crucible, Vehicle, Walker, Reliquant Knight, Paragon Warsuits

**Abilities:**

- **Adamant Wrath:** You can re-roll Advance and Charge rolls made for this unit.
- **Leader:** This model can be attached to the following units: Paragon Warsuits
- **Invulnerable Save (4+):** This model has a 4+ invulnerable save.
...
- **Invulnerable Save:** Models in this units have an invulnerable save of 6+
...
### Saint Celestine
**Points:** 150 | **M:** 12" | **T:** 3 | **SV:** 2+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Fly, Grenades, Imperium, Epic Hero, Jump Pack

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| The Ardent Blade | Ranged | 12" | D6 | N/A | 6 | -2 | 1 | Ignores Cover, Torrent |
| The Ardent Blade | Melee | Melee | 5 | 2+ | 6 | -3 | 2 | Devastating Wounds |
...
■ Seraphim Squad
■ Zephyrim Squad
- **Healing Tears:** While this unit contains a Celestine model, in your Command phase, if this unit is below its Starting Strength, either one destroyed Geminae Superia model or up to D3 other Bodyguard models are returned to this unit.
...
### Sanctifiers
**Points:** 110 | **M:** 6" | **T:** 3 | **SV:** 6+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Sanctifiers

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 2 | 3+ | 3 | 0 | 1 | - |
| ➤ Plasma gun - standard | Ranged | 12" | 1 | 3+ | 7 | -2 | 1 | Rapid Fire 1 |
| ➤ Plasma gun - supercharge | Ranged | 12" | 1 | 3+ | 8 | -3 | 2 | Hazardous, Rapid Fire 1 |
...
- **Attached Unit:** If a Ministorum Priest model from your army with the Leader ability can be attached to a Battle Sisters Squad, it can be attached to this unit instead. If a Ministorum Priest model from your army is attached to this unit during the Declare Battle Formations step, that model gains the Scouts 6" ability.
...
### Seraphim Squad
**Points:** 80 | **M:** 12" | **T:** 3 | **SV:** 3+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Fly, Grenades, Imperium, Seraphim Squad, Jump Pack

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Power Weapon | Melee | Melee | 3 | 3+ | 4 | -2 | 1 | - |
| Chainsword | Melee | Melee | 4 | 3+ | 3 | 0 | 1 | - |
...
| Novitiate melee weapon | Melee | Melee | 2 | 4+ | 4 | 0 | 1 | - |
| Ministorum flamer | Ranged | 12" | D6 | N/A | 5 | 0 | 1 | Ignores Cover, Torrent |
| Novitiate autogun | Ranged | 24" | 1 | 3+ | 3 | 0 | 1 | Rapid Fire 1 |

**Abilities:**

- **Sacred Banner:** You can re-roll Advance and Charge rolls made for the bearer’s unit.
- **Impetuous Fervour:** Impetuous Fervour: Each time a model in this unit makes an attack, re-roll a Hit roll of 1. If the target of that attack is an enemy unit within range of an objective marker, you can re-roll the Hit roll instead.
- **Invulnerable Save:** This model has an invulnerable save of 6+
- **Simulacrum Imperialis:** At the end of your Command phase, for each objective marker you control that has one or more units from your army with this ability within range of it, roll one D6: on a 4+, you gain 1 Miracle dice showing a value equal to that result.
...
### Sororitas Rhino
**Points:** 75 | **M:** 12" | **T:** 9 | **SV:** 3+ | **W:** 10 | **LD:** 7+ | **OC:** 2
**Keywords:** Dedicated Transport, Vehicle, Transport, Smoke, Imperium, Sororitas Rhino
...
**Points:** 235 | **M:** 6" | **T:** 3 | **SV:** 3+ | **W:** 18 | **LD:** 6+ | **OC:** 6
**Keywords:** Infantry, Grenades, Character, Epic Hero, Imperium, Triumph of Saint Katherine

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Bolt Pistols | Ranged | 12" | 6 | 2+ | 4 | 0 | 1 | Pistol |
| Relic Weapons | Melee | Melee | 18 | 2+ | 5 | -2 | 1 | - |

**Abilities:**

- **Leader:** This model can be attached to the following unit:
■ Battle Sisters Squad
- **Damaged: 1-6 Wounds Remaining:** While this model has 1-6 wounds remaining, the Attacks characteristics of all of its weapons are halved, and you can only select one ability when using its Relics of the Matriarchs ability, instead of up to two.
- **Relics of the Matriarchs:** At the start of the battle round, select up to two of the abilities in the Relics of the Matriarchs section. Until the start of the next battle round, this model has those abilities.
- **Relic of the Matriarch - The Fiery Heart (Aura):** While a friendly Adepta Sororitas unit is within 6" of this model, add 2" to that unit's Move characteristic and add 1 to the Advance and Charge rolls made for that unit.
- **Relic of the Matriarch - Censer of the Sacred Rose (Aura):** While a friendly Adepta Sororitas unit is within 6" of this model, you can re-roll all Battle-shock tests taken for that unit.
- **Relic of the Matriarch - Simulacrum of the Ebon Chalice (Aura):** While a friendly Adepta Sororitas unit is within 6" of this model, that unit can perform up to two Acts of Faith per phase, instead of only one.
- **Relic of the Matriarch - Simulacrum of the Argent Shroud (Aura):** While a friendly Adepta Sororitas unit is within 6" of this model, each time a model in that unit makes a ranged attack, re-roll a Wound roll of 1.
- **Relic of the Matriarch - Icon of the Valorous Heart (Aura):** While a friendly Adepta Sororitas unit is within 6" of this model, models in that unit have the Feel No Pain 6+ ability.
- **Relic of the Matriarch - Petals of the Bloody Rose (Aura):** While a friendly Adepta Sororitas unit is within 6" of this model, improve the Armour Penetration characteristic of melee weapons equipped by model in that unit by 1.
...
### Zephyrim Squad
**Points:** 80 | **M:** 12" | **T:** 3 | **SV:** 3+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Fly, Grenades, Imperium, Zephyrim Squad, Jump Pack
