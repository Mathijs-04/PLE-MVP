...
### Arkanyst Evaluator
**Points:** 65 | **M:** 5" | **T:** 5 | **SV:** 3+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Arkanyst Evaluator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Transmatter inverter - half charge | Ranged | 12" | 3 | 2+ | 8 | -1 | 1 | Rapid Fire 1 |
| ➤ Transmatter inverter - full charge | Ranged | 18" | 3 | 2+ | 8 | -2 | 2 | Hazardous, Rapid Fire 2 |
| ➤ Transmatter inverter - overcharge | Ranged | 24" | 3 | 2+ | 8 | -3 | 3 | Hazardous, Overcharge, Rapid Fire 3 |
...
- **Resource Transmutation:** Once per turn, in your Shooting phase, one model with this ability can choose to use it when it is selected to shoot. If it does, you must spend 1YP and, until the end of the phase, ranged weapons equipped by that model have the [Sustained Hits 1] ability and, after that model has shot this phase, if one or more enemy units were destroyed by those attacks, you can gain up to 2YP.

---

### Berehk Stornbröw
**Points:** 110 | **M:** 6" | **T:** 6 | **SV:** 5+ | **W:** 5 | **LD:** 7+ | **OC:** 1
**Keywords:** Epic Hero, Infantry, Character, Cthonian, Berehk Stornbröw

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Kromlôk's Revenge - graviton strikes | Melee | Melee | 4 | 2+ | 10 | -2 | 4 | Anti-Monster 3+, Anti-Vehicle 3+, Sustained Hits 1 |
| Kromlôk's Revenge - plasma sweeps | Melee | Melee | 8 | 2+ | 7 | -2 | 2 | Sustained Hits 1 |
| Warforge gauntlets | Melee | Melee | 2 | 2+ | 6 | -2 | 1 | Extra Attacks, Sustained Hits 1 |

**Abilities:**

- **Invulnerable Save (5+):** This model has a 5+ invulnerable save.
- **Break the Foe:** Melee weapons equipped by models in this unit have the [Sustained Hits 1] ability.
- **Relentless Avalanche:** You can target this model's unit with the Heroic Intervention Stratagem for 0CP, and can do so even if you have already targeted a different unit with that Stratagem this phase.
- **Leader:** This model can be attached to the following units: Cthonian Beserks

---

### Brôkhyr Iron-master
**Points:** 75 | **M:** 5" | **T:** 5 | **SV:** 4+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Character, Brôkhyr

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Autoch-pattern bolt pistol | Ranged | 12" | 1 | 3+ | 4 | 0 | 1 | Pistol |
| Close combat weapon | Melee | Melee | 1 | 4+ | 3 | 0 | 1 | - |
| Plasma torch | Melee | Melee | 1 | 4+ | 6 | -3 | 2 | - |
| Manipulator arms | Melee | Melee | 3 | 4+ | 3 | 0 | 1 | - |
| Las-beam cutter | Ranged | 6" | 1 | 4+ | 6 | -3 | 1 | - |
| Graviton hammer | Melee | Melee | 3 | 4+ | 9 | -1 | 3 | Anti-MONSTER 3+, Anti-VEHICLE 3+ |
| Graviton rifle | Ranged | 18" | 3 | 3+ | 5 | -1 | 3 | Anti-MONSTER 3+, Anti-VEHICLE 3+ |

**Abilities:**

- **Multi-spectral visor:** Each time a model in this unit makes a ranged attack, re-roll a Wound roll of 1.
...
- HEARTHKYN WARRIORS
- BRÔKHYR THUNDERKYN
- **Unit Composition:** If this unit’s Brôkhyr Iron‑master model is ever destroyed, all of this unit’s remaining E‑COG models are also destroyed. While embarking within a Transport and while embarked within a Transport, each E‑COG model takes up the space of 0 models.
...
### Brôkhyr Thunderkyn
**Points:** 80 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 2 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Exoframe, Thunderkyn, Brôkhyr

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 2 | 4+ | 4 | 0 | 1 | - |
| Bolt cannon | Ranged | 36" | 3 | 4+ | 6 | -1 | 2 | Sustained Hits 2 |
| Graviton blast cannon | Ranged | 24" | 3 | 4+ | 5 | -2 | 3 | Anti-MONSTER 3+, Anti-VEHICLE 3+ |
| SP conversion beamer | Ranged | 24" | 2 | 4+ | 7 | -2 | 3 | Conversion, Lethal Hits |
...
### Buri Aegnirssen
**Points:** 95 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Infantry, Character, Buri Aegnirssen

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Autoch-pattern bolt pistol | Ranged | 12" | 1 | 2+ | 4 | 0 | 1 | Pistol |
| ➤ Bane - strike | Melee | Melee | 5 | 2+ | 12 | -3 | 3 | Precision |
| ➤ Bane - sweep | Melee | Melee | 10 | 2+ | 6 | -2 | 1 | - |
...
### Cthonian Beserks
**Points:** 100 | **M:** 6" | **T:** 6 | **SV:** 5+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Cthonian, Beserks

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Twin concussion gauntlets | Melee | Melee | 4 | 4+ | 9 | -2 | 2 | Twin-linked |
| Mole grenade launcher | Ranged | 18" | D6 | 5+ | 5 | -1 | 1 | Blast, Indirect Fire |

**Abilities:**

- **Cyberstimms:** Each time a model in this unit is destroyed by a melee attack, if that model has not fought this phase, roll one D6, adding one to the result if units from your army have Fortify Takeover: on a 4+, do not remove it from play. The destroyed model can fight after the attacking unit has finished making its attacks, and is then removed from play.
- **Subterranean Explosives:** In your Shooting phase, after this unit has shot, select one enemy unit (excluding Monsters and Vehicles) that was hit by one or more of those attacks made with a mole grenade launcher. Until the start of your next Shooting phase, that enemy unit cannot be targeted with the Fire Overwatch Stratagem.

---

### Cthonian Earthshakers
**Points:** 110 | **M:** 4" | **T:** 6 | **SV:** 4+ | **W:** 6 | **LD:** 7+ | **OC:** 2
**Keywords:** Infantry, Artillery, Cthonian, Earthshakers

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Plasma picks | Melee | Melee | 4 | 3+ | 5 | -2 | 1 | - |
| Autoch-pattern bolt pistol | Ranged | 12" | 1 | 4+ | 4 | 0 | 1 | Pistol |
| Breacher ordnance | Ranged | 24" | D6+1 | 5+ | 10 | -1 | 2 | Blast, Heavy, Indirect Fire |
| Tremor shells | Ranged | 36" | D6+4 | 5+ | 6 | -1 | 1 | Blast, Heavy, Indirect Fire |
...
### Einhyr Champion
**Points:** 70 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 5 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Character, Exoarmour, Einhyr Champion

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Mass hammer | Melee | Melee | 3 | 3+ | 12 | -3 | D6+1 | - |
| Darkstar axe | Melee | Melee | 6 | 2+ | 6 | -3 | 2 | - |
...
### Einhyr Hearthguard
**Points:** 135 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 2 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Exoarmour, Einhyr Hearthguard

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Exo-armour grenade launcher | Ranged | 24" | D3 | 3+ | 3 | 0 | 1 | Blast |
| EtaCarn plasma gun | Ranged | 24" | 1 | 3+ | 7 | -3 | 2 | Rapid Fire 1 |
| Volkanite disintegrator | Ranged | 24" | 3 | 3+ | 5 | 0 | 1 | Devastating Wounds |
| Concussion gauntlet | Melee | Melee | 2 | 3+ | 8 | -2 | 2 | - |
| Plasma blade gauntlet | Melee | Melee | 3 | 3+ | 6 | -2 | 1 | - |
| Graviton hammer | Melee | Melee | 3 | 4+ | 9 | -1 | 3 | Anti-MONSTER 3+, Anti-VEHICLE 3+ |
...
### Grimnyr
**Points:** 65 | **M:** 5" | **T:** 5 | **SV:** 4+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Ancestral ward stave | Melee | Melee | 2 | 3+ | 7 | -1 | D3 | Psychic |
| ➤ Ancestral Wrath - witchfire | Ranged | 24" | 3 | 3+ | 6 | -2 | D3 | Psychic |
| ➤ Ancestral Wrath - focused witchfire | Ranged | 24" | 6 | 3+ | 6 | -2 | D3 | Hazardous, Psychic |
| Autoch-pattern bolter | Ranged | 24" | 2 | 4+ | 4 | 0 | 1 | - |
| Close combat weapon | Melee | Melee | 1 | 4+ | 3 | 0 | 1 | - |
...
- **Fortify (Psychic):** While this model is leading a unit, models in that unit have the Feel No Pain 5+ ability.
...
- **Unit Composition:** If this unit’s Grimnyr model is ever destroyed, all of this unit’s remaining CORV models are also destroyed. While embarking within a Transport and while embarked within a Transport, each CORV model takes up the space of 0 models.’

---

### Hearthkyn Warriors
**Points:** 100 | **M:** 5" | **T:** 5 | **SV:** 4+ | **W:** 1 | **LD:** 7+ | **OC:** 2
...
| Theyn's melee weapon | Melee | Melee | 2 | 4+ | 5 | -2 | 2 | - |
| Autoch-pattern bolt pistol | Ranged | 12" | 1 | 4+ | 4 | 0 | 1 | Pistol |
| Autoch-pattern bolter | Ranged | 24" | 2 | 4+ | 4 | 0 | 1 | - |
| Ion blaster | Ranged | 18" | 1 | 4+ | 5 | -2 | 1 | - |
| Theyn's pistol | Ranged | 12" | 1 | 4+ | 8 | -2 | 1 | Pistol |
| HYLas rotary cannon | Ranged | 24" | 6 | 5+ | 6 | -1 | 1 | Heavy, Sustained Hits 1 |
| HYLas auto rifle | Ranged | 24" | 3 | 4+ | 6 | -1 | 1 | Assault, Rapid Fire 3 |
| Magna-rail rifle | Ranged | 18" | 1 | 5+ | 12 | -3 | D3+3 | Devastating Wounds, Heavy |
| EtaCarn plasma beamer | Ranged | 18" | 1 | 4+ | 8 | -3 | 2 | Sustained Hits D3 |

**Abilities:**

- **Luck Has, Need Keeps, Toil Earns:** At the end of your Command phase, if this unit is within range of an objective marker you control, that objective marker remains under your control, until your opponent's Level of Control over that is greater than yours at the end of a phase.
- **Pan-spectral Scanning:** Each time a model in this unit makes a ranged attack, re-roll a Hit roll of 1.

---

### Hekaton Land Fortress
**Points:** 240 | **M:** 10" | **T:** 12 | **SV:** 2+ | **W:** 16 | **LD:** 7+ | **OC:** 5
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Armoured wheels | Melee | Melee | 6 | 4+ | 8 | 0 | 1 | - |
| SP heavy conversion beamer | Ranged | 24" | 4 | 4+ | 10 | -2 | 4 | Conversion, Lethal Hits |
| Heavy magna-rail cannon | Ranged | 30" | 2 | 4+ | 18 | -4 | D6+4 | Devastating Wounds, Heavy |
| Cyclic ion cannon | Ranged | 24" | D6+2 | 4+ | 7 | -2 | 2 | Blast |
| Twin ion beamer | Ranged | 18" | D3+1 | 4+ | 8 | -2 | 1 | Blast, Twin-linked |
| Hekaton warhead | Ranged | 36" | D6+3 | 4+ | 7 | -2 | 2 | Blast, One Shot |
...
- **Pan spectral scanner:** Each time a model in the bearer's unit makes a ranged attack, re-roll a Hit roll of 1.

---

### Hernkyn Pioneers
**Points:** 80 | **M:** 12" | **T:** 6 | **SV:** 4+ | **W:** 3 | **LD:** 7+ | **OC:** 2
**Keywords:** Mounted, Grenades, Fly, Hernkyn Pioneers

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| HYLas rotary cannon | Ranged | 24" | 6 | 4+ | 6 | -1 | 1 | Sustained Hits 1 |
| Ion beamer | Ranged | 18" | D3+1 | 4+ | 8 | -2 | 1 | Blast |
...
### Hernkyn Yaegirs
**Points:** 90 | **M:** 6" | **T:** 5 | **SV:** 5+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Grenades, Hernkyn Yaegirs

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Bolt shotgun | Ranged | 18" | 2 | 4+ | 5 | 0 | 1 | Assault |
| APM launcher | Ranged | 24" | 1 | 4+ | 6 | -2 | D6 | Anti-MONSTER 3+, Anti-VEHICLE 3+ |
| Magna-coil rifle | Ranged | 24" | 1 | 4+ | 5 | -2 | 2 | Ignores Cover, Precision |
...
**Points:** 85 | **M:** 5" | **T:** 6 | **SV:** 2+ | **W:** 3 | **LD:** 7+ | **OC:** 1
...
### Kapricus Carrier
**Points:** 75 | **M:** 12" | **T:** 7 | **SV:** 4+ | **W:** 7 | **LD:** 7+ | **OC:** 2
**Keywords:** Dedicated Transport, Transport, Vehicle, Fly, Hernkyn, Kapricus, Carrier
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Magna-coil autocannon | Ranged | 24" | 3 | 4+ | 7 | -1 | 2 | - |
...
|--------|------|-------|---|-------|---|----|---|----------|
| Armoured hull | Melee | Melee | 3 | 4+ | 6 | 0 | 1 | - |
| Magna-rail cannon  | Ranged | 24" | 1 | 4+ | 14 | -4 | D3+3 | Devastating Wounds, Heavy |
| HYLas rotary cannon | Ranged | 24" | 6 | 4+ | 6 | -1 | 2 | Sustained Hits 1 |
...
**Points:** 65 | **M:** 5" | **T:** 5 | **SV:** 3+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Kinhost Commander, Crucible
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Mass gauntlet | Melee | Melee | 3 | 3+ | 8 | -3 | 3 | - |
| Forgewrought plasma axe | Melee | Melee | 4 | 2+ | 5 | -2 | 2 | - |
...
- HEARTHKYN WARRIORS
- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Seized Opportunity:** Once per phase, one model from your army with this ability can use it when its unit destroys an enemy unit. If it does, gain 1YP.

---

### Living Ancestor [Crucible]
**Points:** 70 | **M:** 5" | **T:** 5 | **SV:** 4+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Crucible, Psyker, Living Ancestor

**Abilities:**

- **Invulnerable Save (4+):** This model has a 4+ invulnerable save.
- **Leader:** This model can be attached to the following units: Hearthkyn Warriors
- **Grimnyr's Regard:** Once per battle, at the start of any phase, you can select one friendly Leagues of Votann unit that is Battle-shocked and within 12" of this model. That unit is no longer Battle-shocked.

---

### Memnyr Strategist
**Points:** 45 | **M:** 5" | **T:** 5 | **SV:** 4+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Memnyr Strategist
...
- **Computational Mastermind:** At the end of your Command phase, before you determine if units from your army have Hostile Acquisition or Fortify Takeover, for each objective marker you control that has one or more models with this ability in range of it, you can spend 1YP or gain 1YP.
...
- **Leader:** This model can be attached to the following units: Ironkin Steeljacks with Heavy Volkanite Disintegrators, Ironkin Steeljacks with Melee Weapons

---

### Sagitaur
**Points:** 90 | **M:** 12" | **T:** 9 | **SV:** 3+ | **W:** 9 | **LD:** 7+ | **OC:** 2
**Keywords:** Vehicle, Transport, Dedicated Transport, Sagitaur
**Transport:** This model has a transport capacity of 6 Leagues of Votann Infantry models. It cannot transport Artillery, Exoarmour, Exoframe or Ironkin Steeljack models.
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Armoured wheels | Melee | Melee | 3 | 4+ | 6 | 0 | 1 | - |
| HYLas beam cannon | Ranged | 24" | 2 | 4+ | 12 | -3 | D6+1 | - |
| Sagitaur missile launcher | Ranged | 36" | 2 | 4+ | 10 | -3 | 3 | - |
...
**Points:** 80 | **M:** 5" | **T:** 6 | **SV:** 2+ | **W:** 5 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Crucible, Ironkin Steeljacks, Steeljack Elder

**Abilities:**

- **Leader:** This model can be attached to the following units: Ironkin Steeljacks with Heavy Volkanite Disintegrators, Ironkin Steeljacks with Melee Weapons
- **Forgewrought Skill:** Each time this model makes an attack, you can re-roll the Hit roll.

---

### Ûthar the Destined
**Points:** 95 | **M:** 5" | **T:** 5 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Epic Hero, Ûthar the Destined

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blade of the Ancestors | Melee | Melee | 5 | 2+ | 6 | -3 | 2 | Devastating Wounds |

**Abilities:**

- **Ancestral Fortune:** Once per turn, you can spend 1YP to change one Hit roll, one Wound roll or one saving throw made for this model to a 6.
- **Leader:** This model can be attached to the following units:
- Einhyr Hearthguard
- Hearthkyn Warriors
- **Invulnerable Save:** This model has a 4+ invulnerable save.
