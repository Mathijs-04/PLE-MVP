...
**Keywords:** Beast, Chaos, Daemon, Nurgle, Summoned, Beasts of Nurgle
...
### Biologus Putrifier
**Points:** 60 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Grenades, Biologus Putrifier

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Hyper blight grenades | Ranged | 12" | D6 | 3+ | 7 | -1 | 2 | Assault, Blast, Lethal Hits |
| Injector pistol | Ranged | 3" | 1 | 3+ | 4 | -1 | 3 | Anti-INFANTRY 2+, Pistol, Precision |
| Plague knives | Melee | Melee | 4 | 3+ | 4 | 0 | 1 | Lethal Hits |

**Abilities:**

- **Extraction of Fresh Disease:** The first time this model's unit destroys an enemy unit as a result of a melee attack, until the end of the battle, add 6 to the Objective Control characteristic of this model.
- **Foul Infusion:** While this model is leading a unit, weapons equipped by models in that unit have the [Lethal Hits] ability. In addition, each time a model in that unit makes an attack, a Critical Hit is scored on an unmodified Hit roll of 5+, instead of only on a 6.

---

### Blightlord Terminators
**Points:** 115 | **M:** 5" | **T:** 7 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Chaos, Nurgle, Blightlord Terminators, Terminator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Combi-bolter | Ranged | 24" | 2 | 3+ | 4 | 0 | 1 | Lethal Hits, Rapid Fire 2 |
| Close combat weapon | Melee | Melee | 3 | 3+ | 4 | 0 | 1 | - |
| Flail of corruption | Melee | Melee | 6 | 3+ | 5 | -1 | 2 | Lethal Hits |
...
**Keywords:** Vehicle, Chaos, Nurgle, Transport, Smoke, Land Raider
...
| Soulshatter lascannon | Ranged | 48" | 2 | 3+ | 12 | -3 | D6+1 | - |
...
**Keywords:** Vehicle, Chaos, Nurgle, Smoke, Predator Destructor

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Predator autocannon | Ranged | 48" | 4 | 3+ | 9 | -1 | 3 | Lethal Hits, Rapid Fire 2 |

**Abilities:**

- **Hail of Corrosive Disease:** In your Shooting phase, after this model has shot, select one enemy unit (excluding Monsters and Vehicles) hit by one or more of those attacks. Until the end of the phase, each time a friending Death Guard unit makes a ranged attack that targets that enemy unit, improve the Armour Penetration characteristic of that attack by 1. The same enemy unit can only be affected by this ability once per phase.
...
**Keywords:** Vehicle, Transport, Dedicated Transport, Smoke, Chaos, Nurgle, Rhino
**Transport:** This model has a transport capacity of 12 Death Guard Infantry models. It cannot transport Terminator models.

**Abilities:**

- **Fire Support:** In your Shooting phase, after this model has shot, select one enemy unit hit by one or more of those attacks. Until the end of the phase, each time a friendly model that disembarked from this Transport this turn makes an attack that targets that unit, you can re-roll the Wound roll.

---

### Chaos Spawn
**Points:** 80 | **M:** 8" | **T:** 7 | **SV:** 4+ | **W:** 4 | **LD:** 7+ | **OC:** 1
...
**Points:** 195 | **M:** 8" | **T:** 12 | **SV:** 2+ | **W:** 10 | **LD:** 6+ | **OC:** 3
...
- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Fevered Strategist:** Once per Battle Round, one model from your army with this ability can use it when a friendly Death Guard unit within 12" of that model is targeted with a Stratagem. If it does, reduce the CP cost of that Stratagem by 1CP.
...
**Points:** 180 | **M:** 12" | **T:** 11 | **SV:** 2+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Monster, Character, Chaos, Nurgle, Daemon, Fly, Daemon Prince with Wings
...
**Points:** 160 | **M:** 5" | **T:** 7 | **SV:** 2+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Chaos, Nurgle, Deathshroud Terminators, Terminator

**Abilities:**

- **Silent Bodyguard:** While a Character model is leading this unit, that Character model has the Feel No Pain 4+ ability.
- **Invulnerable Save:** Models in this unit have a 4+ invulnerable save.
- **Death Approaches:** In your Movement phase, when this unit is set up on the battlefield using the Deep Strike ability, it can be set up anywhere on the battlefield that is more than 6" horizontally away from all Afflicted enemy units, and more than 9" horizontally away from any other enemy units.

---

### Defiler
**Points:** 165 | **M:** 8" | **T:** 11 | **SV:** 3+ | **W:** 14 | **LD:** 6+ | **OC:** 5
**Keywords:** Vehicle, Walker, Chaos, Nurgle, Daemon, Smoke, Defiler

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Battle cannon | Ranged | 48" | D6+3 | 3+ | 10 | -1 | 3 | Blast, Lethal Hits |
...
- **Invulnerable Save:** This model has a 5+ invulnerable save.
- **Barrage of Filth:** In your Shooting phase, after this model has shot, select one enemy unit hit by one or more of those attacks. Until the end of the phase, that enemy unit cannot have the Benefit of Cover.

---

### Foetid Bloat-drone
**Points:** 100 | **M:** 10" | **T:** 9 | **SV:** 3+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Vehicle, Fly, Chaos, Nurgle, Daemon, Foetid Bloat-drone

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Plague probe | Melee | Melee | 3 | 3+ | 6 | -1 | 1 | Lethal Hits |
| Plaguespitter | Ranged | 12" | D6 | N/A | 6 | -1 | 1 | Anti-INFANTRY 2+, Ignores Cover, Torrent |
| Fleshmower | Melee | Melee | 10 | 3+ | 7 | -1 | 2 | Lethal Hits |
...
**Points:** 120 | **M:** 10" | **T:** 9 | **SV:** 3+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Vehicle, Fly, Chaos, Nurgle, Daemon, Foetid Bloat-drone

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Heavy blight launcher | Ranged | 36" | D6+2 | 3+ | 10 | -2 | 3 | Blast, Lethal Hits |
| Plague probe | Melee | Melee | 3 | 3+ | 6 | -1 | 1 | Lethal Hits |
...
### Foul Blightspawn
**Points:** 75 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Grenades, Foul Blightspawn

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 4 | 3+ | 4 | 0 | 1 | - |
| Plague sprayer | Ranged | 12" | D6 | N/A | 7 | -2 | 2 | Anti-INFANTRY 2+, Ignores Cover, Torrent |

**Abilities:**

- **Putrefying Stink:** Enemy models cannot start or end an Advance move within 9" of this model.
- **Blinding Spray:** In the Fight phase, you can select one model from your army with this ability to use this ability. If you do, until the end of that phase, that model's unit has the Fights First ability. Each model can only be selected for this ability once per battle.

---

### Great Unclean One
**Points:** 250 | **M:** 7" | **T:** 12 | **SV:** 5+ | **W:** 20 | **LD:** 6+ | **OC:** 5
**Keywords:** Monster, Character, Psyker, Chaos, Daemon, Nurgle, Great Unclean One, Summoned
...
| ➤ Bilesword - sweep | Melee | Melee | 12 | 2+ | 7 | -1 | 1 | Lethal Hits |
...
### Helbrute
**Points:** 115 | **M:** 7" | **T:** 9 | **SV:** 2+ | **W:** 8 | **LD:** 6+ | **OC:** 3
**Keywords:** Vehicle, Walker, Chaos, Nurgle, Helbrute

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 5 | 3+ | 6 | 0 | 1 | - |
| Helbrute fist | Melee | Melee | 5 | 3+ | 12 | -2 | 3 | - |
| Multi-melta | Ranged | 18" | 2 | 3+ | 9 | -4 | D6 | Lethal Hits, Melta 2 |
| Twin autocannon | Ranged | 48" | 2 | 3+ | 10 | -1 | 3 | Twin-linked, Lethal Hits |
| Plasma cannon | Ranged | 36" | D3 | 3+ | 8 | -3 | 3 | Blast, Hazardous, Lethal Hits |
...
### Icon Bearer
**Points:** 45 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 5+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Grenades, Death Guard Icon Bearer

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Plague knife | Melee | Melee | 4 | 3+ | 4 | 0 | 1 | Lethal Hits |
...
### Lord of Contagion
**Points:** 120 | **M:** 5" | **T:** 7 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Grenades, Lord of Contagion, Terminator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Manreaper - strike | Melee | Melee | 5 | 2+ | 9 | -2 | 3 | Lethal Hits |
| ➤ Manreaper - sweep | Melee | Melee | 10 | 2+ | 6 | -1 | 1 | Lethal Hits |

**Abilities:**

- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Vector of Disease:** While this model is leading a unit, melee weapons equipped by models in that unit have the [Sustained Hits 1] and [Lance] abilties.
...
### Lord of Poxes
**Points:** 75 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Chaos, Nurgle, Lord of Poxes

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Great plague blade | Melee | Melee | 6 | 2+ | 8 | -2 | 2 | Devastating Wounds, Lethal Hits |
...
- **Shroud of Disease:** While this model is leading a unit, that unit cannot be targeted by ranged attacks unless the attacking unit is within 18".

---

### Lord of Virulence
**Points:** 100 | **M:** 5" | **T:** 7 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Lord of Virulence, Terminator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Power fist | Melee | Melee | 5 | 2+ | 8 | -2 | 2 | Lethal Hits |
| Twin plague spewer | Ranged | 12" | D6 | N/A | 5 | -1 | 1 | Anti-INFANTRY 2+, Ignores Cover, Torrent, Twin-linked |
...
**Points:** 60 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Psyker, Malignant Plaguecaster

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Corrupted staff | Melee | Melee | 4 | 3+ | 6 | -1 | D3 | Lethal Hits, Psychic |
| ➤ Plague Wind - witchfire | Ranged | 12" | D6 | N/A | 4 | -1 | D3 | Psychic, Torrent |
| ➤ Plague Wind - focused witchfire | Ranged | 12" | D6+3 | N/A | 6 | -2 | D3 | Hazardous, Psychic, Torrent |

**Abilities:**

- **Gift of Contagion (Psychic):** While this model is leading a unit, each time a model in that unit makes an attack which targets a unit which is Afflicted, that attack has the [Sustained Hits 1] ability.
...
### Miasmic Malignifier
**Points:** 105 | **M:** - | **T:** 10 | **SV:** 3+ | **W:** 12 | **LD:** 6+ | **OC:** 0
**Keywords:** Fortification, Chaos, Nurgle, Miasmic Malignifier

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Miasmic gouts | Ranged | 9" | 2D6 | N/A | 3 | 0 | 1 | Ignores Cover, Torrent |
...
- **Deployment:** Both parts of this Fortification must be deployed within 1" of each other. Both parts are then treated as a single model for all rules purposes.

---

### Mortarion
**Points:** 380 | **M:** 10" | **T:** 12 | **SV:** 2+ | **W:** 16 | **LD:** 5+ | **OC:** 6
**Keywords:** Monster, Psyker, Fly, Character, Epic Hero, Daemon, Grenades, Chaos, Nurgle, Primarch, Mortarion

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Rotwind | Ranged | 24" | D6+3 | 2+ | 7 | -2 | 1 | Blast, Devastating Wounds, Lethal Hits, Psychic |
| Lantern | Ranged | 24" | 1 | 2+ | 10 | -3 | 3 | Pistol, Sustained Hits D3 |
| ➤ Silence - strike | Melee | Melee | 5 | 2+ | 14 | -3 | D6+1 | Devastating Wounds, Lethal Hits |
| ➤ Silence - sweep | Melee | Melee | 15 | 2+ | 8 | -2 | 2 | Lethal Hits, Sustained Hits 1 |

**Abilities:**

- **Host of Plagues:** At the end of your Movement phase, roll one D6 for each enemy unit within 6" of this model, adding 1 to the result if that unit is Afflicted; on a 3+, that enemy unit suffers D3 mortal wounds.
- **Lord of the Death Guard:** Once per turn, this model can use one of the Lord of the Death Guard abilties.
...
**M:** 10" | **T:** 9 | **SV:** 3+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Vehicle, Chaos, Nurgle, Daemon, Smoke, Myphitic Blight-hauler

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Bile spurt | Ranged | 12" | 3 | 3+ | 5 | 0 | 1 | Lethal Hits |
| Gnashing maw | Melee | Melee | 4 | 3+ | 6 | -1 | 1 | Lethal Hits |
| ➤ Missile launcher - frag | Ranged | 48" | D6 | 3+ | 4 | 0 | 1 | Blast |
| ➤ Missile launcher - krak | Ranged | 48" | 1 | 3+ | 9 | -2 | D6 | - |
| Multi-melta | Ranged | 18" | 2 | 3+ | 9 | -4 | D6 | Lethal Hits, Melta 2 |

**Abilities:**

- **Tank Hunters:** In your Shooting phase, each time a model in this unit makes a attack that targets a Monster or Vehicle unit, add 1 to the Hit roll and add 1 to the Wound roll.
- **Invulnerable Save:** Models in this unit have a 5+ invulnerable save.

---

### Noxious Blightbringer
**Points:** 50 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Noxious Blightbringer

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Cursed plague bell | Melee | Melee | 5 | 3+ | 4 | 0 | 2 | Anti-PSYKER 2+, Lethal Hits |
...
- **Leader:** This model can be attached to the following units: Plague Marines, Poxwalkers
...
**Keywords:** Swarm, Chaos, Daemon, Nurgle, Summoned, Nurglings
...
### Plague Drones
**Points:** 115 | **M:** 10" | **T:** 8 | **SV:** 6+ | **W:** 5 | **LD:** 7+ | **OC:** 2
**Keywords:** Mounted, Fly, Chaos, Daemon, Nurgle, Summoned, Plague Drones
...
**Points:** 80 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Chaos, Nurgle, Grenades, Plague Lord
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Power fist | Melee | Melee | 3 | 3+ | 8 | -2 | 2 | Lethal Hits |
| Heavy plague weapon | Melee | Melee | 3 | 4+ | 8 | -2 | 2 | Lethal Hits |
| Meltagun | Ranged | 12" | 1 | 3+ | 9 | -4 | D6 | Melta 2 |
| Plague belcher | Ranged | 12" | D6 | N/A | 4 | 0 | 1 | Anti-INFANTRY 4+, Ignores Cover, Torrent |
...
**Points:** 70 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Psyker, Chaos, Nurgle, Plague Sorcerer

**Abilities:**

- **Gift of Contagion (Psychic):** Each time a model in this unit makes an attack that targets a unit that is Afflicted, that attack has the [Sustained Hits 1] ability.
- **Leader:** This model can be attached to the following units: Plague Marines, Poxwalkers
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Balesword | Melee | Melee | 4 | 3+ | 5 | -2 | 2 | Lethal Hits |
...
**Keywords:** Infantry, Battleline, Chaos, Daemon, Nurgle, Plaguebearers, Summoned
...
### Plagueburst Crawler
**Points:** 210 | **M:** 10" | **T:** 10 | **SV:** 2+ | **W:** 12 | **LD:** 6+ | **OC:** 3
**Keywords:** Vehicle, Chaos, Nurgle, Daemon, Plagueburst Crawler

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Plagueburst mortar | Ranged | 48" | D6+3 | 3+ | 8 | -1 | 2 | Blast, Indirect Fire, Lethal Hits |
| Rothail volley gun | Ranged | 36" | 3 | 3+ | 5 | 0 | 1 | Lethal Hits, Rapid Fire 3 |
| Heavy slugger | Ranged | 36" | 4 | 3+ | 5 | -1 | 1 | Lethal Hits |
| Entropy cannon | Ranged | 36" | 1 | 3+ | 10 | -3 | D6+1 | Lethal Hits |
| Plaguespitter | Ranged | 12" | D6 | N/A | 6 | -1 | 1 | Anti-INFANTRY 2+, Ignores Cover, Torrent |
...
### Poxwalkers
**Points:** 65 | **M:** 5" | **T:** 4 | **SV:** 7+ | **W:** 1 | **LD:** 8+ | **OC:** 1
**Keywords:** Infantry, Chaos, Nurgle, Poxwalkers

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Improvised weapons | Melee | Melee | 2 | 5+ | 3 | 0 | 1 | Lethal Hits |
...
**Keywords:** Monster, Character, Epic Hero, Psyker, Chaos, Daemon, Nurgle, Rotigus, Summoned
...
- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Virulent Blessing (Psychic):** At the start of the Fight phase, you can select one enemy unit within 24" of and visible to this model. Until the end of the phase, each time an attack made by a Plague Legions model is allocated to a model in that unit, add 1 to the Damage characteristic of that attack.
...
- **Seven-fold Chant:** In your Command phase, if this model is on the battlefield, roll 2D6: on a 7+, you gain 1CP.

---

### Tri-lobe Vectors [Crucible]
**Points:** 120 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
...
### Typhus
**Points:** 100 | **M:** 5" | **T:** 7 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Epic Hero, Chaos, Nurgle, Psyker, Typhus, Terminator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Lakrimae - strike | Melee | Melee | 6 | 2+ | 9 | -2 | 3 | Lethal Hits |
| ➤ Lakrimae - sweep | Melee | Melee | 12 | 2+ | 6 | -1 | 1 | Lethal Hits |
