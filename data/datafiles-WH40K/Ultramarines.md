...
### Captain Sicarius
**Points:** 85 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Captain, Imperium, Sicarius

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Artisan Plasma Pistol | Ranged | 12" | 1 | 2+ | 8 | -3 | 2 | Pistol |
| Talassarian Tempest Blade | Melee | Melee | 6 | 2+ | 5 | -2 | 2 | Lethal Hits |
...
### Captain Titus
**Points:** 90 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Titus, Infantry, Character, Epic Hero, Imperium, Tacticus, Grenades, Captain

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Chainsword | Melee | Melee | 8 | 2+ | 5 | -1 | 2 | Anti-infantry 2+ |
| Master-crafted Bolter | Ranged | 24" | 2 | 2+ | 4 | -1 | 2 | Assault, Heavy |

**Abilities:**

- **Press the Attack:** Weapons equipped by models in this model’s unit have the [SUSTAINED HITS 1] ability
- **Honour of Ultramar:** If this model is destroyed by a melee attack, if it has not fought this phase, roll one D6: on a 2+,
...
**Keywords:** Character, Epic Hero, Infantry, Captain, Imperium, Tacticus, Sicarius, Cato

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Artisan Plasma Pistol | Ranged | 12" | 1 | 2+ | 8 | -3 | 2 | Pistol |
| ➤ Talassarian Tempest Blade - Strike | Melee | Melee | 4 | 2+ | 6 | -3 | 3 | Devastating Wounds |
| ➤ Talassarian Tempest Blade - Coup de Grace | Melee | Melee | 6 | 2+ | 5 | -2 | 2 | Precision |
| ➤ Talassarian Tempest Blade - Sweep | Melee | Melee | 9 | 2+ | 5 | -2 | 1 | Sustained Hits 1 |

**Abilities:**

- **Knight Champion of Macragge:** Once per turn, when an enemy unit ends a Normal, Advance or Fall Back move within 9" of this model’s unit, if this unit is not within Engagement Range of one or more enemy units, it can make a Normal move of up to 6".
- **Honour or Death:** You can target this unit with the Heroic Intervention Stratagem for 0CP, even if you have already used
that Stratagem on a different unit this phase.
- **Leader:** This model can be attached to the following units: Victrix Honour Guard
...
**Keywords:** Character, Epic Hero, Infantry, Imperium, Psyker, Chief Librarian Tigurius

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Storm of the Emperor’s Wrath - Witchfire | Ranged | 18" | D6 | 2+ | 6 | -2 | 2 | Blast, Psychic |
| ➤ Storm of the Emperor’s Wrath - Focused Witchfire | Ranged | 18" | 2D6 | 2+ | 6 | -2 | 2 | Blast, Hazardous, Psychic |
| Rod of Tigurius | Melee | Melee | 5 | 3+ | 7 | -2 | D3 | Psychic |
...
- **Master of Prescience (Psychic):** While this model is leading a unit, each time an attack targets that unit, subtract 1 from the Hit roll. In addition, once per battle round, you can target that unit with one of the following Stratagems for 0CP: Counter-offensive; Fire Overwatch; Go to Ground;
Heroic Intervention.
- **Leader:** This model can be attached to the following units:
...
### Lieutenant Titus
**Points:** 70 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Imperium, Grenades, Epic Hero, Lieutenant, Titus, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Astartes Chainsword | Melee | Melee | 8 | 2+ | 4 | -1 | 1 | Anti-Infantry 2+ |

**Abilities:**

- **Press the Attack:** : Weapons equipped by models in this model’s unit have the [SUSTAINED HITS 1] ability.
- **Honour of the Chapter:** If this model is destroyed by a melee attack, if it has not fought this phase, roll one D6: on a 2+, do not remove it from play. This model can fight after the attacking unit has finished making its attacks, and is then removed from play.
- **Leader:** This model can be attached to the following units:
...
### Marneus Calgar
**Points:** 200 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Imperium, Infantry

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Gauntlets of Ultramar | Ranged | 18" | 4 | 2+ | 4 | -1 | 2 | Pistol, Twin-linked |
| Gauntlets of Ultramar | Melee | Melee | 6 | 2+ | 8 | -3 | 3 | Twin-linked |
| Victrix Power Sword | Melee | Melee | 5 | 2+ | 5 | -2 | 2 | - |
...
- **Master Tactician:** At the start of your Command phase, if this unit’s Marneus Calgar model is your WARLORD and is on the battlefield, you gain 1CP.
...
**Points:** 140 | **M:** 6" | **T:** 6 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Imperium, Terminator, Chapter Master, Marneus Calgar
...
### Roboute Guilliman
**Points:** 340 | **M:** 8" | **T:** 9 | **SV:** 2+ | **W:** 10 | **LD:** 5+ | **OC:** 4
**Keywords:** Epic Hero, Character, Imperium, Primarch, Roboute Guilliman, Monster

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Hand of Dominion | Ranged | 30" | 2 | 2+ | 6 | -2 | 2 | Rapid Fire 2 |
| Hand of Dominion | Melee | Melee | 7 | 2+ | 14 | -4 | 4 | Lethal Hits |
| The Emperor's Sword | Melee | Melee | 14 | 2+ | 8 | -3 | 2 | Devastating Wounds |
...
### Uriel Ventris
**Points:** 95 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Uriel Ventris, Character, Epic Hero, Infantry, Captain, Imperium, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Invictus | Ranged | 24" | 2 | 2+ | 4 | -1 | 2 | - |
| Sword of Idaeus | Melee | Melee | 6 | 2+ | 6 | -2 | 2 | Sustained Hits 1 |
...
### Victrix Honour Guard
**Points:** 110 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 2
**Keywords:** Infantry, Imperium, Tacticus, Honor Guard, Victrix

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Bolt Carbine | Ranged | 24" | 2 | 2+ | 4 | -1 | 2 |  |
| Blades of Honour | Melee | Melee | 6 | 2+ | 5 | -2 | 2 | Precision, Twin-linked |
...
- **Attached Unit:** If a Captain or Chapter Master unit from your army can be attached to a Company Heroes unit, it can
...
- **Glory of Ultramar:** In your opponent’s Shooting phase, each time an enemy unit has shot, if any models from this unit
...
### Wardens of Ultramar
**Points:** 105 | **M:** 6" | **T:** 3 | **SV:** 4+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Epic Hero, Grenades, Imperium, Tacticus, Wardens of Ultramar

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 4 | 2+ | 4 | 0 | 1 | - |
| Astropathic Blast | Ranged | 12" | D6 | 3+ | 4 | -1 | 1 | Blast, Psychic |
| Force Stave | Melee | Melee | 1 | 2+ | 5 | -2 | 2 | Psychic |
...
- **Strategium Command:** After both players have deployed their armies, if this unit is on the battlefield (or any Transport it
...
- **Heroes of Ultramar:** At the start of the Declare Battle Formations step, this unit can join one of the following units. This
...
| Wardens of Ultramar | 105 |
| Eversor Assassin | 110 |
| Hellblaster Squad | 110 |
| Victrix Honour Guard | 110 |
...
| Marneus Calgar in Armour of Antilochus | 140 |
