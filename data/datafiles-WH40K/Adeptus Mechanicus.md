...
**Keywords:** Archaeopter Fusilave, Vehicle, Aircraft, Fly, Imperium, Skitarii

**Abilities:**

- **Bomb Rack:** Each time this model finishes a Normal move, you can select one enemy unit it moved across and roll six D6: for each 4+, that unit suffers 1 mortal wound.
...
**Keywords:** Archaeopter Stratoraptor, Skitarii, Vehicle, Aircraft, Fly, Imperium
...
**Keywords:** Archaeopter Transvector, Vehicle, Aircraft, Fly, Imperium, Skitarii, Transport
...
**Keywords:** Belisarius Cawl, Epic Hero, Monster, Character, Tech-Priest, Imperium, Cult Mechanicus
...
**Keywords:** Character, Infantry, Imperium, Crucible, Skitarii, Marshal, Cohort Commander

**Abilities:**

- **Invulnerable Save (5+):** This model has a 5+ invulnerable save.
- **Leader:** This model can be attached to the following units: Skitarii Rangers, Skitarii Vanguard
- **Prioritisation Protocol:** Melee weapons equipped by this model have [Precision].

---

### Corpuscarii Electro-Priests
**Points:** 65 | **M:** 6" | **T:** 3 | **SV:** 7+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Electro-Priests, Corpuscarii, Imperium, Infantry, Cult Mechanicus
...
**Keywords:** Cybernetica Datasmith, Tech-Priest, Infantry, Character, Imperium, Legio Cybernetica
...
**Keywords:** Electro-Priests, Fulgurite, Infantry, Imperium, Cult Mechanicus
...
**Keywords:** Character, Imperium, Crucible, Skitarii, Vehicle, Walker, Smoke, Ironstrider Alpha

**Abilities:**

- **Invulnerable Save (5+):** This model has a 5+ invulnerable save.
- **Leader:** This model can be attached to the following units: Ironstrider Ballistarii, Sydonian Dragoons with Taser Lances, Sydonian Dragoons with Radium Jezzails
- **Vector of the Omnissiah's Wrath:** Ranged weapons equipped by this model have [Ignores Cover].

---

### Ironstrider Ballistarii
**M:** 10" | **T:** 7 | **SV:** 3+ | **W:** 7 | **LD:** 7+ | **OC:** 2
**Keywords:** Ironstrider Ballistarii, Vehicle, Smoke, Skitarii, Walker, Imperium
...
- **Broad Spectrum Data-tether:** Each time you select this unit as the target of a Stratagem, roll one D6: on a 5+, you gain 1CP.

---

### Kastelan Robots
**Points:** 180 | **M:** 6" | **T:** 9 | **SV:** 2+ | **W:** 7 | **LD:** 7+ | **OC:** 2
**Keywords:** Kastelan Robots, Imperium, Vehicle, Walker, Legio Cybernetica
...
**Keywords:** Breachers, Kataphron, Infantry, Imperium, Cult Mechanicus
...
**Keywords:** Destroyers, Kataphron, Infantry, Imperium, Cult Mechanicus

**Abilities:**

- **Sentinel Directive:** Each time you target this unit with the Fire Overwatch Stratagem, hits are scored on unmodified Hit rolls of 5+ when resolving that Stratagem.
- **Invulnerable Save:** Models in this unit have a 6+ invulnerable save.
...
**Keywords:** Character, Infantry, Imperium, Cult Mechanicus, Magos, Tech-Priest, Crucible

**Abilities:**

- **Invulnerable Save (5+):** This model has a 5+ invulnerable save.
- **Leader:** This model can be attached to the following units: Electro-Priests, Kataphrons, Skitarii Rangers, Skitarii Vanguard
- **Technoarcane Zealotry:** While this model's unit is in range of one or more objective markers, improve this model's Leadership characteristic by 1.
...
**Keywords:** Onager Dunecrawler, Imperium, Vehicle, Walker, Skitarii, Smoke
...
- **Emanatus Forcefield (Aura):** While a friendly Adeptus Mechanicus Battleline model is wholly within 6" of this model, that Battleline model has a 4+ invulnerable save against ranged attacks.
- **Invulnerable Save:** 4+
- **Damaged: 1-4 wounds remaining:** While this mdel has 1-4 wounds remaining, each time this model makes an attack, subtract 1 from the Hit roll.
...
**Keywords:** Skystalkers, Imperium, Infantry, Fly, Jump Pack, Grenades, Skitarii, Pteraxii
...
**Keywords:** Sterylizors, Imperium, Infantry, Fly, Jump Pack, Skitarii, Pteraxii
...
**Keywords:** Serberys Raiders, Imperium, Skitarii, Mounted
...
- **Tactica Obliqua:** Once per turn, when an enemy unit ends a Normal, Advance or Fall Back move within 9" of this unit, if this unit is not within Engagement Range of one or more enemy units, it can do one of the following:
...
**Keywords:** Serberys Sulphurhounds, Imperium, Skitarii, Mounted
...
**Points:** 60 | **M:** 6" | **T:** 4 | **SV:** 4+ | **W:** 1 | **LD:** 8+ | **OC:** 1
**Keywords:** Infantry, Imperium, Cult Mechanicus, Servitor Battleclade
...
- **Invulnerable Save:** Models in this unit have a 6+ invulnerable save.
- **Attached Unit:** If a Character unit from your army with the Leader ability can be attached to a Kataphron Breachers unit, it can be attached to this unit instead.

---

### Sicarian Infiltrators
**Points:** 75 | **M:** 8" | **T:** 4 | **SV:** 4+ | **W:** 2 | **LD:** 7+ | **OC:** 1
**Keywords:** Imperium, Skitarii, Infantry, Sicarian, Infiltrators
...
**Keywords:** Ruststalkers, Imperium, Infantry, Skitarii, Sicarian
...
**Keywords:** Marshal, Imperium, Skitarii, Character, Infantry
...
**Keywords:** Rangers, Imperium, Infantry, Skitarii, Battleline
...
- **Enhanced data-tether:** Each time you select the bearer’s unit
...
**Keywords:** Vanguard, Imperium, Infantry, Skitarii, Battleline
...
**Keywords:** Skorpius Disintegrator, Imperium, Skitarii, Vehicle, Smoke
...
**Keywords:** Skorpius Dunerider, Imperium, Vehicle, Dedicated Transport, Transport, Skitarii, Smoke
...
**Keywords:** Imperium, Skitarii, Vehicle, Walker, Sydonian, Dragoons with Radium Jezzails, Smoke
...
**M:** 10" | **T:** 7 | **SV:** 3+ | **W:** 7 | **LD:** 7+ | **OC:** 2
**Keywords:** Imperium, Skitarii, Vehicle, Walker, Sydonian, Dragoons with Taser Lances, Smoke
...
**Keywords:** Infantry, Imperium, Skitarii, Sydonian, Character, Skatros
...
- **Sydonian Sentinel:** This model cannot be your Warlord.
...
**Keywords:** Dominus, Imperium, Tech-Priest, Character, Infantry, Cult Mechanicus
...
**Keywords:** Enginseer, Imperium, Tech-Priest, Character, Infantry, Cult Mechanicus
...
**Keywords:** Manipulus, Imperium, Tech-Priest, Character, Infantry, Cult Mechanicus
...
**Keywords:** Technoarcheologist, Imperium, Tech-Priest, Character, Infantry, Cult Mechanicus
