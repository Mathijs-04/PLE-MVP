...
**Keywords:** Infantry, Character, Epic Hero, Imperium, Terminator, Captain, Caanok Var

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Axiom - Strike | Melee | Melee | 5 | 2+ | 8 | -2 | 2 |  |
| Axiom - Sweep | Melee | Melee | 10 | 2+ | 5 | -2 | 1 |  |

**Abilities:**

- **Cold and Calculating:** Each time a model in this model’s unit makes an attack that targets a Monster or Vehicle unit, that
...
- **Cerebrex Logic Engine:** ■ At the start of the Declare Battle Formations step, you can select one Adeptus Astartes Infantry unit from your army. Until the end of the battle, that unit gains the Scouts 6" ability.
...
- **Leader:** This model can be attached to the following units: Terminator Assault Squad, Terminator Squad
...
### Iron Father Feirros
**Points:** 95 | **M:** 5" | **T:** 6 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Epic Hero, Infantry, Imperium, Gravis, Iron Father Ferrios

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Gorgon's Wrath | Ranged | 36" | 3 | 2+ | 5 | -1 | 2 | Sustained Hits 2 |
| Harrowhand | Melee | Melee | 6 | 3+ | 7 | -2 | 2 | - |
| Medusan Manipuli | Melee | Melee | 2 | 3+ | 8 | -2 | 3 | Extra Attacks |
...
■ Eradicator Squad
■ Heavy Intercessor Squad
- **Inspiring Commander:** If you include this model in your army, until the end of the battle, non-Character models in Heavy
