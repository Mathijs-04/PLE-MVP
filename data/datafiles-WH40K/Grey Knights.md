...
**Keywords:** Brother-Captain, Terminator, Psyker, Infantry, Imperium, Character
...
**Keywords:** Character, Infantry, Psyker, Imperium, Brotherhood Champion
...
- **Inspiring Exemplar:** Each time this model destroys a Character model in the Fight phase, you gain 1CP and, until the end of the battle, add 1 to the Attacks characteristic of its Nemesis force weapon.

---

### Brotherhood Chaplain
**Points:** 65 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 5 | **LD:** 5+ | **OC:** 1
**Keywords:** Brotherhood Chaplain, Terminator, Psyker, Imperium, Infantry, Character
...
**Keywords:** Brotherhood Librarian, Imperium, Terminator, Infantry, Character, Psyker
...
**Points:** 70 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Psyker, Imperium, Brotherhood Techmarine
...
**Keywords:** Battleline, Infantry, Grenades, Psyker, Imperium, Terminator, Brotherhood Terminator Squad

**Abilities:**

- **Force Edge (Psychic):** Each time a model in this unit makes a melee attack that targets a unit (excluding Vehicles or Monsters), improve the Armour Penetration characteristic of that attack by 1.
...
**Keywords:** Castellan Crowe, Psyker, Imperium, Epic Hero, Infantry, Character
...
- **Champion of the Order of Purifiers (Psychic):** While this model is leading a unit, add 1 to the Attacks characteristic of Purifying Flame weapons equipped by that unit.
- **Foesight (Psychic):** Each time this model makes an attack that targets a Character unit, you can re-roll the Hit roll.
...
**Keywords:** Character, Infantry, Crucible, Psyker, Grenades, Imperium, Champion of Titan

**Abilities:**

- **Might of Titan:** Once per battle, at the start of a phase, this model can use this ability. If it does, until the end of the phase, add 3 to the Attacks and Strength characteristics of melee weapons equipped by this model.
- **Leader:** This model can be attached to the following units:
- Purgation Squad
- Strike Squad
...
**Keywords:** Character, Crucible, Psyker, Imperium, Vehicle, Walker, Dreadknight Champion

**Abilities:**

- **Surge of Wrath:** Each time this model makes a melee attack that targets a Monster or Vehicle unit, you can re-roll the Hit roll, you can re-roll the Wound roll and you can re-roll the Damage roll.
- **Damaged: 1-4 Wounds Remaining:** When Damaged, subtract 1 from Hit rolls when it makes attacks.
...
**Keywords:** Infantry, Character, Grenades, Psyker, Terminator, Grand Master, Imperium
...
**Keywords:** Epic Hero, Character, Infantry, Psyker, Imperium, Terminator, Grand Master Voldus
...
**Keywords:** Character, Vehicle, Walker, Psyker, Imperium, Grand Master in Nemesis Dreadknight
...
**Keywords:** Thunderhawk Gunship, Titanic, Vehicle, Fly, Transport, Aircraft, Imperium
...
**Keywords:** Infantry, Grenades, Imperium, Fly, Psyker, Interceptor Squad
...
**Keywords:** Transport, Vehicle, Smoke, Imperium, Land Raider Banisher
...
- **Assault Ramp:** Each time a unit disembarks from this model after it has made a Normal move, that unit is still eligible to declare a charge this turn.
- **Land Raider Banisher:** This model has a transport capacity of 12 Grey Knights Infantry models. Each Terminator model takes up the space of 2 models.

---

### Land Raider Crusader
**Points:** 220 | **M:** 12" | **T:** 12 | **SV:** 2+ | **W:** 16 | **LD:** 6+ | **OC:** 5
**Keywords:** Vehicle, Transport, Smoke, Imperium, Grenades, Land Raider Crusader
...
**Keywords:** Land Raider Redeemer, Grenades, Imperium, Vehicle, Transport, Smoke
...
### Nemesis Dreadknight
**Points:** 210 | **M:** 8" | **T:** 8 | **SV:** 2+ | **W:** 13 | **LD:** 6+ | **OC:** 4
**Keywords:** Nemesis Dreadknight, Vehicle, Walker, Psyker, Imperium
...
**Keywords:** Infantry, Grenades, Imperium, Psyker, Terminator, Paladin Squad
...
**Keywords:** Purgation Squad, Psyker, Imperium, Grenades, Infantry
...
**Keywords:** Purifier Squad, Psyker, Imperium, Grenades, Infantry
...
**Keywords:** Razorback, Dedicated Transport, Vehicle, Transport, Smoke, Imperium
...
**Keywords:** Rhino, Transport, Vehicle, Dedicated Transport, Imperium, Smoke, Rhino
**Transport:** This model has a transport capacity of 12 Grey Knights Infantry models. It cannot transport Terminator models.

**Abilities:**

- **Truesilver Aegis (Psychic):** While a friendly Grey Knights unit is wholly within 6" of this model, models in that unit have the Feel No Pain 6+ ability against mortal wounds.
...
**Keywords:** Stormhawk Interceptor, Vehicle, Aircraft, Fly, Smoke, Imperium
...
**Keywords:** Stormraven Gunship, Aircraft, Vehicle, Transport, Fly, Imperium
...
**Keywords:** Stormtalon Gunship, Aircraft, Vehicle, Fly, Imperium
...
**Keywords:** Strike Squad, Psyker, Imperium, Grenades, Battleline, Infantry

**Abilities:**

- **Sanctifying Ritual (Psychic):** At the end of your Command phase, if this unit is within range of an objective marker that you control, that objective marker remains under you control until your opponent's Level of Control over that objective marker is greater than yours at the end of a phase.
...
**Keywords:** Character, Crucible, Psyker, Imperium, Vehicle, Walker, Smoke, Venerable Daemon Slayer

**Abilities:**

- **Guidance of the Ancients:** In your Shooting phase, after this unit has shot, select one unit hit by one or more of those attacks. Until the end of the phase, each time a Grey Knights model from your army makes an attack that targets that unit, add 1 to the Hit roll.

---

### Venerable Dreadnought
**Points:** 140 | **M:** 8" | **T:** 9 | **SV:** 2+ | **W:** 8 | **LD:** 6+ | **OC:** 3
**Keywords:** Venerable Dreadnought, Walker, Vehicle, Psyker, Smoke, Imperium, Character

**Abilities:**

- **Guidance of the Ancients (Psychic):** In your Shooting phase, after this unit has shot, select one enemy unit hit by one or more of those attacks. Until the end of the phase, each time a Grey Knights model from your army makes an attack which targets that unit, add 1 to the Hit roll.
