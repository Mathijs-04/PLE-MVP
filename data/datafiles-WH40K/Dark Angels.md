...
**Keywords:** Character, Epic Hero, Infantry, Grenades, Imperium, Asmodai, Chaplain, Tacticus, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Heavy Bolt Pistol | Ranged | 18" | 1 | 3+ | 4 | -1 | 1 | Pistol |
| ➤ Crozius Arcanum and Power Weapon - strike | Melee | Melee | 5 | 2+ | 6 | -2 | 2 | - |
| ➤ Crozius Arcanum and Power Weapon - sweep | Melee | Melee | 8 | 2+ | 5 | -2 | 1 | - |
...
### Azrael
**Points:** 125 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Epic Hero, Infantry, Grenades, Imperium, Tacticus, Azrael, Chapter Master, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Lion's Wrath | Ranged | 24" | 2 | 2+ | 8 | -3 | 2 | Anti-Infantry 4+, Devastating Wounds, Rapid Fire 1 |
| The Sword of Secrets | Melee | Melee | 6 | 2+ | 6 | -4 | 2 | Devastating Wounds |
...
**Keywords:** Character, Epic Hero, Infantry, Captain, Imperium, Belial, Terminator, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted storm bolter | Ranged | 24" | 2 | 2+ | 4 | 0 | 2 | Precision, Rapid Fire 2 |
| The Sword of Silence | Melee | Melee | 6 | 2+ | 6 | -2 | 2 | Precision |
...
### Deathwing Knights
**Points:** 250 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Imperium, Deathwing Knights, Terminator, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Mace of absolution | Melee | Melee | 4 | 2+ | 6 | -2 | 2 | Anti-Monster 4+, Anti-Vehicle 4+ |
| Power Weapon | Melee | Melee | 5 | 2+ | 6 | -2 | 2 | - |
| Great Weapon of the Unforgiven | Melee | Melee | 5 | 2+ | 6 | -2 | 2 | Devastating Wounds, Sustained Hits 1 |
| Relic Weapon | Melee | Melee | 6 | 2+ | 7 | -2 | 2 | Lethal Hits |
...
**Keywords:** Infantry, Imperium, Deathwing Terminator Squad, Terminator, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Storm Bolter | Ranged | 24" | 2 | 3+ | 4 | 0 | 1 | Rapid Fire 2 |
| Power Weapon | Melee | Melee | 4 | 3+ | 5 | -2 | 1 | - |
| Power Fist | Melee | Melee | 3 | 3+ | 8 | -2 | 2 | - |
| Chainfist | Melee | Melee | 3 | 4+ | 8 | -2 | 2 | Anti-Vehicle 3+ |

**Abilities:**

- **Invulnerable Save:** Models in this unit have a 4+ invulnerable save.
- **Deathwing:** Each time a model in this unit makes an attack, you can ignore any or all modifiers to that attack’s Ballistic Skill or Weapon Skill characteristics and/or to the Hit roll.
...
### Ezekiel
**Points:** 75 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Epic Hero, Infantry, Grenades, Imperium, Psyker, Ezekiel, Librarian, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| The Deliverer | Ranged | 12" | 1 | 2+ | 4 | -1 | 2 | Pistol, Precision |
| ➤ Mind Wipe - witchfire | Ranged | 12" | 1 | 2+ | 6 | -2 | D6 | Devastating Wounds, Precision, Psychic |
| ➤ Mind Wipe - focussed witchfire | Ranged | 12" | 1 | 2+ | 6 | -2 | D6 | Anti-Character 4+, Devastating Wounds, Hazardous, Precision, Psychic |
| Traitor's Bane | Melee | Melee | 4 | 2+ | 6 | -2 | D3 | Anti-Chaos 2+, Psychic |
...
### Inner Circle Companions
**Points:** 90 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 2
**Keywords:** Infantry, Imperium, Tacticus, Inner Circle Companions, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Heavy Bolt Pistol | Ranged | 18" | 1 | 3+ | 4 | -1 | 1 | Pistol |
| ➤ Calibanite Greatsword - Strike | Melee | Melee | 4 | 3+ | 6 | -2 | 2 | Lethal Hits |
| ➤ Calibanite Greatsword - Sweep | Melee | Melee | 5 | 3+ | 6 | -2 | 1 | Sustained Hits 2 |

**Abilities:**

- **Attached Unit:** If a Character unit from your army with the Leader ability can be attached to a Sternguard Veteran Squad, it can be attached to this unit instead.
...
- **Emnity for the Unworthy:** Each time a model in this unit makes an attack that targets a Character unit, add 1 to the Hit roll.
...
**Points:** 120 | **M:** 14" | **T:** 8 | **SV:** 3+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Fly, Imperium, Vehicle, Land Speeder Vengeance, Ravenwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close Combat Weapon | Melee | Melee | 4 | 3+ | 4 | 0 | 1 | - |
| ➤ Plasma storm battery - standard | Ranged | 36" | D6+1 | 3+ | 8 | -2 | 2 | Blast, Twin-Linked |
| ➤ Plasma storm battery - supercharge | Ranged | 36" | D6+1 | 3+ | 9 | -3 | 3 | Blast, Hazardous, Twin-Linked |
| Assault cannon | Ranged | 24" | 6 | 3+ | 6 | 0 | 1 | Devastating Wounds |
| Heavy bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Sustained Hits 1 |

**Abilities:**

- **Invulnerable Save:** 5+
- **Storm of Vengeance:** Once per turn, in your opponent’s Shooting phase, when another friendly Adeptus Astartes unit within 6" of this model is destroyed, one model with this ability can use it. If it does, after the attacking unit has finished making its attacks, that model can shoot as if it were your Shooting phase, but when resolving those attacks it can only target that enemy unit (and only if it is an eligible target).

---

### Lazarus
**Points:** 70 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Epic Hero, Infantry, Captain, Grenades, Imperium, Lazarus, Tacticus, Deathwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Bolt pistol | Ranged | 12" | 1 | 2+ | 4 | 0 | 1 | Pistol |
| Enmity’s Edge | Melee | Melee | 6 | 2+ | 6 | -3 | 2 | Anti-Psyker 2+ |
...
### Lion El'Jonson
**Points:** 315 | **M:** 8" | **T:** 9 | **SV:** 2+ | **W:** 10 | **LD:** 5+ | **OC:** 4
**Keywords:** Character, Epic Hero, Monster, Imperium, Primarch, Lion El'Jonson

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Arma Luminis - bolt | Ranged | 12" | 4 | 2+ | 4 | -1 | 2 | Pistol |
| ➤ Arma Luminis - plasma | Ranged | 12" | 2 | 2+ | 8 | -3 | 2 | Pistol |
| ➤ Fealty - strike | Melee | Melee | 8 | 2+ | 12 | -4 | 4 | Lethal Hits |
| ➤ Fealty - sweep | Melee | Melee | 16 | 2+ | 6 | -3 | 2 | Sustained Hits 1 |
...
### Nephilim Jetfighter
**Points:** 195 | **M:** 20+" | **T:** 8 | **SV:** 3+ | **W:** 11 | **LD:** 6+ | **OC:** 0
**Keywords:** Vehicle, Fly, Aircraft, Imperium, Nephilim Jetfighter, Ravenwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Armoured hull | Melee | Melee | 3 | 4+ | 6 | 0 | 1 | - |
| Blacksword missiles | Ranged | 36" | 2 | 3+ | 8 | -2 | D6 | Anti-Fly 2+ |
| Twin heavy bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Sustained Hits 1, Twin-Linked |
| Avenger mega bolter | Ranged | 36" | 10 | 3+ | 5 | -1 | 2 | Sustained Hits 1 |
| Nephilim lascannons | Ranged | 48" | 2 | 3+ | 12 | -3 | D6+1 | - |

**Abilities:**

- **Lightning-fast Manoeuvres:** Each time a ranged attack targets this model, subtract 1 from the Hit roll. If that attack was made by a model that can Fly, subtract 1 from the Wound roll as well.
- **Damaged: 1-3 Wounds Remaining:** While this model has 1-3 wounds remaining, each time this model makes an attack, subtract 1 from the Hit roll.
- **Invulnerable Save:** 5+
...
**Keywords:** Mounted, Grenades, Imperium, Ravenwing Black Knights, Ravenwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Bolt Pistol | Ranged | 12" | 1 | 3+ | 4 | 0 | 1 | Pistol |
| Black Knight combat weapon | Melee | Melee | 3 | 3+ | 5 | -2 | 1 | Devastating Wounds |
| ➤ Plasma talon - Standard | Ranged | 18" | 2 | 3+ | 7 | -2 | 1 | Rapid Fire 1 |
| ➤ Plasma talon - Supercharged | Ranged | 18" | 2 | 3+ | 8 | -3 | 2 | Hazardous, Rapid Fire 1 |
...
- **Attached Unit:** If a Character unit from your army with the Leader ability can be attached to an Outrider Squad, it can be attached to this unit instead.
- **Invulnerable Save:** 5+

---

### Ravenwing Command Squad
**Points:** 120 | **M:** 12" | **T:** 5 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 2
**Keywords:** Mounted, Grenades, Imperium, Ravenwing Command Squad, Ravenwing, Character
...
- **Astartes Banner:** While this unit contains a Ravenwing Ancient, add 1 to the Objective Control characteristic of models in this unit.
- **Honour or Death:** While this unit contains a Ravenwing Champion, add 1 to Advance and Charge rolls made for this unit and you can target this unit with the Heroic Intervention Stratagem for 0CP.

---

### Ravenwing Dark Talon
**Points:** 210 | **M:** 20+" | **T:** 8 | **SV:** 3+ | **W:** 11 | **LD:** 6+ | **OC:** 0
**Keywords:** Imperium, Fly, Vehicle, Aircraft, Dark Talon, Ravenwing
...
| Armoured Hull | Melee | Melee | 3 | 4+ | 6 | 0 | 1 | - |
| Hurricane bolter | Ranged | 24" | 6 | 3+ | 4 | 0 | 1 | Rapid Fire 6, Twin-Linked |
| Rift cannon | Ranged | 18" | D3+1 | 3+ | 16 | -4 | 3 | Blast, Devastating Wounds |

**Abilities:**

- **Invulnerable Save:** 5+
- **Stasis Bomb:** Once per battle, one model from your army with this ability can use it after it ends a Normal move. If it does, you can select one enemy unit (excluding Aircraft) that model moved over this phase. That unit suffers D3 mortal wounds and you must roll one D6: on a 1-3, that unit cannot Advance or Fall Back in your opponent’s next Movement phase; on a 4-6, that unit must Remain Stationary in your opponent’s next Movement phase. Each model can only use this ability once per battle.
- **Damaged: 1-3 Wounds Remaining:** While this model has 1-3 wounds remaining, each time this model makes an attack, subtract 1 from the Hit roll.

---

### Ravenwing Darkshroud
**Points:** 100 | **M:** 14" | **T:** 8 | **SV:** 3+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Darkshroud, Imperium, Fly, Vehicle, Ravenwing
...
- **Invulnerable Save:** 5+
- **Icon of Old Caliban (Aura):** While a friendly Adeptus Astartes unit is within 6" of this model, models in that unit have the Stealth ability and each time a ranged attack targets that unit, that unit has the Benefit of Cover against that attack.
...
### Sammael
**Points:** 115 | **M:** 12" | **T:** 5 | **SV:** 3+ | **W:** 7 | **LD:** 6+ | **OC:** 2
**Keywords:** Character, Epic Hero, Mounted, Captain, Imperium, Fly, Grenades, Sammael, Ravenwing

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Bolt Pistol | Ranged | 12" | 1 | 2+ | 4 | 0 | 1 | Pistol |
| Master-crafted plasma cannon | Ranged | 36" | D3 | 2+ | 8 | -3 | 2 | Blast |
| Twin storm bolter | Ranged | 24" | 2 | 2+ | 4 | 0 | 1 | Rapid Fire 2, Twin-Linked |
| The Raven Sword | Melee | Melee | 6 | 2+ | 6 | -3 | 2 | Sustained Hits 2 |
