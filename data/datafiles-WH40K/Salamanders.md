...
**Keywords:** Epic Hero, Character, Infantry, Captain, Adrax Agatone, Imperium, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Drakkis | Ranged | 12" | D6+3 | N/A | 4 | -1 | 1 | Ignores Cover, Pistol, Torrent |
| Malleus Noctum | Melee | Melee | 5 | 2+ | 10 | -2 | 3 | - |
...
### Vulkan He'stan
**Points:** 100 | **M:** 6" | **T:** 4 | **SV:** 2+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Captain, Imperium, Grenades, Vulkan He'stan, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Gauntlet of the Forge | Ranged | 12" | D6+3 | N/A | 6 | -1 | 1 | Ignores Cover, Pistol, Torrent |
| Spear of Vulkan | Melee | Melee | 6 | 2+ | 6 | -2 | 2 | Devastating Wounds |
...
- **Seeker of the Unfound:** The first time this model is set up on the battlefield, select one objective marker on the battlefield. While this model is within range of that objective marker, it has an Objective Control characteristic of 10, a Leadership characteristic of 5+ and the Feel No Pain 4+ ability.
- **Leader:** This model can be attached to the following units:
...
■ Infernus Squad
■ Tactical Squad
- **Inspiring Commander:** If you include this model in your army, until the end of the battle, non-Character models in Infernus Squad units from your army have an Objective Control characteristic of 2 while they are not Battle-shocked.
