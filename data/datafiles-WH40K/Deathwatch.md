...
**Keywords:** Fly, Vehicle, Aircraft, Imperium, Transport, Corvus Blackstar
...
**Points:** 190 | **M:** 5" | **T:** 5 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Imperium, Deathwatch Terminator Squad, Terminator, Kill Team
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Infernus heavy bolter - heavy bolter | Ranged | 36" | 3 | 4+ | 5 | -1 | 2 | Heavy, Sustained Hits 1 |
...
| Power weapon | Melee | Melee | 3 | 3+ | 5 | -2 | 1 | - |
...
**Keywords:** Infantry, Battleline, Grenades, Imperium, Kill Team, Tacticus, Decimus Kill Team
...
| ➤ Infernus heavy bolter - heavy bolter | Ranged | 36" | 3 | 3+ | 5 | -2 | 3 | Sustained Hits 1 |
| ➤ Infernus heavy bolter - heavy flamer | Ranged | 12" | D6 | N/A | 5 | -1 | 1 | Ignores Cover, Torrent |
...
- **Death to the Alien:** Each time a model in this unit makes an attack, re-roll a Hit roll of 1. If the target of that attack does not have the Imperium or Chaos keywords, you can re-roll the Hit roll instead.
- **Attached Unit:** If a Character unit from your army can be attached to a Fortis Kill Team unit, it can be attached to this unit instead.
- **Astartes shield:** The bearer has a 4+ invulnerable save.
...
### Fortis Kill Team
**Points:** 180 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 2
**Keywords:** Infantry, Grenades, Imperium, Fortis Kill Team, Tacticus, Kill Team

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Superfrag missile launcher | Ranged | 48" | D6+1 | 4+ | 5 | 0 | 1 | Blast, Heavy |
| Superkrak missile launcher | Ranged | 48" | 1 | 4+ | 10 | -2 | D6+1 | Heavy |
| Heavy bolt pistol | Ranged | 12" | 1 | 3+ | 4 | -1 | 1 | Pistol |
...
- **Attached Unit:** If a CHARACTER from your army with the Leader ability can be attached to an INTERCESSOR SQUAD, it can be attached to this unit instead.
...
### Indomitor Kill Team
**Points:** 265 | **M:** 5" | **T:** 6 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Indomitor Kill Team, Gravis, Kill Team

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Auto boltstorm gauntlets | Ranged | 18" | 3 | 3+ | 4 | 0 | 1 | Twin-linked |
| Twin power fists | Melee | Melee | 3 | 3+ | 8 | -2 | 2 | Twin-linked |
| Flamestorm gauntlets | Ranged | 12" | D6+1 | N/A | 4 | 0 | 1 | Ignores Cover, Torrent, Twin-linked |
| Deathwatch heavy bolt rifle | Ranged | 30" | 2 | 3+ | 5 | -2 | 2 | Assault, Heavy, Lethal Hits |
| Deathwatch heavy bolter | Ranged | 36" | 3 | 3+ | 5 | -2 | 3 | Assault, Heavy, Lethal Hits, Sustained Hits 1 |
...
- **Attached Unit:** If a CHARACTER unit from your army can be attached to a HEAVY INTERCESSOR SQUAD, it can be attached to this unit instead.
...
### Spectrus Kill Team
**Points:** 180 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Smoke, Spectrus Kill Team, Kill Team, Phobos

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Deathwatch marksman bolt carbine | Ranged | 24" | 2 | 3+ | 5 | -1 | 1 | Heavy, Lethal Hits |
| Deathwatch occulus bolt carbine | Ranged | 24" | 2 | 3+ | 5 | -1 | 1 | Assault, Ignores Cover, Lethal Hits |
| Paired combat blades | Melee | Melee | 3 | 3+ | 4 | -1 | 1 | Sustained Hits 1 |
| Special-issue bolt pistol | Ranged | 12" | 1 | 3+ | 4 | -1 | 1 | Pistol, Precision |
| Combat knife | Melee | Melee | 4 | 3+ | 4 | -1 | 1 | Precision |
| Deathwatch Bolt carbine | Ranged | 24" | 2 | 3+ | 5 | -1 | 1 | Lethal Hits, Precision |
| Instigator bolt carbine | Ranged | 24" | 1 | 3+ | 4 | -2 | 2 | Heavy |
| Bolt sniper rifle | Ranged | 36" | 1 | 3+ | 5 | -2 | 3 | Heavy, Precision |

**Abilities:**

- **Attached Unit:** If a CHARACTER from your army with the Leader ability can be attached to an INFILTRATOR SQUAD, it can be attached to this unit instead. 
...
**Points:** 275 | **M:** 12" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 1
...
| Assault bolters | Ranged | 18" | 3 | 3+ | 5 | -1 | 2 | Assault, Pistol, Sustained Hits 2, Twin-linked |
| ➤ Plasma exterminators - standard | Ranged | 18" | 2 | 3+ | 7 | -2 | 2 | Assault, Pistol, Twin-linked |
| ➤ Plasma exterminators - supercharge | Ranged | 18" | 2 | 3+ | 8 | -3 | 3 | Assault, Hazardous, Pistol, Twin-linked |
...
- **Attached Unit:** If a CHARACTER unit from your army with the Leader ability can be attached to an ASSAULT INTERCESSORS WITH JUMP PACKS unit, it can be attached to this unit instead.
...
**Points:** 65 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Grenades, Imperium, Watch Captain Artemis, Captain
...
**Keywords:** Character, Infantry, Captain, Grenades, Imperium, Watch Master
...
- **Watch Master:** Once per battle round, one unit from your army with this ability can use it when its unit is targeted with a Stratagem. If it does, reduce the CP cost of that use of that Stratagem by 1CP.
- **Leader:** This model can be attached to the following units:
- DEATHWATCH VETERANS
- FORTIS KILL TEAM
