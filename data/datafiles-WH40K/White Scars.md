...
### Kor'sarro Khan
**Points:** 60 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Captain, Imperium, Kor'sarro Khan, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Moonfang | Melee | Melee | 6 | 2+ | 5 | -2 | 2 | Devastating Wounds, Precision |
...
■ Tactical Squad
■ Company Heroes
- **Inspiring Commander:** If you include this model in your army, until the end of the battle, non-Character models in Outrider Squad units from your army have an Objective Control characteristic of 3 while they are not Battle-shocked.
...
### Suboden Khan
**Points:** 115 | **M:** 12" | **T:** 5 | **SV:** 3+ | **W:** 8 | **LD:** 6+ | **OC:** 2
**Keywords:** Mounted, Character, Epic Hero, Imperium, Grenades, Captain, Suboden Khan

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Onslaught Gatling Cannon | Ranged | 24" | 8 | 2+ | 5 | 0 | 1 | Devastating Wounds |
| Stormtooth | Melee | Melee | 6 | 2+ | 6 | -2 | 2 | Lance, Anti-monster 4+, Anti-vehicle 4+ |
| Power Sword | Melee | Melee | 8 | 2+ | 5 | -2 | 1 | - |
...
- **Leader:** This model can be attached to the following units: Outrider Squad
