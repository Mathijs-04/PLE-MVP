...
### Astorath
**Points:** 85 | **M:** 12" | **T:** 4 | **SV:** 2+ | **W:** 5 | **LD:** 5+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Grenades, Fly, Jump Pack, Imperium, Chaplain, Astorath

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| The Executioner's Axe | Melee | Melee | 6 | 2+ | 7 | -3 | 2 | Devastating Wounds, Precision |
...
### Baal Predator
**Points:** 125 | **M:** 12" | **T:** 10 | **SV:** 3+ | **W:** 11 | **LD:** 6+ | **OC:** 3
**Keywords:** Imperium, Smoke, Vehicle, Baal Predator

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Heavy Flamer | Ranged | 12" | D6 | N/A | 5 | -1 | 1 | Assault, Ignores Cover, Torrent |
| Heavy Bolter | Ranged | 36" | 3 | 3+ | 5 | -1 | 2 | Assault, Sustained Hits 1 |
| Baal Flamestorm Cannon | Ranged | 18" | D6+3 | N/A | 6 | -2 | 2 | Assault, Ignores Cover, Torrent |
| Twin Assault Cannon | Ranged | 24" | 6 | 3+ | 6 | 0 | 1 | Assault, Devastating wounds, Twin-linked |
...
**Keywords:** Infantry, Character, Grenades, Imperium, Captain, Tacticus

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Chainsword | Melee | Melee | 7 | 2+ | 4 | -1 | 2 | - |
| Heavy Bolt Pistol | Ranged | 18" | 1 | 2+ | 4 | -1 | 1 | Pistol |
...
**Points:** 120 | **M:** 7" | **T:** 5 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Grenades, Tacticus, Psyker, Chief Librarian Mephiston

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| ➤ Fury of the Ancients - Witchfire | Ranged | 18" | 3 | 2+ | 4 | -1 | D3 | Pistol, Psychic, Sustained Hits 1 |
| ➤ Fury of the Ancients - Focused Witchfire | Ranged | 18" | 3 | 2+ | 5 | -2 | D3 | Hazardous, Pistol, Psychic, Sustained Hits 3 |
| Vitarus | Melee | Melee | 6 | 2+ | 9 | -3 | D3 | Lethal Hits, Psychic |
...
### Commander Dante
**Points:** 120 | **M:** 12" | **T:** 4 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Grenades, Imperium, Fly, Jump Pack, Tacticus, Chapter Master, Commander Dante

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Perdition | Ranged | 6" | 1 | 2+ | 9 | -4 | D6 | Melta 2, Pistol, Sustained Hits D3 |
| The Axe Mortalis | Melee | Melee | 8 | 2+ | 8 | -3 | 2 | Lethal Hits |
...
- **Lord Regent of the Imperium Nihilus:** While this model is leading a unit, add 1 to Advance and Charge rolls made for that unit and each time a model in that unit makes an attack, add 1 to the Hit roll.
- **Leader:** This model can be attached to the following units:
...
**Points:** 70 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Grenades, Imperium, Captain, Tacticus, Death Company

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Master-crafted Chainsword | Melee | Melee | 7 | 2+ | 4 | -1 | 2 | - |
| Heavy Bolt Pistol | Ranged | 18" | 1 | 2+ | 4 | -1 | 1 | - |
...
**Points:** 75 | **M:** 12" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Captain, Grenades, Fly, Imperium, Jump Pack, Tacticus, Death Company
...
- **Death Vision of Sanguinius:** If this model is destroyed by a melee attack, after the attacking unit has finished making its attacks, you can roll one D6, adding 2 to the result if the attacking unit contains the enemy Warlord. On a 2-3, that enemy unit suffers D3 mortal wounds; on a 4-5, that enemy unit suffers 3 mortal wounds; on a 6+ that enemy unit suffers D3+3 mortal wounds.
- **Lost to Fury:** When this model is leading a unit, melee weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability
- **Leader:** This model can be attached to the following units:
...
**Points:** 160 | **M:** 8" | **T:** 10 | **SV:** 2+ | **W:** 12 | **LD:** 6+ | **OC:** 4
**Keywords:** Vehicle, Walker, Imperium, Dreadnought, Death Company Dreadnought, Death Company

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blood Fists | Melee | Melee | 6 | 3+ | 12 | -2 | 3 | Twin-linked |
| Blood Fist Bolt Rifles | Ranged | 24" | 4 | 3+ | 4 | -1 | 1 | Twin-linked |
| ➤ Blood Talons - Strike | Melee | Melee | 6 | 3+ | 12 | -2 | 3 | Twin-linked |
| ➤ Blood Talons - Sweep | Melee | Melee | 10 | 3+ | 7 | -2 | 1 | Twin-linked |

**Abilities:**

- **Driven by Fury:** In your opponent's Shooting phase, each time an enemy unit has shot, if this model was hit by one or more of those attacks, it can make a Driven by Fury move. To do so, roll one D6 and add 2 to the roll; this model moves a number of inches up to the result, but must finish as close as possible to the closest enemy unit [excluding Aircraft]. When doing so, this model can be moved within
Engagement Range of that enemy unit. A model cannot make a Driven by Fury move while it is Battle-shocked or within Engagement Range of one or more enemy units, and can only make one Driven by Fury move per phase.

---

### Death Company Intercessors
**Points:** 75 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Tacticus, Death Company Intercessors
...
**Keywords:** Infantry, Grenades, Imperium, Death Company Marines, Tacticus, Death Company
...
- **Attached Unit:** If a Chaplain model from your army with the Leader ability can be attached to Assault Intercessor Squad, it can be attached to this unit instead.

---

### Death Company Marines with Bolt Rifles
**Points:** 85 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Death Company Marines with Bolt Rifles, Tacticus, Death Company
...
| Bolt Rifle | Ranged | 24" | 2 | 3+ | 4 | -1 | 1 | Assault, Heavy |
| ➤ Astartes Grenade Launcher - Frag | Ranged | 24" | D3 | 3+ | 4 | 0 | 1 | Blast |
| ➤ Astartes Grenade Launcher - Krak | Ranged | 24" | 1 | 3+ | 9 | -2 | D3 | - |

**Abilities:**

- **Attached Unit:** If a Chaplain model from your army with the Leader ability can be attached to Intercessor Squad, it can be attached to this unit instead.

---

### Death Company Marines with Jump Packs
**Points:** 120 | **M:** 12" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Grenades, Imperium, Death Company Marines with Jump Packs, Tacticus, Fly, Jump Pack, Death Company

**Abilities:**

- **Savage Fury:** You can re-roll Charge rolls made for this unit.
- **Attached Unit:** If a Chaplain model from your army with the Leader ability can be attached to Assault Intercessors with Jump Packs, it can be attached to this unit instead
...
### Lemartes
**Points:** 100 | **M:** 12" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 5+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Grenades, Imperium, Fly, Chaplain, Lemartes, Jump Pack

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| The Blood Crozius | Melee | Melee | 5 | 2+ | 6 | -2 | 2 | Lethal Hits |
| Absolvor Bolt Pistol | Ranged | 18" | 1 | 2+ | 5 | -1 | 2 | Pistol |
...
### Sanguinary Guard
**Points:** 125 | **M:** 12" | **T:** 4 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Fly, Grenades, Imperium, Sanguinary Guard, Jump Pack

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Encarmine Blade | Melee | Melee | 4 | 2+ | 6 | -3 | 2 | - |
| Encarmine Spear | Melee | Melee | 4 | 2+ | 6 | -2 | 2 | Lance |
| Angelus Boltgun | Ranged | 12" | 2 | 3+ | 4 | 0 | 1 | Pistol |
...
- **Attached Unit:** If a Captain model from your army with the Leader ability can be attached to Assault Intercessors with Jump Packs, it can be attached to this unit instead.
- **Sanguinary Banner:** Add 1 to the Objective Control characteristic of models in the bearer’s unit.

---

### Sanguinary Priest
**Points:** 75 | **M:** 6" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Imperium, Sanguinary Priest, Tacticus
...
### The Sanguinor
**Points:** 130 | **M:** 12" | **T:** 4 | **SV:** 2+ | **W:** 7 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Fly, Imperium, Jump Pack, The Sanguinor

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Encarmine Broadsword | Melee | Melee | 8 | 2+ | 6 | -3 | 2 | Devastating Wounds |
...
| Astorath | 85 |
| Culexus Assassin | 85 |
| Death Company Marines | 85 |
| Death Company Marines with Bolt Rifles | 85 |
| Eliminator Squad | 85 |
