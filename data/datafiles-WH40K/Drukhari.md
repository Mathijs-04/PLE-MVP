...
**Keywords:** Character, Infantry, Crucible, Wych Cult, Aeldari, Drukhari, Archtormentor

**Abilities:**

#### Invulnerable Save (Archtormentor) (Abilities)
- **Description:** An Archtormentor has a 4+ Invulnerable save
...
#### Cruel Example (Abilities)
- **Description:** Each time this model makes an attack that targets a CHARACTER unit, you can add 1 to the Wound roll. Each time this model’s unit destroys a CHARACTER model, you gain 1CP.
...
**Keywords:** Cronos, Aeldari, Haemonculus Covens, Drukhari, Monster, Fly
...
**Keywords:** Character, Infantry, Crucible, Aeldari, Drukhari, Haemonculus Covens, Flesh Crafter

**Abilities:**

#### Invulnerable Save (Flesh Crafter) (Abilities)
- **Description:** A Flesh Crafter has a 6+ Invulnerable save.

#### Fleshcraft (Pain) (Abilities)
...
### Grotesques [Legends]
**Points:** 80 | **M:** 7" | **T:** 5 | **SV:** 6+ | **W:** 4 | **LD:** 7+ | **OC:** 1
**Keywords:** Grotesques, Aeldari, Haemonculus Covens, Drukhari, Infantry

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Paired monstrous Weapons | Melee | Melee | 4 | 3+ | 5 | -2 | 2 | Twin-Linked |
| Liquifier Gun | Ranged | 12" | D6 | N/A | 4 | -1 | 1 | Anti-Infantry 3+, Torrent |
| Monstrous Weapons | Melee | Melee | 4 | 3+ | 5 | -2 | 2 | - |
...
#### Monstrous Hulks (Abilities)
- **Description:** This unit cannot embark within a **Venom, but it can embark within other Drukhari Transports; when doing so, each Grotesque** model takes up the space of 3 models.

#### Macro-steroids (Pain) (Abilities)
...
#### Monstrous Charge (Abilities)
- **Description:** Each time this unit ends a Charge move, select one enemy unit within Engagement Range of it, then roll one D6 for each model in this unit that is within Engagement Range of that enemy unit: for each 4+, that enemy unit suffers D3 mortal wounds.

---

### Haemonculus
**Points:** 60 | **M:** 7" | **T:** 4 | **SV:** 5+ | **W:** 5 | **LD:** 7+ | **OC:** 1
**Keywords:** Haemonculus, Haemonculus Covens, Aeldari, Drukhari, Character, Infantry
...
**Keywords:** Infantry, Kabal, Character, Aeldari, Archon, Epic Hero, Drukhari, Lady Malys
...
#### Archon of the Poisoned Tongue (Pain) (Abilities)
...
#### Mind Like a Steel Trap [Aura] (Abilities)
...
**Keywords:** Scourges, Aeldari, Drukhari, Fly, Grenades, Infantry, Jump Pack, Blades for Hire, Scourges with Shardcarbines
...
#### Swooping Descent (Pain) (Abilities)
...
**Keywords:** Talos, Aeldari, Haemonculus Covens, Drukhari, Monster, Fly
...
**Points:** 80 | **M:** 7" | **T:** 4 | **SV:** 6+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Urien Rakarth, Haemonculus Covens, Aeldari, Haemonculus, Drukhari, Character, Epic Hero, Infantry

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Haemonculus tools and scissorhands | Melee | Melee | 5 | 2+ | 3 | -1 | D3 | Anti-Infantry 2+, Precision |
| Casket of Flensing | Ranged | 12" | 3D6 | N/A | 3 | -1 | 1 | Devastating Wounds, One Shot, Torrent |
...
#### Horrific Regeneration (Abilities)
...
#### Sculptor of Torments (Pain) (Abilities)
...
**Keywords:** Wracks, Haemonculus Covens, Aeldari, Drukhari, Battleline, Infantry
...
#### Experimental Enhancements (Pain) (Abilities)
...
| Troupe Master | 75 |
| Archon | 80 |
| Grotesques [Legends] | 80 |
| Starweaver | 80 |
| Talos | 80 |
| Urien Rakarth [Legends] | 80 |
| Drazhar | 85 |
| Hellions | 85 |
| Lelith Hesperax | 85 |
| Raider | 85 |
...
| Incubi | 90 |
| Wyches | 90 |
| Court of the Archon [Legends] | 95 |
| Kharseth | 95 |
| Prince Yriel | 95 |
| Skyweavers | 95 |
| Lady Malys | 100 |
