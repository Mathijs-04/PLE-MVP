...
Each time an Emperor's Children unit from your army is selected to fight, if it made a Charge move this turn, select one of the abilities below. While resolving those attacks, melee weapons equipped by models in that unit have the ability:
- [Lethal Hits]
- [Sustained Hits 1]
...
**Points:** 80 | **M:** 7" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Grenades, Chaos, Slaanesh, Crucible, Champion of Excess

**Abilities:**

- **Leader:** This unit can be attached to the following units: Infractors, Noise Marines, Tormentors
...
**Keywords:** Vehicle, Transport, Dedicated Transport, Chaos, Rhino, Smoke, Slaanesh
**Transport:** This model has a transport capacity of 12 Emperor's Children Infantrymodels (excluding Terminator and Flawless Blade models).
...
- **Assault Vehicle:** Units can disembark from this Vehicle after it has Advanced. Units that do so count as having made a Normal move that phase, and cannot declare a charge in the same turn, but can otherwise act normally.

---

### Chaos Spawn
**Points:** 70 | **M:** 10" | **T:** 5 | **SV:** 4+ | **W:** 4 | **LD:** 7+ | **OC:** 1
...
- **Scuttling Horrors:** Once per turn, when an enemy unit ends a Normal, Advance or Fall Back move within 9" of this unit, this unit can make a Normal move of up to 6".

---

### Chaos Terminators
**Points:** 145 | **M:** 6" | **T:** 5 | **SV:** 2+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Chaos, Terminator, Slaanesh, Terminator Squad
...
- **Lethal Obsession:** In your Shooting phase, each time this unit is selected to shoot, if it makes one or more shooting attacks and all of those attacks target the same enemy unit, until the end of the turn, each time this unit declares a charge, if that enemy unit is a target of that charge, you can re-roll the Charge roll.
- **Invulnerable Save:** Models in this unit have a 4+ invulnerable save.

---

### Daemon Prince of Slaanesh
**Points:** 180 | **M:** 10" | **T:** 10 | **SV:** 2+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Monster, Character, Chaos, Daemon, Slaanesh, Daemon Prince

**Abilities:**

- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Lord of Excess:** While this model is within 3" of one or more friendly Slaanesh Infantry, this model has the Lone Operative ability.
- **Excessive Vigour (Aura):** While a friendly Slaanesh unit is within 6" of this model, if that unit made a Charge move this turn, improve the Armour Penetration characteristic of melee weapons equipped by that unit by 1.
...
**Points:** 215 | **M:** 14" | **T:** 9 | **SV:** 2+ | **W:** 10 | **LD:** 6+ | **OC:** 3
**Keywords:** Monster, Character, Chaos, Daemon, Slaanesh, Fly, Daemon Prince with Wings

**Abilities:**

- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Daemonic Destruction:** Each time this model ends a Charge move, select one enemy unit within Engagement Range of this model and roll one D6 for each of this model's remaining wounds: for each 4+, that enemy unit suffers 1 mortal wound (to a maximum of 6 mortal wounds).
...
### Daemonettes
**Points:** 90 | **M:** 9" | **T:** 3 | **SV:** 7+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Battleline, Chaos, Daemon, Slaanesh, Daemonettes, Summoned
...
- **Horrifying Beauty:** At the start of the Fight phase, each enemy unit in Engagement Range of one or more units from your army with this ability must take a Battle-shock test, subtracting 1 from that test if that enemy unit is Below Half-strength.
...
**Points:** 60 | **M:** 7" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Psyker, Grenades, Chaos, Slaanesh, Excruciator, Crucible

**Abilities:**

- **Leader:** This unit can be attached to the following units: Infractors, Noise Marines, Tormentors
- **Warped Invigoration (Psychic):** In your Shooting phase, after this model has shot, if an enemy unit was hit by one or more of those attacks, until the end of the turn, add 1 to Charge rolls made for this unit.

---

### Fiends
**Points:** 95 | **M:** 12" | **T:** 5 | **SV:** 7+ | **W:** 4 | **LD:** 7+ | **OC:** 2
**Keywords:** Beast, Chaos, Daemon, Slaanesh, Fiends, Summoned
...
### Flawless Blades
**Points:** 100 | **M:** 8" | **T:** 5 | **SV:** 3+ | **W:** 3 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Grenades, Chaos, Slaanesh, Flawless Blades

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blissblade | Melee | Melee | 4 | 2+ | 6 | -3 | 2 | - |
...
**Points:** 100 | **M:** 8" | **T:** 5 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Grenades, Chaos, Slaanesh, Crucible, Flawless Champion

**Abilities:**

- **Leader:** This unit can be attached to the following units: Flawless Blades
- **Obsessive Huntsman:** Melee weapons equipped by this model have the [Precision] ability.
- **Invulnerable Save (5+):** This model has a 5+ invulnerable save.

---

### Fulgrim
**Points:** 340 | **M:** 16" | **T:** 11 | **SV:** 2+ | **W:** 16 | **LD:** 5+ | **OC:** 6
**Keywords:** Chaos, Slaanesh, Fulgrim, Primarch, Daemon, Monster, Fly, Epic Hero, Character

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Malefic lash | Ranged | 12" | 6 | 2+ | 8 | -2 | 2 | Sustained Hits 1 |
| Serpentine tail | Melee | Melee | 6 | 2+ | 6 | -1 | 1 | Extra Attacks |
| ➤ Daemonic blades - strike | Melee | Melee | 6 | 2+ | 14 | -3 | D6+1 | Sustained Hits 1 |
| ➤ Daemonic blades - sweep | Melee | Melee | 12 | 2+ | 8 | -2 | 2 | Sustained Hits 1 |
...
- **Daemon Prince of Slaanesh:** At the start of your opponent's Command phase, select one of the abilities in the Daemon Prince of Slaanesh section. Until the start of your opponent's next Command phase, this model has that ability.
...
- **Beguiling Form:** Each time a model makes an attack that targets this unit, subtract 1 from the Hit roll.
...
### Heldrake
**Points:** 195 | **M:** 20"+ | **T:** 10 | **SV:** 3+ | **W:** 14 | **LD:** 7+ | **OC:** 0
**Keywords:** Vehicle, Fly, Aircraft, Chaos, Daemon, Heldrake, Slaanesh

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Heldrake claws | Melee | Melee | 5 | 3+ | 7 | -1 | 2 | Anti-FLY 2+, Devastating Wounds |
| Baleflamer | Ranged | 12" | D6+3 | N/A | 6 | -1 | 2 | Ignores Cover, Torrent |
| Hades autocannon | Ranged | 36" | 6 | 3+ | 8 | -1 | 2 | - |
...
### Infractors
**Points:** 85 | **M:** 7" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 6+ | **OC:** 2
**Keywords:** Infantry, Battleline, Grenades, Chaos, Slaanesh, Infractors

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Duelling sabre | Melee | Melee | 4 | 3+ | 4 | -1 | 1 | Precision |
...
- **Icon of Excess:** At the end of your Shooting phase or the Fight phase, if the bearer's unit destroyed one or more enemy units this phase, the bearer's unit takes a Leadership test. If that test is passed, you gain 1CP.
...
- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Daemon Lord of Slaanesh (Aura):** While a friendly Legions of Excess unit is within 6" of this model, improve the Armour Penetration of melee weapons in that unit by 1.
...
### Lord Exultant
**Points:** 80 | **M:** 7" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Grenades, Chaos, Slaanesh, Lord Exultant

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Close combat weapon | Melee | Melee | 6 | 2+ | 4 | 0 | 1 | - |
| Rapture lash | Melee | Melee | 4 | 2+ | 4 | -1 | 1 | Extra Attacks |
| Phoenix power spear | Melee | Melee | 5 | 2+ | 7 | -2 | 2 | Lance |
| Master-crafted power sword | Melee | Melee | 5 | 2+ | 5 | -2 | 2 | Precision |

**Abilities:**

- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Perfectionists:** While this model is leading a unit, weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Euphoric Strikes:** Once per battle, at the start of the Fight phase, this model can use this ability. If it does so, until the end of the phase, add 3 to the Attacks characteristic of melee weapons equipped by this model and improve the Armour Penetration characteristic of those weapons by 1.
- **Lord of the Host:** If this model is attached to an Emperor's Children Battleline unit during the Declare Battle Formations step, this model has the Infiltrators and Scouts 6" ability.
- **Leader:** This model can be attached to the following units: Infractors; Tormentors

---

### Lord Kakophonist
**Points:** 70 | **M:** 6" | **T:** 5 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Grenades, Infantry, Chaos, Slaanesh, Lord Kakophonist

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Power sword | Melee | Melee | 6 | 2+ | 5 | -2 | 1 | - |
| Close combat weapon | Melee | Melee | 6 | 2+ | 4 | 0 | 1 | - |

**Abilities:**

- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **Leader:** This model can be attached to the following units: Emperor's Children Terminator Squad; Noise Marines
- **Obsessive Annunciation:** While this model is leading a unit, ranged weapons equipped by that unit have the [SUSTAINED HITS 1] ability.
...
### Lucius the Eternal
**Points:** 150 | **M:** 8" | **T:** 5 | **SV:** 2+ | **W:** 6 | **LD:** 6+ | **OC:** 1
**Keywords:** Infantry, Character, Epic Hero, Chaos, Slaanesh, Lucius the Eternal

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blade of the Laer | Melee | Melee | 6 | 2+ | 8 | -3 | 3 | Precision |
| Lash of Torment | Melee | Melee | 10 | 2+ | 4 | -1 | 1 | Sustained Hits 1 |
...
- **Invulnerable Save:** This model has a 4+ invulnerable save.
- **A Challenge Worthy of Skill:** Each time this model makes an attack that targets a Character, Monster or Walker unit, you can re-roll the Hit roll and re-roll the Wound roll.
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Maulerfiend fists | Melee | Melee | 6 | 3+ | 14 | -2 | D6+1 | - |
| Magma cutter | Ranged | 6" | 2 | 3+ | 9 | -4 | D6 | Melta 2 |
| Lasher tendrils | Melee | Melee | 6 | 3+ | 7 | -1 | 1 | Extra Attacks |
...
**Keywords:** Mounted, Chaos, Daemon, Slaanesh, Seekers, Summoned
...
### Sorcerer
**Points:** 60 | **M:** 7" | **T:** 4 | **SV:** 3+ | **W:** 4 | **LD:** 6+ | **OC:** 1
**Keywords:** Character, Infantry, Psyker, Chaos, Slaanesh, Grenades, Sorcerer

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Agonising Energies - witchfire | Ranged | 18" | D6 | 3+ | 5 | -1 | D3 | Psychic |
| Agonising Energies - focused witchfire | Ranged | 18" | D6 | 3+ | 6 | -2 | D3 | Devastating Wounds, Hazardous, Psychic |
| Force weapon | Melee | Melee | 4 | 3+ | 6 | -2 | D3 | Psychic |

**Abilities:**

- **Leader:** This model can be attached to the following units: Infractors; Noise Marines; Tormentors
...
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Boltgun | Ranged | 24" | 2 | 3+ | 4 | 0 | 1 | Precision |
| ➤ Plasma gun - standard | Ranged | 24" | 1 | 3+ | 7 | -2 | 1 | Precision, Rapid Fire 1 |
| ➤ Plasma gun - supercharge | Ranged | 24" | 1 | 3+ | 8 | -3 | 2 | Hazardous, Precision, Rapid Fire 1 |
| Meltagun | Ranged | 12" | 1 | 3+ | 9 | -4 | D6 | Melta 2, Precision |
