...
**Keywords:** Character, Epic Hero, Infantry, Fly, Jump Pack, Imperium, Tacticus, Chapter Master, Aethon Shaan

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Claws of Severax | Melee | Melee | 7 | 2+ | 5 | -2 | 2 | Sustained Hits 2, Twin-linked |

**Abilities:**

- **Chapter Master of the Raven Guard:** At the start of the Declare Battle Formations step, if your army includes Aethon Shaan and Kayvaan
...
- **Blackwing Mantle:** You can target this model’s unit with the Rapid Ingress and Heroic Intervention Stratagems for 0CP,
...
### Kayvaan Shrike
**Points:** 100 | **M:** 12" | **T:** 4 | **SV:** 3+ | **W:** 5 | **LD:** 6+ | **OC:** 1
**Keywords:** Epic Hero, Character, Infantry, Imperium, Fly, Jump Pack, Chapter Master, Kayvaan Shrike, Phobos

**Weapons:**
| Weapon | Type | Range | A | BS/WS | S | AP | D | Keywords |
|--------|------|-------|---|-------|---|----|---|----------|
| Blackout | Ranged | 18" | 2 | 2+ | 5 | -1 | 2 | Pistol, Precision |
| The Raven's Talons | Melee | Melee | 7 | 2+ | 5 | -2 | 2 | Precision, Twin-linked |

**Abilities:**

- **Trifold Path of Shadow:** While this model is leading a unit, models  in this unit cannot be targeted by ranged attacks unless the attacking model is within 12".
...
■ Assault Intercessors with Jump Packs
■ Vanguard Veteran Squad with Jump Packs
- **Inspiring Commander:** If you include this model in your army, until the end of the battle, non-Character models in Assault
