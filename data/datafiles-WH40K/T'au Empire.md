...
**Keywords:** Vehicle, Aircraft, Fly, AX-1-0 Tiger Shark, Non-Kroot
...
**Keywords:** Character, Infantry, Crucible, Fly, Battlesuit, Battlesuit Veteran
...
**Keywords:** Infantry, Battleline, Grenades, Markerlight, Fire Warrior, Breacher Team, Non-Kroot
...
**Keywords:** Vehicle, Walker, Battlesuit, Broadside, Non-Kroot
...
**Keywords:** Character, Infantry, Grenades, Cadre Fireblade, Non-Kroot
...
**Keywords:** Epic Hero, Vehicle, Walker, Fly, Character, Battlesuit, Commander Farsight, Non-Kroot
...
**Keywords:** Epic Hero, Infantry, Fly, Character, Battlesuit, Commander Shadowsun, Non-Kroot
...
**Keywords:** Character, Vehicle, Walker, Fly, Battlesuit, Commander in Coldstar Battlesuit, Non-Kroot
...
**Keywords:** Character, Vehicle, Walker, Fly, Battlesuit, Commander in Enforcer Battlesuit, Non-Kroot
...
**Keywords:** Vehicle, Walker, Fly, Battlesuit, Crisis, Fireknife, Non-Kroot
...
**Keywords:** Vehicle, Walker, Fly, Battlesuit, Crisis, Starscythe, Non-Kroot
...
**Keywords:** Vehicle, Walker, Fly, Battlesuit, Crisis, Sunforge, Non-Kroot
...
**Keywords:** Character, Epic Hero, Darkstrider, Markerlight, Infantry, Non-Kroot
...
**Keywords:** Vehicle, Fly, Transport, Dedicated Transport, Devilfish, Non-Kroot
...
**Keywords:** Character, Infantry, Ethereal, Non-Kroot
...
- **Coordinated Leadership:** In your Command phase, roll one D6: on a 4+, you gain 1CP.
- **Leader:** This model can be attached to the following units:
- Breacher Team
- Strike Team
...
**Keywords:** Character, Infantry, Markerlight, Firesight Team, Non-Kroot
...
**Keywords:** Vehicle, Walker, Fly, Smoke, Battlesuit, Ghostkeel, Non-Kroot
...
**Keywords:** Vehicle, Fly, Hammerhead Gunship, Non-Kroot
...
**Keywords:** Character, Infantry, Crucible, Kroot, Kinband Champion
...
- **Fieldcraft:** At the end of the your Command phase, if this unit within range of an objective marker you control, that objective marker remains under your control, even if you have no models within range of it, until your opponent controls it at the start or end of any turn.
...
### Kroot Farstalkers
**Points:** 85 | **M:** 12" | **T:** 3 | **SV:** 6+ | **W:** 1 | **LD:** 7+ | **OC:** 0
...
- **Rites of Feasting:** While this model is leading a unit, models in that unit have the Feel Not Pain 6+ ability. If that unit destroys one or more enemy units in the Fight phase, unit the end of the battle, models in that unit have the Feel No Pain 5+ ability instead.
...
**Keywords:** Character, Mounted, Kroot, Lone-spear
...
**Keywords:** Mounted, Kroot, Krootox Riders, Grenades
...
**Keywords:** Vehicle, Aircraft, Fly, Titanic, Transport, Markerlight, Manta, Non-Kroot
...
- **Damaged: 1-20 Wounds Remaining:** While this model has 1-20 wounds remaining, each time this model makes an attack, subtract 1 from the Hit roll.

---

### Pathfinder Team
**Points:** 90 | **M:** 7" | **T:** 3 | **SV:** 4+ | **W:** 1 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Grenades, Markerlight, Pathfinder Team, Non-Kroot
...
- **Grav-inhibitor Drone:** Each time an enemy unit selects the bearer's unit as the target of a charge, subtract 2 from the Charge roll (this is not cumulative with any other negative modifiers to that Charge roll).
...
### Piranha
**M:** 14" | **T:** 7 | **SV:** 4+ | **W:** 7 | **LD:** 7+ | **OC:** 2
**Keywords:** Vehicle, Fly, Piranha, Non-Kroot
...
- **Piranha:** At the end of your Movement phase, select one enemy unit within 12" of this unit; that enemy unit must take a Battle-shock test.

---

### Razorshark Strike Fighter
**Points:** 170 | **M:** 20+" | **T:** 10 | **SV:** 3+ | **W:** 12 | **LD:** 7+ | **OC:** 0
**Keywords:** Vehicle, Aircraft, Fly, Razorshark Strike Fighter, Non-Kroot
...
**Keywords:** Vehicle, Walker, Fly, Battlesuit, Riptide, Non-Kroot
...
### Shas'nel [Crucible]
**Points:** 50 | **M:** 6" | **T:** 3 | **SV:** 4+ | **W:** 3 | **LD:** 7+ | **OC:** 1
**Keywords:** Character, Infantry, Crucible, Grenades, Shas'nel
...
**Keywords:** Vehicle, Fly, Markerlight, Sky Ray Gunship, Non-Kroot
...
- **Velocity Tracker:** Each time this model makes an attack with a ranged weapon that targets a unit that can FLY, you can re-roll the Hit roll.

---

### Stealth Battlesuits
**Points:** 100 | **M:** 8" | **T:** 4 | **SV:** 3+ | **W:** 2 | **LD:** 7+ | **OC:** 1
**Keywords:** Infantry, Fly, Battlesuit, Stealth, Grenades, Markerlight, Non-Kroot
...
**Keywords:** Vehicle, Walker, Titanic, Towering, Stormsurge, Non-Kroot
...
- **Damaged: 1-5 Wounds Remaining:** While this model has 1-5 wounds remaining, subtract 3 from this models Objective Control characteristic, and each time this model makes an attack, subtract 1 from the Hit roll.
...
**Keywords:** Infantry, Battleline, Grenades, Markerlight, Fire Warrior, Strike Team, Non-Kroot
...
**Keywords:** Vehicle, Aircraft, Fly, Sun Shark Bomber, Non-Kroot
...
**Keywords:** Vehicle, Titanic, Walker, Towering, Ta'unar Supremacy Armour, Non-Kroot
...
- **Damaged: 1-10 Wounds Remaining:** While this model has 1-10 wounds remaining, subtract 5 from this model’s Objective Control characteristic and each time this model makes an attack, subtract 1 from the Hit roll.
- **Super-Heavy Walker:** Each time a model with this ability makes a Normal, Advance or Fall Back move, it can move through models (excluding Titanic models) and terrain features that are 4" or less in height as if they were not there.

---

### The Twin Lance
**Points:** 160 | **M:** 10" | **T:** 6 | **SV:** 2+ | **W:** 8 | **LD:** 6+ | **OC:** 2
**Keywords:** Epic Hero, Vehicle, Walker, Fly, Character, Battlesuit, Non-Kroot, The Twin Lance
...
- **Neocapacitor Shields:** At the start of your opponent’s Charge phase, you can select one enemy unit (excluding Monster and Vehicle units) within 12" of this unit. That unit must take a Battle‑shock test and, until the end of the turn, subtract 1 from Charge rolls made for that unit.
...
- **Retro-thrusters:** At the end of the Fight phase, this unit can either make a Normal move of up to 6" or a Fall Back move.

---

### Tidewall Droneport
**Points:** 85 | **M:** 4" | **T:** 8 | **SV:** 3+ | **W:** 10 | **LD:** 7+ | **OC:** 0
**Keywords:** Fortification, Vehicle, Transport, Fly, Tidewall Droneport, Non-Kroot
...
- **Droneport:** Each time this FORTIFICATION is selected to shoot, its drone defenders weapon will target and resolve attacks against every enemy unit that is an eligible target to this FORTIFICATION.

---

### Tidewall Gunrig
**Points:** 90 | **M:** 4" | **T:** 8 | **SV:** 3+ | **W:** 14 | **LD:** 7+ | **OC:** 0
**Keywords:** Fortification, Vehicle, Transport, Fly, Tidewall Gunrig, Non-Kroot
**Transport:** This model has a transport capacity of 11 T’AU EMPIRE INFANTRY models. It cannot transport BATTLESUIT, KROOT or VESPID STINGWINGS models.
...
### Tidewall Shieldline
**Points:** 85 | **M:** 4" | **T:** 8 | **SV:** 3+ | **W:** 10 | **LD:** 7+ | **OC:** 0
**Keywords:** Fortification, Vehicle, Transport, Fly, Tidewall Shieldline, Non-Kroot
...
**Keywords:** Vehicle, Aircraft, Fly, Tiger Shark, Non-Kroot
...
**Keywords:** Infantry, Fly, Vespid Stingwings, Non-Kroot
